...
import java.util.*;
public class AyreianVivillonNine extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonNine(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonNine",
                Type.GHOST,Type.BUG,
                new Stats(80,
                        52,
                        65,
