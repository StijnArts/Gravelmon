...
import java.util.*;
public class SoulstonesanBarbaracle extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBarbaracle(int dex) {
        super(dex, "Barbaracle",
                ...
                List.of("It has reached a level of psychic mastery that it is capable of attacking from afar and anticipating enemy attacks because it has seen into the future."),
                List.of(),
                List.of(
