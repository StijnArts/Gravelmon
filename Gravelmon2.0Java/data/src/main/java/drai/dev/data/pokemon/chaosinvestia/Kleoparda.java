...
import java.util.*;
public class Kleoparda extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kleoparda() {
        super("Kleoparda",
                Type.DARK,
                new Stats(64,
                ...
                70,
                50, List.of(),
                List.of("Verbirgt seine Aura und nähert sich seinem Gegner völlig unbemerkt von hinten, um ihm den Garaus zu machen."),
                List.of(),
                List.of(
