...
public class Clefairy extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clefairy() {
        super("Clefairy",
                ...
                70,
                50, List.of(),
                List.of("It is said that happiness will come to those who see a gathering of Clefairy dancing under a full moon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEALING_WISH,48),
                        ...
                        new MoveLearnSetEntry(Move.METRONOME,20),
