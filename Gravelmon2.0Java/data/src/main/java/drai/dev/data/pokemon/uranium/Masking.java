...
public class Masking extends Pokemon {
    public Masking() {
        super("Masking",
                Type.PSYCHIC,
                new Stats(45,
                ...
                List.of("It is capable of disguising itself as anything it likes. Although it appears to be a bird Mon, this is just an illusion. No one has seen its true form."),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TRANSFORM,53),
