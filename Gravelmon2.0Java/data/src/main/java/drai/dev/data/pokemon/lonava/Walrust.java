...
import java.util.*;
public class Walrust extends drai.dev.data.pokemon.Pokemon {
    public Walrust() {
        super("Walrust",
                Type.STEEL,
                new Stats(85,
                        ...
                        110,
                        60),
                List.of(Ability.ROUGH_SKIN), Ability.LIGHT_METAL,
                24, 4540,
                ...
                List.of("Walrust use their powerful incisors to fashion pieces of scrap metal into sharp (and deadly) armour. Over time this armour is absorbed into their skin, meaning that the older a Walrust, the tougher and more dangerous they are."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.ACID_ARMOR,1),
                        new MoveLearnSetEntry(Move.POUND,1),
                        new MoveLearnSetEntry(Move.ABYSSALDIVE,1),
                        new MoveLearnSetEntry(Move.IRON_DEFENSE,10),
                        new MoveLearnSetEntry(Move.WATER_GUN,13),
                        new MoveLearnSetEntry(Move.SLAM,16),
