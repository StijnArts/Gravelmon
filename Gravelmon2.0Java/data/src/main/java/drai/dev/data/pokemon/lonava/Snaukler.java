...
import java.util.*;
public class Snaukler extends drai.dev.data.pokemon.Pokemon {
    public Snaukler() {
        super("Snaukler",
                Type.WATER,
                new Stats(80,
                ...
                List.of("Snaukler developed their signature beak as a result of overhunting. Unable to fly away due to their short wings, whenever they spot a predator they simply jump off the sea cliffs they live in into the ocean below."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FACADE,21),
                ...
                0, List.of(
                ), SpawnContext.SUBMERGED, SpawnPool.UNCOMMON, 27, 54, 1.2, List.of(
