...
import java.util.*;
public class SoulstonesanPorygonZ extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPorygonZ(int dex) {
        super(dex, "PorygonZ",
                Type.BUG,Type.DARK,
                new Stats(85,
                        135,
                ...
                List.of("Its ability to distort and corrupt data allows it to warp spacetime around itself, causing glitches in the fabric of reality."),
                List.of(),
                List.of(
