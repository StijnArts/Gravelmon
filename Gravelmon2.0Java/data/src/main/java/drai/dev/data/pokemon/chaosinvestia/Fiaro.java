...
import java.util.*;
public class Fiaro extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fiaro() {
        super("Fiaro",
                ...
                70,
                50, List.of(),
                List.of("Bei der Jagd erreicht es Geschwindigkeiten von bis zu 500 km/h. Es erledigt seine Beute mit einem kräftigen Tritt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AGILITY,13),
                        new MoveLearnSetEntry(Move.STEEL_WING,60),
