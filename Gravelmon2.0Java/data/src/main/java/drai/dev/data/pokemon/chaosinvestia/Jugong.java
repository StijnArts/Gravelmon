...
import java.util.*;
public class Jugong extends drai.dev.gravelmon.pokemon.Pokemon {
    public Jugong() {
        super("Jugong",
                Type.WATER,Type.ICE,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Sein Körper ist mit einem weißen Fell bedeckt, das es im Schnee fast unsichtbar für Gegner macht."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHEER_COLD,34),
                        ...
                        new MoveLearnSetEntry(Move.HAIL,65)                        ),
