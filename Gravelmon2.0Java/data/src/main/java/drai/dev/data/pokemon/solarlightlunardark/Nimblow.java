...
import java.util.*;
public class Nimblow extends drai.dev.data.pokemon.Pokemon {
    public Nimblow() {
        super("Nimblow",
                Type.FLYING,
                new Stats(60,
                ...
                List.of("Because Nimblow's bodies mostly consist of water vapor, they shrink during droughts and grow during rainy seasons."),
                List.of(new EvolutionEntry("cirribus", EvolutionType.ITEM_INTERACT, false, List.of(), 
