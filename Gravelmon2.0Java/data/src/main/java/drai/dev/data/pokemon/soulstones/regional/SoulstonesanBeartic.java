...
import java.util.*;
public class SoulstonesanBeartic extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBeartic(int dex) {
        super(dex, "Beartic",
                Type.NORMAL,
                new Stats(90,
                        125,
                ...
                List.of("It is very irritable when it is awoken from sleep. It can go on rampages when it is hungry."),
                List.of(),
                List.of(
