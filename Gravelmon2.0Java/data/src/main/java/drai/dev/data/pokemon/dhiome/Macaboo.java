...
import java.util.*;
public class Macaboo extends drai.dev.data.pokemon.Pokemon {
    public Macaboo() {
        super("Macaboo",
                Type.GHOST,
                new Stats(0,
                ...
                List.of("During stormy nights it can be seen wondering at ports, scaring unsespecting sailors. An encounter with that pokemon is considered bad luck."),
                List.of(new EvolutionEntry("spectross", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 11, 35, 4, List.of(
