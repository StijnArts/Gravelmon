...
import java.util.*;
public class AyreianVivillonTwo extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonTwo(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonTwo",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TOXIC_THREAD,12),
