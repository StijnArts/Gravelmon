...
import java.util.*;
public class Zurrokex extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zurrokex() {
        super("Zurrokex",
                ...
                70,
                50, List.of(),
                List.of("Es hat einen dicken Schädel und versetzt jedem, mit dem sich sein Blick kreuzt, eine Kopfnuss."),
                List.of(),
                List.of(
