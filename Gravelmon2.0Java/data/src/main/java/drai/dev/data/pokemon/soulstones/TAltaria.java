...
import java.util.*;
public class TAltaria extends drai.dev.gravelmon.pokemon.Pokemon {
    public TAltaria() {
        super("TAltaria",
                ...
                List.of("These Altaria fly into stormy clouds to attract lightning as a means of healing themselves and boosting their own power."),
                List.of(),
                List.of(
