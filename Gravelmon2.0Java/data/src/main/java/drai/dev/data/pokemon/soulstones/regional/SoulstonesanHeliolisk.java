...
import java.util.*;
public class SoulstonesanHeliolisk extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanHeliolisk(int dex) {
        super(dex, "Heliolisk",
                ...
                List.of("The snakes on this Pokemon's head are capable of turning their target to stone, significantly lowering their speed, making hunting easy."),
                List.of(),
                List.of(
