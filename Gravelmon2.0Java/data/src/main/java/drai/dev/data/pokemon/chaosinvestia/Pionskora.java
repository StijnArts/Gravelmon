...
import java.util.*;
public class Pionskora extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pionskora() {
        super("Pionskora",
                ...
                new Stats(40,
                        ...
                        30,
                        55),
                List.of(Ability.BATTLE_ARMOR,Ability.SNIPER), null,
                8, 120,
                ...
                70,
                50, List.of(),
                List.of("Es kann ein Jahr ohne Nahrung überleben. Greift mit dem Gift aus den Krallen an seinem Schweif an."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.CROSS_POISON,49),
                        new MoveLearnSetEntry(Move.ACUPRESSURE,13),
                        new MoveLearnSetEntry(Move.PURSUIT,16),
                        new MoveLearnSetEntry(Move.TOXIC_SPIKES,34),
                        new MoveLearnSetEntry(Move.KNOCK_OFF,5),
