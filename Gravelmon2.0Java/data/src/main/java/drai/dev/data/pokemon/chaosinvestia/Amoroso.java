...
import java.util.*;
public class Amoroso extends drai.dev.gravelmon.pokemon.Pokemon {
    public Amoroso() {
        super("Amoroso",
                ...
                70,
                50, List.of(),
                List.of("Man geht davon aus, dass das Pokémon ausgestorben ist, weil seine spiralförmige Schale zu groß wurde."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROCK_BLAST,56),
