...
public class Celebi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Celebi() {
        super("Celebi",
                ...
                70,
                50, List.of(),
                List.of("This Pokémon traveled through time to come from the future. It bolsters grass and trees with its own strength, and it can heal wounds, too."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HEAL_BELL,1),
                        new MoveLearnSetEntry(Move.LEECH_SEED,50),
                        new MoveLearnSetEntry(Move.CONFUSION,1),
                        new MoveLearnSetEntry(Move.RECOVER,60),
                        new MoveLearnSetEntry(Move.HEALING_WISH,80),
                        new MoveLearnSetEntry(Move.LEAF_STORM,90),
                        new MoveLearnSetEntry(Move.MAGICAL_LEAF,10),
                        new MoveLearnSetEntry(Move.PERISH_SONG,100),
                        new MoveLearnSetEntry(Move.LIFE_DEW,40),
                        new MoveLearnSetEntry(Move.ANCIENT_POWER,30),
                        new MoveLearnSetEntry(Move.BATON_PASS,20),
                        new MoveLearnSetEntry(Move.FUTURE_SIGHT,70),
