...
//        pokemon.add(new Plagarata());   Missing Stats
//        pokemon.add(new Pomfly());   Missing Stats
//        pokemon.add(new Snoutfly());   Missing Stats
...
//        pokemon.add(new Suastalk());   Missing Stats
...
//        pokemon.add(new Phrynotoad());   Missing Stats
//        pokemon.add(new Jokaite());   Missing Stats
//        pokemon.add(new Lannatee());  Missing Stats
...
//        pokemon.add(new Posschest());   Missing Stats
//        pokemon.add(new Figurina());   Missing Stats
...
//        pokemon.add(new Bonkeet());  Missing Stats
//        pokemon.add(new Kaidalope());  Missing Stats
//        pokemon.add(new Faigalope());   Missing Stats
...
//        pokemon.add(new Rokubandy());  Missing Name  Missing Stats
...
//        pokemon.add(new Eruptor());   Missing Stats
...
//        pokemon.add(new Pestileon());   Missing Stats
//        pokemon.add(new Pupshi());   Missing Stats
//        pokemon.add(new Typhur());   Missing Stats
//        pokemon.add(new Typhoonos());   Missing Stats
//        pokemon.add(new Pottlin());  Missing Stats
//        pokemon.add(new Pottyrm());  Missing Stats
...
//        pokemon.add(new Duabat());   Missing Stats
...
//        pokemon.add(new Onyssilade());   Missing Stats
//        pokemon.add(new Mushi());   Missing Stats
//        pokemon.add(new Mutungus());   Missing Stats
//        pokemon.add(new MushShi());   Missing Stats
//        pokemon.add(new Mimicorn());   Missing Stats
//        pokemon.add(new Grumchick());   Missing Stats
//        pokemon.add(new Horribill());   Missing Stats
//        pokemon.add(new Moschievous());  Missing Stats
//        pokemon.add(new Embush());   Missing Stats
//        pokemon.add(new Yatatree());   Missing Stats
//        pokemon.add(new Humini());   Missing Stats
//        pokemon.add(new Bellagon());Member of line Not Finished
//        pokemon.add(new Smokebreak());   Missing Stats
//        pokemon.add(new Palegon());   Missing Stats
...
//        pokemon.add(new Safauna());   Missing Stats
