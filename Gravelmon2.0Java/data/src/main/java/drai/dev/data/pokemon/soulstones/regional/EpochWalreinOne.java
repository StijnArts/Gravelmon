...
import java.util.*;
public class EpochWalreinOne extends drai.dev.data.pokemon.Pokemon {
    public EpochWalreinOne(String name, Aspect aspect) {
        super(name, aspect, "EpochWalreinOne",
                ...
                List.of("This Pokémon has a plushy mode when it can be squeezed, and a second mode where its 'fur' is made of reinforced steel and almost impenetrable."),
                List.of(),
                List.of(
