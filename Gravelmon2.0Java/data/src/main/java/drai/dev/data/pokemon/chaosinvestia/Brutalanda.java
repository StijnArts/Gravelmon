...
import java.util.*;
public class Brutalanda extends drai.dev.gravelmon.pokemon.Pokemon {
    public Brutalanda() {
        super("Brutalanda",
                ...
                70,
                50, List.of(),
                List.of("Seine Zellstruktur änderte sich, es wuchsen ihm Flügel, da es immer davon träumte, fliegen zu können."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGON_TAIL,80),
                        new MoveLearnSetEntry(Move.EMBER,25),
                        new MoveLearnSetEntry(Move.HEADBUTT,16),
                        new MoveLearnSetEntry(Move.FIRE_FANG,1),
                        new MoveLearnSetEntry(Move.DRAGON_CLAW,61),
