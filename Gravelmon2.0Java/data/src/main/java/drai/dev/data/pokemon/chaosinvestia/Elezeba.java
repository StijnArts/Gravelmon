...
import java.util.*;
public class Elezeba extends drai.dev.gravelmon.pokemon.Pokemon {
    public Elezeba() {
        super("Elezeba",
                Type.ELECTRIC,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Es erscheint, wenn Gewitterwolken den Himmel verdunkeln. Es fängt mit seiner Mähne Blitze und hortet ihre Energie."),
                List.of(),
                List.of(
