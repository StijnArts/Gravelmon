...
import java.util.*;
public class Kongrilla extends drai.dev.data.pokemon.Pokemon {
    public Kongrilla() {
        super("Kongrilla",
                ...
                List.of("Kongrilla are incredibly territorial Pokémon. They often fight against clans of other Kongrilla just to ensure their territories weren't intruded on."),
                List.of(),
                List.of(
