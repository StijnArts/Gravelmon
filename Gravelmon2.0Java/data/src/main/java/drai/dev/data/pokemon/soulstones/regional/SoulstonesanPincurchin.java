...
import java.util.*;
public class SoulstonesanPincurchin extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPincurchin(int dex) {
        super(dex, "Pincurchin",
