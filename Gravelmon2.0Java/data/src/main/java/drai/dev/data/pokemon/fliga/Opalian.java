...
import java.util.*;
public class Opalian extends drai.dev.data.pokemon.Pokemon {
    public Opalian() {
        super("Opalian",
                ...
                new Stats(70,
                        ...
                        120,
                        90),
                List.of(Ability.ILLUMINATE,Ability.SOUNDPROOF), Ability.POWER_SPOT,
                30, 3321,
                ...
                List.of("Gallantly defending the deep caverns of Fliga, Opalian are the perfect blend of elegance and toughness. Many Opalian never leave the deeper parts of the cavern due to their defensive attitudes."),
                List.of(),
                List.of(
                ...
                List.of(Label.FLIGA),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 34, 52, .5, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_CAVE, Biome.IS_MOUNTAIN))
                ), List.of(),
                List.of(SpawnPreset.NATURAL),
                0.28, 0.3,
                List.of());
           setLangFileName("Opalian");
