...
import java.util.*;
public class SoulstonesanAggron extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanAggron(int dex) {
        super(dex, "Aggron",
                Type.BUG,Type.ROCK,
                new Stats(80,
                        115,
                ...
                List.of("When the previous lair king passes on, two Lairons fight each other to assert dominance. The winner evolves and becomes king of the lair."),
                List.of(),
                List.of(
