...
import static drai.dev.data.jsonwriters.assets.SpeciesAssetsJSONWriter.createPlaceholderTextureIfNotExists;
...
//                        }
//                    }
                    BufferedWriter writer = new BufferedWriter(new FileWriter(dir + order + "_" + GravelmonUtils.getCleanName(set.getKey()) + "_" + pokemon.getAdditionalAspect().name().toLowerCase() + ".json"));
