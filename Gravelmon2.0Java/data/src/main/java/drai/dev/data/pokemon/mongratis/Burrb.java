...
import java.util.*;
public class Burrb extends drai.dev.data.pokemon.Pokemon {
    public Burrb() {
        super("Burrb",
                ...
                List.of(new EvolutionEntry("spikonsia", EvolutionType.ITEM_INTERACT, false, List.of(),
