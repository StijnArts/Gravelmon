...
import java.util.*;
public class Chaneira extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chaneira() {
        super("Chaneira",
                Type.NORMAL,
                new Stats(250,
                        ...
                        35,
                        105),
                List.of(Ability.NATURAL_CURE,Ability.SERENE_GRACE), null,
                11, 346,
                ...
                70,
                50, List.of(),
                List.of("Ein freundliches Pokémon, das seine nahrhaften Eier mit verletzten Pokémon und Menschen teilt."),
                List.of(),
                List.of(
