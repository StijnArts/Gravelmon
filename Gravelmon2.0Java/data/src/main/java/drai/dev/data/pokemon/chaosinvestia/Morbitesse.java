...
import java.util.*;
public class Morbitesse extends drai.dev.gravelmon.pokemon.Pokemon {
    public Morbitesse() {
        super("Morbitesse",
                Type.PSYCHIC,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Kann anhand der Sternenkonstellationen die Zukunft voraussagen. Es weiß sogar, wie alt sein Trainer werden wird."),
                List.of(),
                List.of(
