...
import java.util.*;
public class Jeweltal extends drai.dev.data.pokemon.Pokemon {
    public Jeweltal() {
        super("Jeweltal",
                Type.BUG,Type.ROCK,
                new Stats(70,
                ...
                List.of("Ancient Rikotoan Desert Pharaohs would train Jeweltal to sit atop their crown. This both displayed their nobility and protected them from would-be assassins."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HARDEN,1),
                        new MoveLearnSetEntry(Move.SKITTER_SMACK,24),
                        new MoveLearnSetEntry(Move.STEALTH_ROCK,58),
                        new MoveLearnSetEntry(Move.SMACK_DOWN,12),
                        new MoveLearnSetEntry(Move.RECYCLE,28),
                        new MoveLearnSetEntry(Move.SHATTERGEM,28),
                        new MoveLearnSetEntry(Move.BARRIER,53),
                        new MoveLearnSetEntry(Move.BUG_BUZZ,48),
                        new MoveLearnSetEntry(Move.COVET,8),
                        new MoveLearnSetEntry(Move.LIGHTBURST,20),
                        new MoveLearnSetEntry(Move.MAGIC_COAT,0),
                        ...
                        new MoveLearnSetEntry(Move.MYSTICWAVE,1),
