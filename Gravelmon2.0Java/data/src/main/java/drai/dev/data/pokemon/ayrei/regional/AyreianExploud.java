...
import java.util.*;
public class AyreianExploud extends drai.dev.data.pokemon.Pokemon {
    public AyreianExploud(String name, Aspect aspect) {
        super(name, aspect, "Exploud",
                Type.SOUND,
                new Stats(104,
                        71,
                        63,
                ...
                List.of("This Pokémon can do more than just shout. To communicate with others of its kind, it'll emit all sorts of sounds from the holes in its body."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SUPERSONIC,36),
                        ...
                        new MoveLearnSetEntry(Move.FLAMETHROWER,0),
