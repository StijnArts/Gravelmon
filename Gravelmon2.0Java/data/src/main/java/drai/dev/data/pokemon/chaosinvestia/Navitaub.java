...
import java.util.*;
public class Navitaub extends drai.dev.gravelmon.pokemon.Pokemon {
    public Navitaub() {
        super("Navitaub",
                ...
                70,
                50, List.of(),
                List.of("Viele Leute glauben, dass es tief in seinem heimatlichen Wald ein Land der Harmonie gibt, wo man keine Kriege kennt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RAZOR_WIND,36),
