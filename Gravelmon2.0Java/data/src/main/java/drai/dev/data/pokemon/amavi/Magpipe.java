...
import java.util.*;
public class Magpipe extends drai.dev.data.pokemon.Pokemon {
    public Magpipe() {
        super("Magpipe",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("lyricroon", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.AMAVI),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 16, 34, .3, List.of(
