...
import java.util.*;
public class EpochSprigatito extends drai.dev.data.pokemon.Pokemon {
    public EpochSprigatito(String name, Aspect aspect) {
        super(name, aspect, "EpochSprigatito",
                ...
                List.of("It stole its master's wand and refuses to let go of it because it gives it magical abilities."),
                List.of(new EvolutionEntry("epochfloragato", EvolutionType.LEVEL_UP, List.of(), 
