...
import java.util.*;
public class TheossianRaichu extends drai.dev.data.pokemon.Pokemon {
    public TheossianRaichu(String name, Aspect aspect) {
        super(name, aspect, "Raichu",
                ...
                List.of());
        setCanFly(true);
        addAdditionalEvolution("pikachu", new EvolutionEntry(this.getCleanName(), EvolutionType.ITEM_INTERACT, false, List.of(),
                List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.BIOME, Biome.IS_PEAK.getId() + ":" + Biome.IS_PEAK.getName())),List.of(),"cobblemon:thunder_stone"));
