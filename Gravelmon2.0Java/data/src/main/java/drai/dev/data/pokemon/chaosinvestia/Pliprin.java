...
import java.util.*;
public class Pliprin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pliprin() {
        super("Pliprin",
                Type.WATER,
                new Stats(64,
                ...
                70,
                50, List.of(),
                List.of("Jedes Pliprin geht davon aus, dass es das wichtigste ist. Daher können sie keine Gruppen bilden."),
                List.of(),
                List.of(
