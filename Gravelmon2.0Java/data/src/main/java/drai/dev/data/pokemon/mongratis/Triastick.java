...
import java.util.*;
public class Triastick extends drai.dev.data.pokemon.Pokemon {
    public Triastick() {
        super("Triastick",
                ...
                List.of(new EvolutionEntry("jurasper", EvolutionType.LEVEL_UP, List.of(),
