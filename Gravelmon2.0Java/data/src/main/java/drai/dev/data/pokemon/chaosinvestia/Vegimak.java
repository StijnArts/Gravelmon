...
import java.util.*;
public class Vegimak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Vegimak() {
        super("Vegimak",
                Type.GRASS,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Schwächelnden Pokémon gibt es ein paar der Kräuter auf seinem Kopf ab und hilft ihnen so wieder auf die Beine."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SEED_BOMB,22),
