...
import java.util.*;
public class Dressella extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dressella() {
        super("Dressella",
                Type.GRASS,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Der Duft des Blumenschmucks auf seinem Kopf wirkt beruhigend. Damit der Schmuck nicht verwelkt, muss man es gut pflegen."),
                List.of(),
                List.of(
