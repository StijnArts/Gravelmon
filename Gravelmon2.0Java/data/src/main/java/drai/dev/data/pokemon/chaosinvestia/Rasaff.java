...
import java.util.*;
public class Rasaff extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rasaff() {
        super("Rasaff",
                Type.FIGHTING,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Siehst du ihm in die Augen, wird es wütend. Rennst du weg, wird es noch wütender. Ärgerst du es..."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PUNISHMENT,53),
