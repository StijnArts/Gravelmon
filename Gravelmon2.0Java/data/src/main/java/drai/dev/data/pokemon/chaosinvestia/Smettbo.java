...
import java.util.*;
public class Smettbo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Smettbo() {
        super("Smettbo",
                ...
                70,
                50, List.of(),
                List.of("Es liebt Blütenhonig. Es findet selbst Blumen, die sehr wenig Pollen haben."),
                List.of(),
                List.of(
