...
import java.util.*;
public class Flapteryx extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flapteryx() {
        super("Flapteryx",
                ...
                70,
                50, List.of(),
                List.of("Es wurde aus einem Fossil reanimiert. Man geht davon aus, dass es der Urahn aller Vogel-Pokémon ist."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ENDEAVOR,38),
