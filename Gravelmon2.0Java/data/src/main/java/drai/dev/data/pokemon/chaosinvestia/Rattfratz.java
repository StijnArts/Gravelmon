...
import java.util.*;
public class Rattfratz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rattfratz() {
        super("Rattfratz",
                Type.NORMAL,
                new Stats(30,
                ...
                70,
                50, List.of(),
                List.of("Es strotzt vor Lebenskraft und kann in jeder Umgebung leben. Es ist extrem vorsichtig."),
                List.of(),
                List.of(
