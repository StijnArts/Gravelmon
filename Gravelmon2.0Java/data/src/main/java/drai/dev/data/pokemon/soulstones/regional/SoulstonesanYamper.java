...
import java.util.*;
public class SoulstonesanYamper extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanYamper(int dex) {
        super(dex, "Yamper",
                Type.NORMAL,
                new Stats(45,
                        55,
                ...
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.RAPIDSTRIKE,42),
