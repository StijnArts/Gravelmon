...
import java.util.*;
public class Flowby extends drai.dev.data.pokemon.Pokemon {
    public Flowby() {
        super("Flowby",
                Type.FLYING,
                new Stats(40,
                ...
                List.of("Although small and light, Flowby can use its control over the wind to create strong breezes that are capable of lifting an adult off their feet."),
                List.of(new EvolutionEntry("nimblow", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"22")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WEATHER_BALL,43),
