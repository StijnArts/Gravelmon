...
import java.util.*;
public class Bidifas extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bidifas() {
        super("Bidifas",
                ...
                70,
                50, List.of(),
                List.of("Ein von Bidifas eingedämmter Fluss tritt niemals über seine Ufer. Dafür sind die Anrainer dankbar."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HYPER_FANG,23)                        ),
