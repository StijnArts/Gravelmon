...
import java.util.*;
public class Sedimantur extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sedimantur() {
        super("Sedimantur",
                Type.ROCK,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Energie, die ungehindert aus seinem Körper austrat, hat sich an ihm zu orangefarbenen Kristallen verfestigt."),
                List.of(),
                List.of(
