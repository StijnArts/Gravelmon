...
import java.util.*;
public class Grebbit extends drai.dev.gravelmon.pokemon.Pokemon {
    public Grebbit() {
        super("Grebbit",
                ...
                new Stats(85,
                        ...
                        50,
                        77),
                List.of(Ability.PICKUP,Ability.CHEEK_POUCH), null,
                10, 424,
                ...
                70,
                50, List.of(),
                List.of("Mit Ohren so mächtig wie ein Bagger kann es selbst das härteste Gestein zertrümmern. Ist es fertig mit Graben, lümmelt es herum."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ODOR_SLEUTH,26),
                        ...
                        new MoveLearnSetEntry(Move.FACADE,53),
