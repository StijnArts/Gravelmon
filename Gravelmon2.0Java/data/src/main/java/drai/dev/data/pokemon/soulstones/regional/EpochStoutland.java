...
import java.util.*;
public class EpochStoutland extends drai.dev.data.pokemon.Pokemon {
    public EpochStoutland(String name, Aspect aspect) {
        super(name, aspect, "EpochStoutland",
                ...
                List.of("The spirit of a Stoutland that passed away after abuse and starvation. Even death will not give this Pokemon peace and rest."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 37, 54, .1, List.of(
