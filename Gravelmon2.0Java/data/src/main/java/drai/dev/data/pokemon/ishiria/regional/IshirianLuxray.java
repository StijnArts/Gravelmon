...
import java.util.*;
public class IshirianLuxray extends drai.dev.data.pokemon.Pokemon {
    public IshirianLuxray(String name, Aspect aspect) {
        super(name, aspect, "IshirianLuxray",
                ...
                List.of("Luxray’s ability to see through objects comes in handy when it’s scouting for danger."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.THUNDER_WAVE,42),
