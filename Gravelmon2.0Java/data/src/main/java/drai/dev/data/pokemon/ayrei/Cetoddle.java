...
import java.util.*;
public class Cetoddle extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cetoddle() {
        super("Cetoddle",
                Type.ICE,
                new Stats(108,
                        ...
                        30,
                        40),
                List.of(Ability.THICK_FAT,Ability.SNOW_CLOAK), Ability.SHEER_FORCE,
                12, 450,
                new Stats(1,68,45,43,30,40), 150,
                0.5,
                67, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("This species left the ocean and began living on land a very long time ago. It seems to be closely related to Wailmer."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.FLAIL,25),
                        new MoveLearnSetEntry(Move.BLIZZARD,53),
                        new MoveLearnSetEntry(Move.TACKLE,1),
                        new MoveLearnSetEntry(Move.BOUNCE,31),
                        new MoveLearnSetEntry(Move.AMNESIA,40),
                        new MoveLearnSetEntry(Move.AVALANCHE,27),
                        new MoveLearnSetEntry(Move.REST,15),
                        new MoveLearnSetEntry(Move.DOUBLEEDGE,49),
                        new MoveLearnSetEntry(Move.ICE_SPINNER,44),
