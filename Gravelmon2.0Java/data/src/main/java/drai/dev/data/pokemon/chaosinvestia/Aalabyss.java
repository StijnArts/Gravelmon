...
import java.util.*;
public class Aalabyss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Aalabyss() {
        super("Aalabyss",
                Type.WATER,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Es lebt tief im Meer. Sein Schweif ist wie ein kleiner Fisch geformt. Mit ihm lockt es Beute an."),
                List.of(),
                List.of(
