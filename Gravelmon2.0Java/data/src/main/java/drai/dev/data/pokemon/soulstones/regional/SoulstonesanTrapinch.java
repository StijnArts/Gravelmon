...
import java.util.*;
public class SoulstonesanTrapinch extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTrapinch(int dex) {
        super(dex, "Trapinch",
                Type.ICE,
                new Stats(45,
                        65,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ARCTICPARASITE,"egg"),
