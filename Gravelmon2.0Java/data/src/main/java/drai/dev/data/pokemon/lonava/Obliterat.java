...
import java.util.*;
public class Obliterat extends drai.dev.data.pokemon.Pokemon {
    public Obliterat() {
        super("Obliterat",
                Type.DARK,
                new Stats(40,
                        ...
                        45,
                        65),
                List.of(Ability.RUN_AWAY,Ability.TANGLING_HAIR), Ability.ANGER_POINT,
                4, 38,
                ...
                List.of("Obliterat arrived on the island of Harsholme on a ship, where they proceeded to decimate the local ecosystem. Fortunately, they have been brought down to a manageable number in recent years. However, as a result, their anger towards humans has never been higher."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HYPER_FANG,14),
                        new MoveLearnSetEntry(Move.FRUSTRATION,17),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 6, 24, 4.4, List.of(
