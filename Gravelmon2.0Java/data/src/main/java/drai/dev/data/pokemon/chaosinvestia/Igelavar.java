...
import java.util.*;
public class Igelavar extends drai.dev.gravelmon.pokemon.Pokemon {
    public Igelavar() {
        super("Igelavar",
                Type.FIRE,
                new Stats(58,
                ...
                70,
                50, List.of(),
                List.of("Es bedroht seine Gegner mit der Hitze seiner Flammen. Ist es kampfbereit, lodern sie stärker."),
                List.of(),
                List.of(
