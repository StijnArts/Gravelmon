...
import java.util.*;
public class Groink extends drai.dev.gravelmon.pokemon.Pokemon {
    public Groink() {
        super("Groink",
                Type.PSYCHIC,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("Mit schwarzen Perlen verstärkt es seine Psycho-Kräfte. Mit einem Tanz kontrolliert es seine Gegner."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PSYSHOCK,42),
