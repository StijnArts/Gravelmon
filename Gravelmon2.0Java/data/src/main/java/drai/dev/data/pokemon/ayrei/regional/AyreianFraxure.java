...
import java.util.*;
public class AyreianFraxure extends drai.dev.data.pokemon.Pokemon {
    public AyreianFraxure(String name, Aspect aspect) {
        super(name, aspect,"AyreianFraxure",
