...
import java.util.*;
public class Aeropteryx extends drai.dev.gravelmon.pokemon.Pokemon {
    public Aeropteryx() {
        super("Aeropteryx",
                ...
                70,
                50, List.of(),
                List.of("Zu Fuß ist es schneller unterwegs als in der Luft. Bei der Jagd kann es in Sachen Tempo selbst mit Autos mithalten."),
                List.of(),
                List.of(
