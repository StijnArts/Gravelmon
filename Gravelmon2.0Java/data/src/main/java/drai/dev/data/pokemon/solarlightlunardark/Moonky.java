...
import java.util.*;
public class Moonky extends drai.dev.data.pokemon.Pokemon {
    public Moonky() {
        super("Moonky",
                Type.PSYCHIC,
                new Stats(45,
                ...
                List.of("Moonky can be difficult to train due to their rambunctious nature. They're said to have come from the moon ages ago."),
                List.of(new EvolutionEntry("lunape", EvolutionType.ITEM_INTERACT, false, List.of(), 
