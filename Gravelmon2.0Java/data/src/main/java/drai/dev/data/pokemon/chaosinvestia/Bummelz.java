...
import java.util.*;
public class Bummelz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bummelz() {
        super("Bummelz",
                Type.NORMAL,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Es verbringt fast den ganzen Tag mit Faulenzen und Schlafen. Selbst sein Anblick macht bereits müde."),
                List.of(),
                List.of(
