...
import java.util.*;
public class EpochBlitzleOne extends drai.dev.data.pokemon.Pokemon {
    public EpochBlitzleOne(String name, Aspect aspect) {
        super(name, aspect, "EpochBlitzleOne",
                ...
                List.of("This pokemon is still young and quite hyper, only resting when completely exhausted. This can sometimes leave them vulnerable if not careful."),
                List.of(new EvolutionEntry("epochtwozebstrika", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"27")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONFURY,"egg"),
