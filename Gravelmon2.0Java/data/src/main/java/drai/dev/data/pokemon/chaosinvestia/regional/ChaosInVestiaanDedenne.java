...
import java.util.*;
public class ChaosInVestiaanDedenne extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanDedenne(String name, Aspect aspect) {
        super(name, aspect, "Dedenne",
