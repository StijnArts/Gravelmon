...
import java.util.*;
public class Hypnosmog extends drai.dev.data.pokemon.Pokemon {
    public Hypnosmog() {
        super("Hypnosmog",
                ...
                List.of("Hypnosmog can freely control the movement of the smog cloud around it. No armor can hope to shield one from their hypnotic smoke."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.MESMER_SMOKE,51),
                        new MoveLearnSetEntry(Move.CORROSIVE_GAS,0),
