...
import java.util.*;
public class EpochThwackey extends drai.dev.data.pokemon.Pokemon {
    public EpochThwackey(String name, Aspect aspect) {
        super(name, aspect, "EpochThwackey",
                ...
                List.of("They use their magic to enter trances that give them bursts of strength and enchant their bone wands to become melee weapons."),
                List.of(new EvolutionEntry("epochrillaboom", EvolutionType.LEVEL_UP, List.of(), 
