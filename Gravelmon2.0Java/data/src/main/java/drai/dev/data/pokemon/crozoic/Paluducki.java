    ...
    public Paluducki() {
        super("Paluducki",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONCHEERN,1),
                        new MoveLearnSetEntry(Move.HYDRO_PUMP,1),
                        new MoveLearnSetEntry(Move.SING,1),
                        new MoveLearnSetEntry(Move.WATERSPORTN,1),
                        new MoveLearnSetEntry(Move.BODY_SLAM,1),
                        new MoveLearnSetEntry(Move.BUBBLE_BEAM,1),
                        new MoveLearnSetEntry(Move.AQUA_TAIL,1),
                        new MoveLearnSetEntry(Move.MUDSPORTN,1),
                        new MoveLearnSetEntry(Move.ROUNDN,1),
