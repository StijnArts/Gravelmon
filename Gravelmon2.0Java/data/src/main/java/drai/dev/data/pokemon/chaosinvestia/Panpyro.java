...
import java.util.*;
public class Panpyro extends drai.dev.gravelmon.pokemon.Pokemon {
    public Panpyro() {
        super("Panpyro",
                ...
                70,
                50, List.of(),
                List.of("Es kontrolliert die Stärke des Feuers auf seinem Schweif geschickt, um Gegner auf Distanz zu halten."),
                List.of(),
                List.of(
