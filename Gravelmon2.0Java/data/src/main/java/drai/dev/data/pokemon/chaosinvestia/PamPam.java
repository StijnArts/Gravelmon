...
import java.util.*;
public class PamPam extends drai.dev.gravelmon.pokemon.Pokemon {
    public PamPam() {
        super("PamPam",
                Type.FIGHTING,
                new Stats(67,
                ...
                70,
                50, List.of(),
                List.of("Es gibt alles, um ein finsteres Gesicht zu machen und sein Gegenüber böse anzustarren, aber wenn es am Kopf gestreichelt wird, muss es unwillkürlich grinsen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.ARM_THRUST,7),
                        new MoveLearnSetEntry(Move.KARATE_CHOP,12),
                        new MoveLearnSetEntry(Move.SKY_UPPERCUT,48),
