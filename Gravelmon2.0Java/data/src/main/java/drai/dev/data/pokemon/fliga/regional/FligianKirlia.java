...
import java.util.*;
public class FligianKirlia extends drai.dev.data.pokemon.Pokemon {
    public FligianKirlia(String name, Aspect aspect) {
        super(name, aspect, "Kirlia",
                ...
                List.of(new EvolutionEntry("fligiangallade", EvolutionType.ITEM_INTERACT, false, List.of(),
                        List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.PROPERTY, "\"gender=male\"")),List.of(),
                        "cobblemon:shiny_stone"),
                        new EvolutionEntry("fligiangardevoir", EvolutionType.LEVEL_UP, List.of(),
