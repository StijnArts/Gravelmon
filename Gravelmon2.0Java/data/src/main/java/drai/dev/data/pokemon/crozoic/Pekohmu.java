...
import java.util.*;
public class Pekohmu extends drai.dev.data.pokemon.Pokemon {
    public Pekohmu(Stats stats) {
        super("Pekohmu",
                Type.ELECTRIC,
                stats,
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 13, 43, 2, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_LUSH, Biome.IS_SAVANNA))
                ), List.of(),
