...
import java.util.*;
public class Parasea extends drai.dev.data.pokemon.Pokemon {
    public Parasea() {
        super("Parasea",
                ...
                0.5,
                73, ExperienceGroup.SLOW,
                70,
                50, List.of(EggGroup.MONSTER,EggGroup.WATER_1),
                List.of("Parasea kindly allows other smaller Pokémon to perch on its back when crossing the ocean. Few attack it due to its gentle nature and strong fins."),
                List.of(new EvolutionEntry("paradiso", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"40")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RIPPLE_WAVE,43),
                        ...
                        new MoveLearnSetEntry(Move.WEATHER_BALL,58),
