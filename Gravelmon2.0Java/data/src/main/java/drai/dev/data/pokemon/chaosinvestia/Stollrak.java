...
import java.util.*;
public class Stollrak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Stollrak() {
        super("Stollrak",
                ...
                70,
                50, List.of(),
                List.of("Es ernährt sich von Eisenerz. Um sein Revier zu sichern, setzt es seinen harten Körper ein."),
                List.of(),
                List.of(
