...
import java.util.*;
public class Pupkin extends drai.dev.data.pokemon.Pokemon {
    public Pupkin() {
        super("Pupkin",
                ...
                List.of("A spell has animated a carved pumpkin face into Pupkin. It will often mistake jack-o-lanterns during holidays for a pack of their own."),
                List.of(new EvolutionEntry("doggourd", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.HIZA),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 9, 28, 5, List.of(
