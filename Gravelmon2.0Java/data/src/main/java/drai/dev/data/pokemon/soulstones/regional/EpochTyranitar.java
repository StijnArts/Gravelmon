...
public class EpochTyranitar extends drai.dev.data.pokemon.Pokemon {
    public EpochTyranitar(String name, Aspect aspect) {
        super(name, aspect, "EpochTyranitar",
                ...
                List.of("It moves slowly and finds it difficult to navigate due to its reinforced steel plating. Its shielding is almost impenetrable."),
                List.of(),
                List.of(
