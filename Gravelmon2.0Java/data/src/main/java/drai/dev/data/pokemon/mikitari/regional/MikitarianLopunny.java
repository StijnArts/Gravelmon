...
import java.util.*;
public class MikitarianLopunny extends drai.dev.data.pokemon.Pokemon {
    public MikitarianLopunny(String name, Aspect aspect) {
        super(name, aspect, "MikitarianLopunny",
                Type.DARK,
                new Stats(65,
                        76,
                        84,
