...
import java.util.*;
public class Chelcarain extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chelcarain() {
        super("Chelcarain",
                Type.GRASS,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Es weiß, wo es reinstes Quellwasser finden kann. Trägt andere Pokémon auf seinem Rücken dorthin."),
                List.of(),
                List.of(
