...
public class Pitohood extends drai.dev.data.pokemon.Pokemon {
    public Pitohood() {
        super("Pitohood",
                ...
                List.of(""),
                List.of(new EvolutionEntry("aviafel", EvolutionType.ITEM_INTERACT, false, List.of(),
                        List.of(),List.of(),"cobblemon:dusk_stone")),
                List.of(new MoveLearnSetEntry(Move.PECK,5),
