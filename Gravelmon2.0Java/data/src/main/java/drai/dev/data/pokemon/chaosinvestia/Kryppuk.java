...
import java.util.*;
public class Kryppuk extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kryppuk() {
        super("Kryppuk",
                ...
                10, 1080,
                new Stats(0,0,1,0,0,1), 100,
                0.5,
                0, ExperienceGroup.MEDIUM,
                70,
                50, List.of(),
                List.of("Aufgrund seiner ständigen Untaten ist es an einen Spiritkern gebunden."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DREAM_EATER,19),
