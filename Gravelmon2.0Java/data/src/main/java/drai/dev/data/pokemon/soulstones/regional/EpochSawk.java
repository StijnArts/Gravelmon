...
public class EpochSawk extends drai.dev.data.pokemon.Pokemon {
    public EpochSawk(String name, Aspect aspect) {
        super(name, aspect, "EpochSawk",
                ...
                List.of("An old fable says that this golem was brought to life through the wish of an ill child, so it came to life to help them battle the disease they were facing."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHARPEN,15),
