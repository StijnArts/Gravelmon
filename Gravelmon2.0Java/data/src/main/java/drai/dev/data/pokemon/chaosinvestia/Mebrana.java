...
import java.util.*;
public class Mebrana extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mebrana() {
        super("Mebrana",
                ...
                70,
                50, List.of(),
                List.of("Es lebt zu Wasser und zu Lande. Mit seiner langen, klebrigen Zunge umklammert und fängt es seine Beute."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ECHOED_VOICE,42)                        ),
