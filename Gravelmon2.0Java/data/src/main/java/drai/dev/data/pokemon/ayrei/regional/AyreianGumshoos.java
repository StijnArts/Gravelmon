...
import java.util.*;
public class AyreianGumshoos extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianGumshoos(int dex) {
        super(dex, "Gumshoos",
                Type.DARK,
                new Stats(88,
                        140,
                ...
                70,
                50, List.of(),
                List.of("This Pokemon finds joy in hurting and taking from others. The only time it is ever seen smiling when everything else around it is miserable."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.KOWTOW_CLEAVE,0),
