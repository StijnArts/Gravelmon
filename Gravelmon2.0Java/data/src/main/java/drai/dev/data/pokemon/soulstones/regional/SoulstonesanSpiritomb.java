...
import java.util.*;
public class SoulstonesanSpiritomb extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSpiritomb(int dex) {
        super(dex, "Spiritomb",
                ...
                10, 9990,
                new Stats(50,92,1,35,92,108), 100,
                0.5,
                170, ExperienceGroup.MEDIUM,
                70,
