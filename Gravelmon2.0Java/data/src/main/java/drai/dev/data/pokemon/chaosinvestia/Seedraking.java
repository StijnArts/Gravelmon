...
import java.util.*;
public class Seedraking extends drai.dev.gravelmon.pokemon.Pokemon {
    public Seedraking() {
        super("Seedraking",
                ...
                18, 1520,
                new Stats(0,1,0,0,1,1), 45,
                0.5,
                0, ExperienceGroup.MEDIUM,
                70,
                50, List.of(),
                List.of("Es lebt in Höhlen auf dem Meeresgrund. Jedes Mal, wenn es sich bewegt, entsteht ein Strudel."),
                List.of(),
                List.of(
