...
import java.util.*;
public class Caesurio extends drai.dev.gravelmon.pokemon.Pokemon {
    public Caesurio() {
        super("Caesurio",
                ...
                70,
                50, List.of(),
                List.of("Es rückt seinen Opfern mit einer Schar von Gladiantri im Gefolge auf den Pelz. Den letzten Hieb übernimmt es selbst."),
                List.of(),
                List.of(
