...
import java.util.*;
public class AyreianVenusaur extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianVenusaur(int dex) {
        super(dex, "Venusaur",
                ...
                new Stats(110,
                        ...
                        60,
                        90),
                List.of(Ability.STAMINA,Ability.WEAK_ARMOR), null,
                20, 1000,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PARTING_SHOT,70),
                        new MoveLearnSetEntry(Move.GROWL,1),
                        new MoveLearnSetEntry(Move.BULLDOZE,12),
                        new MoveLearnSetEntry(Move.BODY_PRESS,63),
                        new MoveLearnSetEntry(Move.FAKE_OUT,21),
                        new MoveLearnSetEntry(Move.KAOLINBASH,0),
