...
import java.util.*;
public class Parasek extends drai.dev.gravelmon.pokemon.Pokemon {
    public Parasek() {
        super("Parasek",
                Type.BUG,Type.GRASS,
                new Stats(60,
                        ...
                        60,
                        80),
                List.of(Ability.EFFECT_SPORE,Ability.DRY_SKIN), null,
                10, 295,
                new Stats(0,2,1,0,0,0), 75,
                0.5,
                0, ExperienceGroup.MEDIUM,
                70,
                50, List.of(),
                List.of("Parasek wird von einem Pilz, der größer als das Pokémon ist, kontrolliert. Er gibt Giftsporen ab."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.XSCISSOR,66),
                        new MoveLearnSetEntry(Move.RAGE_POWDER,59),
