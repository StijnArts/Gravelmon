...
import java.util.*;
public class Bisaknosp extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bisaknosp() {
        super("Bisaknosp",
                ...
                70,
                50, List.of(),
                List.of("Sobald die Knospe auf seinem Rücken ein süßes Aroma abgibt, steht die Blüte kurz bevor."),
                List.of(),
                List.of(
