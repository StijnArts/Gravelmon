...
import java.util.*;
public class Keerin extends drai.dev.data.pokemon.Pokemon {
    public Keerin() {
        super("Keerin",
                ...
                List.of("Legends say that it can be found high in snowy mountains. Travelers describe it as a mysterious creature that walks on a frozen lake during the full moon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HIGH_HORSEPOWER,60),
                        new MoveLearnSetEntry(Move.DRACO_METEOR,64),
