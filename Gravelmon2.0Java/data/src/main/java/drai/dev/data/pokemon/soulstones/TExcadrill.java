...
import java.util.*;
public class TExcadrill extends drai.dev.gravelmon.pokemon.Pokemon {
    public TExcadrill() {
        super("TExcadrill",
                Type.ICE,Type.LIGHT,
                new Stats(85,
                ...
                List.of("It uses the crystals on its head and arms to help it dig through caves. They are capable of emitting their own light to help it navigate."),
                List.of(),
                List.of(
