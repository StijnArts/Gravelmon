...
public class EpochThroh extends drai.dev.data.pokemon.Pokemon {
    public EpochThroh(String name, Aspect aspect) {
        super(name, aspect, "EpochThroh",
                ...
                List.of("This golem is magically enchanted to provide it with a level of hardiness that far exceeds many other golem Pokemon creations."),
                List.of(),
                List.of(
