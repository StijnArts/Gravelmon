...
public class DeltaMeditite extends Pokemon {
    public DeltaMeditite(String name, Aspect aspect) {
        super(name, aspect,"DeltaMeditite",
                Type.FAIRY,
                new Stats(30, 40, 55, 40, 55, 60),
                ...
                List.of("A Delta Species discovered by ensentiumseraph. Its powerful, goat-like legs allow it to scale steep mountain walls with little to no difficulty."),
                List.of(new EvolutionEntry("deltamedicham", EvolutionType.LEVEL_UP, List.of(),
