...
import java.util.*;
public class TJumpluff extends drai.dev.gravelmon.pokemon.Pokemon {
    public TJumpluff() {
        super("TJumpluff",
                Type.BUG,Type.LIGHT,
                new Stats(85,
                ...
                List.of("It is able to produce its own light source significant enough that it does not need to chase other lights like other moth Pokemon do."),
                List.of(),
                List.of(
