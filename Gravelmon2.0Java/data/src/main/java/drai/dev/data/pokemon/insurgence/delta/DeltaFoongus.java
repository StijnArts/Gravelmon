...
public class DeltaFoongus extends Pokemon {
    public DeltaFoongus(String name, Aspect aspect) {
        super(name, aspect,"DeltaFoongus",
                Type.GHOST, Type.DARK,
                new Stats(69, 55, 45, 55, 55, 15),
                ...
                List.of("A Delta Species discovered by Ubodot. It disguises itself as a harmless umbrella and then frightens people attempting to grab it by licking their hand."),
                List.of(new EvolutionEntry("deltaamoonguss", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MEAN_LOOK,35),
