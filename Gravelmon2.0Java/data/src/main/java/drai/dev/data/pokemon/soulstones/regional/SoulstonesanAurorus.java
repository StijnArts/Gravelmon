...
import java.util.*;
public class SoulstonesanAurorus extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanAurorus(int dex) {
        super(dex, "Aurorus",
                ...
                0.5,
                104, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.MONSTER),
                List.of("Apparently, it is able to walk seamlessly between the waking world and the dream realm. Anyone seeing it while fast asleep will have good luck for a year."),
                List.of(),
                List.of(
