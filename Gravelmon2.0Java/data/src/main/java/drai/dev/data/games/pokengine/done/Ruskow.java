...
public class Ruskow extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        addNewPokemon(new Eleplant().addLabels(Label.STARTER));
        addNewPokemon(new Herbederm().addLabels(Label.STARTER));
        addNewPokemon(new Mammahonia().addLabels(Label.STARTER));
        addNewPokemon(new Bollokin().addLabels(Label.STARTER));
        addNewPokemon(new Flamabull().addLabels(Label.STARTER));
        addNewPokemon(new Audhroch(new Stats(524, StatArchetype.SPECIAL_ATTACKER,
                List.of(StatType.DEFENCE))).addLabels(Label.STARTER));
        addNewPokemon(new Newtiny().addLabels(Label.STARTER).fishingSpawnFromExisting());
        addNewPokemon(new Salamarsh().addLabels(Label.STARTER));
        addNewPokemon(new Caudatidal(new Stats(524, StatArchetype.BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.SPECIAL_DEFENCE))).addLabels(Label.STARTER));
        ...
        addNewPokemon(new Dayfly(new Stats(440, StatArchetype.SPECIAL_WALL,
                List.of(StatType.SPECIAL_DEFENCE))));
        addNewPokemon(new Duskito(new Stats(440, StatArchetype.PHYSICAL_ATTACKER,
        ...
        addNewPokemon(new Palaices(new Stats(440, StatArchetype.BULKY_SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_DEFENCE))));
        addNewPokemon(new Dolfun().fishingSpawnFromExisting());
        addNewPokemon(new Tropiaqua(new Stats(450, StatArchetype.FAST_SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_DEFENCE))).fishingSpawnFromExisting());
