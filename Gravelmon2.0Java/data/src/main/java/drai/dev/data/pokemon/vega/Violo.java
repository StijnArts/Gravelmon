...
public class Violo extends Pokemon {
    public Violo() {
        super( "Violo",
                Type.NORMAL,
                new Stats(70	,
                ...
                List.of("It plays the trumpet with amazing skill. It sometimes invites Violo and Pianon to listen to its herd's concerts."),
                List.of(),
                List.of(
