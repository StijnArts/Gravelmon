...
import java.util.*;
public class Lampi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lampi() {
        super("Lampi",
                ...
                new Stats(75,
                        ...
                        56,
                        56),
                List.of(Ability.VOLT_ABSORB,Ability.ILLUMINATE), null,
                5, 120,
                ...
                70,
                50, List.of(),
                List.of("Über seine Antennen entlädt es Elektrizität, mit der es seinen Gegnern einen Schlag versetzt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.BUBBLE,1),
                        new MoveLearnSetEntry(Move.FLAIL,9),
                        ...
                        new MoveLearnSetEntry(Move.ELECTRO_BALL,28),
                        ...
                        new MoveLearnSetEntry(Move.BUBBLE_BEAM,31),
