...
import java.util.*;
public class EpochSquirtle extends drai.dev.data.pokemon.Pokemon {
    public EpochSquirtle(String name, Aspect aspect) {
        super(name, aspect, "EpochSquirtle",
                ...
                List.of("Initially, people were concerned to find this Pokemon in hazardous areas, but taking it away would just upset it."),
                List.of(new EvolutionEntry("epochwartortle", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"16")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHELL_SIDE_ARM,"egg"),
