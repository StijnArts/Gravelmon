...
import java.util.*;
public class SoulstonesanLopunny extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanLopunny(int dex) {
        super(dex, "Lopunny",
                ...
                List.of("This Pokemon is very competitive by nature. Do not try to steal its thunder as they become enraged very easily!"),
                List.of(),
                List.of(
