...
import java.util.*;
public class Smaqua extends drai.dev.data.pokemon.Pokemon {
    public Smaqua() {
        super("Smaqua",
                ...
                List.of("Smaqua train by standing on rocks in the center of whitewater rapids, avoiding and smashing any obstacles that may wash down the river."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.AQUA_SLAM,32),
