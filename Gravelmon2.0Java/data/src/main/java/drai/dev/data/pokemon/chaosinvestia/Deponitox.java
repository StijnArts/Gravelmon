...
import java.util.*;
public class Deponitox extends drai.dev.gravelmon.pokemon.Pokemon {
    public Deponitox() {
        super("Deponitox",
                Type.POISON,
                new Stats(80,
                        ...
                        60,
                        82),
                List.of(Ability.STENCH,Ability.WEAK_ARMOR), null,
                19, 1073,
                ...
                70,
                50, List.of(),
                List.of("Es verschlingt Abfall und macht ihn zu einem Teil seines Körpers. Mit seinen rechten Fingerspitzen versprüht es Gift."),
                List.of(),
                List.of(
