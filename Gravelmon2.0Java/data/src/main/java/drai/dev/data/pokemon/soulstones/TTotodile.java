...
import java.util.*;
public class TTotodile extends drai.dev.gravelmon.pokemon.Pokemon {
    public TTotodile() {
        super("TTotodile",
                Type.DARK,Type.FIRE,
                new Stats(50,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.KINDLE,"egg"),
