...
import java.util.*;
public class Debumue extends drai.dev.data.pokemon.Pokemon {
    public Debumue() {
        super("Debumue",
                Type.GROUND,
                new Stats(45,
                ...
                List.of("The lower part of its body is covered with extremely dry skin. This makes it difficult for it to move outside the desert, but its movements in the sand are impressive."),
                List.of(new EvolutionEntry("Momdysis", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SAND_TOMB,45),
