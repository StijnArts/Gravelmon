...
import java.util.*;
public class Glurak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Glurak() {
        super("Glurak",
                ...
                70,
                50, List.of(),
                List.of("Man sagt, Gluraks Feuer lodert stärker, wenn es harte Kämpfe überstanden hat."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WING_ATTACK,36),
