...
import java.util.*;
public class EpochPetilil extends drai.dev.data.pokemon.Pokemon {
    public EpochPetilil(String name, Aspect aspect) {
        super(name, aspect, "EpochPetilil",
                ...
                List.of("Its giggle is infectious and can cause anyone that hears it to burst into an uncontrollable fit of laughter."),
                List.of(new EvolutionEntry("epochlilligant", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "cobblemon:fire_stone")),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.IGNITE,"egg"),
