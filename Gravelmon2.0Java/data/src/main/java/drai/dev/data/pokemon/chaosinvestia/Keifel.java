...
import java.util.*;
public class Keifel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Keifel() {
        super("Keifel",
                ...
                70,
                50, List.of(),
                List.of("Schützt sich mit seinem dicken Fell vor der Kälte. Seine Stoßzähne aus Eis werden dicker, wenn es schneit."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FURY_ATTACK,33),
