...
import java.util.*;
public class EpochWiglett extends drai.dev.data.pokemon.Pokemon {
    public EpochWiglett(String name, Aspect aspect) {
        super(name, aspect, "EpochWiglett",
                Type.BUG,Type.STEEL,
                new Stats(60,
                        75,
                        45,
                ...
                List.of("These small steel worms are known to latch onto prey and cause nasty bites. The little probes floating around them shoot lasers."),
                List.of(new EvolutionEntry("epochwugtrio", EvolutionType.LEVEL_UP, List.of(), 
