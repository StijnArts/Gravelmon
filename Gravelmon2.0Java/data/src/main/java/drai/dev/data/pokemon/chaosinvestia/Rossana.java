...
import java.util.*;
public class Rossana extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rossana() {
        super("Rossana",
                ...
                70,
                50, List.of(),
                List.of("Sein Ruf klingt wie menschliche Sprache. Trotzdem ist nicht zu verstehen, was es sagt."),
                List.of(),
                List.of(
