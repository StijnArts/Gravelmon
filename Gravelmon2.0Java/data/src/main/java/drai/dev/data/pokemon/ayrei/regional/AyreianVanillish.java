...
import java.util.*;
public class AyreianVanillish extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianVanillish(int dex) {
        super(dex, "Vanillish",
                ...
                new Stats(61,
                        ...
                        80,
                        75),
                List.of(Ability.LEVITATE,Ability.FLAME_BODY), null,
                11, 410,
                ...
                70,
                50, List.of(),
                List.of("It blasts enemies with hot air reaching 200 degrees Fahrenheit, burning them. But it spares their lives afterwards. It's a kind Pok̩mon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FLAME_BURST,0),
