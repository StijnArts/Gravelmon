...
import java.util.*;
public class Bisaflor extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bisaflor() {
        super("Bisaflor",
                ...
                70,
                50, List.of(),
                List.of("Nach einem Regentag riecht die Blume auf seinem Rücken intensiver. Das Aroma zieht andere Pokémon an."),
                List.of(),
                List.of(
