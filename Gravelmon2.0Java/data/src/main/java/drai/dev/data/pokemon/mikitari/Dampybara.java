...
import java.util.*;
public class Dampybara extends drai.dev.data.pokemon.Pokemon {
    public Dampybara() {
        super("Dampybara",
                Type.WATER,
                new Stats(60,
                ...
                List.of("When its fur is wet it become slippery like oil. It uses that advantage to escape even from the clasped jaws."),
                List.of(new EvolutionEntry("glovet", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RETALIATE,18),
                        new MoveLearnSetEntry(Move.REVENGE,21),
                        new MoveLearnSetEntry(Move.DETECT,24),
                        new MoveLearnSetEntry(Move.AQUA_JET,27),
                        new MoveLearnSetEntry(Move.BRICK_BREAK,30),
                        new MoveLearnSetEntry(Move.LIQUIDATION,33),
