...
import java.util.*;
public class SoulstonesanGoodra extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanGoodra(int dex) {
        super(dex, "Goodra",
                ...
                List.of("Every step it takes leaves a small part of itself behind. Not to worry because it quickly regenerates itself."),
                List.of(),
                List.of(
