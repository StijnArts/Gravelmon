...
import java.util.*;
public class Lavenseed extends drai.dev.data.pokemon.Pokemon {
    public Lavenseed() {
        super("Lavenseed",
                ...
                new Stats(40,
                        ...
                        52,
                        68),
                List.of(Ability.CUTE_CHARM,Ability.AROMA_VEIL), Ability.FLOWER_VEIL,
                2, 13,
                ...
                List.of("Lavenseed spends most of their day basking in sunlight for necessary nutrients. They are attracted to kind people, though large crowds may scare them away."),
                List.of(new EvolutionEntry("lavenbelle", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"13")))),
                List.of(
                        new MoveLearnSetEntry(Move.AROMATIC_MIST,28),
                        ...
                        new MoveLearnSetEntry(Move.LIGHTBURST,22),
                        new MoveLearnSetEntry(Move.WISH,43),
                        new MoveLearnSetEntry(Move.PETAL_BLIZZARD,31),
                        ...
                        new MoveLearnSetEntry(Move.ALLURINGVOICE,34),
