...
import java.util.*;
public class Schlurp extends drai.dev.gravelmon.pokemon.Pokemon {
    public Schlurp() {
        super("Schlurp",
                Type.NORMAL,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Streckt es seine ca. zwei Meter lange Zunge, zittert sein Schweif. Sie scheinen verbunden zu sein."),
                List.of(),
                List.of(
