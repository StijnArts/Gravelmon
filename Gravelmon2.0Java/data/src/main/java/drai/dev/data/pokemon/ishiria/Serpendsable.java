...
import java.util.*;
public class Serpendsable extends drai.dev.data.pokemon.Pokemon {
    public Serpendsable() {
        super("Serpendsable",
                ...
                new Stats(75,
                        ...
                        110,
                        80),
                List.of(Ability.CURSED_BODY,Ability.TIGHTGRIP), Ability.SAND_RUSH,
                36, 200,
                ...
                List.of("Having never been able to get rid of its second layer of skin, its vital energy was completely absorbed. Its soul is however still imprisoned within it."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SAND_TOMB,48),
                        new MoveLearnSetEntry(Move.COIL,53),
                        new MoveLearnSetEntry(Move.MEAN_LOOK,57),
