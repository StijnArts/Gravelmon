...
public class Culponi extends drai.dev.data.pokemon.Pokemon {
    public Culponi() {
        super("Culponi",
                Type.DARK,
                new Stats(58,
                ...
                List.of(new EvolutionEntry("bronconvict", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.QAMOR),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 6, 27, 5.4, List.of(
