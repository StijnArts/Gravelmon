...
import java.util.*;
public class SoulstonesanFeraligatr extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanFeraligatr(int dex) {
        super(dex, "Feraligatr",
                ...
                List.of("It adds a tattoo to its skin for every foe it takes out in combat to constantly bask in its combat superiority."),
                List.of(),
                List.of(
