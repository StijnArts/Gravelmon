...
import java.util.*;
public class Kanivanha extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kanivanha() {
        super("Kanivanha",
                ...
                70,
                50, List.of(),
                List.of("Sie begegnen jedem Gegner, der in ihr Revier eindringt, im Schwarm. Ihre Zähne durchdringen alles."),
                List.of(),
                List.of(
