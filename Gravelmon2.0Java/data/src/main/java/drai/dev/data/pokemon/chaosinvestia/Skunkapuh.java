...
import java.util.*;
public class Skunkapuh extends drai.dev.gravelmon.pokemon.Pokemon {
    public Skunkapuh() {
        super("Skunkapuh",
                ...
                new Stats(63,
                        ...
                        41,
                        41),
                List.of(Ability.STENCH,Ability.AFTERMATH), null,
                4, 192,
                ...
                70,
                50, List.of(),
                List.of("Versprüht eine Substanz aus seinem Hinterleib, die in einem großen Radius andere Pokémon fernhält."),
                List.of(),
                List.of(
