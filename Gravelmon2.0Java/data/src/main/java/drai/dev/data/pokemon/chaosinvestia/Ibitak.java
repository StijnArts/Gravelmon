...
import java.util.*;
public class Ibitak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Ibitak() {
        super("Ibitak",
                ...
                70,
                50, List.of(),
                List.of("Es hat genügend Ausdauer, den ganzen Tag zu fliegen. Sein scharfer Schnabel dient als Waffe."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.MIRROR_MOVE,23),
