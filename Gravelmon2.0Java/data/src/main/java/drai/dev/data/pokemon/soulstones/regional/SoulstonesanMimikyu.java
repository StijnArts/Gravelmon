...
import java.util.*;
public class SoulstonesanMimikyu extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMimikyu(int dex) {
        super(dex, "Mimikyu",
                Type.ICE,Type.GHOST,
                new Stats(55,
                        115,
                ...
                2, 7,
                new Stats(55,2,106,80,54,80), 90,
                0.5,
                167, ExperienceGroup.MEDIUM,
                70,
