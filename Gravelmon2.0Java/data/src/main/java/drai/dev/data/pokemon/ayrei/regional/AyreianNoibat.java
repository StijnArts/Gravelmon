...
import java.util.*;
public class AyreianNoibat extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianNoibat(int dex) {
        super(dex, "Noibat",
                Type.FAIRY,Type.SOUND,
                new Stats(70,
                        50,
                        55,
                        50,
                        93,
                        60),
                List.of(Ability.MOLD_BREAKER,Ability.FRIEND_GUARD), null,
                5, 80,
                ...
                70,
                50, List.of(),
                List.of("It is blind, and it spreads bright scales while fluttering about that keep predators from attacking it."),
                List.of(),
                List.of(
