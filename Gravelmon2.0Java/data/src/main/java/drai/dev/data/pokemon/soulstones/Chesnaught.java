...
import java.util.*;
public class Chesnaught extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chesnaught() {
        super("Chesnaught",
                ...
                16, 900,
                new Stats(103,112,3,59,59,75), 90,
                0.875,
                239, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("If one of its crystals are taken away without permission, it can go into a rampage that can cause nearby tremors."),
                List.of(),
                List.of(
