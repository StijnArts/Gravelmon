...
import java.util.*;
public class AyreianLoudred extends drai.dev.data.pokemon.Pokemon {
    public AyreianLoudred(String name, Aspect aspect) {
        super(name, aspect, "Loudred",
                Type.SOUND,
                new Stats(84,
                        61,
                        43,
                ...
                List.of("The force of this Pokémon's loud voice isn't just the sound. It's also the wave of air pressure that blows opponents away and damages them."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SNARL,0),
