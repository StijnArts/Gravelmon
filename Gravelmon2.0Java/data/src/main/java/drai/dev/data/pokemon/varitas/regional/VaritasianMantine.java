...
public class VaritasianMantine extends drai.dev.data.pokemon.Pokemon {
    public VaritasianMantine(String s, Aspect aspect) {
        super(s, aspect, "Mantine",
                ...
                List.of("It half-buries itself in the sandy seafloor as camouflage. It can move surprisingly quickly through the sand and its tail developed a special barbed tip for attacking quickly while staying hidden."),
                List.of(),
                List.of(
