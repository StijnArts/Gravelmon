...
import java.util.*;
public class Enton extends drai.dev.gravelmon.pokemon.Pokemon {
    public Enton() {
        super("Enton",
                Type.WATER,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Leidet unter stetigem Kopfschmerz, ausgelöst durch seltsame Kräfte, die es aber auch einsetzen kann."),
                List.of(),
                List.of(
