...
import java.util.*;
public class Rexblisar extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rexblisar() {
        super("Rexblisar",
                Type.GRASS,Type.ICE,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Sie erscheinen beim Blühen der Schneeblumen und verschwinden wieder, sobald diese verblüht sind."),
                List.of(),
                List.of(
