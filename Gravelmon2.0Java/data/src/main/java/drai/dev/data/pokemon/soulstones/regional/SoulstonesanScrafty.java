...
import java.util.*;
public class SoulstonesanScrafty extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanScrafty(int dex) {
        super(dex, "Scrafty",
                ...
                11, 300,
                new Stats(65,1,80,58,100,80), 90,
                0.5,
                171, ExperienceGroup.MEDIUM,
                70,
