...
import java.util.*;
public class SoulstonesanLedian extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanLedian(int dex) {
        super(dex, "Ledian",
                Type.BUG,Type.STEEL,
                new Stats(60,
                        45,
                ...
                List.of("When discovered, they can beat its wings to emit a high-frequency screeching noise to deafen and distract to allow it enough time to escape."),
                List.of(),
                List.of(
