...
import java.util.*;
public class AyreianHaunter extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianHaunter(int dex) {
        super(dex, "Haunter",
                ...
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.FIRE_PUNCH,0),
                        new MoveLearnSetEntry(Move.SHADOW_PUNCH,0),
