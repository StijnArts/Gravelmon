...
import java.util.*;
public class Rettan extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rettan() {
        super("Rettan",
                Type.POISON,
                new Stats(35,
                        ...
                        40,
                        54),
                List.of(Ability.INTIMIDATE,Ability.SHED_SKIN), null,
                20, 69,
                ...
                70,
                50, List.of(),
                List.of("Es bewegt sich ohne einen Laut durch das Gras und greift seine ahnungslose Beute von hinten an."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MUD_BOMB,33),
