...
import java.util.*;
public class Jiutesto extends drai.dev.gravelmon.pokemon.Pokemon {
    public Jiutesto() {
        super("Jiutesto",
                Type.FIGHTING,
                new Stats(120,
                        ...
                        30,
                        85),
                List.of(Ability.GUTS,Ability.INNER_FOCUS), null,
                13, 555,
                ...
                70,
                50, List.of(),
                List.of("Hat von Natur aus den Drang, Gegner zu werfen, die größer sind als es selbst. Es bildet stets Fünferrudel."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.BIND,1),
                        new MoveLearnSetEntry(Move.VITAL_THROW,17),
