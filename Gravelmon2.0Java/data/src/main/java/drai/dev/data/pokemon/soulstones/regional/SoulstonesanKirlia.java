...
import java.util.*;
public class SoulstonesanKirlia extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanKirlia(int dex) {
        super(dex, "Kirlia",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SPIRITBARRAGE,42),
