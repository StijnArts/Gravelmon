...
import java.util.*;
public class Flambirex extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flambirex() {
        super("Flambirex",
                ...
                70,
                50, List.of(),
                List.of("Es trägt einen Backenbart aus Feuer und beherrscht Kampftechniken, die ebenso wuchtig wie schnell sind."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROAR,55),
                        ...
                        new MoveLearnSetEntry(Move.ASSURANCE,38),
