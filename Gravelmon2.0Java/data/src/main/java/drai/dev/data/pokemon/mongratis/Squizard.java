...
import java.util.*;
public class Squizard extends drai.dev.data.pokemon.Pokemon {
    public Squizard() {
        super("Squizard",
                Type.PSYCHIC,
                new Stats(0,
                ...
                List.of(new EvolutionEntry("sorcepher", EvolutionType.LEVEL_UP, List.of(),
