...
//        addNewPokemon(new 341676());Missing Art
        ...
        addNewPokemon(new Huskules(new Stats(440, StatArchetype.FAST_SUPPORT,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Turfin().fishingSpawnFromExisting());
        addNewPokemon(new Metalodon(new Stats(440, StatArchetype.BULKY_SPECIAL_ATTACKER,
                List.of(StatType.DEFENCE))).fishingSpawnFromExisting());
        ...
        addNewPokemon(new Adoraphin().fishingSpawnFromExisting());
        addNewPokemon(new Dolphet().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Dramingo(new Stats(520, StatArchetype.FAST_PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));//renamed from fauxmingo
        ...
        addNewPokemon(new Sylphemy(new Stats(360, StatArchetype.FAST_SUPPORT,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Dankton().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Fluffury(new Stats(510, StatArchetype.FAST_PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Ninpea());//ninpea
        addNewPokemon(new Hancacov(new Stats(478, StatArchetype.SPECIAL_ATTACKER,
                List.of(StatType.DEFENCE))));//hancacov
        ...
        addNewPokemon(new Grinreap(new Stats(450, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Beakat().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Fowland().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Seismyth(new Stats(600, StatArchetype.BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.SPEED))).addLabels(Label.PSEUDO_LEGENDARY));
