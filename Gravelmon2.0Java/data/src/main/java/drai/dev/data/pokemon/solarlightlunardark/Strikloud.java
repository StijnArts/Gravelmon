...
import java.util.*;
public class Strikloud extends drai.dev.data.pokemon.Pokemon {
    public Strikloud() {
        super("Strikloud",
                ...
                List.of("Strikloud and Nimblow often come into odds with each other. Whenever two of the species battle in the sky, a terrible thunderstorm is created."),
                List.of(new EvolutionEntry("strikyon", EvolutionType.LEVEL_UP, List.of(), 
