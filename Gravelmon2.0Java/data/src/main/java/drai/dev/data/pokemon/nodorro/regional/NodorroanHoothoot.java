...
import java.util.*;
public class NodorroanHoothoot extends drai.dev.data.pokemon.Pokemon {
    public NodorroanHoothoot(String name, Aspect aspect) {
        super(name, aspect, "NodorroanHoothoot",
