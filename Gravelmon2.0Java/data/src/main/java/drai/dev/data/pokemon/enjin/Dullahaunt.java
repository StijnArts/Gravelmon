    ...
    public Dullahaunt() {
        super("Dullahaunt",
                ...
                new Stats(65,
                        ...
                        112,
                        101),
                List.of(Ability.WANDERINGSPIRIT), Ability.WANDERINGSPIRIT,
                0, 0,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FIRESPINN,8),
                        new MoveLearnSetEntry(Move.PURSUITN,13),
                        new MoveLearnSetEntry(Move.WILLOWISP,17),
                        new MoveLearnSetEntry(Move.FEINT_ATTACK,20),
                        new MoveLearnSetEntry(Move.MEANLOOKN,23),
                        new MoveLearnSetEntry(Move.GRUDGEN,27),
                        new MoveLearnSetEntry(Move.HEX,31),
                        new MoveLearnSetEntry(Move.MYSTICAL_FIRE,36),
                        new MoveLearnSetEntry(Move.DESTINYBONDN,40),
                        new MoveLearnSetEntry(Move.SPIRITFLAMEN,45),
                        ...
                        new MoveLearnSetEntry(Move.NIGHTMAREN,"tm"),
