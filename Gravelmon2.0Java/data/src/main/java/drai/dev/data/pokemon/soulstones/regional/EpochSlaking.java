...
public class EpochSlaking extends drai.dev.data.pokemon.Pokemon {
    public EpochSlaking(String name, Aspect aspect) {
        super(name, aspect, "EpochSlaking",
                ...
                List.of("This Pokemon is quick to anger when it is awoken from its sleep or hungry. Many dare not to disturb it."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 37, 54, 0.2, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_SNOWY_FOREST))
                ), List.of(),
                List.of(SpawnPreset.NATURAL),
                0.28, 0.3,
                List.of());
           setLangFileName("Slaking");
