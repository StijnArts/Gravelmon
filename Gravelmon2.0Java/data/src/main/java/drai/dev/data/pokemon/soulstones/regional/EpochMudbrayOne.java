...
import java.util.*;
public class EpochMudbrayOne extends drai.dev.data.pokemon.Pokemon {
    public EpochMudbrayOne(String name, Aspect aspect) {
        super(name, aspect, "EpochMudbrayOne",
                ...
                List.of("These Pokemon have a habit of setting things ablaze when distressed. They are kept in fireplaces but can often burn houses to the ground if left unattended."),
                List.of(new EvolutionEntry("epochtwomudsdale", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"30")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PYRO_BALL,"egg"),
