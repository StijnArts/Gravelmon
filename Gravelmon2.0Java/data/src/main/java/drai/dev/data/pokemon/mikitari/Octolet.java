...
import java.util.*;
public class Octolet extends drai.dev.data.pokemon.Pokemon {
    public Octolet() {
        super("Octolet",
                Type.PSYCHIC,
                new Stats(45,
                ...
                List.of("An extremely strange creature with a strong self-awareness. There are rumors that it comes from another planet."),
                List.of(),
                List.of(
