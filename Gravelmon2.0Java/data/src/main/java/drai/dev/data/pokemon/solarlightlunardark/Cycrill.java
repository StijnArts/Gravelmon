...
import java.util.*;
public class Cycrill extends drai.dev.data.pokemon.Pokemon {
    public Cycrill() {
        super("Cycrill",
                ...
                0.5,
                128, ExperienceGroup.FLUCTUATING,
                70,
                50, List.of(EggGroup.AMORPHOUS),
                List.of("Cycrill take residence in caves near the sea. They would create strong winds that push Pokémon and boats alike from the shore."),
                List.of(new EvolutionEntry("syphoon", EvolutionType.ITEM_INTERACT, false, List.of(), 
