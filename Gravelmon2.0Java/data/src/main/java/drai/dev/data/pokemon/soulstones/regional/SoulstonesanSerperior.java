...
import java.util.*;
public class SoulstonesanSerperior extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSerperior(int dex) {
        super(dex, "Serperior",
                Type.GHOST,
                new Stats(75,
                        75,
                ...
                0.875,
                238, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD,EggGroup.GRASS),
                List.of("This enraged Pokemon is sick and tired of people causing harm to its species, so now it reacts violently to anything that approaches its kin."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BURNINGOFUDA,1),
