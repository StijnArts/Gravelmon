...
public class NorheimanWailmer extends drai.dev.data.pokemon.Pokemon {
    public NorheimanWailmer(String name, Aspect aspect) {
        super(name, aspect, "Wailmer",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("wailwhale", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                ), SpawnContext.SUBMERGED, SpawnPool.UNCOMMON, 3, 22, 5, List.of(
