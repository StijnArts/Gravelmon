...
import java.util.*;
public class Kapilz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kapilz() {
        super("Kapilz",
                ...
                70,
                50, List.of(),
                List.of("Seine kurzen Arme dehnen sich aus, wenn es zuschlägt. Seine Technik ähnelt der von Profi-Boxern."),
                List.of(),
                List.of(
