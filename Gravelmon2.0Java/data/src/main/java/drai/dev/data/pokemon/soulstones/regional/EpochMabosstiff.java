...
import java.util.*;
public class EpochMabosstiff extends drai.dev.data.pokemon.Pokemon {
    public EpochMabosstiff(String name, Aspect aspect) {
        super(name, aspect, "EpochMabosstiff",
                Type.DARK,Type.FIRE,
                new Stats(90,
                        110,
                        90,
                ...
                List.of("Myths say that this Pokemon was lulled to sleep by a traveler trying to pass onto the underworld to rescue his wife's spirit."),
                List.of(),
                List.of(
