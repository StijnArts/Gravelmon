...
import java.util.*;
public class NodorroanSamurott extends drai.dev.data.pokemon.Pokemon {
    public NodorroanSamurott(String name, Aspect aspect) {
        super(name, aspect, "NodorroanSamurott",
