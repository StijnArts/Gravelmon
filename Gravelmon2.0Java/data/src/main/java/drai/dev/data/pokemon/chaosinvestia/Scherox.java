...
import java.util.*;
public class Scherox extends drai.dev.gravelmon.pokemon.Pokemon {
    public Scherox() {
        super("Scherox",
                Type.BUG,Type.STEEL,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Setzt seine mit Markierungen versehenen Scheren ein, um Gegner einzuschüchtern."),
                List.of(),
                List.of(
