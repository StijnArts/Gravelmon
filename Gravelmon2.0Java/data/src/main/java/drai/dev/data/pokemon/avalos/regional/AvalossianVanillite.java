...
import java.util.*;
public class AvalossianVanillite extends drai.dev.data.pokemon.Pokemon {
    public AvalossianVanillite(String name, Aspect aspect) {
        super(name, aspect, "Vanillite",
                ...
                List.of(new EvolutionEntry("AvalossianVanillish", EvolutionType.LEVEL_UP, List.of(),
