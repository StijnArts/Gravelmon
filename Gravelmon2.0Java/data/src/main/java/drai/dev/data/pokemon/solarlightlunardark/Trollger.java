...
import java.util.*;
public class Trollger extends drai.dev.data.pokemon.Pokemon {
    public Trollger() {
        super("Rollger",
                ...
                0.5,
                228, ExperienceGroup.SLOW,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("Known as the ‘Enforcers of Nature’, they have a terrible temper and little patience for those who would dare harm the environment."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.EMBARGO,37),
                        new MoveLearnSetEntry(Move.LEER,1),
                        new MoveLearnSetEntry(Move.COMEUPPANCE,57),
                        new MoveLearnSetEntry(Move.FEY_HAMMER,62),
