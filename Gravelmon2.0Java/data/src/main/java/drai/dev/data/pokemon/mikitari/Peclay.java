...
import java.util.*;
public class Peclay extends drai.dev.data.pokemon.Pokemon {
    public Peclay() {
        super("Peclay",
                ...
                new Stats(55,
                        ...
                        65,
                        30),
                List.of(Ability.WEAK_ARMOR), Ability.SHELL_ARMOR,
                3, 55,
                ...
                List.of("Peclay's clay shell protects it from being carried away by a sandstorm. It uses its strong legs to launch itself like a cannonball."),
                List.of(),
                List.of(
