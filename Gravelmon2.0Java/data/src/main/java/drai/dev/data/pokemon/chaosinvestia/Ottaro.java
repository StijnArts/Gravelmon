...
import java.util.*;
public class Ottaro extends drai.dev.gravelmon.pokemon.Pokemon {
    public Ottaro() {
        super("Ottaro",
                Type.WATER,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Die Muschel auf seinem Bauch besteht aus demselben Material wie seine Krallen. Nimmt es sie ab, fungiert sie als Klinge."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FURY_CUTTER,19),
