...
import java.util.*;
public class Seigoxic extends drai.dev.data.pokemon.Pokemon {
    public Seigoxic() {
        super("Seigoxic",
                ...
                List.of("A mind-affecting toxin accumulates in its whole body, but is most potent in the cone. Seigoxic's frightening adornment largely appears to be a warning display."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FILTHYTERRAIN,"tm"),
