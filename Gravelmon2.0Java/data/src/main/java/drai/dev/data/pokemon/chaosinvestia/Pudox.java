...
import java.util.*;
public class Pudox extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pudox() {
        super("Pudox",
                ...
                70,
                50, List.of(),
                List.of("Es streut mit jedem Flügelschlag giftiges Pulver. Nachts entfernt es die Blätter von Bäumen an Alleen."),
                List.of(),
                List.of(
