...
import java.util.*;
public class IshirianNinetales extends drai.dev.data.pokemon.Pokemon {
    public IshirianNinetales(String name, Aspect aspect) {
        super(name, aspect, "IshirianNinetales",
                Type.GHOST,
                new Stats(82,
                        76,
                        75,
                ...
                List.of());
        addAdditionalEvolution("vulpix", new EvolutionEntry("ishirianninetales", EvolutionType.ITEM_INTERACT, false, List.of(),
