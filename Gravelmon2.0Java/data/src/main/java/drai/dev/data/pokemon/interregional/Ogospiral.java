...
public class Ogospiral extends drai.dev.data.pokemon.Pokemon {
    public Ogospiral() {
        super("Ogospiral",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("nesspin", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 25, 38, .4, List.of(
