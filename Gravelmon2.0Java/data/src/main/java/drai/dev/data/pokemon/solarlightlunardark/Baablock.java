...
import java.util.*;
public class Baablock extends drai.dev.data.pokemon.Pokemon {
    public Baablock() {
        super("Baablock",
                ...
                new Stats(80,
                        ...
                        75,
                        90),
                List.of(Ability.PROSPECTOR), Ability.GLUTTONY,
                13, 626,
                new Stats(0,2,0,1,0,0), 75,
                0.875,
                186, ExperienceGroup.MEDIUM_SLOW,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("Baablock's wool cannot be sheared with mundane tools at all, as they are as hard as a rock; They are valuable in building walls and other strong structures."),
                List.of(),
                List.of(
