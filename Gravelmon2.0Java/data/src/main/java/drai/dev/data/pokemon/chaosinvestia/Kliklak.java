...
import java.util.*;
public class Kliklak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kliklak() {
        super("Kliklak",
                Type.STEEL,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Lässt seine Einzelteile rapide rotieren und feuert sie auf Gegner ab. Kehren sie nicht zurück, wird es brenzlig."),
                List.of(),
                List.of(
