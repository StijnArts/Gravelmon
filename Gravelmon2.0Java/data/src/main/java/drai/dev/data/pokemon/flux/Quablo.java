...
import java.util.*;
public class Quablo extends drai.dev.data.pokemon.Pokemon {
    public Quablo() {
        super("Quablo",
                ...
                List.of("Glands on its fins exude pigments that it dabs onto the seafloor, leaving lifelike imprints that can serve as decoys."),
                List.of(),
                List.of(
