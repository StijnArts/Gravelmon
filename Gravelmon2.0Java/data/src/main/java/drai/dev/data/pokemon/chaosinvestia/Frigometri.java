...
import java.util.*;
public class Frigometri extends drai.dev.gravelmon.pokemon.Pokemon {
    public Frigometri() {
        super("Frigometri",
                Type.ICE,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Es fängt seine Beute mit Ketten, die sich aus Eiskristallen zusammensetzen. Entstanden ist es aus einer Schneewolke."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.NIGHT_SLASH,57),
                        new MoveLearnSetEntry(Move.BIND,1),
                        new MoveLearnSetEntry(Move.CONFUSE_RAY,45),
