...
import java.util.*;
public class Dragoran extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dragoran() {
        super("Dragoran",
                ...
                70,
                50, List.of(),
                List.of("Man sagt, es lebe in den Meeren. Es bringt Schiffbrüchige sicher an Land."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HURRICANE,81),
                        ...
                        new MoveLearnSetEntry(Move.WING_ATTACK,55),
                        ...
                        new MoveLearnSetEntry(Move.DRAGON_RUSH,47)                        ),
