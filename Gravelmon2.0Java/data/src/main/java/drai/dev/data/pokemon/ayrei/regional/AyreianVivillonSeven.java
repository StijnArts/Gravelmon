...
import java.util.*;
public class AyreianVivillonSeven extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonSeven(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonSeven",
                Type.WATER,Type.BUG,
                new Stats(80,
                        52,
                        65,
