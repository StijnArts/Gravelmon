...
import java.util.*;
public class AyreianWigglytuff extends drai.dev.data.pokemon.Pokemon {
    public AyreianWigglytuff(String name, Aspect aspect) {
        super(name, aspect, "Wigglytuff",
                ...
                10, 120,
                new Stats(3,0,0,0,0,0), 50,
                0.0,
                0, ExperienceGroup.FAST,
                70,
                50, List.of(EggGroup.FAIRY),
                List.of("It's proud of its fur, which is fine and delicate. In particular, the curl on its forehead has a texture that's perfectly heavenly."),
                List.of(),
                List.of(
