...
import java.util.*;
public class SoulstonesanBronzong extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBronzong(int dex) {
        super(dex, "Bronzong",
                ...
                List.of("Some say this Pokemon was once an idol that early civilizations prayed to so it would bring rain and crops would be allowed to grow."),
                List.of(),
                List.of(
