...
import java.util.*;
public class Fermicula extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fermicula() {
        super("Fermicula",
                Type.BUG,Type.STEEL,
                new Stats(58,
                        ...
                        48,
                        48),
                List.of(Ability.SWARM,Ability.HUSTLE), null,
                3, 330,
                ...
                70,
                50, List.of(),
                List.of("Es hebt ein komplexes Tunnelsystem im Berginneren aus und nutzt dieses Labyrinth als seinen Bau."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AGILITY,16),
                        new MoveLearnSetEntry(Move.IRON_DEFENSE,56),
                        new MoveLearnSetEntry(Move.BUG_BITE,26),
                        new MoveLearnSetEntry(Move.DIG,41),
                        new MoveLearnSetEntry(Move.BITE,11),
                        new MoveLearnSetEntry(Move.VICEGRIP,1),
                        ...
                        new MoveLearnSetEntry(Move.METAL_SOUND,66),
