...
import java.util.*;
public class Lohgock extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lohgock() {
        super("Lohgock",
                ...
                70,
                50, List.of(),
                List.of("Aus seinen Handgelenken kommt Feuer, das seine Knöchel umhüllt. Schläge verbrennen den Gegner."),
                List.of(),
                List.of(
