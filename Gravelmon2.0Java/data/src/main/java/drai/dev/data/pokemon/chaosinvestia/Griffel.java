...
import java.util.*;
public class Griffel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Griffel() {
        super("Griffel",
                Type.NORMAL,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Lebt in den Baumwipfeln. Kann seinen Schweif genauso gut wie seine Hände verwenden."),
                List.of(),
                List.of(
