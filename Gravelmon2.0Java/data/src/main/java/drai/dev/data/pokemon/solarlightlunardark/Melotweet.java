...
import java.util.*;
public class Melotweet extends drai.dev.data.pokemon.Pokemon {
    public Melotweet() {
        super("Melotweet",
                ...
                List.of("Melotweet can compose songs so beautiful, anyone who listens to them for too long would become entranced and lose their sense of time passing."),
                List.of(),
                List.of(
