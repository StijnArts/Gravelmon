...
import java.util.*;
public class Huskold extends drai.dev.data.pokemon.Pokemon {
    public Huskold() {
        super("Huskold",
                Type.ICE,
                new Stats(65,
                        ...
                        90,
                        60),
                List.of(Ability.SNOW_CLOAK,Ability.MOXIE), Ability.SNOW_WARNING,
                9, 235,
                ...
                List.of("A layer of ice forms on the bite marks left by Huskold, leading to the term frostbite. The ancient people of Rikoto called it the Arctic Beast."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.BLIZZARD,53),
                        new MoveLearnSetEntry(Move.BITE,10),
                        new MoveLearnSetEntry(Move.FROSTCLAW,44),
