...
import java.util.*;
public class Mamutel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mamutel() {
        super("Mamutel",
                ...
                new Stats(110,
                        ...
                        70,
                        60),
                List.of(Ability.OBLIVIOUS,Ability.SNOW_CLOAK), null,
                25, 2910,
                ...
                70,
                50, List.of(),
                List.of("Ein eingefrorenes Exemplar wurde aus 10 000 Jahre altem Erdreich ausgegraben. Es wachte sogar auf!"),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.BLIZZARD,52),
                        new MoveLearnSetEntry(Move.ENDURE,14),
                        new MoveLearnSetEntry(Move.DOUBLE_HIT,33),
                        ...
                        new MoveLearnSetEntry(Move.HAIL,21),
                        new MoveLearnSetEntry(Move.SCARY_FACE,58)                        ),
