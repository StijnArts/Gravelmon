...
import java.util.*;
public class FligianDuskull extends drai.dev.data.pokemon.Pokemon {
    public FligianDuskull(String name, Aspect aspect) {
        super(name, aspect, "Duskull",
                ...
                List.of(""),
                List.of(new EvolutionEntry("fligiandusclops", EvolutionType.LEVEL_UP, List.of(),
