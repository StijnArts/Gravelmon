...
import java.util.*;
public class Hottop extends drai.dev.data.pokemon.Pokemon {
    public Hottop() {
        super("Hottop",
                Type.FIRE,Type.ROCK,
                new Stats(55,
                ...
                List.of("Hottop can disguise themselves as rocks when they feel threatened, though the smoke escaping from their chutes makes the disguise rather ineffective."),
                List.of(new EvolutionEntry("fizire", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"31")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEAT_CRASH,45),
                        ...
                        new MoveLearnSetEntry(Move.FLAREUP,37),
