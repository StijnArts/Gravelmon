...
import java.util.*;
public class Vipitis extends drai.dev.gravelmon.pokemon.Pokemon {
    public Vipitis() {
        super("Vipitis",
                Type.POISON,
                new Stats(73,
                ...
                70,
                50, List.of(),
                List.of("Seit Generationen ist es mit Sengo verfeindet. Es wetzt seinen scharfen Schweif an Felsen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GASTRO_ACID,34),
                        new MoveLearnSetEntry(Move.HAZE,38),
                        ...
                        new MoveLearnSetEntry(Move.POISON_FANG,27),
