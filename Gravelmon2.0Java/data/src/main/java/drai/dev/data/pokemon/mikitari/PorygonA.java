...
import java.util.*;
public class PorygonA extends drai.dev.data.pokemon.Pokemon {
    public PorygonA() {
        super("PorygonA",
                Type.NORMAL,
                new Stats(93,
                        ...
                        92,
                        65),
                List.of(Ability.GLITCHED), Ability.ANALYTIC,
                8, 415,
                ...
                List.of("It's the first prototype of Porygon. Often freezes in place analyzing what to do next and its movement is chaotic."),
                List.of(),
                List.of(
