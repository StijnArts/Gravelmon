...
import java.util.*;
public class Tauboss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tauboss() {
        super("Tauboss",
                ...
                70,
                50, List.of(),
                List.of("Schlägt Tauboss mit ganzer Kraft seine Flügel, beugen sich selbst große Bäume durch den Windstoß."),
                List.of(),
                List.of(
