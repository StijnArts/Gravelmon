...
import java.util.*;
public class EpochDoubladeTwo extends drai.dev.data.pokemon.Pokemon {
    public EpochDoubladeTwo(String name, Aspect aspect) {
        super(name, aspect, "EpochDoubladeTwo",
                Type.FIRE,
                new Stats(99,
                        90,
                        80,
