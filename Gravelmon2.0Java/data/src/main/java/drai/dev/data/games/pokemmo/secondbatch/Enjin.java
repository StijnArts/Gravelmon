...
//        pokemon.add(new Feilex()); Member of line Not Finished
        ...
        pokemon.add(new Bistodum(new Stats(354, StatArchetype.FAST_SPECIAL_ATTACKER, List.of(StatType.SPECIAL_ATTACK))));   Missing Stats
        pokemon.add(new Coldfin(new Stats(354, StatArchetype.FAST_SPECIAL_WALL, List.of(StatType.SPECIAL_DEFENCE))));   Missing Stats
        pokemon.add(new Raveclem());
        pokemon.add(new Galats(new Stats(340, StatArchetype.FAST_PHYSICAL_ATTACKER, List.of(StatType.SPEED))));   Missing Stats
        pokemon.add(new Coldier(new Stats(330, StatArchetype.FAST_SUPPORT, List.of(StatType.HP))));   Missing Stats
        ...
        pokemon.add(new Magmaligna(new Stats(423, StatArchetype.PHYSICAL_ATTACKER, List.of(StatType.ATTACK))));   Missing Stats
        pokemon.add(new Queenival(new Stats(365, StatArchetype.PHYSICAL_WALL, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Punky(new Stats(345, StatArchetype.FAST_PHYSICAL_ATTACKER, List.of(StatType.SPEED))));   Missing Stats
        pokemon.add(new Slamb(new Stats(367, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Roselot(new Stats(387, StatArchetype.PHYSICAL_ATTACKER, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Rosival(new Stats(387, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Roswain(new Stats(387, StatArchetype.SPECIAL_WALL, List.of(StatType.HP))));   Missing Stats
...
//        pokemon.add(new Snouturf());Member of line Not Finished
        pokemon.add(new Volverdi(new Stats(324, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.SPEED))));   Missing Stats
        pokemon.add(new Curstar());
        pokemon.add(new Shihtzoof());   Missing Stats
        pokemon.add(new Priminpup(new Stats(432, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Cucuppy(new Stats(350, StatArchetype.PHYSICAL_WALL, List.of(StatType.HP))));   Member of line Not Finished
        pokemon.add(new Gremelon());Member of line Not Finished
        pokemon.add(new Skoopy());Member of line Not Finished
        pokemon.add(new Thornip(new Stats(332, StatArchetype.FAST_SUPPORT, List.of(StatType.SPECIAL_DEFENCE))));   Missing Stats
        ...
        pokemon.add(new Wotter(new Stats(354, StatArchetype.FAST_PHYSICAL_ATTACKER, List.of(StatType.SPEED))));   Missing Stats
        pokemon.add(new Cyclub(new Stats(342, StatArchetype.PHYSICAL_ATTACKER, List.of(StatType.ATTACK))));   Missing Stats
        pokemon.add(new Angeroid(new Stats(352, StatArchetype.PHYSICAL_WALL, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Teleprog());
        pokemon.add(new Clampere(new Stats(340, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.SPECIAL_ATTACK))));   Missing Stats
        pokemon.add(new Balbuni(new Stats(356, StatArchetype.PHYSICAL_WALL, List.of(StatType.HP))));   Missing Stats
        pokemon.add(new Criseti());Member of line Not Finished
        pokemon.add(new Anseti());   Member of line Not Finished
        pokemon.add(new Macrochip(new Stats(343, StatArchetype.FAST_SUPPORT, List.of(StatType.SPECIAL_ATTACK))));   Missing Stats
        ...
        pokemon.add(new Burielle(new Stats(600, StatArchetype.ALL_ROUND, List.of())));   Missing Stats
        pokemon.add(new Aristocalf());   Missing Stats
        pokemon.add(new Majestapir(new Stats(540, StatArchetype.PHYSICAL_WALL, List.of(StatType.HP))));   Missing Stats
    }
