...
public class EpochDruddigon extends drai.dev.data.pokemon.Pokemon {
    public EpochDruddigon(String name, Aspect aspect) {
        super(name, aspect, "EpochDruddigon",
                ...
                List.of("It has forgone its ability to fly in exchange for developing jagged spikes on its back and as such, now largely resides in dark caves."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONFURY,5),
                        new MoveLearnSetEntry(Move.SPIKES,9),
                        new MoveLearnSetEntry(Move.BRICK_BREAK,34),
                        new MoveLearnSetEntry(Move.ROCK_SMASH,1),
                        new MoveLearnSetEntry(Move.EDGESTRIKE,21),
                        new MoveLearnSetEntry(Move.WYVERNSLASH,27),
                        new MoveLearnSetEntry(Move.CRUNCH,37),
                        new MoveLearnSetEntry(Move.REVENGE,12),
                        new MoveLearnSetEntry(Move.BREAKING_SWIPE,15),
                        new MoveLearnSetEntry(Move.DRAGON_DANCE,41),
                        new MoveLearnSetEntry(Move.DRAGON_CLAW,49),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 28, 48, 2, List.of(
