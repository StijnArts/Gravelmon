...
import java.util.*;
public class Lampire extends drai.dev.data.pokemon.Pokemon {
    public Lampire() {
        super("Lampire",
                ...
                List.of("Flying around with their bulb powered down, Lampire drop in front of other unsuspecting Electric types, stunning them with a powerful blast of light. They then drain their victim's electricity reserves, before vanishing into the night."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 28, 48, .4, List.of(
