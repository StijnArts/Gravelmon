...
import java.util.*;
public class SoulstonesanHitmonlee extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanHitmonlee(int dex) {
        super(dex, "Hitmonlee",
                ...
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.RAPIDSTRIKE,1),
