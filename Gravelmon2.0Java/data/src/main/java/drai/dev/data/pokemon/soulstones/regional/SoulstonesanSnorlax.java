...
import java.util.*;
public class SoulstonesanSnorlax extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSnorlax(int dex) {
        super(dex, "Snorlax",
                ...
                List.of("As it hibernates, it has honed its psychic powers to be able to retrieve objects from afar without resorting to have to get up and move."),
                List.of(),
                List.of(
