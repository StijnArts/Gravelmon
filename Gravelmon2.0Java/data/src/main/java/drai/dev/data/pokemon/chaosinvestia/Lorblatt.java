...
import java.util.*;
public class Lorblatt extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lorblatt() {
        super("Lorblatt",
                Type.GRASS,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Die Knospen an seinem Hals geben ein würziges Aroma ab, das andere aufheitert."),
                List.of(),
                List.of(
