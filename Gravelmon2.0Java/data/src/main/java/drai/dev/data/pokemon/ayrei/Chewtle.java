    ...
    public Chewtle() {
        super("Chewtle",
                ...
                new Stats(50,
                        ...
                        38,
                        38),
                List.of(Ability.STRONG_JAW,Ability.SHELL_ARMOR), null,
                3, 85,
                ...
                70,
                50, List.of(),
                List.of("It starts off battles by attacking with its rock-hard horn, but as soon as the opponent flinches, this Pokémon bites down and never lets go."),
                List.of(),
                List.of(
