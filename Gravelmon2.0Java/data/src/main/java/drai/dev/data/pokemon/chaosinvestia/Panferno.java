...
import java.util.*;
public class Panferno extends drai.dev.gravelmon.pokemon.Pokemon {
    public Panferno() {
        super("Panferno",
                ...
                70,
                50, List.of(),
                List.of("Es verwendet einzigartige Attacken mit dem Feuer an seinen Händen und Füßen. Stellt sich jedem Gegner."),
                List.of(),
                List.of(
