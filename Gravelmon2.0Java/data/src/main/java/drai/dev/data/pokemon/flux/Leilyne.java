...
import java.util.*;
public class Leilyne extends drai.dev.data.pokemon.Pokemon {
    public Leilyne() {
        super("Leilyne",
                ...
                List.of("The regenerated bodies of Leilyne are said to be very close to their ancient counterparts, found along ancient routes of interest."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GUARD_SWAP,45),
