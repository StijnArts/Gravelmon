...
import java.util.*;
public class EpochChewtle extends drai.dev.data.pokemon.Pokemon {
    public EpochChewtle(String name, Aspect aspect) {
        super(name, aspect, "EpochChewtle",
                ...
                List.of("This Pokemon is often used in ground combat to support infantry in wars because of the tough spikes and armor built into their shells."),
                List.of(new EvolutionEntry("epochdrednaw", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"22")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SPIKEDRAM,"egg")),
