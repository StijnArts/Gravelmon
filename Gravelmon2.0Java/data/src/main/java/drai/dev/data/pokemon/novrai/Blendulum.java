...
public class Blendulum extends drai.dev.data.pokemon.Pokemon {
    public Blendulum() {
        super("Blendulum",
                ...
                List.of("It mixes the colorful liquids it seeps into beautiful works of abstract art. Some think that the strange landscapes it paints are actually how it perceives the world."),
                List.of(),
                List.of(
