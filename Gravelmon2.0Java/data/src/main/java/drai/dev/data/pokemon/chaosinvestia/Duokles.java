...
import java.util.*;
public class Duokles extends drai.dev.gravelmon.pokemon.Pokemon {
    public Duokles() {
        super("Duokles",
                ...
                70,
                50, List.of(),
                List.of("Nicht einmal ein Meister des Schwertkampfs kann den komplizierten aufeinanderfolgenden Angriffen der zwei Schwerter ausweichen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SACRED_SWORD,51),
                        ...
                        new MoveLearnSetEntry(Move.POWER_TRICK,41),
