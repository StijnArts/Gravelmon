...
import java.util.*;
public class Smogmog extends drai.dev.gravelmon.pokemon.Pokemon {
    public Smogmog() {
        super("Smogmog",
                Type.POISON,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Es wächst, indem es Gase aufnimmt, die aus dem Müll aufsteigen. Selten kann man Drillinge von ihnen finden."),
                List.of(),
                List.of(
