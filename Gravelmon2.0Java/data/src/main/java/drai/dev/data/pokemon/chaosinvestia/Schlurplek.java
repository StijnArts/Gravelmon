...
import java.util.*;
public class Schlurplek extends drai.dev.gravelmon.pokemon.Pokemon {
    public Schlurplek() {
        super("Schlurplek",
                Type.NORMAL,
                new Stats(110,
                        ...
                        80,
                        95),
                List.of(Ability.OWN_TEMPO,Ability.OBLIVIOUS), null,
                17, 1400,
                ...
                70,
                50, List.of(),
                List.of("Die lange Zunge ist immer feucht. Ihr Speichel enthält eine Substanz, die Taubheit hervorrufen kann."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.REFRESH,45),
                        ...
                        new MoveLearnSetEntry(Move.GYRO_BALL,61),
                        new MoveLearnSetEntry(Move.ROLLOUT,33),
                        new MoveLearnSetEntry(Move.POWER_WHIP,53),
                        new MoveLearnSetEntry(Move.SCREECH,49),
                        new MoveLearnSetEntry(Move.KNOCK_OFF,13),
                        new MoveLearnSetEntry(Move.CHIP_AWAY,37)                        ),
