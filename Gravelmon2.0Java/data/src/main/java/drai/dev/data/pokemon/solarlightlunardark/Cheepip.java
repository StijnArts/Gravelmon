...
import java.util.*;
public class Cheepip extends drai.dev.data.pokemon.Pokemon {
    public Cheepip() {
        super("Cheepip",
                ...
                List.of("Cheepip travel in large flocks. Sometimes there are such large amounts of them together that, when resting, they make can make entire rock faces look covered in grass."),
                List.of(new EvolutionEntry("aeroma", EvolutionType.LEVEL_UP, List.of(), 
