...
import java.util.*;
public class AyreianHoothoot extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianHoothoot(int dex) {
        super(dex, "Hoothoot",
                ...
                new Stats(60,
                        ...
                        65,
                        55),
                List.of(Ability.INSOMNIA,Ability.MIRROR_ARMOR), null,
                7, 212,
