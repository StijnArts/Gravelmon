...
import java.util.*;
public class Kikugi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kikugi() {
        super("Kikugi",
                Type.GRASS,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Der kleine Ball ist nicht nur voller Nährstoffe, sondern auch schmackhaft. Staralili pickt oft danach."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WORRY_SEED,28),
