...
import java.util.*;
public class Elektek extends drai.dev.gravelmon.pokemon.Pokemon {
    public Elektek() {
        super("Elektek",
                Type.ELECTRIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Verstärkt Schläge durch rasantes Drehen seiner Arme. Gegner rennen unterdessen auch schon mal davon."),
                List.of(),
                List.of(
