...
import java.util.*;
public class AvalossianVigoroth extends drai.dev.data.pokemon.Pokemon {
    public AvalossianVigoroth(String name, Aspect aspect) {
        super(name, aspect, "Vigoroth",
                ...
                List.of("Avalossian Vigoroth are just as energetic as their cousins in the Hoenn region, though due to their odd diet of poisonous fruits and berries, they appear more sluggish. Along with their stumbling gait, they possess a potent anger paired with a sluggish brain."),
