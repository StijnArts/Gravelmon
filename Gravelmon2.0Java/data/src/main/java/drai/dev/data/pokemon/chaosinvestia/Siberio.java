...
import java.util.*;
public class Siberio extends drai.dev.gravelmon.pokemon.Pokemon {
    public Siberio() {
        super("Siberio",
                Type.ICE,
                new Stats(95,
                ...
                70,
                50, List.of(),
                List.of("Kämpft mit Reißzähnen aus Eis, die es aus gefrorenem Atem herstellt. Es lebt im Norden, wo es kalt ist."),
                List.of(),
                List.of(
