...
import java.util.*;
public class AvalossianRalts extends drai.dev.data.pokemon.Pokemon {
    public AvalossianRalts(String name, Aspect aspect) {
        super(name, aspect, "Ralts",
                Type.FAIRY,
                new Stats(33,
                        35,
                        25,
                ...
                List.of(new EvolutionEntry("Avalossiankirlia", EvolutionType.LEVEL_UP, List.of(),
