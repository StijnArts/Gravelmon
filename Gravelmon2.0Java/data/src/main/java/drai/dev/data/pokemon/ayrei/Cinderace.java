...
import java.util.*;
public class Cinderace extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cinderace() {
        super("Cinderace",
                Type.FIRE,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("It's skilled at both offense and defense, and it gets pumped up when cheered on. But if it starts showboating, it could put itself in a tough spot."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.COURT_CHANGE,62),
                        new MoveLearnSetEntry(Move.FEINT,1),
                        new MoveLearnSetEntry(Move.PYRO_BALL,1),
