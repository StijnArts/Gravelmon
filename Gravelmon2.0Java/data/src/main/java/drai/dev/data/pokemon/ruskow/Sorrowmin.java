...
import java.util.*;
public class Sorrowmin extends drai.dev.data.pokemon.Pokemon {
    public Sorrowmin() {
        super("Sorrowmin",
                Type.WATER,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("ermourne", EvolutionType.LEVEL_UP, List.of(),
