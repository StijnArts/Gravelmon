...
import java.util.*;
public class Flarepent extends drai.dev.data.pokemon.Pokemon {
    public Flarepent() {
        super("Flarepent",
                Type.FIRE,
                new Stats(57,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BURN_UP,44),
