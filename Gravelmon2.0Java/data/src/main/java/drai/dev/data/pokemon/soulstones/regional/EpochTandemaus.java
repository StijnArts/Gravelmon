...
import java.util.*;
public class EpochTandemaus extends drai.dev.data.pokemon.Pokemon {
    public EpochTandemaus(String name, Aspect aspect) {
        super(name, aspect, "EpochTandemaus",
                ...
                List.of("They absorb as much sand as they leave behind; they get blown away by strong winds but re-emerge when the winds die down."),
                List.of(new EvolutionEntry("epochmaushold", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "gravelmon:solid_stone")),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RAPIDSTRIKE,"egg"),
