...
import java.util.*;
public class AyreianVivillon extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillon(String name, Aspect aspect) {
        super(name, aspect, "Vivillon",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.COACHING,12),
