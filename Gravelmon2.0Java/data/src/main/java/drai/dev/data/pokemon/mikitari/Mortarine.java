...
import java.util.*;
public class Mortarine extends drai.dev.data.pokemon.Pokemon {
    public Mortarine() {
        super("Mortarine",
                ...
                List.of("Its big gloves contain pressurized water. During impact all water is rapidly released empowering its blow."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WATER_GUN,1),
                        new MoveLearnSetEntry(Move.TAIL_WHIP,1),
                        new MoveLearnSetEntry(Move.HYDROPUNCH,1),
                        ...
                        new MoveLearnSetEntry(Move.FOCUS_PUNCH,12),
                        ...
                        new MoveLearnSetEntry(Move.DYNAMICPUNCH,48),
