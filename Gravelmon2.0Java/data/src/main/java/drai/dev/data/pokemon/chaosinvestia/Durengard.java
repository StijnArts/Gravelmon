...
import java.util.*;
public class Durengard extends drai.dev.gravelmon.pokemon.Pokemon {
    public Durengard() {
        super("Durengard",
                ...
                70,
                50, List.of(),
                List.of("Angeblich erkennt es jene Menschen, die Potenzial zum Herrscher haben. Es heißt, von ihm anerkannte Personen seien bald darauf Könige geworden."),
                List.of(),
                List.of(
