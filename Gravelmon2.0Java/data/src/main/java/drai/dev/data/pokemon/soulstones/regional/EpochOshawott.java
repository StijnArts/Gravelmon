...
import java.util.*;
public class EpochOshawott extends drai.dev.data.pokemon.Pokemon {
    public EpochOshawott(String name, Aspect aspect) {
        super(name, aspect, "EpochOshawott",
                ...
                List.of("They dream of working in construction and live in cities to learn from humans. They even have little toy hammers they cherish with their life."),
                List.of(new EvolutionEntry("epochdewott", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"17")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.VANGUARD,"egg"),
                        new MoveLearnSetEntry(Move.BLESSEDHAMMER,"egg")),
