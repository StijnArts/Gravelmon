...
import java.util.*;
public class ChaosInVestiaanMalamar extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanMalamar(String name, Aspect aspect) {
        super(name, aspect, "Malamar",
