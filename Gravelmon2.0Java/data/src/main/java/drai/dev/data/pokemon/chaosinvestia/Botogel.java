...
import java.util.*;
public class Botogel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Botogel() {
        super("Botogel",
                ...
                new Stats(45,
                        ...
                        65,
                        45),
                List.of(Ability.VITAL_SPIRIT,Ability.HUSTLE), null,
                9, 160,
                ...
                70,
                50, List.of(),
                List.of("Im eingerollten Schweif transportiert es Futter, das es mit denen teilt, die sich verlaufen haben."),
                List.of(),
                List.of(
