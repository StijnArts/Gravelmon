...
import java.util.*;
public class Bissbark extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bissbark() {
        super("Bissbark",
                Type.NORMAL,
                new Stats(85,
                        ...
                        45,
                        90),
                List.of(Ability.INTIMIDATE,Ability.SAND_RUSH), null,
                12, 610,
                ...
                70,
                50, List.of(),
                List.of("Seine Stärke ist es, Menschen zu retten, die auf hoher See oder in den Bergen in Not geraten. Ein sehr kluges Pokémon."),
                List.of(),
                List.of(
