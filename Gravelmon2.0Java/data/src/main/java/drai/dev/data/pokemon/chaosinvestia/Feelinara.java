...
import java.util.*;
public class Feelinara extends drai.dev.gravelmon.pokemon.Pokemon {
    public Feelinara() {
        super("Feelinara",
                Type.FAIRY,
                new Stats(95,
                        ...
                        110,
                        130),
                List.of(Ability.CUTE_CHARM,Ability.CUTE_CHARM), null,
                10, 235,
                ...
                70,
                50, List.of(),
                List.of("Es umwickelt den Arm seines geliebten Trainers mit seinen bandförmigen Fühlern und geht so mit ihm spazieren."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MISTY_TERRAIN,29)                        ),
