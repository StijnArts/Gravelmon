...
import java.util.*;
public class Meterock extends drai.dev.data.pokemon.Pokemon {
    public Meterock() {
        super("Meterock",
                ...
                List.of("Meterock zoom across the stratosphere, having little care for what they crash into. Rocket launches have to be carefully planned around their flying routes."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.METEOR_MASH,0),
                        ...
                        new MoveLearnSetEntry(Move.VOLT_TACKLE,57),
