...
import java.util.*;
public class Omot extends drai.dev.gravelmon.pokemon.Pokemon {
    public Omot() {
        super("Omot",
                ...
                70,
                50, List.of(),
                List.of("Es schlägt mit den Flügeln, um staubartige Schuppen abzusondern. Diese geben bei Kontakt Gift ab."),
                List.of(),
                List.of(
