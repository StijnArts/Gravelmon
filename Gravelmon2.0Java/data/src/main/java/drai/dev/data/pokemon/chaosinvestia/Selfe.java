...
import java.util.*;
public class Selfe extends drai.dev.gravelmon.pokemon.Pokemon {
    public Selfe() {
        super("Selfe",
                Type.PSYCHIC,
                new Stats(75,
                ...
                3, 3,
                new Stats(0,0,2,0,0,1), 3,
                -1.0,
                0, ExperienceGroup.SLOW,
                70,
                50, List.of(),
                List.of("Als Selfe flog, erlangten Menschen die Fähigkeit, Probleme zu lösen. Es war die Geburt des Wissens."),
                List.of(),
                List.of(
