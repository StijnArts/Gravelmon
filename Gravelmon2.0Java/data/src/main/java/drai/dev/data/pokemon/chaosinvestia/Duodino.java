...
import java.util.*;
public class Duodino extends drai.dev.gravelmon.pokemon.Pokemon {
    public Duodino() {
        super("Duodino",
                ...
                70,
                50, List.of(),
                List.of("Seine zwei Köpfe liegen stets im Streit. So wird jede Mahlzeit ein Wettstreit für sie, bei dem sich beide überfressen."),
                List.of(),
                List.of(
