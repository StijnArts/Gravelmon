...
import java.util.*;
public class EpochGallade extends drai.dev.data.pokemon.Pokemon {
    public EpochGallade(String name, Aspect aspect) {
        super(name, aspect, "EpochGallade",
                ...
                new Stats(108,
                        ...
                        65,
                        80),
                List.of(Ability.HYPER_CUTTER,Ability.VENGEFUL), Ability.NOBILITY,
                16, 520,
                ...
                List.of("Keen to seek out vengeance on those who harmed it during its earlier stages, it has become very focused and unforgiving on seeking its revenge."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SHADOW_SNEAK,9),
                        new MoveLearnSetEntry(Move.NIGHT_SLASH,30),
                        new MoveLearnSetEntry(Move.PLAGUE,45),
                        new MoveLearnSetEntry(Move.METEOR_MASH,1),
                        new MoveLearnSetEntry(Move.POISON_JAB,33),
                        new MoveLearnSetEntry(Move.GRIMREAPER,42),
                        new MoveLearnSetEntry(Move.NECROPHAGY,27),
                        new MoveLearnSetEntry(Move.CROSS_POISON,20),
                        new MoveLearnSetEntry(Move.HYPNOSIS,13),
                        new MoveLearnSetEntry(Move.DEATHREAP,1),
                        new MoveLearnSetEntry(Move.SCORESETTLER,16),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 40, 56, .15, List.of(
