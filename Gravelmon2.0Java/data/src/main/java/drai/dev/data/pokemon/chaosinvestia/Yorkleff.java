...
import java.util.*;
public class Yorkleff extends drai.dev.gravelmon.pokemon.Pokemon {
    public Yorkleff() {
        super("Yorkleff",
                Type.NORMAL,
                new Stats(45,
                        ...
                        25,
                        45),
                List.of(Ability.VITAL_SPIRIT,Ability.PICKUP), null,
                4, 41,
                ...
                70,
                50, List.of(),
                List.of("Das lange Fell um sein Gesicht fungiert als Hightech-Radar, mit dem es fein säuberlich seine Umgebung abtastet."),
                List.of(),
                List.of(
