...
import java.util.*;
public class Jelliqueen extends drai.dev.data.pokemon.Pokemon {
    public Jelliqueen() {
        super("Jelliqueen",
                ...
                List.of("Jelliqueen do not allow any intruders to approach their offsprings. If a stray Jellitot or Jellinip drifts near, Jelliqueen would take it under its care."),
                List.of(),
                List.of(
