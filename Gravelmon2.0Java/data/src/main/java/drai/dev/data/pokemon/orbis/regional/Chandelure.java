...
import java.util.*;
public class Chandelure extends drai.dev.data.pokemon.Pokemon {
    public Chandelure(String name, Aspect aspect) {
        super(name, aspect, "Chandelure",
                ...
                List.of("This Pokémon haunts dilapidated mansions. It sways its arms to hypnotize opponents with the ominous dancing of its flames."),
                List.of(),
                List.of(
