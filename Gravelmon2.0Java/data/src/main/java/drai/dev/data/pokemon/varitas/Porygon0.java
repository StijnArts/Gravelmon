...
public class Porygon0 extends drai.dev.data.pokemon.Pokemon {
    public Porygon0() {
        super("Porygon0",
                ...
                List.of("Interfacing with official Silph Co. software caused it to unexpectedly evolve into this new unknown form. It seems to have stabilized but posseses the ability to spread computer viruses at will as well as an actively malicious AI."),
                List.of(),
                List.of(
