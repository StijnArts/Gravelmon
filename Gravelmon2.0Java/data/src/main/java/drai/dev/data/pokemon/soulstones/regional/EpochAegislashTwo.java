...
import java.util.*;
public class EpochAegislashTwo extends drai.dev.data.pokemon.Pokemon {
    public EpochAegislashTwo(String name, Aspect aspect) {
        super(name, aspect, "EpochAegislashTwo",
