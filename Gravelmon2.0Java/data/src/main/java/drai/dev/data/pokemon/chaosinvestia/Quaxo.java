...
import java.util.*;
public class Quaxo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quaxo() {
        super("Quaxo",
                Type.WATER,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Es versammelt andere Pokémon um sich herum und führt sie an. Quapsel gehorchen seinem Ruf."),
                List.of(),
                List.of(
