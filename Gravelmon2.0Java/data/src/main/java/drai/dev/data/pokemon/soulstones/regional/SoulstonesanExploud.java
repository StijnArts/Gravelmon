...
import java.util.*;
public class SoulstonesanExploud extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanExploud(int dex) {
        super(dex, "Exploud",
                ...
                List.of("This Pokemon likes to constantly yell "Turn down for what?!" for some reason."),
                List.of(),
                List.of(
