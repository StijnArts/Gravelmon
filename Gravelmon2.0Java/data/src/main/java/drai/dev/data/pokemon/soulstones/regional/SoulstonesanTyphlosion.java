...
import java.util.*;
public class SoulstonesanTyphlosion extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTyphlosion(int dex) {
        super(dex, "Typhlosion",
                ...
                List.of("It can remove the gear on its back and throw it a sort of boomerang or throwing weapon."),
                List.of(),
                List.of(
