...
public class EpochChandelure extends drai.dev.data.pokemon.Pokemon {
    public EpochChandelure(String name, Aspect aspect) {
        super(name, aspect, "EpochChandelure",
                ...
                List.of("The spirit possessed a chandelier and now pranks people by turning on and off rapidly to create a more menacing atmosphere."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MACABREDANCE,1),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 47, 58, .12, List.of(
