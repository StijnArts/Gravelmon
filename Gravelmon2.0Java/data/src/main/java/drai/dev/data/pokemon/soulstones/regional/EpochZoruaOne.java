...
import java.util.*;
public class EpochZoruaOne extends drai.dev.data.pokemon.Pokemon {
    public EpochZoruaOne(String name, Aspect aspect) {
        super(name, aspect, "EpochZoruaOne",
                ...
                List.of("It emits purifying light strong enough to drive away other Ghost-types, leaving it a shy, lonely, and sad Pokemon that is afraid to open itself to others."),
                List.of(new EvolutionEntry("epochtwozoroark", EvolutionType.LEVEL_UP, List.of(), 
