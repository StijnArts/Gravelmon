...
import java.util.*;
public class AvalossianDusclops extends drai.dev.data.pokemon.Pokemon {
    public AvalossianDusclops(String name, Aspect aspect) {
        super(name, aspect, "Dusclops",
                ...
                List.of(""),
                List.of(new EvolutionEntry("Avalossiandusknoir", EvolutionType.LEVEL_UP, List.of(),
