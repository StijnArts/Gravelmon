...
import java.util.*;
public class Brockoloss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Brockoloss() {
        super("Brockoloss",
                Type.ROCK,
                new Stats(85,
                ...
                70,
                50, List.of(),
                List.of("Es absorbiert über seine orangefarbenen Kristalle das Sonnenlicht und schießt die so gewonnene Energie aus seinem Maul."),
                List.of(),
                List.of(
