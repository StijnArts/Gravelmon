...
import java.util.*;
public class SoulstonesanStaravia extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanStaravia(int dex) {
        super(dex, "Staravia",
