...
import java.util.*;
public class MikitarinianBuneary extends drai.dev.data.pokemon.Pokemon {
    public MikitarinianBuneary(String name, Aspect aspect) {
        super(name, aspect, "MikitarinianBuneary",
                Type.DARK,
                new Stats(55,
                        66,
                        44,
