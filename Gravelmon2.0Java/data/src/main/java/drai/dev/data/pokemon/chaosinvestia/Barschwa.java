...
import java.util.*;
public class Barschwa extends drai.dev.gravelmon.pokemon.Pokemon {
    public Barschwa() {
        super("Barschwa",
                Type.WATER,
                new Stats(20,
                ...
                70,
                50, List.of(),
                List.of("Ein schäbiges, ja sogar hässliches Pokémon. Dafür ist es abgehärtet und überlebt mit wenig Wasser."),
                List.of(),
                List.of(
