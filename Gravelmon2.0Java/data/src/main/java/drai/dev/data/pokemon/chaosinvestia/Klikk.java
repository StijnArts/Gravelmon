...
import java.util.*;
public class Klikk extends drai.dev.gravelmon.pokemon.Pokemon {
    public Klikk() {
        super("Klikk",
                Type.STEEL,
                new Stats(40,
                ...
                70,
                50, List.of(),
                List.of("Es gewinnt lebenswichtige Energie, indem es seine zwei Einzelteile ineinander verzahnt und rotieren lässt."),
                List.of(),
                List.of(
