...
import java.util.*;
public class Glutexo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Glutexo() {
        super("Glutexo",
                Type.FIRE,
                new Stats(58,
                ...
                70,
                50, List.of(),
                List.of("Glutexo leben in den Bergen. Die Flammen auf ihren Schweifspitzen leuchten in der Nacht wie Sterne."),
                List.of(),
                List.of(
