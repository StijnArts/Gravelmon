...
import java.util.*;
public class Wablu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Wablu() {
        super("Wablu",
                ...
                70,
                50, List.of(),
                List.of("Es kann nicht entspannen, wenn es oder seine Umgebung dreckig ist. Säubert alles mit den Flügeln."),
                List.of(),
                List.of(
