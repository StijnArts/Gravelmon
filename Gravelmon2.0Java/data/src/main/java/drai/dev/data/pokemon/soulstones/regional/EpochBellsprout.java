...
import java.util.*;
public class EpochBellsprout extends drai.dev.data.pokemon.Pokemon {
    public EpochBellsprout(String name, Aspect aspect) {
        super(name, aspect, "EpochBellsprout",
                ...
                List.of("It is rotting away but is very vindictive and will destroy everything around it in a vengeance before it dies."),
                List.of(new EvolutionEntry("epochweepinbell", EvolutionType.LEVEL_UP, List.of(), 
