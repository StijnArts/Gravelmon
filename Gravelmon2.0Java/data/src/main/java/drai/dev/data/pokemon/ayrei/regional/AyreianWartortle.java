...
import java.util.*;
public class AyreianWartortle extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianWartortle(int dex) {
        super(dex, "Wartortle",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.METAL_CLAW,0),
