...
import java.util.*;
public class AyreianGardevoir extends drai.dev.data.pokemon.Pokemon {
    public AyreianGardevoir(String name, Aspect aspect) {
        super(name, aspect, "Gardevoir",
                ...
                List.of("It has a latent power to read minds. A folktale tells that, long ago, this Pokemon and its 'mirrored image' served a malicious king."),
                List.of(),
                List.of(
