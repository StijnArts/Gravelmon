...
import java.util.*;
public class Traunmagil extends drai.dev.gravelmon.pokemon.Pokemon {
    public Traunmagil() {
        super("Traunmagil",
                Type.GHOST,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Sein Ruf ähnelt einer Beschwörung. Man sagt, dass er manchmal über die Kraft verfüge, glücklich zu machen."),
                List.of(),
                List.of(
