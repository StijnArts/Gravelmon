...
import java.util.*;
public class Amacorala extends drai.dev.gravelmon.pokemon.Pokemon {
    public Amacorala() {
        super("Amacorala",
                ...
                70,
                50, List.of(),
                List.of("It stores high amounts of water inside of its body, which it then shoots as precise water jets."),
                List.of(),
                List.of(
