...
import java.util.*;
public class SoulstonesanQuagsire extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanQuagsire(int dex) {
        super(dex, "Quagsire",
                ...
                0.5,
                151, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.WATER_1,EggGroup.FIELD),
                List.of("This Pokemon is viewed as very wise in folk tales, but in reality, it actually has very low intelligence."),
                List.of(),
                List.of(
