...
import java.util.*;
public class Apoquallyp extends drai.dev.gravelmon.pokemon.Pokemon {
    public Apoquallyp() {
        super("Apoquallyp",
                ...
                70,
                50, List.of(),
                List.of("Es bewegt sich wie mit einer Düse fort, indem es Meerwasser ausstößt. Seine Leibspeise ist Lebensenergie."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WATER_SPOUT,69),
                        ...
                        new MoveLearnSetEntry(Move.HEX,45),
