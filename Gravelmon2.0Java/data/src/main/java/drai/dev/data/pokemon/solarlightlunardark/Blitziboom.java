...
import java.util.*;
public class Blitziboom extends drai.dev.data.pokemon.Pokemon {
    public Blitziboom() {
        super("Blitziboom",
                ...
                List.of("Battles between Blitziboom illuminates the whole night sky. Even if it is raining, a Blitziboom at full power would simply blow away the rainclouds with ease."),
                List.of(),
                List.of(
