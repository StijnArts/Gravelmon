...
import java.util.*;
public class EpochQuaxly extends drai.dev.data.pokemon.Pokemon {
    public EpochQuaxly(String name, Aspect aspect) {
        super(name, aspect, "EpochQuaxly",
                ...
                List.of("It is full of pride and swagger. It finds any reason to show off its lack of lyrical skill, creating a sort of cacophony when it attempts to rap."),
                List.of(new EvolutionEntry("epochquaxwell", EvolutionType.LEVEL_UP, List.of(), 
