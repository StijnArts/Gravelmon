...
import java.util.*;
public class Sarzenia extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sarzenia() {
        super("Sarzenia",
                ...
                70,
                50, List.of(),
                List.of("In seinem Maul sammelt sich eine Flüssigkeit, die nach Honig riecht, in Wahrheit aber ätzend ist."),
                List.of(),
                List.of(
