...
import java.util.*;
public class AyreianRoselia extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianRoselia(int dex) {
        super(dex, "Roselia",
                ...
                70,
                50, List.of(),
                List.of("If threatened, it will barrage its opponent with heavy blows from its rock-solid arms, which are also full of toxins."),
                List.of(),
                List.of(
