...
import java.util.*;
public class Maschock extends drai.dev.gravelmon.pokemon.Pokemon {
    public Maschock() {
        super("Maschock",
                Type.FIGHTING,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("Es hievt gern schwere Ladung, um so zu trainieren. Es hilft auch gern anderen bei harter Arbeit."),
                List.of(),
                List.of(
