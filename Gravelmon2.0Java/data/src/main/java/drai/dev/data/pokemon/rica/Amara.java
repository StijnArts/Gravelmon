    ...
    public Amara() {
        super("Amara",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.QUICKGUARDN,1),
                        new MoveLearnSetEntry(Move.FOLLOWMEN,7),
                        new MoveLearnSetEntry(Move.HEAL_PULSE,12),
                        new MoveLearnSetEntry(Move.MAGICAL_LEAF,16),
                        new MoveLearnSetEntry(Move.BATONPASSN,20),
                        ...
                        new MoveLearnSetEntry(Move.FUTURESIGHTN,41),
                        new MoveLearnSetEntry(Move.AROMATHERAPY,46),
                        new MoveLearnSetEntry(Move.ALLYSWITCHN,52),
                        new MoveLearnSetEntry(Move.ECHOED_VOICE,"tm"),
                        new MoveLearnSetEntry(Move.NATUREPOWERN,"tm"),
                        ...
                        new MoveLearnSetEntry(Move.LOVELARIATN,"tm"),
