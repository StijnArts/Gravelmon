...
import java.util.*;
public class AyreianMagneton extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianMagneton(int dex) {
        super(dex, "Magneton",
                ...
                new Stats(50,
                        ...
                        120,
                        80),
                List.of(Ability.FLAME_BODY,Ability.MAGNET_PULL), null,
                10, 600,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TRI_ATTACK,0),
