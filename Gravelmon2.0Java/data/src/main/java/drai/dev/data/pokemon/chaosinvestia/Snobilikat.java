...
import java.util.*;
public class Snobilikat extends drai.dev.gravelmon.pokemon.Pokemon {
    public Snobilikat() {
        super("Snobilikat",
                Type.NORMAL,
                new Stats(65,
                        ...
                        65,
                        65),
                List.of(Ability.LIMBER,Ability.TECHNICIAN), null,
                10, 320,
                ...
                70,
                50, List.of(),
                List.of("Ein sehr stolzes Pokémon. Für Fans ist die Größe des Juwels auf seiner Stirn Anlass für Diskussionen."),
                List.of(),
                List.of(
