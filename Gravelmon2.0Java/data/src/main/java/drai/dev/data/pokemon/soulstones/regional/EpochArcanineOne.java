...
import java.util.*;
public class EpochArcanineOne extends drai.dev.data.pokemon.Pokemon {
    public EpochArcanineOne(String name, Aspect aspect) {
        super(name, aspect, "EpochArcanineOne",
                ...
                List.of("It has a distinctive mane pattern and twisting, crown-like horns. Some view it as a type of deity from the void."),
                List.of(),
                List.of(
