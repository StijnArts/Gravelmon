...
import java.util.*;
public class Histeria extends drai.dev.data.pokemon.Pokemon {
    public Histeria() {
        super("Histeria",
                Type.FIRE,Type.DARK,
                new Stats(77,
                ...
                List.of("It moves like a shadow, sneaking silently behind its ennemies. Its paralysing glaze can traumatize anyone if it wishes to. Only its singing is able to unfreeze its victims."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROOST,54),
