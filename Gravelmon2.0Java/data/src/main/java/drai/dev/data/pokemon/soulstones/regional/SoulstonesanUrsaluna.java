...
import java.util.*;
public class SoulstonesanUrsaluna extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanUrsaluna(int dex) {
        super(dex, "Ursaluna",
                ...
                List.of("It is able to shift from a corporeal form to ethereal form at will, which it uses to its advantage for hunting."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TRIVEGA,39),
