...
import java.util.*;
public class Barschuft extends drai.dev.gravelmon.pokemon.Pokemon {
    public Barschuft() {
        super("Barschuft",
                Type.WATER,
                new Stats(70,
                        ...
                        80,
                        55),
                List.of(Ability.RECKLESS,Ability.ADAPTABILITY), null,
                10, 180,
                ...
                70,
                50, List.of(),
                List.of("Rot gestreifte und blau gestreifte Exemplare sind sich feindlich gesonnen. Doch ist jeder Schwarm bunt gemischt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AQUA_TAIL,28),
                        new MoveLearnSetEntry(Move.SOAK,32),
                        new MoveLearnSetEntry(Move.FLAIL,46),
