...
import java.util.*;
public class SoulstonesanPolteageist extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPolteageist(int dex) {
        super(dex, "Polteageist",
                ...
                List.of("Polteageist has definitely had too much to drink. It doesn't ever let go of its bottle as it's very attached to it."),
                List.of(),
                List.of(
