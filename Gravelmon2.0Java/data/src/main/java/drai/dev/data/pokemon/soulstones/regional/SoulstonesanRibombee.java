...
import java.util.*;
public class SoulstonesanRibombee extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanRibombee(int dex) {
        super(dex, "Ribombee",
                ...
                0.5,
                162, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.BUG,EggGroup.FLYING),
                List.of("It hovers around dirty, urban areas most often. One of its favourite locations is the Orion Landfill."),
                List.of(),
                List.of(
