...
import java.util.*;
public class Lektrobal extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lektrobal() {
        super("Lektrobal",
                Type.ELECTRIC,
                new Stats(60,
                        ...
                        80,
                        80),
                List.of(Ability.SOUNDPROOF,Ability.STATIC), null,
                12, 666,
                ...
                70,
                50, List.of(),
                List.of("Es lässt sich vom Wind treiben, wenn es so voller Elektrizität ist, dass es fast explodiert."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SWIFT,40),
                        ...
                        new MoveLearnSetEntry(Move.MIRROR_COAT,62),
