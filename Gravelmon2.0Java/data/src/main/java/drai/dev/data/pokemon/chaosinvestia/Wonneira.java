...
import java.util.*;
public class Wonneira extends drai.dev.gravelmon.pokemon.Pokemon {
    public Wonneira() {
        super("Wonneira",
                Type.NORMAL,
                new Stats(100,
                ...
                70,
                50, List.of(),
                List.of("Hat immer einen kleinen Felsen bei sich. Wandelt zwischen den Füßen anderer, was diese stolpern lässt."),
                List.of(),
                List.of(
