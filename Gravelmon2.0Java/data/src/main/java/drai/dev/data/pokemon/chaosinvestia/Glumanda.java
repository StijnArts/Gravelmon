...
import java.util.*;
public class Glumanda extends drai.dev.gravelmon.pokemon.Pokemon {
    public Glumanda() {
        super("Glumanda",
                Type.FIRE,
                new Stats(39,
                ...
                70,
                50, List.of(),
                List.of("Lodert die Flamme auf seiner Schweifspitze hell, ist Glumanda gesund."),
                List.of(),
                List.of(
