...
public class Crystallier extends drai.dev.data.pokemon.Pokemon {
    public Crystallier() {
        super("Crystallier",
                ...
                List.of("Crystallier uses its combined brain power to gather crystals and hold them close to itself for protection. It is believed that the central head is in charge."),
                List.of(),
                List.of(
