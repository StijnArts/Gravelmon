...
import java.util.*;
public class Moterpel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Moterpel() {
        super("Moterpel",
                ...
                70,
                50, List.of(),
                List.of("Es liebt Honig, sammelt ihn aber nicht, sondern stiehlt den Honig, der von Wadribie gesammelt wurde."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.POISON_POWDER,29),
                        ...
                        new MoveLearnSetEntry(Move.CAMOUFLAGE,35),
                        ...
                        new MoveLearnSetEntry(Move.SILVER_WIND,38),
