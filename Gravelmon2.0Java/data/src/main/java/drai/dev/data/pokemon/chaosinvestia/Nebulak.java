...
import java.util.*;
public class Nebulak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Nebulak() {
        super("Nebulak",
                ...
                70,
                50, List.of(),
                List.of("Eingehüllt in seinen gasförmigen, Gift enthaltenden Körper würde jeder in Ohnmacht fallen."),
                List.of(),
                List.of(
