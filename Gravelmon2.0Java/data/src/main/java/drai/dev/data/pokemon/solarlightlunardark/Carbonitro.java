...
import java.util.*;
public class Carbonitro extends drai.dev.data.pokemon.Pokemon {
    public Carbonitro() {
        super("Carbonitro",
                Type.ICE,
                new Stats(105,
                ...
                List.of("Carbonitro have complete control over their body temperature, allowing them to become freezing cold or scorching hot at will."),
                List.of(),
                List.of(
