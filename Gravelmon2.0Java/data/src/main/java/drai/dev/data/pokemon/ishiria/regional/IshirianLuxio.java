...
import java.util.*;
public class IshirianLuxio extends drai.dev.data.pokemon.Pokemon {
    public IshirianLuxio(String name, Aspect aspect) {
        super(name, aspect, "IshirianLuxio",
                ...
                List.of(new EvolutionEntry("ishirianluxray", EvolutionType.LEVEL_UP, List.of(),
