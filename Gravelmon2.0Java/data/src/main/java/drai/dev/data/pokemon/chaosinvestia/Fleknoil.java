...
import java.util.*;
public class Fleknoil extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fleknoil() {
        super("Fleknoil",
                ...
                new Stats(55,
                        ...
                        55,
                        43),
                List.of(Ability.UNAWARE,Ability.KLUTZ), null,
                4, 21,
                ...
                70,
                50, List.of(),
                List.of("Wenn es schläft, saugt es sich mit seinem Nasenloch an einer Höhlenwand fest und hinterlässt dort eine herzförmige Spur."),
                List.of(),
                List.of(
