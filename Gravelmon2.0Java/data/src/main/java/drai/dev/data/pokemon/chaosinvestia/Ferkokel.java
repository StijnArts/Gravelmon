...
import java.util.*;
public class Ferkokel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Ferkokel() {
        super("Ferkokel",
                ...
                70,
                50, List.of(),
                List.of("Nutzt Nahrung als Brennstoff, um das Feuer in seinem Magen zu schüren. Mit Wut im Bauch heizt es ungleich stärker."),
                List.of(),
                List.of(
