...
import java.util.*;
public class Castellith extends drai.dev.gravelmon.pokemon.Pokemon {
    public Castellith() {
        super("Castellith",
                Type.BUG,Type.ROCK,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Er ist hart genug im Nehmen, um mitsamt seines schweren Felsens mehrere Tage durch trockene Gebiete zu wandern."),
                List.of(),
                List.of(
