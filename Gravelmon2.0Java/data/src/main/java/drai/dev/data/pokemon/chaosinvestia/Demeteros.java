...
import java.util.*;
public class Demeteros extends drai.dev.gravelmon.pokemon.Pokemon {
    public Demeteros() {
        super("Demeteros",
                ...
                70,
                50, List.of(),
                List.of("Es vergießt mit seinem Schweif Energie, die den Boden mit Nährstoffen anreichert und für reichhaltige Ernten sorgt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SANDSTORM,61),
