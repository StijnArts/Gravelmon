...
import java.util.*;
public class Digdri extends drai.dev.gravelmon.pokemon.Pokemon {
    public Digdri() {
        super("Digdri",
                Type.GROUND,
                new Stats(35,
                        ...
                        50,
                        70),
                List.of(Ability.SAND_VEIL,Ability.ARENA_TRAP), null,
                7, 333,
                ...
                70,
                50, List.of(),
                List.of("Die drei Köpfe bewegen sich abwechselnd, um sich durch harte Erde in Tiefen von bis zu 100 km zu graben."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.EARTH_POWER,33),
