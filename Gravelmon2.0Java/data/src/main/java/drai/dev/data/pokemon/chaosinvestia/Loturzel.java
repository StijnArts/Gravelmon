...
import java.util.*;
public class Loturzel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Loturzel() {
        super("Loturzel",
                ...
                new Stats(40,
                        ...
                        40,
                        50),
                List.of(Ability.SWIFT_SWIM,Ability.RAIN_DISH), null,
                5, 26,
                ...
                70,
                50, List.of(),
                List.of("Es sieht aus wie eine Wasserpflanze. Es dient den Pokémon, die nicht schwimmen können, als Fähre."),
                List.of(),
                List.of(
