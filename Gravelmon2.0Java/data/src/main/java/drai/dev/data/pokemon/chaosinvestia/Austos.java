...
import java.util.*;
public class Austos extends drai.dev.gravelmon.pokemon.Pokemon {
    public Austos() {
        super("Austos",
                Type.WATER,Type.ICE,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Im Kampf schließt es seine Schale, um sich zu schützen. Es schießt mit Stacheln auf seine Gegner."),
                List.of(),
                List.of(
