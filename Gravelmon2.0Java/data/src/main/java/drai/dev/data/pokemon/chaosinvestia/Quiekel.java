...
import java.util.*;
public class Quiekel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quiekel() {
        super("Quiekel",
                ...
                70,
                50, List.of(),
                List.of("Verfügt über eine äußerst sensible Nase, die Pilze, Beeren und selbst heiße Quellen unter dem Eis findet."),
                List.of(),
                List.of(
