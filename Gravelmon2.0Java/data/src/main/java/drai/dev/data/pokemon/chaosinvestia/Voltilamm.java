...
import java.util.*;
public class Voltilamm extends drai.dev.gravelmon.pokemon.Pokemon {
    public Voltilamm() {
        super("Voltilamm",
                Type.ELECTRIC,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Sein weiches Fell wird doppelt so dick, wenn sich Elektrizität aufbaut."),
                List.of(),
                List.of(
