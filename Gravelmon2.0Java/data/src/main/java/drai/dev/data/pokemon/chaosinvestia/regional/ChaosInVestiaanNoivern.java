...
import java.util.*;
public class ChaosInVestiaanNoivern extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanNoivern(String name, Aspect aspect) {
        super(name, aspect, "Noivern",
