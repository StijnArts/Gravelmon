...
import java.util.*;
public class AyreianInfernape extends drai.dev.data.pokemon.Pokemon {
    public AyreianInfernape(String name, Aspect aspect) {
        super(name, aspect, "Infernape",
                ...
                List.of("It tosses its enemies around with agility. It uses all its limbs to fight in its own unique style."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.FIRE_PUNCH,30),
                        new MoveLearnSetEntry(Move.FLARE_BLITZ,62),
                        new MoveLearnSetEntry(Move.CLOSE_COMBAT,0),
