...
public class Winotinger extends Pokemon {
    public Winotinger() {
        super("Winotinger",
                ...
                List.of("It combines illusion and trickery with physical strength. Because it only reveals itself to drunk people, it was considered an imaginary Mon until very recently."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 38, 58, 0.9, List.of(
