...
import java.util.*;
public class SoulstonesanSnover extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSnover(int dex) {
        super(dex, "Snover",
                Type.GRASS,
                new Stats(70,
                        52,
                ...
                10, 505,
                new Stats(70,1,70,20,52,70), 120,
                0.5,
