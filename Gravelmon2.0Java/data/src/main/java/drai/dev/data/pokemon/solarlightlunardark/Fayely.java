...
import java.util.*;
public class Fayely extends drai.dev.data.pokemon.Pokemon {
    public Fayely() {
        super("Fayely",
                ...
                List.of("Fayely will only bond with kind-hearted people. They can become physically ill should their trainer commit evil deeds, but will still never leave their side."),
                List.of(new EvolutionEntry("fayegon", EvolutionType.LEVEL_UP, List.of(), 
