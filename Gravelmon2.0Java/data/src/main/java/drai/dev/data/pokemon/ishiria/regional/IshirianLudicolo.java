...
import java.util.*;
public class IshirianLudicolo extends drai.dev.data.pokemon.Pokemon {
    public IshirianLudicolo(String name, Aspect aspect) {
        super(name, aspect, "IshirianLudicolo",
