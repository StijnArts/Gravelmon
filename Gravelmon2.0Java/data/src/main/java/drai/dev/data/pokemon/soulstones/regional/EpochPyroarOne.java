...
import java.util.*;
public class EpochPyroarOne extends drai.dev.data.pokemon.Pokemon {
    public EpochPyroarOne(String name, Aspect aspect) {
        super(name, aspect, "EpochPyroarOne",
                ...
                List.of("It has embraced its weight that it was previously ashamed of as a Litleo. It prefers to groom its beard while basking under the hot sun."),
                List.of(),
                List.of(
