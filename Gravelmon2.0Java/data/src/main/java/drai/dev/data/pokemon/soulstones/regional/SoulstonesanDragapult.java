...
import java.util.*;
public class SoulstonesanDragapult extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanDragapult(int dex) {
        super(dex, "Dragapult",
                ...
                List.of("It draws in air from the vents on its head and expells it outward, creating a cloud trail that envelops its body while propelling it forwards."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MAGNETICCANNON,1),
