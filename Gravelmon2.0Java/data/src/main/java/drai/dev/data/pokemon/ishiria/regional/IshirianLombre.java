...
import java.util.*;
public class IshirianLombre extends drai.dev.data.pokemon.Pokemon {
    public IshirianLombre(String name, Aspect aspect) {
        super(name, aspect, "IshirianLombre",
                ...
                List.of(new EvolutionEntry("ishirianludicolo", EvolutionType.ITEM_INTERACT, false, List.of(),
