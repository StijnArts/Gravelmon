...
import java.util.*;
public class NodorroanSteelix extends drai.dev.data.pokemon.Pokemon {
    public NodorroanSteelix(String name, Aspect aspect) {
        super(name, aspect, "NodorroanSteelix",
