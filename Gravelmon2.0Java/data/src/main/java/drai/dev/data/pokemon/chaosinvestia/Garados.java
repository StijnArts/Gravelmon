...
import java.util.*;
public class Garados extends drai.dev.gravelmon.pokemon.Pokemon {
    public Garados() {
        super("Garados",
                ...
                70,
                50, List.of(),
                List.of("Wütet ein Garados, wird es alles niederbrennen. Dies geschieht selbst während eines Sturms."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AQUA_TAIL,35),
                        new MoveLearnSetEntry(Move.HYPER_BEAM,47),
                        new MoveLearnSetEntry(Move.HYDRO_PUMP,41),
                        new MoveLearnSetEntry(Move.DRAGON_RAGE,23),
                        new MoveLearnSetEntry(Move.LEER,26),
