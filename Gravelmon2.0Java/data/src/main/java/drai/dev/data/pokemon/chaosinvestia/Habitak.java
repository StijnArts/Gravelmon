...
import java.util.*;
public class Habitak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Habitak() {
        super("Habitak",
                ...
                70,
                50, List.of(),
                List.of("Im Flug schlägt es eifrig mit den Flügeln. Mit seinem Schnabel sucht es im Gras nach Beute."),
                List.of(),
                List.of(
