...
public class DeltaTurtwig extends Pokemon {
    public DeltaTurtwig(String name, Aspect aspect) {
        super(name, aspect,"DeltaTurtwig",
                ...
                List.of("A Delta Species discovered by NoNameDummy. Made from sand, the shell on its back hardens as it floats along the ocean's surface. As it dives, the shell softens."),
                List.of(new EvolutionEntry("deltagrotle", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WATER_SPOUT,45),
