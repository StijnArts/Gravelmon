...
import java.util.*;
public class SoulstonesanArcheops extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanArcheops(int dex) {
        super(dex, "Archeops",
                ...
                List.of("Its feathers carry a significant amount of static electricity. In sufficient quantities, these feathers can be used to create chain lightning."),
                List.of(),
                List.of(
