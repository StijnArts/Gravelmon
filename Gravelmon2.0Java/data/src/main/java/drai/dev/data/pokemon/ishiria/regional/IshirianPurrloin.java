...
import java.util.*;
public class IshirianPurrloin extends drai.dev.data.pokemon.Pokemon {
    public IshirianPurrloin(String name, Aspect aspect) {
        super(name, aspect, "IshirianPurrloin",
                Type.DARK,Type.ICE,
                new Stats(41,
                        50,
                        37,
                ...
                List.of(new EvolutionEntry("ishirianpurrloin", EvolutionType.LEVEL_UP, List.of(),
