...
import java.util.*;
public class SoulstonesanCorviknight extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanCorviknight(int dex) {
        super(dex, "Corviknight",
