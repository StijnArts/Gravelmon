...
import java.util.*;
public class Stolloss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Stolloss() {
        super("Stolloss",
                ...
                70,
                50, List.of(),
                List.of("Auf der Suche nach Eisen, seiner Nahrung, gräbt es mit seinen Stahlhörnern sogar Tunnel durch Felsen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.IRON_DEFENSE,15),
                        new MoveLearnSetEntry(Move.HARDEN,1),
                        new MoveLearnSetEntry(Move.METAL_BURST,74),
                        ...
                        new MoveLearnSetEntry(Move.HEAVY_SLAM,57)                        ),
