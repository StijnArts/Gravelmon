...
public class FligianBellsprout extends drai.dev.data.pokemon.Pokemon {
    public FligianBellsprout(String name, Aspect aspect) {
        super(name, aspect, "Paras",
                ...
                List.of(""),
                List.of(new EvolutionEntry("weepinbell fligian", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.FLIGA),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 3, 21, 5.4, List.of(
