...
import java.util.*;
public class EpochFraxure extends drai.dev.data.pokemon.Pokemon {
    public EpochFraxure(String name, Aspect aspect) {
        super(name, aspect, "EpochFraxure",
                ...
                List.of("It is found in mountainous regions. It typically stalks cliffs and will pounce on unwitting prey from above and impale them with its tail."),
                List.of(new EvolutionEntry("epochhaxorus", EvolutionType.LEVEL_UP, List.of(), 
