...
import java.util.*;
public class Angelight extends drai.dev.data.pokemon.Pokemon {
    public Angelight() {
        super("Angelight",
                Type.WATER,
                new Stats(92,
                ...
                List.of("Angelight are considered one of the most beautiful Pokémon in the oceans of Rikoto, and yet they do not actively look down on other Pokémon for not being as beautiful."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WATER_PULSE,15),
                        new MoveLearnSetEntry(Move.HYDRO_PUMP,49),
                        new MoveLearnSetEntry(Move.LOVELY_KISS,54),
                        ...
                        new MoveLearnSetEntry(Move.WISH,44),
                        new MoveLearnSetEntry(Move.PLAYFIGHT,1),
                        new MoveLearnSetEntry(Move.ATTRACT,39),
