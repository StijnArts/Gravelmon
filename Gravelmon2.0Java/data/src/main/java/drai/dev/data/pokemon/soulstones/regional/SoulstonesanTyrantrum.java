...
import java.util.*;
public class SoulstonesanTyrantrum extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTyrantrum(int dex) {
        super(dex, "Tyrantrum",
                Type.FIRE,Type.ICE,
                new Stats(82,
                        121,
                ...
                25, 2700,
                new Stats(82,2,119,71,69,59), 90,
                0.875,
                182, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.MONSTER,EggGroup.DRAGON),
                List.of("Its flames burn with a violent passion but the snow that has collected on its back never seems to melt. It is unclear how this is possible."),
                List.of(),
                List.of(
