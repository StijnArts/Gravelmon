...
import java.util.*;
public class AyreianVivillonFour extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonFour(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonFour",
                Type.FIRE,Type.BUG,
                new Stats(80,
                        52,
                        65,
