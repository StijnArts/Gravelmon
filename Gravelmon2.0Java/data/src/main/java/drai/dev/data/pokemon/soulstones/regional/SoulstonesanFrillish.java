...
import java.util.*;
public class SoulstonesanFrillish extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanFrillish(int dex) {
        super(dex, "Frillish",
