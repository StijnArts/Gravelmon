...
import java.util.*;
public class IshirianShinx extends drai.dev.data.pokemon.Pokemon {
    public IshirianShinx(String name, Aspect aspect) {
        super(name, aspect, "IshirianShinx",
                ...
                List.of(new EvolutionEntry("ishirianluxio", EvolutionType.LEVEL_UP, List.of(),
