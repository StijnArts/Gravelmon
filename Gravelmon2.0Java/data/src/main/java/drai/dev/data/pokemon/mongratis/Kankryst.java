...
import java.util.*;
public class Kankryst extends drai.dev.data.pokemon.Pokemon {
    public Kankryst() {
        super("Kankryst",
                ...
                List.of(new EvolutionEntry("kankersaur", EvolutionType.LEVEL_UP, List.of(),
