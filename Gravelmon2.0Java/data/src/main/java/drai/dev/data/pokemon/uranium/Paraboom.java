...
public class Paraboom extends Pokemon {
    public Paraboom() {
        super("Paraboom",
                ...
                18, 775,
                new Stats(0,0,0,2,0,0), 220,
                0.5,
                182, ExperienceGroup.MEDIUM_FAST,
                70,
                100, List.of(EggGroup.FIELD),
                List.of("It uses massive sonic booms to attack from a distance. An encounter with one will leave your ears ringing for days."),
                List.of(),
                List.of(
