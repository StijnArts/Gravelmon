...
import java.util.*;
public class Megalon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Megalon() {
        super("Megalon",
                Type.PSYCHIC,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Es manipuliert die Gehirne seiner Gegner mit Psycho-Kräften, indem es die Bilder ihrer Erinnerungen umgestaltet."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.ZEN_HEADBUTT,32),
                        new MoveLearnSetEntry(Move.CALM_MIND,45),
                        new MoveLearnSetEntry(Move.SYNCHRONOISE,63),
                        new MoveLearnSetEntry(Move.WONDER_ROOM,68),
                        ...
                        new MoveLearnSetEntry(Move.POWER_SPLIT,58)                        ),
