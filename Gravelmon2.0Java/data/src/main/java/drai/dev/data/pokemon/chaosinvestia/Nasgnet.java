...
import java.util.*;
public class Nasgnet extends drai.dev.gravelmon.pokemon.Pokemon {
    public Nasgnet() {
        super("Nasgnet",
                Type.ROCK,
                new Stats(30,
                ...
                70,
                50, List.of(),
                List.of("Es schützt sich bei Gefahr durch Gegenstände aus Eisen, die es mit erhöhtem Magnetismus an sich zieht."),
                List.of(),
                List.of(
