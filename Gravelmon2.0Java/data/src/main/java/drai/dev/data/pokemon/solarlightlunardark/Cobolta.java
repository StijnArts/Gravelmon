...
import java.util.*;
public class Cobolta extends drai.dev.data.pokemon.Pokemon {
    public Cobolta() {
        super("Cobolta",
                ...
                new Stats(70,
                        ...
                        100,
                        60),
                List.of(Ability.SHED_SKIN,Ability.TERRIFY), Ability.CORROSION,
                32, 625,
                ...
                List.of("Cobolta can change the patterns on its body by directing the electrical current in its body. This is mostly for intimidation, though it sees use during mating seasons as well."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SULFURIC_SPRAY,42),
                        ...
                        new MoveLearnSetEntry(Move.RISING_VOLTAGE,30),
                        new MoveLearnSetEntry(Move.VENOM_DRENCH,34),
                        new MoveLearnSetEntry(Move.POISON_FANG,14),
                        new MoveLearnSetEntry(Move.SCARY_FACE,0),
