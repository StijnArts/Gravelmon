...
import java.util.*;
public class TheossianShinx extends drai.dev.data.pokemon.Pokemon {
    public TheossianShinx(String name, Aspect aspect) {
        super(name, aspect, "Shinx",
                ...
                List.of(new EvolutionEntry("theossianluxio", EvolutionType.LEVEL_UP, List.of(),
