...
import java.util.*;
public class EpochKingambit extends drai.dev.data.pokemon.Pokemon {
    public EpochKingambit(String name, Aspect aspect) {
        super(name, aspect, "EpochKingambit",
                ...
                0.5,
                275, ExperienceGroup.MEDIUM_FAST,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("It earns more tassels with every one of its victories. Conversely however, it must lose one of its tassels when it loses."),
                List.of(),
                List.of(
                ...
                0, List.of(
                        ...
                        .setMinLevel(50).setPool(SpawnPool.UNCOMMON).setWeight(SpawnWeight.COMMON)
                        .setContext(SpawnContext.GROUNDED)
                        .setBiomes(Biome.IS_CHERRY_GROVE).duringDaytime()
                        .setSpawnPreset(SpawnPreset.NATURAL).build(),
                List.of());
           setLangFileName("Kingambit");
