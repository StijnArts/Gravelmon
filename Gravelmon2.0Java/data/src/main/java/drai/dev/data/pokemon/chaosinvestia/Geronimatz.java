...
import java.util.*;
public class Geronimatz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Geronimatz() {
        super("Geronimatz",
                ...
                70,
                50, List.of(),
                List.of("Es zettelt willkürlich Kämpfe an, egal wie stark der Gegner auch ist. Es gewinnt an Stärke, indem es seine Fehler analysiert."),
                List.of(),
                List.of(
