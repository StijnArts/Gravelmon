...
import java.util.*;
public class AyreianVivillonEight extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonEight(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonEight",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONCHEER,12),
