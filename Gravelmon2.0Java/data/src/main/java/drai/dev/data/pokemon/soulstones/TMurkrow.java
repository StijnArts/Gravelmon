...
import java.util.*;
public class TMurkrow extends drai.dev.gravelmon.pokemon.Pokemon {
    public TMurkrow() {
        super("TMurkrow",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MANICOVERLOAD,"egg"),
                        new MoveLearnSetEntry(Move.TRICK,"egg"),
                        new MoveLearnSetEntry(Move.MIXEDWAVES,"egg"),
