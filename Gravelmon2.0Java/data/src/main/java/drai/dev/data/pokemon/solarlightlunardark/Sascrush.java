...
import java.util.*;
public class Sascrush extends drai.dev.data.pokemon.Pokemon {
    public Sascrush() {
        super("Sascrush",
                ...
                List.of("Due to their keen senses, Sascrush were elusive to cameras until recently. Their large footprints in the mountains used to inspire folk-tales of giants."),
                List.of(),
                List.of(
