...
import java.util.*;
public class EpochGastrodonThree extends drai.dev.data.pokemon.Pokemon {
    public EpochGastrodonThree(String name, Aspect aspect) {
        super(name, aspect, "EpochGastrodonThree",
