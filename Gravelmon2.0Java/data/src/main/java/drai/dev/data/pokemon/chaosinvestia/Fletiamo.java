...
import java.util.*;
public class Fletiamo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fletiamo() {
        super("Fletiamo",
                ...
                70,
                50, List.of(),
                List.of("Wer den Ultraschallwellen eines Männchens in der Balz ausgesetzt wird, verfällt in eine euphorische Stimmung."),
                List.of(),
                List.of(
