...
import java.util.*;
public class Machomei extends drai.dev.gravelmon.pokemon.Pokemon {
    public Machomei() {
        super("Machomei",
                Type.FIGHTING,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Es erwischt Gegner mit harten Schlägen seiner kräftigen Arme und hackt mit enormer Geschwindigkeit."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DYNAMICPUNCH,55),
