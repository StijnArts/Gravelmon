...
import java.util.*;
public class IshirianOnix extends drai.dev.data.pokemon.Pokemon {
    public IshirianOnix(String name, Aspect aspect) {
        super(name, aspect, "IshirianOnix",
                ...
                List.of(new EvolutionEntry("ishiriansteelix", EvolutionType.ITEM_INTERACT, false, List.of(),
