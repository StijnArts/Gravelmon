...
import java.util.*;
public class Kinoso extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kinoso() {
        super("Kinoso",
                Type.GRASS,
                new Stats(70,
                        ...
                        87,
                        78),
                List.of(Ability.FLOWER_GIFT), null,
                5, 93,
                ...
                70,
                50, List.of(),
                List.of("Spürt es Sonnenlicht, öffnet es seine Blütenblätter und nimmt die Energie der Sonnenstrahlen auf."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.LEECH_SEED,10),
                        new MoveLearnSetEntry(Move.MORNING_SUN,1),
                        new MoveLearnSetEntry(Move.PETAL_DANCE,25),
                        ...
                        new MoveLearnSetEntry(Move.WORRY_SEED,30),
