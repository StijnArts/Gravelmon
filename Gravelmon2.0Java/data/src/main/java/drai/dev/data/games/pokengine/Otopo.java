...
public class Otopo extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        ...
        addNewPokemon(new Migravion());
        addNewPokemon(new Quink());
        addNewPokemon(new Tadacid());
        addNewPokemon(new Rancroak());
        addNewPokemon(new Gamutrid());
        addNewPokemon(new Duhmbey().fishingSpawnFromExisting());
        addNewPokemon(new Vishuslayk().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Maizeby(new Stats(410, StatArchetype.FAST_SUPPORT,
                List.of(StatType.HP))));
        addNewPokemon(new Halseaon().fishingSpawnFromExisting());
        addNewPokemon(new Ventilio().fishingSpawnFromExisting());
        addNewPokemon(new Katanicut().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Seevil(new Stats(390, StatArchetype.FAST_SPECIAL_ATTACKER,
                List.of(StatType.SPEED))));
...
//        addNewPokemon(new Ickko()); Member of line Not Finished
        ...
        addNewPokemon(new Tiamond(new Stats(550, StatArchetype.BULKY_SPECIAL_ATTACKER,
                List.of(StatType.DEFENCE))));
        ...
        addNewPokemon(new Pinacier().fishingSpawnFromExisting());
        addNewPokemon(new Narcicle().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Mizukomu().fishingSpawnFromExisting());
        ...
        addNewPokemon(new Oceadra().fishingSpawnFromExisting());
