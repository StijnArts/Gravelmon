...
public class Amygdalanche extends drai.dev.data.pokemon.Pokemon {
    public Amygdalanche() {
        super("Amygdalanche",
                ...
                List.of("As the temperature around it drops, its psychic powers grow ever stronger. It spends its time meditating in the iciest, most secluded caverns of Novrai."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ICE_PUNCH,56),
                        new MoveLearnSetEntry(Move.ROLE_PLAY,63),
