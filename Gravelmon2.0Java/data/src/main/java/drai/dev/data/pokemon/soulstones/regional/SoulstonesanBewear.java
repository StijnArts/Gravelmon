...
import java.util.*;
public class SoulstonesanBewear extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBewear(int dex) {
        super(dex, "Bewear",
                ...
                List.of("Parts of its body that were hanging together have torn further at its seams, revealing part of the ghost that possesses it."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.POSSESSION,56),
