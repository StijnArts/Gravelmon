...
import java.util.*;
public class Sealver extends drai.dev.data.pokemon.Pokemon {
    public Sealver() {
        super("Sealver",
                Type.STEEL,
                new Stats(40,
                        ...
                        60,
                        30),
                List.of(Ability.LIMBER), Ability.LIGHT_METAL,
                8, 300,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SLAM,10),
                        new MoveLearnSetEntry(Move.MINIMIZE,13),
                        new MoveLearnSetEntry(Move.HEADBUTT,16),
                        new MoveLearnSetEntry(Move.REST,19),
                        new MoveLearnSetEntry(Move.MIRROR_SHOT,22),
                        new MoveLearnSetEntry(Move.LIQUIDMETAL,25),
