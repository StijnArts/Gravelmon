...
import java.util.*;
public class SoulstonesanDragonite extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanDragonite(int dex) {
        super(dex, "Dragonite",
                ...
                List.of("In certain fables, these Pokemon were considered to be some of the emissaries of the heavens because they were blessed with godly speed."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WRAP,1),
                        new MoveLearnSetEntry(Move.FABLEDRUSH,34),
                        new MoveLearnSetEntry(Move.LEER,4),
                        new MoveLearnSetEntry(Move.DRAGON_ENERGY,63),
                        new MoveLearnSetEntry(Move.REVITALIZE,39),
                        new MoveLearnSetEntry(Move.DRACOSURGE,48),
                        new MoveLearnSetEntry(Move.RENEWAL,19),
                        new MoveLearnSetEntry(Move.EXTREME_SPEED,58),
                        new MoveLearnSetEntry(Move.VALKYRIECHARIOT,53),
                        new MoveLearnSetEntry(Move.TWISTER,9),
                        new MoveLearnSetEntry(Move.PURIFY,29),
                        new MoveLearnSetEntry(Move.SKYBLESSING,44),
                        new MoveLearnSetEntry(Move.ENDERSHOCK,24),
                        new MoveLearnSetEntry(Move.HOLYBOLT,1),
                        new MoveLearnSetEntry(Move.ZEAL,14),
