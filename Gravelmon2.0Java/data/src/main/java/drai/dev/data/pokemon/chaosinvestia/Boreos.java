...
import java.util.*;
public class Boreos extends drai.dev.gravelmon.pokemon.Pokemon {
    public Boreos() {
        super("Boreos",
                Type.FLYING,
                new Stats(79,
                ...
                70,
                50, List.of(),
                List.of("Mit der Energie aus seiner Rute erzeugt es wilde Stürme, die stark genug sind, um ganze Wohnhäuser davonzuwehen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RAIN_DANCE,61),
