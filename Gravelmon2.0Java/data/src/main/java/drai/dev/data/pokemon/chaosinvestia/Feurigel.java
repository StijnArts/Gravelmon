...
import java.util.*;
public class Feurigel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Feurigel() {
        super("Feurigel",
                Type.FIRE,
                new Stats(39,
                ...
                70,
                50, List.of(),
                List.of("Erschrickt sich dieses scheue Pokémon, lodern die Flammen auf seinem Rücken kräftiger."),
                List.of(),
                List.of(
