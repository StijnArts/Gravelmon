...
import java.util.*;
public class Pantimimi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pantimimi() {
        super("Pantimimi",
                ...
                70,
                50, List.of(),
                List.of("Ahmt die Bewegungen und Gesichtsausdrücke anderer nach, um ihre Gefühle besser zu verstehen."),
                List.of(),
                List.of(
