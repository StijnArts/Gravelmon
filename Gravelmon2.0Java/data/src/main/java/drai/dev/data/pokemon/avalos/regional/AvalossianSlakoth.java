...
import java.util.*;
public class AvalossianSlakoth extends drai.dev.data.pokemon.Pokemon {
    public AvalossianSlakoth(String name, Aspect aspect) {
        super(name, aspect, "Slakoth",
                ...
                List.of(""),
                List.of(new EvolutionEntry("Avalossianvigoroth", EvolutionType.LEVEL_UP, List.of(),
