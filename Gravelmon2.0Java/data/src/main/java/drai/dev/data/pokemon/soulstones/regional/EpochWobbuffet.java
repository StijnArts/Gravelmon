...
import java.util.*;
public class EpochWobbuffet extends drai.dev.data.pokemon.Pokemon {
    public EpochWobbuffet(String name, Aspect aspect) {
        super(name, aspect, "EpochWobbuffet",
                ...
                List.of("Deep within its fluffy exterior, it has been brewing a grudge that threatens to burst forth from its seams."),
                List.of(),
                List.of(
