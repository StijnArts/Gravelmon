...
import java.util.*;
public class MikitarinianFalinks extends drai.dev.data.pokemon.Pokemon {
    public MikitarinianFalinks(String name, Aspect aspect) {
        super(name, aspect, "MikitarinianFalinks",
