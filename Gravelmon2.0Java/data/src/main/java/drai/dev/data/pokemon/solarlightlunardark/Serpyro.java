...
import java.util.*;
public class Serpyro extends drai.dev.data.pokemon.Pokemon {
    public Serpyro() {
        super("Serpyro",
                ...
                List.of("Serpyro prefer living in the hottest parts of the volcanoes, especially where its dark and an abundance of active vents. As such, sightings of Serpyro are incredibly rare."),
                List.of(new EvolutionEntry("slitheat", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"35")))),
                List.of(
                        new MoveLearnSetEntry(Move.SMOKESCREEN,1),
                        new MoveLearnSetEntry(Move.BURNING_JEALOUSY,30),
                        new MoveLearnSetEntry(Move.GLARE,26),
                        new MoveLearnSetEntry(Move.RAGING_FURY,54),
