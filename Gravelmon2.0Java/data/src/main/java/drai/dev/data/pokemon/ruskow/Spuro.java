...
import java.util.*;
public class Spuro extends drai.dev.data.pokemon.Pokemon {
    public Spuro() {
        super("Spuro",
                Type.ELECTRIC,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("spurtail", EvolutionType.ITEM_INTERACT, false, List.of(),
