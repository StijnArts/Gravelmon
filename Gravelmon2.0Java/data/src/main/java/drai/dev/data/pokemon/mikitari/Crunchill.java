...
import java.util.*;
public class Crunchill extends drai.dev.data.pokemon.Pokemon {
    public Crunchill() {
        super("Crunchill",
                Type.ICE,
                new Stats(100,
                ...
                List.of("Its jaws can freeze anything it bites. Crunchill then brutally shatters the frozen object."),
                List.of(),
                List.of(
