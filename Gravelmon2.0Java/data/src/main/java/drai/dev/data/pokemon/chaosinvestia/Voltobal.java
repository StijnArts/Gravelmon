...
import java.util.*;
public class Voltobal extends drai.dev.gravelmon.pokemon.Pokemon {
    public Voltobal() {
        super("Voltobal",
                Type.ELECTRIC,
                new Stats(40,
                ...
                70,
                50, List.of(),
                List.of("Sieht aus wie ein Pokéball. Es ist gefährlich, da es bei Berührung explodieren kann."),
                List.of(),
                List.of(
