...
import java.util.*;
public class SoulstonesanAraquanid extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanAraquanid(int dex) {
        super(dex, "Araquanid",
                ...
                List.of("It moves around with noisy clacking sounds because its legs do not allow it to retain much gracefulness or be able to sneak up on people."),
                List.of(),
                List.of(
