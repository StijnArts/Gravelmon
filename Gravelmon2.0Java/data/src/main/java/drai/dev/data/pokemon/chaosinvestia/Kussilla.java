...
import java.util.*;
public class Kussilla extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kussilla() {
        super("Kussilla",
                ...
                new Stats(45,
                        ...
                        85,
                        65),
                List.of(Ability.OBLIVIOUS,Ability.FOREWARN), null,
                4, 60,
                ...
                70,
                50, List.of(),
                List.of("Dieses Pokémon berührt alles mit den Lippen. Diese merken sich, was es mag und nicht mag."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.POUND,1),
                        new MoveLearnSetEntry(Move.COPYCAT,41),
