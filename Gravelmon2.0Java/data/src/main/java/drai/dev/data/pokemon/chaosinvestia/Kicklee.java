...
import java.util.*;
public class Kicklee extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kicklee() {
        super("Kicklee",
                Type.FIGHTING,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Seine Beine können die doppelte Länge annehmen. Gegner, die das nicht wissen, erschrecken."),
                List.of(),
                List.of(
