...
import java.util.*;
public class Elevoltek extends drai.dev.gravelmon.pokemon.Pokemon {
    public Elevoltek() {
        super("Elevoltek",
                Type.ELECTRIC,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Berührt seinen Gegner mit seinen beiden Schweifspitzen und entlädt dann starke Elektrizität."),
                List.of(),
                List.of(
