...
import java.util.*;
public class SoulstonesanKommoo extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanKommoo(int dex) {
        super(dex, "Kommoo",
                ...
                16, 782,
                new Stats(120,3,115,75,80,110), 90,
                0.5,
