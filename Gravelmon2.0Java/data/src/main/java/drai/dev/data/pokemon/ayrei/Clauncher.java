...
import java.util.*;
public class Clauncher extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clauncher() {
        super("Clauncher",
                Type.WATER,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("By detonating gas that accumulates in its right claw, this Pokémon launches water like a bullet. This is how Clauncher defeats its enemies."),
                List.of(),
                List.of(
