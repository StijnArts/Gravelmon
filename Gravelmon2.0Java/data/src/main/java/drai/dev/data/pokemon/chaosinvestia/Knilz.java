...
import java.util.*;
public class Knilz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Knilz() {
        super("Knilz",
                Type.GRASS,
                new Stats(60,
                        ...
                        40,
                        60),
                List.of(Ability.EFFECT_SPORE,Ability.POISON_HEAL), null,
                4, 45,
                ...
                70,
                50, List.of(),
                List.of("Es setzt an seinem Kopf Giftsporen frei. Werden diese eingeatmet, verursachen sie Schmerzen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.LEECH_SEED,13),
                        new MoveLearnSetEntry(Move.POISON_POWDER,25),
