...
import java.util.*;
public class SoulstonesanSalazzle extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSalazzle(int dex) {
        super(dex, "Salazzle",
                ...
                List.of("It is able to leap and surprise attack a foe, and electrocute its prey using those sacs on its skin."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FISHIOUS_REND,51),
