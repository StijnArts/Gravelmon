...
import java.util.*;
public class EpochPansear extends drai.dev.data.pokemon.Pokemon {
    public EpochPansear(String name, Aspect aspect) {
        super(name, aspect, "EpochPansear",
                Type.FLYING,
                new Stats(50,
                        45,
                        48,
                ...
                List.of("These fluffy little monkeys are excellent climbers, and like to hang around mountains, hoping to hitch a ride on clouds."),
                List.of(new EvolutionEntry("epochsimisear", EvolutionType.ITEM_INTERACT, false, List.of(), 
