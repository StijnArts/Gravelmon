...
import java.util.*;
public class EpochGolettOne extends drai.dev.data.pokemon.Pokemon {
    public EpochGolettOne(String name, Aspect aspect) {
        super(name, aspect, "EpochGolettOne",
                ...
                List.of("The embers within its central core are constantly burning. Therefore, it doesn't require any time to warm itself up."),
                List.of(new EvolutionEntry("epochtwogolurk", EvolutionType.LEVEL_UP, List.of(), 
