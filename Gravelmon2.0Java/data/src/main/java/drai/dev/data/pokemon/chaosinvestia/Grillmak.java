...
import java.util.*;
public class Grillmak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Grillmak() {
        super("Grillmak",
                Type.FIRE,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Das Feuer in seinem Kopfbüschel erreicht Temperaturen von bis zu 300 Grad. Es ist in Vulkanhöhlen zu Hause."),
                List.of(),
                List.of(
