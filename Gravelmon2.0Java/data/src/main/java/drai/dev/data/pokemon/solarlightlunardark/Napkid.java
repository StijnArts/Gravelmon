...
import java.util.*;
public class Napkid extends drai.dev.data.pokemon.Pokemon {
    public Napkid() {
        super("Napkid",
                Type.GHOST,
                new Stats(30,
                ...
                List.of("Napkid's body is incredibly soft and silky. They favor hiding among blankets and scare people who did not notice their presence."),
                List.of(new EvolutionEntry("phansheet", EvolutionType.ITEM_INTERACT, false, List.of(), 
