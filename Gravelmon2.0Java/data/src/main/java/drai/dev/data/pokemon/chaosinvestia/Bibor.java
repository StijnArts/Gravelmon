...
import java.util.*;
public class Bibor extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bibor() {
        super("Bibor",
                ...
                70,
                50, List.of(),
                List.of("Sein bester Angriff: Schnell auf den Gegner zufliegen, mit Giftstacheln zustechen und davonfliegen."),
                List.of(),
                List.of(
