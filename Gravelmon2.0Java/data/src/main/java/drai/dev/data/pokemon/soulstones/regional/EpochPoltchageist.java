...
import java.util.*;
public class EpochPoltchageist extends drai.dev.data.pokemon.Pokemon {
    public EpochPoltchageist(String name, Aspect aspect) {
        super(name, aspect, "EpochPoltchageist",
                ...
                List.of("It is seen as a bit of a nuisance to local authorities because it uses its brush to vandalize public property."),
                List.of(new EvolutionEntry("epochsinistcha", EvolutionType.ITEM_INTERACT, false, List.of(), 
