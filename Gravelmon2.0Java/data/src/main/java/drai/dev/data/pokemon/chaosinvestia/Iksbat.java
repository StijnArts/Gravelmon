...
import java.util.*;
public class Iksbat extends drai.dev.gravelmon.pokemon.Pokemon {
    public Iksbat() {
        super("Iksbat",
                ...
                70,
                50, List.of(),
                List.of("Die Umwandlung seiner Beine in Schwingen wirkte sich positiv aufs Fliegen aus. Das Laufen litt eher."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.POISON_FANG,42)                        ),
