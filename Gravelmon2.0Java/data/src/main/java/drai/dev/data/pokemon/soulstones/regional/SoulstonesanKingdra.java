...
import java.util.*;
public class SoulstonesanKingdra extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanKingdra(int dex) {
        super(dex, "Kingdra",
                ...
                18, 1520,
                new Stats(100,55,90,2,95,110), 90,
                0.5,
                243, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.WATER_1,EggGroup.DRAGON),
                List.of("The light emitted by their tail fins change based on the temperature of the water in which they are swimming."),
                List.of(),
                List.of(
