...
import java.util.*;
public class Seemon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Seemon() {
        super("Seemon",
                Type.WATER,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Seine Stacheln schützen es. Seine Flossen und Knochen werden bei der Herstellung von Medizin verwendet."),
                List.of(),
                List.of(
