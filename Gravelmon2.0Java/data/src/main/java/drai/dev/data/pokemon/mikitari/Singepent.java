...
import java.util.*;
public class Singepent extends drai.dev.data.pokemon.Pokemon {
    public Singepent() {
        super("Searpent",
                ...
                List.of(new EvolutionEntry("conflevour", EvolutionType.LEVEL_UP, List.of(),
