...
import java.util.*;
public class IshirianArcanine extends drai.dev.data.pokemon.Pokemon {
    public IshirianArcanine(String name, Aspect aspect) {
        super(name, aspect, "IshirianArcanine",
