...
import java.util.*;
public class SoulstonesanIncineroar extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanIncineroar(int dex) {
        super(dex, "Incineroar",
                ...
                18, 830,
                new Stats(95,3,80,100,75,65), 90,
                0.875,
                239, ExperienceGroup.PARABOLIC,
                70,
