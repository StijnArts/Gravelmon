...
import java.util.*;
public class Savagewe extends drai.dev.data.pokemon.Pokemon {
    public Savagewe() {
        super("Savagewe",
                Type.DARK,
                new Stats(80,
                ...
                List.of("Savagewe's matted fur causes it to pick up anything it brushes against: leaves, brambles, barbed wire, or even small Pokémon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEAD_CHARGE,68),
