...
import java.util.*;
public class Hubelupf extends drai.dev.gravelmon.pokemon.Pokemon {
    public Hubelupf() {
        super("Hubelupf",
                ...
                70,
                50, List.of(),
                List.of("Sobald es wärmer wird, blüht es auf. Es schwebt am Himmel und nimmt so viel Sonnenlicht auf wie möglich."),
                List.of(),
                List.of(
