...
public class Furibal extends drai.dev.data.pokemon.Pokemon {
    public Furibal() {
        super("Furibal",
                Type.ICE,
                new Stats(40,
                ...
                List.of(new EvolutionEntry("cottontile", EvolutionType.LEVEL_UP, List.of(),
                        List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"34")))),
                List.of(      new MoveLearnSetEntry(Move.COTTON_GUARD,1),
