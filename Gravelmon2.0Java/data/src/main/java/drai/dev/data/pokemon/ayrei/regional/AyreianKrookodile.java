...
import java.util.*;
public class AyreianKrookodile extends drai.dev.data.pokemon.Pokemon {
    public AyreianKrookodile(String name, Aspect aspect) {
        super(name, aspect, "Krookodile",
                ...
                List.of("This Pok̩mon is known as the Bully of the Tundra. Krookodile's mighty jaws can bite through permafrost with ease."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHATTERBLADE,50),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 39, 57, .1, List.of(
