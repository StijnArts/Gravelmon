...
import java.util.*;
public class Murasalem extends drai.dev.data.pokemon.Pokemon {
    public Murasalem() {
        super("Murasalem",
                ...
                new Stats(90,
                        ...
                        80,
                        54),
                List.of(Ability.MERCILESS), Ability.SHEER_FORCE,
                10, 175,
                ...
                List.of("Murasalem is very aggressive by nature. During combat, it attacks madly until it tires out."),
                List.of(),
                List.of(
