...
import java.util.*;
public class Feranther extends drai.dev.data.pokemon.Pokemon {
    public Feranther() {
        super("Feranther",
                Type.DARK, Type.FIRE,
                new Stats(75,
                ...
                List.of("Poachers are attracted to their black hide because of its malignant qualities. They are masters of stealth, hunting alone and bringing even the most powerful opponent to the ground."),
                List.of(),
                List.of(
