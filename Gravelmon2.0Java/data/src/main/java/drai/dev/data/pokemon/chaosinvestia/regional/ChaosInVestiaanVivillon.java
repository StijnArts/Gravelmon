package drai.dev.gravelmon.pokemon.chaosinvestia.regional;
...
import java.util.*;
public class ChaosInVestiaanVivillon extends drai.dev.gravelmon.pokemon.Pokemon {
    public ChaosInVestiaanVivillon(int dex) {
        super(dex, "Vivillon",
                Type.BUG,Type.FAIRY,
                new Stats(88,
                        60,
