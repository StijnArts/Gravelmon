...
import java.util.*;
public class AyreianVivillonTen extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonTen(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonTen",
                Type.ROCK,Type.BUG,
                new Stats(80,
                        52,
                        65,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WIDE_GUARD,12),
