...
import java.util.*;
public class Perlu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Perlu() {
        super("Perlu",
                Type.WATER,
                new Stats(35,
                ...
                70,
                50, List.of(),
                List.of("In seinem Leben erschafft es eine einzige Perle. Diese soll Psycho-Kräfte verstärken."),
                List.of(),
                List.of(
