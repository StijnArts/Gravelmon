...
public class Chesnaught extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chesnaught() {
        super("Chesnaught",
                ...
                70,
                50, List.of(),
                List.of("When it takes a defensive posture with its fists guarding its face, it could withstand a bomb blast."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GIGA_IMPACT,78),
