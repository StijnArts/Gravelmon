...
import java.util.*;
public class Sumpex extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sumpex() {
        super("Sumpex",
                ...
                70,
                50, List.of(),
                List.of("Es kann im Schwimmen ein großes Schiff ziehen. Seine Gegner schlägt es mit Schlägen seiner Arme zurück."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ENDEAVOR,61),
                        new MoveLearnSetEntry(Move.WATER_GUN,10),
                        new MoveLearnSetEntry(Move.PROTECT,46),
                        new MoveLearnSetEntry(Move.MUDSLAP,6),
                        new MoveLearnSetEntry(Move.HAMMER_ARM,69),
