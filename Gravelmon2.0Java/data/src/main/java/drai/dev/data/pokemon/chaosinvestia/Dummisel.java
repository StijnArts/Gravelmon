...
import java.util.*;
public class Dummisel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dummisel() {
        super("Dummisel",
                Type.NORMAL,
                new Stats(100,
                ...
                70,
                50, List.of(),
                List.of("Es gräbt sich mit seinem Schweif in die Erde und baut ein labyrinthartiges Nest. Es kann kaum fliegen."),
                List.of(),
                List.of(
