...
import java.util.*;
public class Voltula extends drai.dev.gravelmon.pokemon.Pokemon {
    public Voltula() {
        super("Voltula",
                ...
                70,
                50, List.of(),
                List.of("Lässt seine Beute in elektrisch geladene Fäden tappen. Solang diese durch den Schock gelähmt ist, labt es sich an ihr."),
                List.of(),
                List.of(
