...
import java.util.*;
public class AyreianVivillonThree extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonThree(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonThree",
                Type.GRASS,Type.BUG,
                new Stats(80,
                        52,
                        65,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.STRENGTH_SAP,12),
