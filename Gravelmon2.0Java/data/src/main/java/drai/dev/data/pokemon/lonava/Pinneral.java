...
import java.util.*;
public class Pinneral extends drai.dev.data.pokemon.Pokemon {
    public Pinneral() {
        super("Pinneral",
                Type.STEEL,
                new Stats(60,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.IRON_DEFENSE,7),
                        ...
                        new MoveLearnSetEntry(Move.LIQUIDMETAL,28),
