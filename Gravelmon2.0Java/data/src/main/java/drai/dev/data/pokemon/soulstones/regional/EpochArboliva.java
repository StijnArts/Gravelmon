...
import java.util.*;
public class EpochArboliva extends drai.dev.data.pokemon.Pokemon {
    public EpochArboliva(String name, Aspect aspect) {
        super(name, aspect, "EpochArboliva",
                ...
                List.of("When cornered, it has the ability to spray a toxic fluid or use its psychic powers to disable a predator."),
                List.of(),
                List.of(
