...
import java.util.*;
public class IshirianGardevoir extends drai.dev.data.pokemon.Pokemon {
    public IshirianGardevoir(String name, Aspect aspect) {
        super(name, aspect, "IshirianGardevoir",
                ...
                new Stats(73,
                        ...
                        125,
                        70),
                List.of(Ability.INFILTRATOR,Ability.PIXILATE), Ability.TELEPATHY,
                16, 484,
                ...
                List.of("Gardevoir has the psychokinetic power to distort the dimensions and create a small black hole. This Pokémon will try to protect its Trainer even at the risk of its own life."),
                List.of(),
                List.of(
