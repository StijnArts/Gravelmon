...
import java.util.*;
public class Charmian extends drai.dev.gravelmon.pokemon.Pokemon {
    public Charmian() {
        super("Charmian",
                Type.NORMAL,
                new Stats(49,
                        ...
                        42,
                        37),
                List.of(Ability.LIMBER,Ability.OWN_TEMPO), null,
                5, 39,
                ...
                70,
                50, List.of(),
                List.of("Es verbirgt, dass es bei schlechter Fütterung gern seine Krallen in die Nase des Trainers gräbt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HONE_CLAWS,48),
