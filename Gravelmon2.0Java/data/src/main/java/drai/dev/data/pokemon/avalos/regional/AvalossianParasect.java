...
import java.util.*;
public class AvalossianParasect extends drai.dev.data.pokemon.Pokemon {
    public AvalossianParasect(String name, Aspect aspect) {
        super(name, aspect, "Parasect",
                ...
                70,
                50, List.of(),
                List.of("Avalossian Parasects emit a cloud of infectious spores on a constant basis. Thankfully, professors have studied how to counteract the diseases brought on by the spores, allowing Parasect to be kept as companions easier."),
                List.of(),
                List.of(
