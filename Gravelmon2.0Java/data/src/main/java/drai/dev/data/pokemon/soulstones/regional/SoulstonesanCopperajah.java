...
import java.util.*;
public class SoulstonesanCopperajah extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanCopperajah(int dex) {
        super(dex, "Copperajah",
                ...
                List.of("In marital ceremonies among island tribes, this Pokemon often carries the bride and groom up and down the aisle."),
                List.of(),
                List.of(
