...
import java.util.*;
public class EpochAegislash extends drai.dev.data.pokemon.Pokemon {
    public EpochAegislash(String name, Aspect aspect) {
        super(name, aspect, "EpochAegislash",
                ...
                17, 530,
                new Stats(79,65,80,2,81,95), 222,
                0.5,
                234, ExperienceGroup.MEDIUM_FAST,
                70,
                50, List.of(EggGroup.MINERAL),
                List.of("Only the most skilled weapon masters will ever see an Aegislash in its true form as it is dependent on their proficiency in the use of the specific weapon."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.QUICKSPELL,1),
                        new MoveLearnSetEntry(Move.REFLECT,40),
                        new MoveLearnSetEntry(Move.ARCANEENERGY,48),
                        new MoveLearnSetEntry(Move.NYMPHSSPELL,12),
                        new MoveLearnSetEntry(Move.LIGHT_SCREEN,40),
                        new MoveLearnSetEntry(Move.AURA_SPHERE,28),
                        ...
                        new MoveLearnSetEntry(Move.RAINBOWBEAM,8),
                        new MoveLearnSetEntry(Move.MYSTICPULSE,1),
                        new MoveLearnSetEntry(Move.KARMASPELL,20),
