...
import java.util.*;
public class SoulstonesanTrevenant extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTrevenant(int dex) {
        super(dex, "Trevenant",
