...
import java.util.*;
public class Tohaido extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tohaido() {
        super("Tohaido",
                ...
                70,
                50, List.of(),
                List.of("Seine Zähne durchdringen sogar Eisen. Es schwimmt mit 120 km/h und wird „Tyrann des Meeres“ genannt."),
                List.of(),
                List.of(
