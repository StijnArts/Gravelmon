...
import java.util.*;
public class EpochLickitung extends drai.dev.data.pokemon.Pokemon {
    public EpochLickitung(String name, Aspect aspect) {
        super(name, aspect, "EpochLickitung",
                Type.GHOST,
                new Stats(90,
                        75,
                        55,
                ...
                List.of("It is an old legend that this creature took shelter in a haunted area and a spirit possessed it for its own use."),
                List.of(new EvolutionEntry("epochlickilicky", EvolutionType.LEVEL_UP, List.of(), 
