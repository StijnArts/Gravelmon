...
public class DeltaGrimer extends Pokemon {
    public DeltaGrimer(String name, Aspect aspect) {
        super(name, aspect,"DeltaGrimer",
                ...
                List.of("A Delta Species discovered by EchoTheThird. With sand absorbed into its circulation, it can vanish into surrounding sand to escape from predators."),
                List.of(new EvolutionEntry("deltamuk", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 12, 35, 2.0, List.of(
