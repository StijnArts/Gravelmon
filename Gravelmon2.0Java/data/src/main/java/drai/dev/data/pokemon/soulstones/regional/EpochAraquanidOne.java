...
import java.util.*;
public class EpochAraquanidOne extends drai.dev.data.pokemon.Pokemon {
    public EpochAraquanidOne(String name, Aspect aspect) {
        super(name, aspect, "EpochAraquanidOne",
                ...
                List.of("When it chitters, it is able to further intimidate and scare its foe because it is able to project its voice so it makes it seem like there are more nearby."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MEMORYBLOCK,1),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 22, 43, .3, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_END))
                ), List.of(),
                List.of(SpawnPreset.NATURAL),
                0.28, 0.3,
                List.of());
           setLangFileName("Araquanid");
