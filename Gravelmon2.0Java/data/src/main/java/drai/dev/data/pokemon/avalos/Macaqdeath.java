...
import java.util.*;
public class Macaqdeath extends drai.dev.data.pokemon.Pokemon {
    public Macaqdeath() {
        super("Macaqdeath",
                ...
                List.of("Upon receiving a skull helmet of another Aipom, Avalossian Aipom grow incredibly introspective and morose, evolving into Macaqdeath. Their creativity with music is translated into morbid theatrics with haunting soliloquies."),
                List.of(),
                List.of(
