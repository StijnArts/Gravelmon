...
import java.util.*;
public class TMamoswine extends drai.dev.gravelmon.pokemon.Pokemon {
    public TMamoswine() {
        super("TMamoswine",
                ...
                List.of("This Pokemon will often bash its head against larger trees in an effort to knock down the fruits that grow on them."),
                List.of(),
                List.of(
