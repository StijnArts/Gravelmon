...
import java.util.*;
public class Geowaz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Geowaz() {
        super("Geowaz",
                ...
                70,
                50, List.of(),
                List.of("Selbst Sprengstoff kann seinem harten Körper nichts anhaben. Häutet sich nur einmal jährlich."),
                List.of(),
                List.of(
