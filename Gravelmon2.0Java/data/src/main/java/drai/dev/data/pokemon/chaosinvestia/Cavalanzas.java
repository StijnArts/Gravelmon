...
import java.util.*;
public class Cavalanzas extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cavalanzas() {
        super("Cavalanzas",
                Type.BUG,Type.STEEL,
                new Stats(70,
                        ...
                        60,
                        105),
                List.of(Ability.SWARM,Ability.SHELL_ARMOR), null,
                10, 330,
                ...
                70,
                50, List.of(),
                List.of("Es ist bei der Entwicklung in die Muschel eines Schnuthelm geschlüpft. Die Eisenrüstung schützt seinen ganzen Körper."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.QUICK_GUARD,8),
