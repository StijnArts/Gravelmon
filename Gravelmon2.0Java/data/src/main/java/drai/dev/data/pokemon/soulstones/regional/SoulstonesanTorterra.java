...
import java.util.*;
public class SoulstonesanTorterra extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTorterra(int dex) {
        super(dex, "Torterra",
                ...
                0.875,
                236, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.MONSTER),
                List.of("It is recommended to keep a short distance away as the volcanic formation on its back periodically releases short bouts of lava and smoke."),
                List.of(),
                List.of(
