...
import java.util.*;
public class SoulstonesanElectivire extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanElectivire(int dex) {
        super(dex, "Electivire",
                ...
                List.of("It will fight any foe as every fight, regardless of the outcome, is a learning moment that it uses to get stronger."),
                List.of(),
                List.of(
