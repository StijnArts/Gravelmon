...
public class Aveden extends Pokemon {
    public Aveden() {
        super("Aveden",
                Type.NORMAL, Type.FLYING,
                new Stats(62,50,42,77,62,65),
                ...
                List.of("The blue feathers on its chest reflect light. They use flashes to communicate with one another in the forest canopy."),
                List.of(new EvolutionEntry("splendifowl", EvolutionType.LEVEL_UP, List.of(),
