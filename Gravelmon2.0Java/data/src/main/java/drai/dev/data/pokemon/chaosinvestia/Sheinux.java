...
import java.util.*;
public class Sheinux extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sheinux() {
        super("Sheinux",
                Type.ELECTRIC,
                new Stats(45,
                        ...
                        40,
                        34),
                List.of(Ability.RIVALRY,Ability.INTIMIDATE), null,
                5, 95,
                ...
                70,
                50, List.of(),
                List.of("Es erzeugt Elektrizität durch das Strecken und Zusammenziehen seiner Muskeln. Bei Bedrohung glüht es."),
                List.of(),
                List.of(
