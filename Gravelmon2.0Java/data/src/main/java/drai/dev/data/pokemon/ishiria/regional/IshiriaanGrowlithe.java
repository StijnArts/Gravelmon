...
import java.util.*;
public class IshiriaanGrowlithe extends drai.dev.data.pokemon.Pokemon {
    public IshiriaanGrowlithe(String name, Aspect aspect) {
        super(name, aspect, "IshiriaanGrowlithe",
