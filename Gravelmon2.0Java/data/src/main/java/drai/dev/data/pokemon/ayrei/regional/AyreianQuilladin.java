...
import java.util.*;
public class AyreianQuilladin extends drai.dev.data.pokemon.Pokemon {
    public AyreianQuilladin(String name, Aspect aspect) {
        super(name, aspect, "AyreianQuilladin",
                ...
                List.of("They strengthen their lower bodies by running into one another. They are very kind and won't start fights."),
                List.of(),
                List.of(
