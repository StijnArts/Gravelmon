...
import java.util.*;
public class Clawitzer extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clawitzer() {
        super("Clawitzer",
                Type.WATER,
                new Stats(71,
                ...
                70,
                50, List.of(),
                List.of("Clawitzer's right arm is a cannon that launches projectiles made of seawater. Shots from a Clawitzer's cannon arm can sink a tanker."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MUDDY_WATER,56),
                        ...
                        new MoveLearnSetEntry(Move.CRABHAMMER,63),
