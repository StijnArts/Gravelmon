...
import java.util.*;
public class Lavados extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lavados() {
        super("Lavados",
                ...
                70,
                50, List.of(),
                List.of("Eines der Legendären Vogel-Pokémon. Es wird als Bote des Frühlings angesehen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SOLAR_BEAM,71),
                        new MoveLearnSetEntry(Move.SUNNY_DAY,85),
                        ...
                        new MoveLearnSetEntry(Move.SKY_ATTACK,78),
                        ...
                        new MoveLearnSetEntry(Move.HEAT_WAVE,64)                        ),
