...
import java.util.*;
public class Cetitan extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cetitan() {
        super("Cetitan",
                Type.ICE,
                new Stats(170,
                        ...
                        45,
                        55),
                List.of(Ability.THICK_FAT,Ability.SLUSH_RUSH), Ability.SHEER_FORCE,
                45, 7000,
                new Stats(2,113,65,73,45,55), 50,
                0.5,
                182, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("This Pokémon wanders around snowy, icy areas. It protects its body with powerful muscles and a thick layer of fat under its skin."),
                List.of(),
                List.of(
