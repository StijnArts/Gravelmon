...
import java.util.*;
public class Zwirrklop extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zwirrklop() {
        super("Zwirrklop",
                Type.GHOST,
                new Stats(40,
                ...
                70,
                50, List.of(),
                List.of("Sucht dahintreibende Irrlichter und saugt sie in seinen leeren Körper. Alles andere ist ein Rätsel."),
                List.of(),
                List.of(
