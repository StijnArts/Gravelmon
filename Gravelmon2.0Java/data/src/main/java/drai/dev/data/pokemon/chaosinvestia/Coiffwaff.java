...
import java.util.*;
public class Coiffwaff extends drai.dev.gravelmon.pokemon.Pokemon {
    public Coiffwaff() {
        super("Coiffwaff",
                Type.NORMAL,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Schneidet man sein Fell zurecht, wird es nicht nur schöner, sondern auch beweglicher."),
                List.of(),
                List.of(
