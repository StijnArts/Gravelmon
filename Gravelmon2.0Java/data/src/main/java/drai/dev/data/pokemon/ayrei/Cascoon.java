...
import java.util.*;
public class Cascoon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cascoon() {
        super("Cascoon",
                Type.BUG,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("It never forgets any attack it endured while in the cocoon. After evolution, it seeks payback."),
                List.of(),
                List.of(
