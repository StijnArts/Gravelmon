...
public class DeltaWooper extends Pokemon {
    public DeltaWooper(String name, Aspect aspect) {
        super(name, aspect,"DeltaWooper",
                Type.GRASS, Type.FIRE,
                new Stats(55, 45,45,25,25,15),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TRICKORTREAT,29),
                        new MoveLearnSetEntry(Move.MYSTICAL_FIRE,33),
                        new MoveLearnSetEntry(Move.MIMIC,37),
                        new MoveLearnSetEntry(Move.HEAT_CRASH,43),
