...
import java.util.*;
public class Duflor extends drai.dev.gravelmon.pokemon.Pokemon {
    public Duflor() {
        super("Duflor",
                ...
                70,
                50, List.of(),
                List.of("Der Honig, den es abgibt, riecht so entsetzlich, dass sich sogar Nasen in 2 km Entfernung rümpfen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.NATURAL_GIFT,35)                        ),
