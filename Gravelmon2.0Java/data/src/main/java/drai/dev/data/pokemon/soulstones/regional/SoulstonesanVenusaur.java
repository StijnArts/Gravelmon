...
import java.util.*;
public class SoulstonesanVenusaur extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanVenusaur(int dex) {
        super(dex, "Venusaur",
                Type.ICE,Type.FAIRY,
                new Stats(80,
                        82,
                ...
                List.of("It is able to make the various crystals on its back turn into different colours as a way of attracting mates."),
                List.of(),
                List.of(
