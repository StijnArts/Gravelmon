...
import java.util.*;
public class AyreianGrovyle extends drai.dev.data.pokemon.Pokemon {
    public AyreianGrovyle(String name, Aspect aspect) {
        super(name, aspect, "Grovyle",
                ...
                List.of("The sheer power gained from evolution changed this Pokemon's metabolism, as it now behaves like an ambush predator."),
                List.of(new EvolutionEntry("sceptile ayreian", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGON_BREATH,0),
