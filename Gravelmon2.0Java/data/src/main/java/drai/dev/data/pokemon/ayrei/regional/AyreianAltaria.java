...
import java.util.*;
public class AyreianAltaria extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianAltaria(int dex) {
        super(dex, "Altaria",
                ...
                new Stats(75,
                        ...
                        100,
                        105),
                List.of(Ability.LEVITATE,Ability.FLUFFY), null,
                11, 206,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RISING_VOLTAGE,0),
