...
import java.util.*;
public class ChaosInVestiaanFennekin extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanFennekin(String name, Aspect aspect) {
        super(name, aspect, "Fennekin",
