...
import java.util.*;
public class EpochGastrodonTen extends drai.dev.data.pokemon.Pokemon {
    public EpochGastrodonTen(String name, Aspect aspect) {
        super(name, aspect, "EpochGastrodonTen",
