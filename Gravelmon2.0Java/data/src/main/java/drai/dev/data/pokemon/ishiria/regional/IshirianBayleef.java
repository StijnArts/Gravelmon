...
import java.util.*;
public class IshirianBayleef extends drai.dev.data.pokemon.Pokemon {
    public IshirianBayleef(String name, Aspect aspect) {
        super(name, aspect, "IshirianBayleef",
                Type.STEEL,
                new Stats(76,
                        83,
                        80,
                ...
                List.of(new EvolutionEntry("IshirianMeganium", EvolutionType.LEVEL_UP, List.of(),
