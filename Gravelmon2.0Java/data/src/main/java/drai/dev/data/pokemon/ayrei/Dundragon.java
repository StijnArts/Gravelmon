...
public class Dundragon extends Pokemon {
    public Dundragon() {
        super("Dundragon",
                Type.NORMAL, Type.DRAGON,
                new Stats(140,95,75,55,90,80),
                List.of(Ability.SERENE_GRACE, Ability.RUN_AWAY), Ability.MULTISCALE,
                22, 2340,
                new Stats(3,0,0,0,0,0), 45,
                0.5,
                244, ExperienceGroup.MEDIUM_SLOW,
                70,
