...
import java.util.*;
public class Rocara extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rocara() {
        super("Rocara",
                ...
                new Stats(50,
                        ...
                        50,
                        150),
                List.of(Ability.CLEAR_BODY,Ability.STURDY), null,
                3, 57,
                ...
                70,
                50, List.of(),
                List.of("Dieses Pokémon entstand aus Druck und Hitze in den tiefsten Erdschichten. Mithilfe des Steines in seinem Kopf feuert es Energiestrahlen ab"),
                List.of(),
                List.of(
