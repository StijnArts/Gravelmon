...
public class Puglup extends drai.dev.data.pokemon.Pokemon {
    public Puglup() {
        super("Puglup",
                Type.NORMAL,
                new Stats(65,
                ...
                List.of(new EvolutionEntry("brusbime", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.QAMOR),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 3, 22, 5.6, List.of(
