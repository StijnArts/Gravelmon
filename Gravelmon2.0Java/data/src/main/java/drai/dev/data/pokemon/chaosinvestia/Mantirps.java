...
import java.util.*;
public class Mantirps extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mantirps() {
        super("Mantirps",
                ...
                70,
                50, List.of(),
                List.of("Man organisiert Touren, um diesem Pokémon zuzusehen, wie es mit Remoraid über die Wellen gleitet."),
                List.of(),
                List.of(
