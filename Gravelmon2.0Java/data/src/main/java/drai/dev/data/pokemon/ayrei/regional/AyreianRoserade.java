...
import java.util.*;
public class AyreianRoserade extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianRoserade(int dex) {
        super(dex, "Roserade",
                ...
                new Stats(60,
                        ...
                        60,
                        105),
                List.of(Ability.STEELY_SPIRIT,Ability.POISON_TOUCH), null,
                12, 1445,
                new Stats(0,0,0,2,0,1), 75,
                0.5,
                0, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(),
                List.of("The serrated fangs on both arms are filled to the brim with quick acting poison. It catches prey with agile movements and injects lethal toxins."),
                List.of(),
                List.of(
