...
import java.util.*;
public class SoulstonesanMandibuzz extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMandibuzz(int dex) {
        super(dex, "Mandibuzz",
                ...
                List.of("They circle around dying Pokemon in rough terrain. When the Pokemon finally dies, the Mandibuzz are first to help themselves to the remains."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BONE_CLUB,34),
                        new MoveLearnSetEntry(Move.SWEEPINGTALON,39),
                        new MoveLearnSetEntry(Move.GLIDE,14),
                        new MoveLearnSetEntry(Move.BONEMERANG,56),
                        new MoveLearnSetEntry(Move.CHEAP_SHOT,1),
                        new MoveLearnSetEntry(Move.FEATHER_DANCE,23),
                        new MoveLearnSetEntry(Move.PECK,1),
                        new MoveLearnSetEntry(Move.TAILWIND,11),
                        new MoveLearnSetEntry(Move.BONE_RUSH,19),
