...
import java.util.*;
public class Phoxy extends drai.dev.data.pokemon.Pokemon {
    public Phoxy() {
        super("Phoxy",
                Type.FAIRY,
                new Stats(45,
                ...
                List.of("Phoxy are remarkably skittish, fleeing from even other docile Pokémon. If pursued, they use their petite size to escape through the forest."),
                List.of(new EvolutionEntry("phoxiven", EvolutionType.ITEM_INTERACT, false, List.of(), 
