...
public class Scruffur extends drai.dev.data.pokemon.Pokemon {
    public Scruffur() {
        super("Scruffur",
                Type.GROUND,
                new Stats(74,
                ...
                11, 165,
                new Stats(0,0,0,0,0,2), 170,
                0.5,
                151, ExperienceGroup.MEDIUM_SLOW,
                70,
                50, List.of(EggGroup.FIELD),
                List.of(""),
                List.of(new EvolutionEntry("olynx", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.NOSTO),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 19, 34, 1, List.of(
