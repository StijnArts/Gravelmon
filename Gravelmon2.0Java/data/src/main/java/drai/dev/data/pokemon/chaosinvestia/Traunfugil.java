...
import java.util.*;
public class Traunfugil extends drai.dev.gravelmon.pokemon.Pokemon {
    public Traunfugil() {
        super("Traunfugil",
                Type.GHOST,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Ein Pokémon, das Menschen mitten in der Nacht erschreckt. Es sammelt die Angst als seine Energie."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEX,23),
