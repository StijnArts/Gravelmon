...
import java.util.*;
public class LinFu extends drai.dev.gravelmon.pokemon.Pokemon {
    public LinFu() {
        super("LinFu",
                Type.FIGHTING,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Ein Meister der Attacken in Serie. Wenn es sich geistig sammelt, werden die Attacken geschmeidiger und flotter."),
                List.of(),
                List.of(
