...
public class Nawdile extends drai.dev.data.pokemon.Pokemon {
    public Nawdile() {
        super("Nawdile",
                Type.GRASS,
                new Stats(47,
                ...
                List.of("Nawdile are very sly and sneaky. On sunny days Nawdile like to lay in the sun for hours, absorbing the sun's energy. But be careful not to disturb them or they will come biting at you."),
                List.of(new EvolutionEntry("aliblador", EvolutionType.LEVEL_UP, List.of(),
