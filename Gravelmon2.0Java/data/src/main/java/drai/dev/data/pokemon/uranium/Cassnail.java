...
public class Cassnail extends Pokemon {
    public Cassnail() {
        super("Cassnail",
                ...
                List.of("It dissolves minerals in sand and uses them to form a hard carapace on its back. It lives in coastal regions."),
                List.of(new EvolutionEntry("sableau", EvolutionType.LEVEL_UP, List.of(),
