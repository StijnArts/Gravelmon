...
import java.util.*;
public class Pisaugon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pisaugon() {
        super("Pisaugon",
                Type.PSYCHIC,
                new Stats(74,
                        ...
                        83,
                        81),
                List.of(Ability.KEEN_EYE,Ability.INFILTRATOR), null,
                6, 85,
                new Stats(0,0,0,1,0,0), 228,
                0.5,
                0, ExperienceGroup.MEDIUM,
                70,
                50, List.of(),
                List.of("In Gefahrensituationen hebt es seine Ohren an und setzt Psycho-Kräfte frei, die einen 10 t schweren LKW zu Schrott verarbeiten können."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.REFLECT,35),
