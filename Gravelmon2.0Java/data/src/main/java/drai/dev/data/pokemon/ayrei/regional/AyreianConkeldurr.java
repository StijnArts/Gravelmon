...
import java.util.*;
public class AyreianConkeldurr extends drai.dev.data.pokemon.Pokemon {
    public AyreianConkeldurr(String name, Aspect aspect) {
        super(name, aspect,"AyreianConkeldurr",
                ...
                List.of("Concrete mixed by Conkeldurr is much more durable than normal concrete, even when the compositions of the two materials are the same."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WOOD_HAMMER,0),
