...
import java.util.*;
public class Quaputzi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quaputzi() {
        super("Quaputzi",
                Type.WATER,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Das Spiralmuster auf seinem Bauch dreht sich langsam. Starrt man darauf, wird einem schwindelig."),
                List.of(),
                List.of(
