...
import java.util.*;
public class Shinodea extends drai.dev.data.pokemon.Pokemon {
    public Shinodea() {
        super("Shinodea",
                Type.BUG, Type.DARK,
                new Stats(75,
                ...
                List.of("As Avalossian Nincada grow and evolve, their hunting techniques of sneak attacks and preying on the oblivious lead them to evolve into Shinodea. Shinodea wield razor sharp wings, capable of slicing ignorant quarry into ribbons before they even have a chance to react."),
                List.of(),
                List.of(
