...
import java.util.*;
public class SoulstonesanTalonflame extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTalonflame(int dex) {
        super(dex, "Talonflame",
                ...
                12, 245,
                new Stats(82,90,77,126,59,3), 255,
                0.5,
                175, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FLYING),
                List.of("Its favoured techniques is to charge itself up with electricity and dive into an enemy. The damage it deals is far more significant than the damage it sustains."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.RAPIDSTRIKE,34),
