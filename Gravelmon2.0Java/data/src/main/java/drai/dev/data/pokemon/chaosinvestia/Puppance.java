...
import java.util.*;
public class Puppance extends drai.dev.gravelmon.pokemon.Pokemon {
    public Puppance() {
        super("Puppance",
                ...
                70,
                50, List.of(),
                List.of("Es bewegt sich, indem es sich auf seinem Fuß dreht. Ein seltenes Pokémon, das in alten Ruinen lebte."),
                List.of(),
                List.of(
