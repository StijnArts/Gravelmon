...
import java.util.*;
public class TMuk extends drai.dev.gravelmon.pokemon.Pokemon {
    public TMuk() {
        super("TMuk",
                ...
                0.5,
                175, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.AMORPHOUS),
                List.of("When it opens its mouth to breathe, you can feel a large expulsion of hot air that will coat your entire body in sweat."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PYRO_BALL,57),
                        new MoveLearnSetEntry(Move.HEATSTROKE,1),
                        new MoveLearnSetEntry(Move.LANDS_WRATH,40),
                        new MoveLearnSetEntry(Move.MUDSLAP,12),
                        new MoveLearnSetEntry(Move.FLAME_WHEEL,29),
                        new MoveLearnSetEntry(Move.ROCK_SLIDE,37),
                        new MoveLearnSetEntry(Move.FIRE_LASH,46),
                        new MoveLearnSetEntry(Move.BULLDOZE,26),
                        new MoveLearnSetEntry(Move.STONE_SURGE,53),
                        new MoveLearnSetEntry(Move.MELTAWAY,43),
                        new MoveLearnSetEntry(Move.MINIMIZE,21),
                        new MoveLearnSetEntry(Move.FLAMEVOLLEY,15),
                        new MoveLearnSetEntry(Move.EARTHQUAKE,64),
                        new MoveLearnSetEntry(Move.STEAMROLLER,18),
