...
import java.util.*;
public class Klikdiklak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Klikdiklak() {
        super("Klikdiklak",
                Type.STEEL,
                new Stats(60,
                        ...
                        70,
                        85),
                List.of(Ability.PLUS,Ability.MINUS), null,
                6, 810,
                ...
                70,
                50, List.of(),
                List.of("Indem es das Rad mit dem roten Zentrum mit hohem Tempo zum Rotieren bringt, kann es eine Turboladung durchführen."),
                List.of(),
                List.of(
