...
import java.util.*;
public class AyreianDwebble extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianDwebble(int dex) {
        super(dex, "Dwebble",
                Type.BUG,Type.WATER,
                new Stats(70,
                        45,
                        ...
                        45,
                        85),
                List.of(Ability.RAIN_DISH,Ability.SHELL_ARMOR), null,
                3, 145,
                ...
                70,
                50, List.of(),
                List.of("The plant on top of its back secretes a sticky substance similar to glue. Sometimes, Dwebble will have items attached to it, like Heart Scales."),
                List.of(),
                List.of(
