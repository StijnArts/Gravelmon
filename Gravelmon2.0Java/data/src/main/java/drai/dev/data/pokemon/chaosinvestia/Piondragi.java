...
import java.util.*;
public class Piondragi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Piondragi() {
        super("Piondragi",
                ...
                70,
                50, List.of(),
                List.of("Es ist sehr stolz auf seine Stärke und besiegt Gegner auch ohne die Verwendung seines Gifts."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.CROSS_POISON,57),
