...
import java.util.*;
public class SoulstonesanTsareena extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTsareena(int dex) {
        super(dex, "Tsareena",
                ...
                List.of("A folk tale says that Tsareena was actually an angel that was cast out of heaven by the Gods for attempting to lead a rebellion."),
                List.of(),
                List.of(
