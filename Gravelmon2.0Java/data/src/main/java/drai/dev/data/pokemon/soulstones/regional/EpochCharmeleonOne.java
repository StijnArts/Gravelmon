...
import java.util.*;
public class EpochCharmeleonOne extends drai.dev.data.pokemon.Pokemon {
    public EpochCharmeleonOne(String name, Aspect aspect) {
        super(name, aspect, "EpochCharmeleonOne",
                Type.BUG,
                new Stats(76,
                        75,
                        60,
                ...
                List.of("It has begun to grow wings and a small horn on its head. The horn will fall off when it evolves, but for now it needs the defensive utility."),
                List.of(new EvolutionEntry("epochtwocharizard", EvolutionType.LEVEL_UP, List.of(),
