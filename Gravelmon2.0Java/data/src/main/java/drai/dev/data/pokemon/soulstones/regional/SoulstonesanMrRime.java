...
import java.util.*;
public class SoulstonesanMrRime extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMrRime(int dex) {
        super(dex, "MrRime",
                ...
                0.5,
                182, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("It uses its prop walking cane and prop hat to really elevate its act to the next level because it is no longer confined to just using its hands and feet."),
                List.of(),
                List.of(
