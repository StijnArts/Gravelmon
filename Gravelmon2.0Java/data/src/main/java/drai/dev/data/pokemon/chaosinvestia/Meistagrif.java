...
import java.util.*;
public class Meistagrif extends drai.dev.gravelmon.pokemon.Pokemon {
    public Meistagrif() {
        super("Meistagrif",
                Type.FIGHTING,
                new Stats(105,
                ...
                70,
                50, List.of(),
                List.of("Besitzt die Fähigkeit, die Säulen, die es als Gehstöcke verwendet, ganz ohne Krafteinsatz umherzuschwingen."),
                List.of(),
                List.of(
