...
import java.util.*;
public class Dusselgurr extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dusselgurr() {
        super("Dusselgurr",
                ...
                70,
                50, List.of(),
                List.of("Ein Pokémon, das in der Stadt zu Hause ist. Es ist sehr zutraulich und bevölkert in Scharen öffentliche Plätze und Parks."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SWAGGER,39),
                        new MoveLearnSetEntry(Move.ROOST,18),
                        new MoveLearnSetEntry(Move.FACADE,43),
