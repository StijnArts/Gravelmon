...
import java.util.*;
public class Muntier extends drai.dev.gravelmon.pokemon.Pokemon {
    public Muntier() {
        super("Muntier",
                Type.NORMAL,
                new Stats(80,
                        ...
                        55,
                        55),
                List.of(Ability.VITAL_SPIRIT), null,
                14, 465,
                ...
                70,
                50, List.of(),
                List.of("Sein Herz schlägt schneller als das anderer Lebewesen. Daher kann es nicht für einen Moment still sitzen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.CHIP_AWAY,43),
