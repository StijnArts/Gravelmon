...
import java.util.*;
public class SoulstonesanRampardos extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanRampardos(int dex) {
        super(dex, "Rampardos",
                ...
                List.of("Its skull is as hard as iron. It is a brute that tears down jungle trees while catching prey."),
                List.of(),
                List.of(
