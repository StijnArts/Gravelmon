...
import java.util.*;
public class Zirpeise extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zirpeise() {
        super("Zirpeise",
                Type.BUG,
                new Stats(77,
                ...
                70,
                50, List.of(),
                List.of("Es gibt ein Dorf, das basierend auf den imposanten Rufen dieses Pokémon einen Wettbewerb veranstaltet."),
                List.of(),
                List.of(
