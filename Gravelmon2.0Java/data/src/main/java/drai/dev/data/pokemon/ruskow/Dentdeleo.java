...
import java.util.*;
public class Dentdeleo extends drai.dev.data.pokemon.Pokemon {
    public Dentdeleo() {
        super("Dentdeleo",
                Type.GRASS,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("dandylion", EvolutionType.LEVEL_UP, List.of(),
