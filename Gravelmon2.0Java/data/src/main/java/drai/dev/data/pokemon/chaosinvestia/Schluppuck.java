...
import java.util.*;
public class Schluppuck extends drai.dev.gravelmon.pokemon.Pokemon {
    public Schluppuck() {
        super("Schluppuck",
                Type.POISON,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Sein Körper besteht fast nur aus Magen. Seine starken Verdauungssäfte zersetzen alles sehr schnell."),
                List.of(),
                List.of(
