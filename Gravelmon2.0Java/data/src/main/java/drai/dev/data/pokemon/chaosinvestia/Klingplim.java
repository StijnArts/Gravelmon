...
import java.util.*;
public class Klingplim extends drai.dev.gravelmon.pokemon.Pokemon {
    public Klingplim() {
        super("Klingplim",
                Type.PSYCHIC,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("In seinem Maul befindet sich eine Kugel, die beim Hopsen ein klingelndes Geräusch erzeugt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.LAST_RESORT,22),
