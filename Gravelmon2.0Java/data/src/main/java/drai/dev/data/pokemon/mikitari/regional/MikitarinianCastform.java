...
import java.util.*;
public class MikitarinianCastform extends drai.dev.data.pokemon.Pokemon {
    public MikitarinianCastform(String name, Aspect aspect) {
        super(name, aspect, "MikitarinianCastform",
                Type.ROCK,
                new Stats(70,
                        70,
                        70,
