...
public class EpochEevee extends drai.dev.data.pokemon.Pokemon {
    public EpochEevee(String name, Aspect aspect) {
        super(name, aspect, "EpochEevee",
                ...
                List.of(new EvolutionEntry("epochvaporeon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "cobblemon:sun_stone"),
new EvolutionEntry("epochjolteon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "gravelmon:air_stone"),
new EvolutionEntry("epochflareon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "gravelmon:solid_stone"),
new EvolutionEntry("epochleafeon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "cobblemon:silver_powder"),
new EvolutionEntry("epochglaceon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "gravelmon:astral_stone"),
new EvolutionEntry("epochespeon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "cobblemon:black_sludge"),
new EvolutionEntry("epochumbreon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "cobblemon:black_belt"),
new EvolutionEntry("epochsylveon", EvolutionType.ITEM_INTERACT, false, List.of(),
 List.of(), List.of(), "gravelmon:astral_stone")),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PERISH_SONG,30),
