...
public class Chiraudio extends drai.dev.data.pokemon.Pokemon {
    public Chiraudio() {
        super("Chiraudio",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROUND,32),
                        new MoveLearnSetEntry(Move.EMBARGO,35),
                        new MoveLearnSetEntry(Move.BEAT_UP,38),
                        new MoveLearnSetEntry(Move.AIR_SLASH,42),
                        new MoveLearnSetEntry(Move.JUMPSCARE,46),
                        new MoveLearnSetEntry(Move.DRAIN_LIFE,50),
                        new MoveLearnSetEntry(Move.AERIAL_ACE,54),
                        new MoveLearnSetEntry(Move.PARTING_SHOT,58),
                        new MoveLearnSetEntry(Move.THROAT_CHOP,62),
