...
public class DeltaBisharp extends Pokemon {
    public DeltaBisharp(String name, Aspect aspect) {
        super(name, aspect,"DeltaBisharp",
                ...
                List.of("It commands a large group of Pawniard. A single swing of its arm is enough to summon a hurricane."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BULK_UP,63),
                        new MoveLearnSetEntry(Move.HURRICANE,71),
