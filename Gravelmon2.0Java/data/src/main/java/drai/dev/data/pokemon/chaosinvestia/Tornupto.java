...
import java.util.*;
public class Tornupto extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tornupto() {
        super("Tornupto",
                Type.FIRE,
                new Stats(78,
                ...
                70,
                50, List.of(),
                List.of("Es greift seine Gegner mit Feuer an. Dabei entsteht ein Hitzeflimmern, in dem es sich versteckt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DEFENSE_CURL,24),
                        ...
                        new MoveLearnSetEntry(Move.ERUPTION,74),
