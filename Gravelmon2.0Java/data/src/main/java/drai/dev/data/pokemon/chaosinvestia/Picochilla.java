...
import java.util.*;
public class Picochilla extends drai.dev.gravelmon.pokemon.Pokemon {
    public Picochilla() {
        super("Picochilla",
                Type.NORMAL,
                new Stats(55,
                        ...
                        40,
                        40),
                List.of(Ability.CUTE_CHARM,Ability.TECHNICIAN), null,
                4, 58,
                ...
                70,
                50, List.of(),
                List.of("Ein Pokémon mit Putzfimmel. Es benutzt seinen Schweif als Staubwedel und putzt seinen Bau, bis alles picobello ist."),
                List.of(),
                List.of(
