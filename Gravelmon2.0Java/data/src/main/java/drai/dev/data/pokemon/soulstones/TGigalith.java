...
import java.util.*;
public class TGigalith extends drai.dev.gravelmon.pokemon.Pokemon {
    public TGigalith() {
        super("TGigalith",
                ...
                0.5,
                232, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.MINERAL),
                List.of("This Pokemon carries so much latent energy that it is able to seamlessly connect multiple rocks together through an electrical current."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.IRON_DEFENSE,20),
                        new MoveLearnSetEntry(Move.STEALTH_ROCK,36),
                        new MoveLearnSetEntry(Move.LOCKON,52),
                        new MoveLearnSetEntry(Move.GEMSTORM,1),
