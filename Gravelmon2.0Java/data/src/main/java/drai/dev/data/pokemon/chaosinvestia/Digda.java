...
import java.util.*;
public class Digda extends drai.dev.gravelmon.pokemon.Pokemon {
    public Digda() {
        super("Digda",
                Type.GROUND,
                new Stats(10,
                ...
                70,
                50, List.of(),
                List.of("Dieses Pokémon lebt unterirdisch. Da es an Dunkelheit gewöhnt ist, schreckt helles Licht es ab."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.EARTH_POWER,29),
