...
import java.util.*;
public class Voluminas extends drai.dev.gravelmon.pokemon.Pokemon {
    public Voluminas() {
        super("Voluminas",
                ...
                70,
                50, List.of(),
                List.of("Es steuert drei kleine Einheiten mithilfe von starkem Magnetismus. Man nennt sie Mininasen."),
                List.of(),
                List.of(
