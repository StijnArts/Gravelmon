...
import java.util.*;
public class Rameidon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rameidon() {
        super("Rameidon",
                Type.ROCK,
                new Stats(97,
                ...
                70,
                50, List.of(),
                List.of("Schlagen zwei von ihnen mit den Köpfen zusammen, verhindern ihre dicken Schädel eine Ohnmacht."),
                List.of(),
                List.of(
