...
public class Chansey extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chansey() {
        super("Chansey",
                ...
                70,
                50, List.of(),
                List.of("This species was once very slow. To protect their eggs from other creatures, these Pokémon became able to flee quickly."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SING,16),
