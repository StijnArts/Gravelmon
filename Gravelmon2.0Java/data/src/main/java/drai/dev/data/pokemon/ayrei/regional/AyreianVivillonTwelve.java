...
import java.util.*;
public class AyreianVivillonTwelve extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonTwelve(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonTwelve",
                Type.SOUND,Type.BUG,
                new Stats(80,
                        52,
                        65,
