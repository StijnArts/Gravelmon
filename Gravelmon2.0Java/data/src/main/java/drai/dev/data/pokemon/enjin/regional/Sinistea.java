...
import java.util.*;
public class Sinistea extends drai.dev.data.pokemon.Pokemon {
    public Sinistea(String name, Aspect aspect) {
        super(name, aspect, "Sinistea",
                Type.GHOST,
                new Stats(40,
                        45,
                        45,
                ...
                List.of("The teacup in which this Pokémon makes its home is a famous piece of antique tableware. Many forgeries are in circulation."),
                List.of(),
                List.of(
