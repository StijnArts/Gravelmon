...
import java.util.*;
public class Rokkaiman extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rokkaiman() {
        super("Rokkaiman",
                ...
                70,
                50, List.of(),
                List.of("Die spezielle Membran um seine Augen fungiert als Wärmesensor, durch den es sich auch im Dunkeln zurechtfindet."),
                List.of(),
                List.of(
