...
public class AyreianTorchic extends Pokemon {
    public AyreianTorchic(String name, Aspect aspect) {
        super(name, aspect,"AyreianTorchic",
                ...
                List.of("Their immense ghostly energy allows them to summon additional limbs for a short time, but their inexperience makes them quite clumsy."),
                List.of(new EvolutionEntry("ayreiancombusken", EvolutionType.LEVEL_UP, List.of(),
                        List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"16")))),
                List.of(
                        new MoveLearnSetEntry(Move.SWIFT_STRIKE, 1),
