...
import java.util.*;
public class Somniam extends drai.dev.gravelmon.pokemon.Pokemon {
    public Somniam() {
        super("Somniam",
                Type.PSYCHIC,
                new Stats(76,
                        ...
                        67,
                        55),
                List.of(Ability.FOREWARN,Ability.SYNCHRONIZE), null,
                6, 233,
                ...
                70,
                50, List.of(),
                List.of("Es verschlingt die Träume der Menschen. Frisst es einen fröhlichen Traum, stößt es danach einen rosafarbenen Dunst aus."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.ZEN_HEADBUTT,23),
                        ...
                        new MoveLearnSetEntry(Move.SYNCHRONOISE,25),
                        new MoveLearnSetEntry(Move.DREAM_EATER,41),
                        ...
                        new MoveLearnSetEntry(Move.IMPRISON,13),
