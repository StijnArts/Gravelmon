...
import java.util.*;
public class AyreianRelicanth extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianRelicanth(int dex) {
        super(dex, "Relicanth",
                ...
                new Stats(65,
                        ...
                        90,
                        125),
                List.of(Ability.SWIFT_SWIM,Ability.STORM_DRAIN), null,
                10, 234,
                new Stats(0,0,1,0,0,1), 25,
                0.875,
