...
import java.util.*;
public class TTyphlosion extends drai.dev.gravelmon.pokemon.Pokemon {
    public TTyphlosion() {
        super("TTyphlosion",
                Type.ICE,
                new Stats(98,
                ...
                0.875,
                240, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("The crystal on its body is hardened to be almost as tough as diamonds."),
                List.of(),
                List.of(
