...
import java.util.*;
public class SoulstonesanSableye extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSableye(int dex) {
        super(dex, "Sableye",
                Type.FIRE,Type.DARK,
                new Stats(75,
                        110,
                ...
                5, 110,
                new Stats(75,1,75,110,45,65), 100,
                0.5,
                133, ExperienceGroup.PARABOLIC,
                70,
