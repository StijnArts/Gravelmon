...
import java.util.*;
public class Zapplalek extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zapplalek() {
        super("Zapplalek",
                Type.ELECTRIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Hat es seine Beute erspäht, lähmt es sie mit Elektrizität und verspeist sie anschließend."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ACID_SPRAY,49),
                        ...
                        new MoveLearnSetEntry(Move.ZAP_CANNON,69)                        ),
