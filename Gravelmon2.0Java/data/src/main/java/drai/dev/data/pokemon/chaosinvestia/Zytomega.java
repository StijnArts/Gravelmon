...
import java.util.*;
public class Zytomega extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zytomega() {
        super("Zytomega",
                Type.PSYCHIC,
                new Stats(110,
                ...
                70,
                50, List.of(),
                List.of("Sein Griff ist so stark, dass es damit ganze Felsen zermalmen kann. Es ist sehr intelligent."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WONDER_ROOM,59),
                        ...
                        new MoveLearnSetEntry(Move.DIZZY_PUNCH,41),
