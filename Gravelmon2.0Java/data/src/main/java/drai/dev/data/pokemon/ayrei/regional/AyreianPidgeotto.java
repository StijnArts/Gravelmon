...
import java.util.*;
public class AyreianPidgeotto extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianPidgeotto(int dex) {
        super(dex, "Pidgeotto",
                ...
                new Stats(63,
                        ...
                        50,
                        50),
                List.of(Ability.FLOWER_GIFT,Ability.OVERGROW), null,
                11, 300,
                ...
                70,
                50, List.of(),
                List.of("Very protective of its sprawling territorial area, this Pok̩mon will fiercely peck at any intruder."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ACROBATICS,18),
