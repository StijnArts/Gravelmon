...
public class NostanDiglett extends drai.dev.data.pokemon.Pokemon {
    public NostanDiglett(String name, Aspect aspect) {
        super(name, aspect, "Diglett",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.EARTHQUAKE,35),
