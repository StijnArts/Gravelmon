...
import java.util.*;
public class Tikitoko extends drai.dev.data.pokemon.Pokemon {
    public Tikitoko() {
        super("Ikitoko",
                ...
                List.of("Tikitoko construct their own masks from the trees of the jungle. Excavated masks built by ancient Tikitoko are noted to hold DNAs from Pokémon of the past."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MEAN_LOOK,48),
                        ...
                        new MoveLearnSetEntry(Move.INSTRUCT,0),
                        new MoveLearnSetEntry(Move.WIDE_GUARD,64),
