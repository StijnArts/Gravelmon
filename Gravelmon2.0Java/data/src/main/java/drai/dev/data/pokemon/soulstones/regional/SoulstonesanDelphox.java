...
import java.util.*;
public class SoulstonesanDelphox extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanDelphox(int dex) {
        super(dex, "Delphox",
                ...
                List.of("This ancient Pokemon is thought to be only a myth. It stores so much power inside its glass orb it is said it can communicate with the underworld freely."),
                List.of(),
                List.of(
