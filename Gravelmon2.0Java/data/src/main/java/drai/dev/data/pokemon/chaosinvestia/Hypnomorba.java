...
import java.util.*;
public class Hypnomorba extends drai.dev.gravelmon.pokemon.Pokemon {
    public Hypnomorba() {
        super("Hypnomorba",
                Type.PSYCHIC,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Zieht seine Energie aus dem Sternenlicht. Bei Nacht bringt es Steine zum Schweben und bildet damit Sternzeichen nach."),
                List.of(),
                List.of(
