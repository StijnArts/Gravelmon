...
import java.util.*;
public class SoulstonesanLuxray extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanLuxray(int dex) {
        super(dex, "Luxray",
                ...
                14, 420,
                new Stats(90,3,89,105,55,89), 90,
                0.5,
                235, ExperienceGroup.PARABOLIC,
                70,
