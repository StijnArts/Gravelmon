...
import java.util.*;
public class EpochShellosFour extends drai.dev.data.pokemon.Pokemon {
    public EpochShellosFour(String name, Aspect aspect) {
        super(name, aspect, "EpochShellosFour",
                ...
                List.of(new EvolutionEntry("epochshellos gastrodon", EvolutionType.LEVEL_UP, List.of(),
