...
import java.util.*;
public class Schwalbini extends drai.dev.gravelmon.pokemon.Pokemon {
    public Schwalbini() {
        super("Schwalbini",
                ...
                70,
                50, List.of(),
                List.of("Es ist sehr mutig und stellt sich auch starken Gegnern. Es sucht ständig nach warmen Regionen."),
                List.of(),
                List.of(
