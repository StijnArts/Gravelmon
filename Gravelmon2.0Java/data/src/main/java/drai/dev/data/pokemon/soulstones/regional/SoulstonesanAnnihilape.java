...
import java.util.*;
public class SoulstonesanAnnihilape extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanAnnihilape(int dex) {
        super(dex, "Annihilape",
                ...
                List.of("It has become unstable and frayed from its relentless screeching. Its persistence is one of its most admirable but also most despised qualities."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SONICCRASH,1),
