...
import java.util.*;
public class AyreianLairon extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianLairon(int dex) {
        super(dex, "Lairon",
                Type.FIRE,Type.ROCK,
                new Stats(50,
                        80,
                ...
                70,
                50, List.of(),
                List.of("During territorial disputes, Lairon emits high amounts of steam. Close inspection of their magma armor reveals scratches and dents."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEAT_CRASH,0),
