...
import java.util.*;
public class Mewtu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mewtu() {
        super("Mewtu",
                Type.PSYCHIC,
                new Stats(106,
                ...
                70,
                50, List.of(),
                List.of("Die Gene von Mew wurden neu angeordnet, wodurch dieses Pokémon entstand. Es hat ein wildes Herz."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.DISABLE,1),
                        new MoveLearnSetEntry(Move.ME_FIRST,71),
                        new MoveLearnSetEntry(Move.BARRIER,1),
                        new MoveLearnSetEntry(Move.SAFEGUARD,86),
