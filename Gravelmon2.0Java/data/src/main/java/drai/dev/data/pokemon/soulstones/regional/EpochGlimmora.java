...
import java.util.*;
public class EpochGlimmora extends drai.dev.data.pokemon.Pokemon {
    public EpochGlimmora(String name, Aspect aspect) {
        super(name, aspect, "EpochGlimmora",
                ...
                List.of("It uses its vines to latch onto your face and will rapidly poison you or horribly maim you."),
                List.of(),
                List.of(
