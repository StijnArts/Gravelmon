...
import java.util.*;
public class Makabaja extends drai.dev.gravelmon.pokemon.Pokemon {
    public Makabaja() {
        super("Makabaja",
                Type.GHOST,
                new Stats(38,
                ...
                70,
                50, List.of(),
                List.of("Es entsteht aus den Seelen von längst begrabenen Menschen und kann sich noch immer an deren Vergangenheit erinnern."),
                List.of(),
                List.of(
