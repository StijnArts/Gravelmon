...
import java.util.*;
public class SoulstonesanStarly extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanStarly(int dex) {
        super(dex, "Starly",
