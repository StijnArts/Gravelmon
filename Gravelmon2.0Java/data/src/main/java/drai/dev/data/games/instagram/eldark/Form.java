...
//        addNewPokemon(new FormanBlissey("", Aspect.FORMAN));//Member of line not finished
        ...
        addNewPokemon(new FormanBulbasaur("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Spiksaur().addLabels(Label.STARTER));
        addNewPokemon(new Gemsaur().addLabels(Label.STARTER));
        addNewPokemon(new FormanCharmander("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Glameleon().addLabels(Label.STARTER));
        addNewPokemon(new Glacizard().addLabels(Label.STARTER));
        addNewPokemon(new FormanSquirtle("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Driltos().addLabels(Label.STARTER));
        addNewPokemon(new Oniturl().addLabels(Label.STARTER));
        addNewPokemon(new FormanCaterpie("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Bloboon().addLabels(Label.STARTER));
        addNewPokemon(new Glowfly().addLabels(Label.STARTER));
        ...
        addNewPokemon(new Everieon().addLabels(Label.EEVEELUTION));
        ...
        addNewPokemon(new FormanArticuno("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanZapdos("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanMoltres("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanDratini("", Aspect.FORMAN).fishingSpawnFromExisting().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new FormanDragonair("", Aspect.FORMAN).fishingSpawnFromExisting().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Dragorai().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Mewters().addLabels(Label.LEGENDARY));
        addNewPokemon(new Meu().addLabels(Label.MYTHICAL));
        addNewPokemon(new FormanChikorita("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Sawtears().addLabels(Label.STARTER));
        addNewPokemon(new Helgold().addLabels(Label.STARTER));
        addNewPokemon(new FormanCyndaquil("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Jestruff().addLabels(Label.STARTER));
        addNewPokemon(new Puppetdra().addLabels(Label.STARTER));
        addNewPokemon(new FormanTotodile("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Dracro().addLabels(Label.STARTER));
        addNewPokemon(new Savagaitor().addLabels(Label.STARTER));
        ...
        addNewPokemon(new FormanLarvitar("", Aspect.FORMAN).addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Toothitar().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Rodanitar().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new FormanRaikou("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanEntei("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanSuicune("", Aspect.FORMAN).addLabels(Label.SUB_LEGENDARY));
        addNewPokemon(new FormanLugia("", Aspect.FORMAN).addLabels(Label.LEGENDARY));
        addNewPokemon(new FormanHooh("", Aspect.FORMAN).addLabels(Label.LEGENDARY));
        addNewPokemon(new Celeby().addLabels(Label.MYTHICAL));
        addNewPokemon(new FormanTreecko("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Muecko().addLabels(Label.STARTER));
        addNewPokemon(new Skeptile().addLabels(Label.STARTER));
        addNewPokemon(new FormanTorchic("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Galatoo().addLabels(Label.STARTER));
        addNewPokemon(new Secrebuyo().addLabels(Label.STARTER));
        addNewPokemon(new FormanMudkip("", Aspect.FORMAN).addLabels(Label.STARTER));
        addNewPokemon(new Salathyst().addLabels(Label.STARTER));
        addNewPokemon(new Soljailer().addLabels(Label.STARTER));
    }
