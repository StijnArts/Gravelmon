...
import java.util.*;
public class Fukano extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fukano() {
        super("Fukano",
                Type.FIRE,
                new Stats(55,
                        ...
                        70,
                        50),
                List.of(Ability.INTIMIDATE,Ability.FLASH_FIRE), null,
                7, 190,
                ...
                70,
                50, List.of(),
                List.of("Ein loyales Pokémon. Es wird erst dann aktiv, wenn sein Trainer ihm Anweisungen gegeben hat."),
                List.of(),
                List.of(
