...
import java.util.*;
public class Sniebel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sniebel() {
        super("Sniebel",
                Type.DARK,Type.ICE,
                new Stats(55,
                        ...
                        35,
                        75),
                List.of(Ability.INNER_FOCUS,Ability.KEEN_EYE), null,
                9, 280,
                ...
                70,
                50, List.of(),
                List.of("Ein raffiniertes Pokémon, das in Zusammenarbeit mit einem anderen Sniebel gern Eier stiehlt."),
                List.of(),
                List.of(
