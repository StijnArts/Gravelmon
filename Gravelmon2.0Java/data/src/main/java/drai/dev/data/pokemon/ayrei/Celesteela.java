...
import java.util.*;
public class Celesteela extends drai.dev.gravelmon.pokemon.Pokemon {
    public Celesteela() {
        super("Celesteela",
                ...
                new Stats(97,
                        ...
                        107,
                        101),
                List.of(Ability.BEAST_BOOST), null,
                92, 9999,
                ...
                70,
                50, List.of(),
                List.of("One of the dangerous UBs, high energy readings can be detected coming from both of its huge arms."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.AUTOTOMIZE,30),
                        ...
                        new MoveLearnSetEntry(Move.HEAVY_SLAM,60),
