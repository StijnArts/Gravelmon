...
import java.util.*;
public class AyreianMinccino extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianMinccino(int dex) {
        super(dex, "Minccino",
                ...
                new Stats(55,
                        ...
                        50,
                        40),
                List.of(Ability.MAGNET_PULL,Ability.TECHNICIAN), null,
                4, 58,
                ...
                70,
                50, List.of(),
                List.of("Old ladies adore this Pokemon, even if it tends to steal jewelry while no one's looking. Everyone finds it adorable though."),
                List.of(),
                List.of(
