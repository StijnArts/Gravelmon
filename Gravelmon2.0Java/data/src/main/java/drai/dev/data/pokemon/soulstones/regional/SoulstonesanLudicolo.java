...
import java.util.*;
public class SoulstonesanLudicolo extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanLudicolo(int dex) {
        super(dex, "Ludicolo",
                ...
                15, 550,
                new Stats(2,45,70,60,100,95), 95,
                0.5,
                240, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.GRASS),
                List.of("This Pokemon can launch its barbs in a volley at an enemy when annoyed. Its happy-go-lucky attitude should not be taken for granted."),
                List.of(),
                List.of(
