...
import java.util.*;
public class Castform extends drai.dev.gravelmon.pokemon.Pokemon {
    public Castform() {
        super("Castform",
                Type.NORMAL,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("It has the ability to change its form into the sun, the rain, or a snow cloud, depending on the weather."),
                List.of(),
                List.of(
