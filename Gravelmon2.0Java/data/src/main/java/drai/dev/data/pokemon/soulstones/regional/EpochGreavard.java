...
import java.util.*;
public class EpochGreavard extends drai.dev.data.pokemon.Pokemon {
    public EpochGreavard(String name, Aspect aspect) {
        super(name, aspect, "EpochGreavard",
                Type.POISON,
                new Stats(70,
                        71,
                        55,
                ...
                List.of("It gives off the most rank odour imaginable. This is to be expected because it enjoys frolicking in sewers and landfills."),
                List.of(new EvolutionEntry("epochhoundstone", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"30")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GRABANDGO,"egg"),
