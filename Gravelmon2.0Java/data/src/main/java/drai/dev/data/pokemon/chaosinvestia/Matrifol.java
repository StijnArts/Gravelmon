...
import java.util.*;
public class Matrifol extends drai.dev.gravelmon.pokemon.Pokemon {
    public Matrifol() {
        super("Matrifol",
                Type.BUG,Type.GRASS,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Nutzt die Hitze kompostierenden Laubes zum Ausbrüten von Eiern. Es fertigt aus Blättern Kleidchen für Strawickl an."),
                List.of(),
                List.of(
