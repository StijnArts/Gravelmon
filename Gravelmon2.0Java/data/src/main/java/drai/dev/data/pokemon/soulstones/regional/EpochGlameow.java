...
import java.util.*;
public class EpochGlameow extends drai.dev.data.pokemon.Pokemon {
    public EpochGlameow(String name, Aspect aspect) {
        super(name, aspect, "EpochGlameow",
                ...
                List.of("These Pokémon are often found in tar pits and other toxic pools, being common on mines, presumably as a form of protection against predators."),
                List.of(new EvolutionEntry("epochpurugly", EvolutionType.LEVEL_UP, List.of(), 
