...
import java.util.*;
public class TReuniclus extends drai.dev.gravelmon.pokemon.Pokemon {
    public TReuniclus() {
        super("TReuniclus",
                ...
                List.of("It is actually an interstellar parasite that consume the resources from the planet and then summarily migrate onto the next world."),
                List.of(),
                List.of(
