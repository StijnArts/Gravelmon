...
import java.util.*;
public class EpochWhimsicottOne extends drai.dev.data.pokemon.Pokemon {
    public EpochWhimsicottOne(String name, Aspect aspect) {
        super(name, aspect, "EpochWhimsicottOne",
                ...
                List.of("They float around on air currents, absorbing the sun into their fluff to create electricity, allowing them to shock predators."),
                List.of(),
                List.of(
                ...
                0, List.of(
                        ...
                        .setMinLevel(34).setPool(SpawnPool.UNCOMMON).setWeight(SpawnWeight.VERY_COMMON)
