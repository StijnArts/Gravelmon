...
import java.util.*;
public class EpochCetoddleOne extends drai.dev.data.pokemon.Pokemon {
    public EpochCetoddleOne(String name, Aspect aspect) {
        super(name, aspect, "EpochCetoddleOne",
                ...
                List.of("They like eating space debris and expel energy when they're finished eating, making them very useful to space agencies."),
                List.of(new EvolutionEntry("epochtwocetitan", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "cobblemon:moon_stone")),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MUDSURGE,"egg"),
                        new MoveLearnSetEntry(Move.CONTINENTALRIFT,"egg"),
                        new MoveLearnSetEntry(Move.HYPERSPACE_HOLE,"egg"),
