...
import java.util.*;
public class AyreianSprigatito extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianSprigatito(int dex) {
        super(dex, "Sprigatito",
