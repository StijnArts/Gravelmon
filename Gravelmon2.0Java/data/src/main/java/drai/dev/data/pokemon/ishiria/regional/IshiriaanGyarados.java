...
import java.util.*;
public class IshiriaanGyarados extends drai.dev.data.pokemon.Pokemon {
    public IshiriaanGyarados(String name, Aspect aspect) {
        super(name, aspect, "IshiriaanGyarados",
