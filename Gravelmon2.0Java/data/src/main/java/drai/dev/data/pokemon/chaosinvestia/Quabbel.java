...
import java.util.*;
public class Quabbel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quabbel() {
        super("Quabbel",
                ...
                new Stats(55,
                        ...
                        65,
                        85),
                List.of(Ability.WATER_ABSORB,Ability.CURSED_BODY), null,
                12, 330,
                ...
                70,
                50, List.of(),
                List.of("Es lähmt seine Beute mit Gift und verschleppt sie in seinen Unterschlupf, acht Kilometer unter dem Meeresspiegel."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEX,43),
