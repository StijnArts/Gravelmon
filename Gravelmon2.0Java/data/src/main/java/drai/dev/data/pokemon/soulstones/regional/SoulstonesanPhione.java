...
import java.util.*;
public class SoulstonesanPhione extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPhione(int dex) {
        super(dex, "Phione",
                Type.FAIRY,
                new Stats(100,
                        100,
                ...
                List.of("Whenever a person requests a wish from a Manaphy, a Phione is rumoured to be created as a result."),
                List.of(),
                List.of(
