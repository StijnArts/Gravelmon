...
import java.util.*;
public class Blanas extends drai.dev.gravelmon.pokemon.Pokemon {
    public Blanas() {
        super("Blanas",
                ...
                70,
                50, List.of(),
                List.of("Der Ton seiner Grasflöte beunruhigt die, die ihn hören. Es lebt tief in den Wäldern."),
                List.of(),
                List.of(
