...
import java.util.*;
public class SoulstonesanManectric extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanManectric(int dex) {
        super(dex, "Manectric",
                ...
                15, 402,
                new Stats(70,115,55,105,55,2), 90,
                0.5,
                166, ExperienceGroup.SLOW,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("When it evolved, the skull it scavenged as an Electrike became a part of its features, that they can no longer be independently removed."),
                List.of(),
                List.of(
