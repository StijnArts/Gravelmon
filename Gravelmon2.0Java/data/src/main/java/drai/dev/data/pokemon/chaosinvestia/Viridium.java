...
import java.util.*;
public class Viridium extends drai.dev.gravelmon.pokemon.Pokemon {
    public Viridium() {
        super("Viridium",
                ...
                70,
                50, List.of(),
                List.of("Das Horn an seinem Kopf ist eine scharfe Klinge. Neckt seine Gegner mit quirligen Bewegungen und greift blitzartig an."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.LEAF_BLADE,67),
