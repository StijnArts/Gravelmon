...
import java.util.*;
public class MikitarianNoctowl extends drai.dev.data.pokemon.Pokemon {
    public MikitarianNoctowl(String name, Aspect aspect) {
        super(name, aspect, "MikitarianNoctowl",
