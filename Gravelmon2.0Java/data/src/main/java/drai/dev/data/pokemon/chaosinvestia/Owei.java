...
import java.util.*;
public class Owei extends drai.dev.gravelmon.pokemon.Pokemon {
    public Owei() {
        super("Owei",
                ...
                70,
                50, List.of(),
                List.of("Die sechs Eier kommunizieren telepathisch. Werden sie getrennt, finden sie sich schnell wieder."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BESTOW,53),
