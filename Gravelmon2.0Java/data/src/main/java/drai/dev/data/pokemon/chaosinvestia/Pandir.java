...
import java.util.*;
public class Pandir extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pandir() {
        super("Pandir",
                Type.NORMAL,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Das Muster eines Pandir ist wie ein Fingerabdruck. Sein Taumeln senkt die gegnerische Zielsicherheit."),
                List.of(),
                List.of(
