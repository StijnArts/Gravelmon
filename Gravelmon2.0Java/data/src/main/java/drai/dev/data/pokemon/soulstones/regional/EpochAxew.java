...
import java.util.*;
public class EpochAxew extends drai.dev.data.pokemon.Pokemon {
    public EpochAxew(String name, Aspect aspect) {
        super(name, aspect, "EpochAxew",
                ...
                List.of("Its mace tail is exceptionally heavy, and a simple swing of it can shatter bones."),
                List.of(new EvolutionEntry("epochfraxure", EvolutionType.LEVEL_UP, List.of(), 
