...
import java.util.*;
public class IshiriaanShinx extends drai.dev.data.pokemon.Pokemon {
    public IshiriaanShinx(String name, Aspect aspect) {
        super(name, aspect, "IshiriaanShinx",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TRIPLE_AXEL,41),
