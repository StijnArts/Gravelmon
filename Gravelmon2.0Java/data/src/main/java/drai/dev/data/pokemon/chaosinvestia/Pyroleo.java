...
import java.util.*;
public class Pyroleo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pyroleo() {
        super("Pyroleo",
                ...
                70,
                50, List.of(),
                List.of("Das Männchen mit der prächtigsten Feuermähne führt das Rudel an."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.INCINERATE,51),
