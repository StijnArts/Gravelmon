...
public class Ultraspace extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        ...
        addNewPokemon(new Croatex(new Stats(490, StatArchetype.SPECIAL_ATTACKER,
                List.of(StatType.SPEED))));      
        addNewPokemon(new Jawminate());   
        addNewPokemon(new Imposibeast(new Stats(490, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Knuclaw());   
        addNewPokemon(new Huntitan(new Stats(490, StatArchetype.BULKY_PHYSICAL_ATTACKER,
...
//                List.of(StatType.SPEED))));      MEMBER OF LINE NOT FINISHED
        ...
        addNewPokemon(new Croptic(new Stats(460, StatArchetype.FAST_SPECIAL_WALL,
                List.of(StatType.SPEED))));      
        addNewPokemon(new Eleslink());   
        addNewPokemon(new Eleconda(new Stats(455, StatArchetype.FAST_SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_ATTACK))));
        addNewPokemon(new Puffgi());   
        addNewPokemon(new Mushboom(new Stats(450, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.SPECIAL_ATTACK))));
...
//        addNewPokemon(new 403508());   Missing Art
        addNewPokemon(new Outepede(new Stats(430, StatArchetype.FAST_SPECIAL_ATTACKER,
                List.of(StatType.SPEED))));      
        addNewPokemon(new Grosscean(new Stats(440, StatArchetype.BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.DEFENCE))));
        addNewPokemon(new Aylien(new Stats(360, StatArchetype.FAST_PHYSICAL_ATTACKER,
                List.of(StatType.SPEED))));      
        addNewPokemon(new Sharcoe(new Stats(330, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Bullvanize(new Stats(410, StatArchetype.SLOW_BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.DEFENCE))));
...
//        addNewPokemon(new 658638());   Missing Art
        addNewPokemon(new Screechean(new Stats(420, StatArchetype.SLOW_BULKY_SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_ATTACK))));
        addNewPokemon(new Sulgast(new Stats(400, StatArchetype.FAST_SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_ATTACK))));
        addNewPokemon(new Goonanas(new Stats(390, StatArchetype.SLOW_BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.DEFENCE))));
        addNewPokemon(new Worminder(new Stats(410, StatArchetype.BULKY_SUPPORT,
                List.of(StatType.SPECIAL_DEFENCE))));
        addNewPokemon(new Chainitie(new Stats(400, StatArchetype.FAST_PHYSICAL_WALL,
                List.of(StatType.DEFENCE))));
        addNewPokemon(new Barbaris(new Stats(390, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
        addNewPokemon(new Galaxey(new Stats(380, StatArchetype.SPECIAL_ATTACKER,
                List.of(StatType.SPECIAL_ATTACK))));
        addNewPokemon(new Sculptean(new Stats(410, StatArchetype.SPECIAL_WALL,
                List.of(StatType.SPECIAL_DEFENCE))));
        addNewPokemon(new Cerebranch(new Stats(510, StatArchetype.FAST_SPECIAL_WALL,
                List.of(StatType.SPEED))));      
        addNewPokemon(new Inclemight(new Stats(510, StatArchetype.BULKY_PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK))));
    }
