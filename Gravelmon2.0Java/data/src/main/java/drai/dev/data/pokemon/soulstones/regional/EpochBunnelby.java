...
import java.util.*;
public class EpochBunnelby extends drai.dev.data.pokemon.Pokemon {
    public EpochBunnelby(String name, Aspect aspect) {
        super(name, aspect, "EpochBunnelby",
                ...
                List.of("They are commonly viewed as a nuisance as they will frequently raid and steal supplies from small desert towns."),
                List.of(new EvolutionEntry("epochdiggersby", EvolutionType.ITEM_INTERACT, false, List.of(), 
