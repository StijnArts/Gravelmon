...
import java.util.*;
public class SoulstonesanTapuBulu extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTapuBulu(int dex) {
        super(dex, "TapuBulu",
