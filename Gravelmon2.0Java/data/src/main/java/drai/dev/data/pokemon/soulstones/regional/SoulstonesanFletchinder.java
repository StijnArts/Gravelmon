...
import java.util.*;
public class SoulstonesanFletchinder extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanFletchinder(int dex) {
        super(dex, "Fletchinder",
