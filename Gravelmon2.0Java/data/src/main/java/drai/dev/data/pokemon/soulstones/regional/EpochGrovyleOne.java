...
import java.util.*;
public class EpochGrovyleOne extends drai.dev.data.pokemon.Pokemon {
    public EpochGrovyleOne(String name, Aspect aspect) {
        super(name, aspect, "EpochGrovyleOne",
                ...
                List.of("It uses the gear for temporal attacks. Any attempts to steal the gear will result in you being transported to a different timeline."),
                List.of(new EvolutionEntry("epochtwosceptile", EvolutionType.LEVEL_UP, List.of(), 
