...
import java.util.*;
public class AyreianSceptile extends drai.dev.data.pokemon.Pokemon {
    public AyreianSceptile(String name, Aspect aspect) {
        super(name, aspect, "Sceptile",
                ...
                new Stats(70,
                        ...
                        110,
                        60),
                List.of(Ability.MIMICRY,Ability.STAKEOUT), null,
                17, 422,
                ...
                List.of("It can adapt to any and all environments, sitting at the top of the food chain. Because of this, they are an invasive species in most areas of the world."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PIN_MISSILE,30),
                        new MoveLearnSetEntry(Move.SCALE_SHOT,70),
                        ...
                        new MoveLearnSetEntry(Move.TERRESTRIALCLAW,0),
                        new MoveLearnSetEntry(Move.TERRAIN_PULSE,1),
                        new MoveLearnSetEntry(Move.DUAL_CHOP,35),
