...
import java.util.*;
public class Chelterrar extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chelterrar() {
        super("Chelterrar",
                ...
                70,
                50, List.of(),
                List.of("Manche Pokémon werden auf dem Rücken eines Chelterrar geboren und verbringen ihr ganzes Leben dort."),
                List.of(),
                List.of(
