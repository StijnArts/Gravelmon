...
import java.util.*;
public class Chordeon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chordeon() {
        super("Chordeon",
                Type.SOUND,
                new Stats(85,
                ...
                70,
                50, List.of(),
                List.of("The note-like horns on its head cover its ears, as its high-pitched voice can easily shatter eardrums. A pack of this Pokemon is called an orchestra."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.COPYCAT,1),
                        new MoveLearnSetEntry(Move.MEMENTO,35),
                        new MoveLearnSetEntry(Move.QUICK_ATTACK,10),
                        new MoveLearnSetEntry(Move.TACKLE,1),
                        new MoveLearnSetEntry(Move.ROUND,0),
                        ...
                        new MoveLearnSetEntry(Move.TORCH_SONG,45),
