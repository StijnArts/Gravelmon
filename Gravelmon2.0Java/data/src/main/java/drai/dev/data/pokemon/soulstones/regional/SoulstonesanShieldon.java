...
import java.util.*;
public class SoulstonesanShieldon extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanShieldon(int dex) {
        super(dex, "Shieldon",
                Type.ICE,Type.STEEL,
                new Stats(30,
                        42,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.STEEL_ROLLER,"egg"),
