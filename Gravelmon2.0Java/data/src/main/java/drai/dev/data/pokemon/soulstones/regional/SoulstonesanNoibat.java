...
import java.util.*;
public class SoulstonesanNoibat extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanNoibat(int dex) {
        super(dex, "Noibat",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGON_ASCENT,"egg"),
