...
import java.util.*;
public class AyreianVivillonSix extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonSix(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonSix",
                Type.DARK,Type.BUG,
                new Stats(80,
                        52,
                        65,
