...
import java.util.*;
public class Burmadame extends drai.dev.gravelmon.pokemon.Pokemon {
    public Burmadame() {
        super("Burmadame",
                Type.BUG,Type.GRASS,
                new Stats(60,
                        ...
                        79,
                        105),
                List.of(Ability.ANTICIPATION), null,
                5, 65,
                ...
                70,
                50, List.of(),
                List.of("Es nimmt während der Entwicklung Dinge aus der Umgebung auf, daher gibt es viele Variationen von ihm."),
                List.of(),
                List.of(
