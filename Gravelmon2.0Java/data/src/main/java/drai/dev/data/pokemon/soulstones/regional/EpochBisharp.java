...
import java.util.*;
public class EpochBisharp extends drai.dev.data.pokemon.Pokemon {
    public EpochBisharp(String name, Aspect aspect) {
        super(name, aspect, "EpochBisharp",
                ...
                List.of("It is very particular about keeping its helmet and belt clean. It is viewed as a symbol of discipline."),
                List.of(new EvolutionEntry("epochkingambit", EvolutionType.LEVEL_UP, List.of(), 
