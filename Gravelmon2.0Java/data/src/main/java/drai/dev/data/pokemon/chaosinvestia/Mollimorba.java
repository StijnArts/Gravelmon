...
import java.util.*;
public class Mollimorba extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mollimorba() {
        super("Mollimorba",
                Type.PSYCHIC,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Beobachtet andere Pokémon und Trainer mit durchdringendem Blick, als könne es etwas erkennen, das keiner sonst sieht."),
                List.of(),
                List.of(
