...
import java.util.*;
public class EpochMienfoo extends drai.dev.data.pokemon.Pokemon {
    public EpochMienfoo(String name, Aspect aspect) {
        super(name, aspect, "EpochMienfoo",
                ...
                List.of("It is made of pure fire. Every one of its attacks follows a unique movement reminiscent of dancing."),
                List.of(new EvolutionEntry("epochmienshao", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"32")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MYSTICAL_FIRE,"egg"),
