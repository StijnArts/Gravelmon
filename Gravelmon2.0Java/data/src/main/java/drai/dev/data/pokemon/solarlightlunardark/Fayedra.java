...
import java.util.*;
public class Fayedra extends drai.dev.data.pokemon.Pokemon {
    public Fayedra() {
        super("Fayedra",
                ...
                List.of("Highly revered in Rikoto for their selflessness and kind-hearted nature, Fayedra will not hesitate to sacrifice itself to save a life, even that of a stranger."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONIC_GLOW,66),
