...
import java.util.*;
public class AyreianAlakazam extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianAlakazam(int dex) {
        super(dex, "Alakazam",
                ...
                new Stats(55,
                        ...
                        100,
                        65),
                List.of(Ability.SNIPER,Ability.INNER_FOCUS), null,
                15, 480,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.THROAT_CHOP,0),
