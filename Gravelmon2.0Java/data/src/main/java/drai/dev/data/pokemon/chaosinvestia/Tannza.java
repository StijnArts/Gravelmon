...
import java.util.*;
public class Tannza extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tannza() {
        super("Tannza",
                Type.BUG,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Es sieht aus wie ein Tannenzapfen. Seine Schale schützt es vor Vogel-Pokémon, die an ihm picken wollen."),
                List.of(),
                List.of(
