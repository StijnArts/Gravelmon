...
import java.util.*;
public class EpochTinkaton extends drai.dev.data.pokemon.Pokemon {
    public EpochTinkaton(String name, Aspect aspect) {
        super(name, aspect, "EpochTinkaton",
                ...
                List.of("It swings around the skeleton of an ancient dragon. Some say the skeleton itself is sentient."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 38, 51, .1, List.of(
