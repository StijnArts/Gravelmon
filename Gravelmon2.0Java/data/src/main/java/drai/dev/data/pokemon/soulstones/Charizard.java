...
import java.util.*;
public class Charizard extends drai.dev.gravelmon.pokemon.Pokemon {
    public Charizard() {
        super("Charizard",
                ...
                List.of("Its skin is very oily. It is unclear what substance hangs off its wings, as any previous attempts to harvest some have angered it greatly."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONFURY,8),
                        new MoveLearnSetEntry(Move.BONEMERANG,40),
                        new MoveLearnSetEntry(Move.WYVERNSLASH,24),
                        new MoveLearnSetEntry(Move.CRUNCH,36),
                        new MoveLearnSetEntry(Move.TRAMPLE,1),
                        new MoveLearnSetEntry(Move.TREMOR,15),
                        new MoveLearnSetEntry(Move.DRACONICCRASH,52),
