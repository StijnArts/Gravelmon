...
import java.util.*;
public class FligianParas extends drai.dev.data.pokemon.Pokemon {
    public FligianParas(String name, Aspect aspect) {
        super(name, aspect, "Paras",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("fligianparasect", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.FLIGA),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 7, 24, 3, List.of(
