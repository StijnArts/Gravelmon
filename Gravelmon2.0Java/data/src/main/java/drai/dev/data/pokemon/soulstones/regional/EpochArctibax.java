...
import java.util.*;
public class EpochArctibax extends drai.dev.data.pokemon.Pokemon {
    public EpochArctibax(String name, Aspect aspect) {
        super(name, aspect, "EpochArctibax",
                ...
                List.of("They are far more bull-headed and plow into prey at high speeds, with sufficient force to break bones and shatter rocks."),
                List.of(new EvolutionEntry("epochbaxcalibur", EvolutionType.LEVEL_UP, List.of(), 
