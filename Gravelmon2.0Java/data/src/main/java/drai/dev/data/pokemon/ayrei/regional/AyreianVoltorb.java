...
import java.util.*;
public class AyreianVoltorb extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianVoltorb(int dex) {
        super(dex, "Voltorb",
                Type.FIRE,Type.ROCK,
                new Stats(50,
                        60,
                        ...
                        70,
                        65),
                List.of(Ability.STEAM_ENGINE), null,
                5, 604,
                ...
                70,
                50, List.of(),
                List.of("Usually found in shrines and caves, it stores heat inside its body to prepare for evolution."),
                List.of(),
                List.of(
