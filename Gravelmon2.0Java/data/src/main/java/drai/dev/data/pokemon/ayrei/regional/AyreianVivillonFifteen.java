...
import java.util.*;
public class AyreianVivillonFifteen extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonFifteen(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonFifteen",
                Type.FAIRY,Type.BUG,
                new Stats(80,
                        52,
                        65,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FLORAL_HEALING,12),
