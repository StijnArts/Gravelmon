...
import java.util.*;
public class Cyanix extends drai.dev.data.pokemon.Pokemon {
    public Cyanix() {
        super("Cyanix",
                ...
                List.of("Its blue flames shed little heat, so people used to catch Cyanix to light their homes. It is a popular nightlight design."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BURN_UP,77),
                        new MoveLearnSetEntry(Move.MEMENTO,84),
                        new MoveLearnSetEntry(Move.HEALING_WISH,84),
