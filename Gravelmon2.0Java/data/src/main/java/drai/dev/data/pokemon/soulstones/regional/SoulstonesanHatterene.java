...
import java.util.*;
public class SoulstonesanHatterene extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanHatterene(int dex) {
        super(dex, "Hatterene",
                ...
                List.of("This Pokemon's knowledge of the arcane arts dips into forbidden magic. It was cast out from society for practicing the dark arts."),
                List.of(),
                List.of(
