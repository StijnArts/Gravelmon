...
import java.util.*;
public class Whiskitty extends drai.dev.data.pokemon.Pokemon {
    public Whiskitty() {
        super("Whiskitty",
                Type.STEEL,
                new Stats(40,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("gourmeow", EvolutionType.LEVEL_UP, List.of(),
