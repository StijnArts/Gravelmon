...
public class OrohnHavai extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        ...
        addNewPokemon(new Troopant());
        addNewPokemon(new Antzooka());
...
//        addNewPokemon(new AvorianChemecko(chemecko.getPokedexNumber()));
        ...
        addNewPokemon(new Glimpid());
        addNewPokemon(new Cryosect());
        ...
        addNewPokemon(new Konchore());
        addNewPokemon(new Neptide());
        addNewPokemon(new Seavereign(new Stats(545, StatArchetype.PHYSICAL_ATTACKER, List.of(StatType.SPEED, StatType.ATTACK, StatType.HP))));
        addNewPokemon(new Lemomi());
        addNewPokemon(new Shelmissy());
        addNewPokemon(new Empressea(new Stats(545, StatArchetype.SPECIAL_ATTACKER, List.of(StatType.SPEED, StatType.SPECIAL_ATTACK, StatType.HP))));
        addNewPokemon(new Sharfin());
        addNewPokemon(new Thrashark());
//        addNewPokemon(new HavaiianSwinub("", Aspect.HAVAIIAN)); Missing Art
//        addNewPokemon(new HavaiianPiloswine("", Aspect.HAVAIIAN)); Missing Art
//        addNewPokemon(new HavaiianMamoswine("", Aspect.HAVAIIAN)); Missing Art
        addNewPokemon(new Voidefish());
        addNewPokemon(new Voidevour());
        addNewPokemon(new Gargobble());
        addNewPokemon(new Garglizer());
...
//        addNewPokemon(new Eskiflurr()); Missing art
        ...
        addNewPokemon(new Chainect());
        addNewPokemon(new Chainector());
        addNewPokemon(new Tundrill());
        addNewPokemon(new Malakele());
        addNewPokemon(new Kahukele());
...
//        addNewPokemon(new Polighoul()); Missing art
        ...
        addNewPokemon(new Vexigon().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Noxareo().addLabels(Label.PSEUDO_LEGENDARY));
        addNewPokemon(new Darcastro().addLabels(Label.PSEUDO_LEGENDARY));
...
//        addNewPokemon(new Indureion().addLabels(Label.SUB_LEGENDARY)); Missing art
        ...
        addNewPokemon(new Intelix().addLabels(Label.SUB_LEGENDARY));
