...
public class FligianWeepinbell extends drai.dev.data.pokemon.Pokemon {
    public FligianWeepinbell(String name, Aspect aspect) {
        super(name, aspect, "Paras",
                ...
                List.of(""),
                List.of(new EvolutionEntry("victreebel fligian", EvolutionType.ITEM_INTERACT, false, List.of(),
