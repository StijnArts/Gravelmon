...
import java.util.*;
public class Schwalboss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Schwalboss() {
        super("Schwalboss",
                ...
                70,
                50, List.of(),
                List.of("Es fliegt auf der Suche nach Beute ständig umher. Findet es Beute, stürzt es sich im Sturzflug auf sie."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.AIR_SLASH,61),
