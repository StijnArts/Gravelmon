...
import java.util.*;
public class Ohrdoch extends drai.dev.gravelmon.pokemon.Pokemon {
    public Ohrdoch() {
        super("Ohrdoch",
                Type.NORMAL,
                new Stats(103,
                ...
                70,
                50, List.of(),
                List.of("Hat ein außerordentlich feines Gehör. Es tastet seine Umgebung auf jedes noch so leise Geräusch ab wie ein Radar."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ENTRAINMENT,25),
                        ...
                        new MoveLearnSetEntry(Move.SECRET_POWER,20),
