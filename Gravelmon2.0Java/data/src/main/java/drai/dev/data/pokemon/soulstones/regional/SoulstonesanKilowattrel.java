...
import java.util.*;
public class SoulstonesanKilowattrel extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanKilowattrel(int dex) {
        super(dex, "Kilowattrel",
                Type.ICE,Type.ROCK,
                new Stats(70,
                        105,
                        60,
                ...
                0.5,
                172, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD,EggGroup.FLYING),
                List.of("It is an endangered Pokemon but it has found refuge by nesting atop tall mountains in cold climates to discourage intruders from attacking its young."),
                List.of(),
                List.of(
