...
import java.util.*;
public class SoulstonesanJynx extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanJynx(int dex) {
        super(dex, "Jynx",
                Type.SOUND,Type.ICE,
                new Stats(85,
                        35,
                ...
                0.0,
                159, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("Its voice is able to reach very high notes effortlessly. However, it has learned to be conscious of when and where it sings this way, for fear of causing avalanches."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HYPOTHERMIA,24),
                        new MoveLearnSetEntry(Move.RALLENTANDO,1),
                        ...
                        new MoveLearnSetEntry(Move.PHILHARMONIC,1),
