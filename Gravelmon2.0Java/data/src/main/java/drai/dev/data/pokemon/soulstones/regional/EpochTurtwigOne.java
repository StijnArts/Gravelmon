...
import java.util.*;
public class EpochTurtwigOne extends drai.dev.data.pokemon.Pokemon {
    public EpochTurtwigOne(String name, Aspect aspect) {
        super(name, aspect, "EpochTurtwigOne",
                ...
                List.of("The clouds that cover its mouth and shell are actually hollow, meaning they can absorb rain very well."),
                List.of(new EvolutionEntry("epochtwogrotle", EvolutionType.LEVEL_UP, List.of(), 
