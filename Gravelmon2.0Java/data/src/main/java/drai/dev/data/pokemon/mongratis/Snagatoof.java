...
import java.util.*;
public class Snagatoof extends drai.dev.data.pokemon.Pokemon {
    public Snagatoof() {
        super("Snagatoof",
                Type.DRAGON,
                new Stats(0,
                ...
                List.of(new EvolutionEntry("Snagajin", EvolutionType.ITEM_INTERACT, false, List.of(),
