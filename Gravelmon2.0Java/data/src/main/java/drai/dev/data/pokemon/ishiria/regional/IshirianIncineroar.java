...
import java.util.*;
public class IshirianIncineroar extends drai.dev.data.pokemon.Pokemon {
    public IshirianIncineroar(String name, Aspect aspect) {
        super(name, aspect, "IshirianIncineroar",
                ...
                List.of("It uses its ability to sneak in the shadows and illusion to lure the looters out of the desert's ruin. It is rumored that once one is spotted by a Incineroar, escape is impossible."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MAGICBACKLASH,60),
