...
import java.util.*;
public class AyreianMarowak extends drai.dev.data.pokemon.Pokemon {
    public AyreianMarowak(String name, Aspect aspect) {
        super(name, aspect, "AyreianMarowak",
                ...
                List.of("This Pokémon overcame its sorrow to evolve a sturdy new body. Marowak faces its opponents bravely, using a bone as a weapon."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.STOMPING_TANTRUM,24),
                        new MoveLearnSetEntry(Move.SPIKES,36),
                        new MoveLearnSetEntry(Move.TAIL_WHIP,1),
                        new MoveLearnSetEntry(Move.BONEMERANG,42),
