...
import java.util.*;
public class SoulstonesanGardevoir extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanGardevoir(int dex) {
        super(dex, "Gardevoir",
