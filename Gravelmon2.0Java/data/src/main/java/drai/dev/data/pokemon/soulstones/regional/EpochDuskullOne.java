...
import java.util.*;
public class EpochDuskullOne extends drai.dev.data.pokemon.Pokemon {
    public EpochDuskullOne(String name, Aspect aspect) {
        super(name, aspect, "EpochDuskullOne",
                ...
                List.of("It is the restless spirit of a Pokemon that passed away while on board a ship that sank into the sea."),
                List.of(new EvolutionEntry("epochtwodusclops", EvolutionType.LEVEL_UP, List.of(), 
