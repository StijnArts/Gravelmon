...
import java.util.*;
public class Hippoterus extends drai.dev.gravelmon.pokemon.Pokemon {
    public Hippoterus() {
        super("Hippoterus",
                Type.GROUND,
                new Stats(108,
                ...
                70,
                50, List.of(),
                List.of("Es wird überraschend schnell wütend. Als Zeichen seiner Stärke sperrt es sein Maul auf."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SAND_TOMB,25),
