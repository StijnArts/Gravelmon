...
import java.util.*;
public class AvalossianQwilfish extends drai.dev.data.pokemon.Pokemon {
    public AvalossianQwilfish(String name, Aspect aspect) {
        super(name, aspect, "Qwilfish",
                ...
                List.of("Qwilfish suck in water to shoot out toxic quills when feeling threatened, though unfortunately their body shape that enables this is cumbersome for swimming. Avalossian Qwilfish have a different lip color than typical breeds."),
