...
import java.util.*;
public class Knightile extends drai.dev.data.pokemon.Pokemon {
    public Knightile() {
        super("Knightile",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("geckombat", EvolutionType.LEVEL_UP, List.of(),
