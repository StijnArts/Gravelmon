...
public class Flairees  extends Pokemon {
    public Flairees() {
        super("Flairees",
                Type.FIRE, Type.ROCK,
                new Stats(80, 120, 75, 90, 80, 90),
                ...
                List.of("The fire on Flairees' body propels it with enough force to break steel. It forms its territory by smashing apart and leveling mountaintops."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BLAZE_KICK,38),
                        new MoveLearnSetEntry(Move.BATTERING_RAM,43),
                        new MoveLearnSetEntry(Move.ROCK_CLIMB,48),
                        new MoveLearnSetEntry(Move.SWAGGER,53),
                        new MoveLearnSetEntry(Move.EARTH_POWER,58),
                        new MoveLearnSetEntry(Move.STANDOFF,63),
