...
import java.util.*;
public class Blitza extends drai.dev.gravelmon.pokemon.Pokemon {
    public Blitza() {
        super("Blitza",
                Type.ELECTRIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Bringt man es aus der Ruhe, verwendet es Elektrizität, um kleine Knäuel seines Fells abzufeuern."),
                List.of(),
                List.of(
