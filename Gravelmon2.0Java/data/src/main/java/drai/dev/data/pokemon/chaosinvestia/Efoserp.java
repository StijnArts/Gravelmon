...
import java.util.*;
public class Efoserp extends drai.dev.gravelmon.pokemon.Pokemon {
    public Efoserp() {
        super("Efoserp",
                Type.GRASS,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Huscht beinahe gleitend über den Boden und täuscht Gegner mit agilen Manövern, bis es mithilfe seiner Efeurute obsiegt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GASTRO_ACID,48),
