...
import java.util.*;
public class AyreianCamerupt extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianCamerupt(int dex) {
        super(dex, "Camerupt",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MUDDY_WATER,0),
