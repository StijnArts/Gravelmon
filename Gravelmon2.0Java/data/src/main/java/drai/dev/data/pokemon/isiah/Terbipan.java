...
import java.util.*;
public class Terbipan extends drai.dev.data.pokemon.Pokemon {
    public Terbipan() {
        super("Terbipan",
                ...
                new Stats(75,
                        ...
                        72,
                        80),
                List.of(Ability.TANGLED_FEET,Ability.PINWHEEL), Ability.SECONDWIND,
                0, 0,
                ...
                List.of("A single Terbipan can create winds of enough force able to power a windmill for a whole day. They are used to help power rural towns with no other access to sources of energy."),
                List.of(),
                List.of(
