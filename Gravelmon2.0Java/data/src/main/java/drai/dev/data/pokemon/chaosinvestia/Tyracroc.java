...
import java.util.*;
public class Tyracroc extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tyracroc() {
        super("Tyracroc",
                Type.WATER,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Hat es einmal zugebissen, lässt es erst los, wenn es seine Zähne verliert, die schnell nachwachsen."),
                List.of(),
                List.of(
