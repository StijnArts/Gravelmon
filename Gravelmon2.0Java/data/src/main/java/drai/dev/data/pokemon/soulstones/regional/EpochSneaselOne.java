...
import java.util.*;
public class EpochSneaselOne extends drai.dev.data.pokemon.Pokemon {
    public EpochSneaselOne(String name, Aspect aspect) {
        super(name, aspect, "EpochSneaselOne",
                ...
                new Stats(70,
                        ...
                        75,
                        65),
                List.of(Ability.BLACKLIGHT,Ability.WHITEOUT), Ability.ARSONIST,
                9, 280,
                ...
                List.of("Its life choices determine their evolution; mischievous, mean-spirited evolve into T.Sneasler, while pure-hearted ones evolve into T.Weavile."),
                List.of(new EvolutionEntry("epochtwosneasler", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "cobblemon:moon_stone"),
new EvolutionEntry("epochtwoweavile", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "cobblemon:sun_stone")),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HOLYBOLT,"egg"),
                        ...
                        new MoveLearnSetEntry(Move.RAPTURE,"egg"),
                        new MoveLearnSetEntry(Move.UMBRALWAVE,"egg")),
