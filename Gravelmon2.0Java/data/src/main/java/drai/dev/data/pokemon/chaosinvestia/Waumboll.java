...
import java.util.*;
public class Waumboll extends drai.dev.gravelmon.pokemon.Pokemon {
    public Waumboll() {
        super("Waumboll",
                ...
                70,
                50, List.of(),
                List.of("Lässt sich vom unbekümmert vom Wind treiben. Regen beschwert seinen Körper, sodass es unter großen Bäumen Schutz sucht."),
                List.of(),
                List.of(
