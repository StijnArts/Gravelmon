...
import java.util.*;
public class SoulstonesanScyther extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanScyther(int dex) {
        super(dex, "Scyther",
