...
import java.util.*;
public class EpochKirliaOne extends drai.dev.data.pokemon.Pokemon {
    public EpochKirliaOne(String name, Aspect aspect) {
        super(name, aspect, "EpochKirliaOne",
                ...
                List.of("It can entrance enemies using its flute or its psychic prowess, being able to lull Pokemon to sleep or disable them."),
                List.of(new EvolutionEntry("epochtwogardevoir", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "gravelmon:air_stone"),
new EvolutionEntry("epochtwogallade", EvolutionType.ITEM_INTERACT, false, List.of(), 
