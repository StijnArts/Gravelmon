...
import java.util.*;
public class Tangoloss extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tangoloss() {
        super("Tangoloss",
                Type.GRASS,
                new Stats(100,
                ...
                70,
                50, List.of(),
                List.of("Seine Arme bestehen aus Ranken, die sich an Dinge klammern und nach dem Abschneiden sofort nachwachsen."),
                List.of(),
                List.of(
