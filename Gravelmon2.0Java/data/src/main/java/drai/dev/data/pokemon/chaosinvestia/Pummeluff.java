...
import java.util.*;
public class Pummeluff extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pummeluff() {
        super("Pummeluff",
                ...
                70,
                50, List.of(),
                List.of("Sobald es mit seinen großen, runden Augen rollt, fängt es an, ein Lied zu singen und jeder schläft ein."),
                List.of(),
                List.of(
