...
import java.util.*;
public class Paragoni extends drai.dev.gravelmon.pokemon.Pokemon {
    public Paragoni() {
        super("Paragoni",
                ...
                70,
                50, List.of(),
                List.of("Bei diesen Pokémon soll es sich um die Seelen von Kindern handeln, die sich im Wald verliefen und ums Leben kamen und nun in Baumstümpfen hausen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HORN_LEECH,54),
