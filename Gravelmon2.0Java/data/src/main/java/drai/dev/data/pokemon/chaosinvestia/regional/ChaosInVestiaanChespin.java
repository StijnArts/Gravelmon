...
import java.util.*;
public class ChaosInVestiaanChespin extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanChespin(String name, Aspect aspect) {
        super(name, aspect, "Chespin",
