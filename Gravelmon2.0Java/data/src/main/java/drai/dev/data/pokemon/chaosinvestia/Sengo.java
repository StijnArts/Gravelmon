...
import java.util.*;
public class Sengo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sengo() {
        super("Sengo",
                Type.NORMAL,
                new Stats(73,
                ...
                70,
                50, List.of(),
                List.of("Seit Generationen ist es mit Vipitis verfeindet. Seine scharfen Klauen sind seine stärksten Waffen."),
                List.of(),
                List.of(
