...
import java.util.*;
public class Chelast extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chelast() {
        super("Chelast",
                Type.GRASS,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Der Panzer auf seinem Rücken besteht aus Erdreich. Bei gesunden Chelast ist der Panzer feucht."),
                List.of(),
                List.of(
