...
import java.util.*;
public class EpochGarganaclOne extends drai.dev.data.pokemon.Pokemon {
    public EpochGarganaclOne(String name, Aspect aspect) {
        super(name, aspect, "EpochGarganaclOne",
                ...
                List.of("They were instrumental in the creation of some of the most well-known weapons throughout history. They are able to  wield them effortlessly."),
                List.of(),
                List.of(
