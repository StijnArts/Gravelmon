...
import java.util.*;
public class Kapuno extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kapuno() {
        super("Kapuno",
                ...
                70,
                50, List.of(),
                List.of("Da es nichts sehen kann, sucht es seine Umgebung mit Rempel- und Bissattacken ab und ist immer mit Wunden übersät."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SCARY_FACE,52),
