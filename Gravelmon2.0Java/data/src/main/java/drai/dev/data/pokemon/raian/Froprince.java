...
import java.util.*;
public class Froprince extends drai.dev.data.pokemon.Pokemon {
    public Froprince(Stats stats) {
        super("Froprince",
                ...
                List.of(Label.RAIAN),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 39, 57, .3, List.of(
