...
import java.util.*;
public class AyreianJigglypuff extends drai.dev.data.pokemon.Pokemon {
    public AyreianJigglypuff(String name, Aspect aspect) {
        super(name, aspect, "Jigglypuff",
                ...
                List.of("Jigglypuff has top-notch lung capacity, even by comparison to other Pokémon. It won't stop singing its lullabies until its foes fall asleep."),
                List.of(),
                List.of(
