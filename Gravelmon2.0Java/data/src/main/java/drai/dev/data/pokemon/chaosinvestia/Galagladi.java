...
import java.util.*;
public class Galagladi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Galagladi() {
        super("Galagladi",
                ...
                70,
                50, List.of(),
                List.of("Will es beschützen, streckt es seine Ellbogen zu etwas Schwertähnlichem und kämpft auf wilde Art."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HELPING_HAND,39),
                        new MoveLearnSetEntry(Move.SLASH,22),
                        new MoveLearnSetEntry(Move.FEINT,45),
