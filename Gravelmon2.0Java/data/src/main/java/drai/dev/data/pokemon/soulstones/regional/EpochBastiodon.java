...
import java.util.*;
public class EpochBastiodon extends drai.dev.data.pokemon.Pokemon {
    public EpochBastiodon(String name, Aspect aspect) {
        super(name, aspect,"EpochBastiodon",
                Type.ICE,Type.STEEL,
                new Stats(60,
                        72,
                        168,
                ...
                13, 1495,
                new Stats(60,72,2,30,27,138), 90,
                0.875,
                173, ExperienceGroup.ERRATIC,
                70,
                50, List.of(EggGroup.MONSTER),
                List.of("Despite its unfortunate typing, the crystal wall on its head is able to be used to break almost any other naturally formed surface."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHIELD_BASH,51),
                        new MoveLearnSetEntry(Move.WINTERSHOWL,50),
