...
import java.util.*;
public class Fluffeluff extends drai.dev.gravelmon.pokemon.Pokemon {
    public Fluffeluff() {
        super("Fluffeluff",
                ...
                70,
                50, List.of(),
                List.of("Es hat einen weichen, elastischen Körper. Hat es einmal angefangen zu hüpfen, ist es nicht zu stoppen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.POUND,9),
                        new MoveLearnSetEntry(Move.COPYCAT,17),
