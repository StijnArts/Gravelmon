...
import java.util.*;
public class Tikitik extends drai.dev.data.pokemon.Pokemon {
    public Tikitik() {
        super("Ikitik",
                ...
                List.of("A traditional ritual among Tikitik is to set up a bonfire, then dance around it as a group. It is yet unknown what purpose the ritual serves."),
                List.of(new EvolutionEntry("tikitoko", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"42")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TIKI_TORCH,35),
                        new MoveLearnSetEntry(Move.WIDE_GUARD,59),
