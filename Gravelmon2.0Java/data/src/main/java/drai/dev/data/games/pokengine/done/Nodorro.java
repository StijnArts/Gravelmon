...
public class Nodorro extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        ...
        addNewPokemon(new Hackile());
        addNewPokemon(new Axfeller(new Stats(523, StatArchetype.PHYSICAL_ATTACKER,
                List.of(StatType.ATTACK, StatType.SPEED))));
        addNewPokemon(new Webling());
        addNewPokemon(new Silkrawl());
        addNewPokemon(new Arachnoir());
        addNewPokemon(new Arachneve());
