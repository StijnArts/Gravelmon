...
public class Chimaconda extends Pokemon {
    public Chimaconda() {
        super("Chimaconda",
                ...
                List.of("Normally passive unless provoked, Chimaconda inject their prey with a paralytic venom and then wrap it in their tails, squeezing the life out."),
                List.of(),
                List.of(
