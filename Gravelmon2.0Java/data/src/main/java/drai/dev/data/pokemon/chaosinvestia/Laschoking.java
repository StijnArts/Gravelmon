...
import java.util.*;
public class Laschoking extends drai.dev.gravelmon.pokemon.Pokemon {
    public Laschoking() {
        super("Laschoking",
                ...
                70,
                50, List.of(),
                List.of("Wird es von Muschas gebissen, wird es so intelligent, dass es sich mit Nobelpreisträgern messen kann."),
                List.of(),
                List.of(
