...
import java.util.*;
public class Golbit extends drai.dev.gravelmon.pokemon.Pokemon {
    public Golbit() {
        super("Golbit",
                ...
                70,
                50, List.of(),
                List.of("Man nimmt an, dass es ein Produkt der verblüffenden wissenschaftlichen Künste einer uralten Zivilisation sei."),
                List.of(),
                List.of(
