...
import java.util.*;
public class IshirianChikorita extends drai.dev.data.pokemon.Pokemon {
    public IshirianChikorita(String name, Aspect aspect) {
        super(name, aspect, "IshirianChikorita",
                Type.STEEL,
                new Stats(60,
                        49,
                        70,
                ...
                List.of(new EvolutionEntry("ishirianbayleef", EvolutionType.LEVEL_UP, List.of(),
