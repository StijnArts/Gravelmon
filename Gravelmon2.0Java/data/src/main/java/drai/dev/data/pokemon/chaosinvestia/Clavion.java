...
import java.util.*;
public class Clavion extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clavion() {
        super("Clavion",
                ...
                new Stats(57,
                        ...
                        80,
                        87),
                List.of(Ability.PRANKSTER,Ability.MAGICIAN), null,
                2, 30,
                ...
                70,
                50, List.of(),
                List.of("Da es Schlüssel, die ihm gefallen, wie seinen Augapfel hütet, vertrauen Menschen ihm die Schlüssel ihrer Tresore an, um Diebstahl vorzubeugen."),
                List.of(),
                List.of(
