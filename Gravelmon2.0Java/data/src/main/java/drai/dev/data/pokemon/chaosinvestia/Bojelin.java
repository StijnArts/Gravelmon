...
import java.util.*;
public class Bojelin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bojelin() {
        super("Bojelin",
                Type.WATER,
                new Stats(85,
                ...
                70,
                50, List.of(),
                List.of("Man findet es oft in der Nähe von Häfen. Rettet dort Menschen, schleppt aber auch Beute hinfort."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DOUBLE_HIT,29),
                        new MoveLearnSetEntry(Move.WATER_GUN,15),
                        new MoveLearnSetEntry(Move.CRUNCH,1),
                        new MoveLearnSetEntry(Move.WHIRLPOOL,35),
                        new MoveLearnSetEntry(Move.PURSUIT,18),
                        new MoveLearnSetEntry(Move.RAZOR_WIND,41),
