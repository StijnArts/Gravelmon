...
import java.util.*;
public class SoulstonesanWeavile extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanWeavile(int dex) {
        super(dex, "Weavile",
                ...
                List.of("Scientists are able to evaluate the age of a subject Weavile simply by assessing the length of its branches."),
                List.of(),
                List.of(
