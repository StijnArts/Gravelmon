...
import java.util.*;
public class Elfun extends drai.dev.gravelmon.pokemon.Pokemon {
    public Elfun() {
        super("Elfun",
                ...
                70,
                50, List.of(),
                List.of("Es kommt auf Sturmböen geritten und dringt durch kleine Spalten in Häuser ein, um dort Schabernack zu treiben."),
                List.of(),
                List.of(
