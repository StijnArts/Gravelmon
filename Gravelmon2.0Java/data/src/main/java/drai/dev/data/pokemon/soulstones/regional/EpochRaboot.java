...
import java.util.*;
public class EpochRaboot extends drai.dev.data.pokemon.Pokemon {
    public EpochRaboot(String name, Aspect aspect) {
        super(name, aspect, "EpochRaboot",
                ...
                List.of("Their psychic ability has grown stronger since their previous evolution, allowing them to float the bells in the air while juggling them."),
                List.of(new EvolutionEntry("epochcinderace", EvolutionType.LEVEL_UP, List.of(), 
