...
import java.util.*;
public class Chubboink extends drai.dev.data.pokemon.Pokemon {
    public Chubboink() {
        super("Chubboink",
                Type.NORMAL,
                new Stats(80,
                        ...
                        21,
                        51),
                List.of(Ability.LIMBER,Ability.THICK_FAT), Ability.RATTLED,
                4, 86,
                ...
                List.of("It covers itself with a layer of mud to protect its skin. Often prefers hiding in tall grass to avoid danger."),
                List.of(new EvolutionEntry("muchog", EvolutionType.LEVEL_UP, List.of(),
