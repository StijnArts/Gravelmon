...
import java.util.*;
public class TGolem extends drai.dev.gravelmon.pokemon.Pokemon {
    public TGolem() {
        super("TGolem",
                ...
                List.of("Touching this Pokemon will send a chill through your bones because it is a way for it to gradually siphon your life essence without you noticing."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ICETOMB,24),
                        ...
                        new MoveLearnSetEntry(Move.MINDDRAIN,44),
