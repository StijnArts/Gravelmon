...
import java.util.*;
public class EpochTreeckoOne extends drai.dev.data.pokemon.Pokemon {
    public EpochTreeckoOne(String name, Aspect aspect) {
        super(name, aspect, "EpochTreeckoOne",
                ...
                List.of("It was entrusted with a gear, though it's not clear what power this gear holds. It is found in areas of historical significance or otherworldly places."),
                List.of(new EvolutionEntry("epochtwogrovyle", EvolutionType.LEVEL_UP, List.of(), 
