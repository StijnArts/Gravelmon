...
public class Hagoop extends Pokemon {
    public Hagoop() {
        super("Hagoop",
                ...
                List.of("Its body exudes a sticky slime that protects its soft flesh. It traps prey in the slime and delivers a lightning shock through its whiskers."),
                List.of(new EvolutionEntry("haagross", EvolutionType.LEVEL_UP, List.of(),
