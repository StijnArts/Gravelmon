...
import java.util.*;
public class Lahmus extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lahmus() {
        super("Lahmus",
                ...
                new Stats(95,
                        ...
                        100,
                        80),
                List.of(Ability.OBLIVIOUS,Ability.OWN_TEMPO), null,
                16, 785,
                ...
                70,
                50, List.of(),
                List.of("Ein begriffsstutziges Pokémon. Beißt das Muschas am Schweif zu, scheint es Intelligenz zu gewinnen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WITHDRAW,37),
