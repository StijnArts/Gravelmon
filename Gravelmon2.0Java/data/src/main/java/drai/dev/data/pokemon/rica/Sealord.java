...
public class Sealord extends drai.dev.data.pokemon.Pokemon {
    public Sealord() {
        super("Sealord",
                ...
                List.of("Sealord fiercely guard the beaches where Merjestic go to give birth. They attack anyone who approaches the pups."),
                List.of(),
                List.of(
