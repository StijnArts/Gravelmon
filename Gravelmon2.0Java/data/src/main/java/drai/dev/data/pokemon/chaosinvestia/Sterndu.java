...
import java.util.*;
public class Sterndu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sterndu() {
        super("Sterndu",
                Type.WATER,
                new Stats(30,
                        ...
                        70,
                        55),
                List.of(Ability.ILLUMINATE,Ability.NATURAL_CURE), null,
                8, 345,
                ...
                70,
                50, List.of(),
                List.of("In der Körpermitte befindet sich ein roter Kern, der mysteriöse Radiowellen in die Nacht sendet."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RECOVER,12),
