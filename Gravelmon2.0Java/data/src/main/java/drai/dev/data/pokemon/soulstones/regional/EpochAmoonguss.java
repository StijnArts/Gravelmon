...
import java.util.*;
public class EpochAmoonguss extends drai.dev.data.pokemon.Pokemon {
    public EpochAmoonguss(String name, Aspect aspect) {
        super(name, aspect, "EpochAmoonguss",
                ...
                List.of("It is quick to anger and will blast out heat and sulfur. The other vents are smaller Foongus that have grown but not yet evolved."),
                List.of(),
                List.of(
