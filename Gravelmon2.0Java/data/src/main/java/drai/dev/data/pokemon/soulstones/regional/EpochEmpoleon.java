...
import java.util.*;
public class EpochEmpoleon extends drai.dev.data.pokemon.Pokemon {
    public EpochEmpoleon(String name, Aspect aspect) {
        super(name, aspect,"EpochEmpoleon",
                Type.WATER,Type.ICE,
                new Stats(84,
                        111,
                        88,
                ...
                17, 845,
                new Stats(84,111,88,3,86,101), 90,
                0.875,
                239, ExperienceGroup.MEDIUM_SLOW,
                70,
                50, List.of(EggGroup.WATER_1,EggGroup.FIELD),
                List.of("It is the leader of a small colony of Piplup and Prinplup. Each colony usually only has one male Empoleon as the king and one female as the queen."),
                List.of(),
                List.of(
