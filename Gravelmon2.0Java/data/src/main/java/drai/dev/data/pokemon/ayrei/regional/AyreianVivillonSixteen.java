...
import java.util.*;
public class AyreianVivillonSixteen extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonSixteen(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonSixteen",
