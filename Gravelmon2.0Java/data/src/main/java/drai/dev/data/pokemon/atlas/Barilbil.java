...
public class Barilbil extends drai.dev.data.pokemon.Pokemon {
    public Barilbil() {
        super("Barilbil",
                Type.NORMAL,
                new Stats(63,
                ...
                List.of(new EvolutionEntry("haibril", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.ATLAS),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 3, 22, 6.6, List.of(
