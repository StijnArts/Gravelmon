...
import java.util.*;
public class Luxtra extends drai.dev.gravelmon.pokemon.Pokemon {
    public Luxtra() {
        super("Luxtra",
                Type.ELECTRIC,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("Es kann durch Wände sehen und spürt auf diese Weise Beute und verlorengegangene Junge auf."),
                List.of(),
                List.of(
