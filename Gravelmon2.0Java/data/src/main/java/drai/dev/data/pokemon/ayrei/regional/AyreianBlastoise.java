...
import java.util.*;
public class AyreianBlastoise extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianBlastoise(int dex) {
        super(dex, "Blastoise",
                ...
                new Stats(79,
                        ...
                        75,
                        80),
                List.of(Ability.BULLETPROOF,Ability.SHELL_ARMOR), null,
                17, 1855,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SUCKER_PUNCH,63),
                        new MoveLearnSetEntry(Move.CLOSE_COMBAT,70),
                        new MoveLearnSetEntry(Move.FORCE_PALM,16),
                        new MoveLearnSetEntry(Move.TAIL_WHIP,1),
                        new MoveLearnSetEntry(Move.SOVEREIGNEDGE,0),
                        new MoveLearnSetEntry(Move.METAL_CLAW,1),
                        new MoveLearnSetEntry(Move.POWER_TRIP,42),
