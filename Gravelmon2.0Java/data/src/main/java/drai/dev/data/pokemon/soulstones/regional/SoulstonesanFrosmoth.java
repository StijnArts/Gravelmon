...
import java.util.*;
public class SoulstonesanFrosmoth extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanFrosmoth(int dex) {
        super(dex, "Frosmoth",
                ...
                List.of("There is a fairytale about an old claymaker that fashioned this Frosmoth, and it was brought to life because of a wish he made during a shooting star."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MINERALWAVE,24),
                        new MoveLearnSetEntry(Move.GEMSTORM,56),
                        new MoveLearnSetEntry(Move.MUD_SHOT,9),
                        new MoveLearnSetEntry(Move.DIAMONDSHARD,4),
