...
public class EghoCyndaquil extends Pokemon {
    public EghoCyndaquil(String name, Aspect aspect) {
        super(name, aspect,"EghoCyndaquil",
                Type.FIRE, Type.ELECTRIC,
                new Stats(50, 40, 52, 65, 42, 60),
                ...
                List.of("Cyndaquil is always producing a small cloud of volcanic ash, which is electrically charged. It can be tough to handle for new trainers."),
                List.of(new EvolutionEntry("eghoquilava", EvolutionType.LEVEL_UP, List.of(),
