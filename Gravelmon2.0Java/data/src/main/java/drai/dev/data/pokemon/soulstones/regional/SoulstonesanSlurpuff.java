...
import java.util.*;
public class SoulstonesanSlurpuff extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSlurpuff(int dex) {
        super(dex, "Slurpuff",
                ...
                List.of("It is said that the feathers from its wings grant wishes, so they are highly sought after Pokemon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FANTASYSEAL,1),
