...
import java.util.*;
public class Scoppel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Scoppel() {
        super("Scoppel",
                Type.NORMAL,
                new Stats(38,
                ...
                70,
                50, List.of(),
                List.of("Es besitzt schaufelähnliche Ohren, die durch ständiges Graben so kräftig werden, dass sie auch dicke Wurzeln durchtrennen können."),
                List.of(),
                List.of(
