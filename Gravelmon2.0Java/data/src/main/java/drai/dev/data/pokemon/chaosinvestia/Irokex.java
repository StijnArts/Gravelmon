...
import java.util.*;
public class Irokex extends drai.dev.gravelmon.pokemon.Pokemon {
    public Irokex() {
        super("Irokex",
                ...
                new Stats(65,
                        ...
                        45,
                        115),
                List.of(Ability.SHED_SKIN,Ability.MOXIE), null,
                11, 300,
                ...
                70,
                50, List.of(),
                List.of("Wählt seinen Anführer über die Größe des Kamms auf dem Kopf. Ein Tritt von ihm reicht, um Betonblöcke zu zertrümmern."),
                List.of(),
                List.of(
