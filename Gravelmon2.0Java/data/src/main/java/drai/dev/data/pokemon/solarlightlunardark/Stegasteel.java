...
import java.util.*;
public class Stegasteel extends drai.dev.data.pokemon.Pokemon {
    public Stegasteel() {
        super("Stegasteel",
                ...
                List.of("The plates on Stegasteel fossils, still preserving their charges, have been used as batteries on mountain areas where power supply isn't easy to come by."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HYPER_BEAM,59),
