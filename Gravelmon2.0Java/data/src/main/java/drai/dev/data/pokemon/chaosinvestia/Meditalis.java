...
import java.util.*;
public class Meditalis extends drai.dev.gravelmon.pokemon.Pokemon {
    public Meditalis() {
        super("Meditalis",
                ...
                70,
                50, List.of(),
                List.of("Es kann die Aura seines Gegners erkennen, indem es durch Hungern seinen Geist schärft."),
                List.of(),
                List.of(
