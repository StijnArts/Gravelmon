...
import java.util.*;
public class Polarpow extends drai.dev.data.pokemon.Pokemon {
    public Polarpow() {
        super("Polarpow",
                ...
                new Stats(90,
                        ...
                        70,
                        75),
                List.of(Ability.THERMAL_EXCHANGE), Ability.SNOW_WARNING,
                27, 2190,
                ...
                List.of("Despite living in completely different climates, Polarpow exhibit extreme aggression when fighting Magrizzly. This phenomenon is still being studied."),
                List.of(),
                List.of(
