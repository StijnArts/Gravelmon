...
import java.util.*;
public class Alpollo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Alpollo() {
        super("Alpollo",
                ...
                70,
                50, List.of(),
                List.of("Lauert in der Dunkelheit. Die Berührung seiner gasförmigen Hand erzeugt endloses Schaudern."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.NIGHTMARE,61),
