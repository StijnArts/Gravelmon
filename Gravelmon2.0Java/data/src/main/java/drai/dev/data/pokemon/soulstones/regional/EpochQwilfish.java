...
import java.util.*;
public class EpochQwilfish extends drai.dev.data.pokemon.Pokemon {
    public EpochQwilfish(String name, Aspect aspect) {
        super(name, aspect, "EpochQwilfish",
                ...
                List.of("It often roots itself down near desert oases so that it can catch unsuspecting people in search of relief."),
                List.of(new EvolutionEntry("epochoverqwil", EvolutionType.LEVEL_UP, List.of(), 
