...
public class RapidashStorm extends Pokemon {
    public RapidashStorm(String name, Aspect aspect) {
        super(name, aspect,"RapidashX",
                ...
                SpawnContext.GROUNDED, SpawnPool.RARE, 40, 56, 0, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_VOID))
                ), List.of(),
        ...
        getPosingFileData().setAnimationFileName("rapidash_x_storm");
