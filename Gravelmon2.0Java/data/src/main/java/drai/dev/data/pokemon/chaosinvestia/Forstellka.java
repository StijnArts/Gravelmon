...
import java.util.*;
public class Forstellka extends drai.dev.gravelmon.pokemon.Pokemon {
    public Forstellka() {
        super("Forstellka",
                Type.BUG,Type.STEEL,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Dieses Pokémon ist von einer Stahlhülle umgeben. Seine stechenden Augen sind alles, was man von ihm sieht."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MAGNET_RISE,60),
                        new MoveLearnSetEntry(Move.EXPLOSION,42),
                        new MoveLearnSetEntry(Move.MIRROR_SHOT,31),
