...
import java.util.*;
public class Stollunior extends drai.dev.gravelmon.pokemon.Pokemon {
    public Stollunior() {
        super("Stollunior",
                ...
                70,
                50, List.of(),
                List.of("Normalerweise lebt es in dunklen Bergen. Ist es hungrig, frisst es auch Eisenbahnschienen und Autos."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.IRON_TAIL,36),
