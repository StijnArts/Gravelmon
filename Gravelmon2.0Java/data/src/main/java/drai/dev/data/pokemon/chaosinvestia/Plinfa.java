...
import java.util.*;
public class Plinfa extends drai.dev.gravelmon.pokemon.Pokemon {
    public Plinfa() {
        super("Plinfa",
                Type.WATER,
                new Stats(53,
                ...
                70,
                50, List.of(),
                List.of("Es fällt leider oft hin. Allerdings ist es sehr stolz und so rappelt es sich immer wieder ohne Sorge auf."),
                List.of(),
                List.of(
