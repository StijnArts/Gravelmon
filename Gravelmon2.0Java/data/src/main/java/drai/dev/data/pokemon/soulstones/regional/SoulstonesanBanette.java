...
import java.util.*;
public class SoulstonesanBanette extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBanette(int dex) {
        super(dex, "Banette",
                ...
                11, 125,
                new Stats(74,2,55,80,63,63), 90,
                0.5,
                159, ExperienceGroup.FAST,
                70,
                50, List.of(EggGroup.AMORPHOUS),
                List.of("This Pokemon is used to produce entertainment for entitled royalty. It harbours a seething hatred for the court in which it performs."),
                List.of(),
                List.of(
