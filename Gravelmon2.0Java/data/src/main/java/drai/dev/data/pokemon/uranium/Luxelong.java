...
public class Luxelong extends Pokemon {
    public Luxelong() {
        super("Luxelong",
                ...
                21, 1406,
                new Stats(1,0,0,1,1,0), 45,
                0.5,
                70, ExperienceGroup.MEDIUM_SLOW,
                70,
                100, List.of(EggGroup.DRAGON),
                List.of("A Mon so rare and gentle, simply seeing one is said to bless someone with good fortune for a whole year."),
                List.of(),
                List.of(
