...
import java.util.*;
public class EpochCrawdaunt extends drai.dev.data.pokemon.Pokemon {
    public EpochCrawdaunt(String name, Aspect aspect) {
        super(name, aspect, "EpochCrawdaunt",
                Type.ROCK,Type.DARK,
                new Stats(63,
                        120,
                        95,
                ...
                List.of("It often groups in small bands along seashores and coves. In large enough groups, they are used to raid local fishing villages."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 31, 45, .8, List.of(
