...
import java.util.*;
public class Sharfax extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sharfax() {
        super("Sharfax",
                Type.DRAGON,
                new Stats(66,
                ...
                70,
                50, List.of(),
                List.of("Mit seinen Fängen kriegt es sogar Felsen klein. Gegen Artgenossen, die sein Revier passieren, geht es besonders hart vor."),
                List.of(),
                List.of(
