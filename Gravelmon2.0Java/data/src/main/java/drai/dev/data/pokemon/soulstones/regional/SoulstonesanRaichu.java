...
import java.util.*;
public class SoulstonesanRaichu extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanRaichu(int dex) {
        super(dex, "Raichu",
                ...
                0.5,
                218, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.FIELD,EggGroup.FAIRY),
                List.of("From its turntable, it can produce certain musical tracks if you request it."),
                List.of(),
                List.of(
