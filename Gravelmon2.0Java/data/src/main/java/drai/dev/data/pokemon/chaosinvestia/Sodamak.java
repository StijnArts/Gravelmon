...
import java.util.*;
public class Sodamak extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sodamak() {
        super("Sodamak",
                Type.WATER,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Es wringt Wasser aus dem Büschel auf seinem Kopf und bespritzt damit Gegner. Kein Pokémon für trockene Gegenden."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SCALD,22),
