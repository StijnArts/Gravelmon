...
import java.util.*;
public class SoulstonesanPersian extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPersian(int dex) {
        super(dex, "Persian",
                Type.ELECTRIC,
                new Stats(65,
                        50,
                ...
                0.5,
                154, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("It is said that the spots on any Persian are always unique in size, shape and pattern."),
                List.of(),
                List.of(
