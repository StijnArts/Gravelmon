...
import java.util.*;
public class Rizeros extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rizeros() {
        super("Rizeros",
                ...
                70,
                50, List.of(),
                List.of("Das Stehen auf den Hinterbeinen hat es klüger gemacht. Leider ist es aber auch sehr vergesslich."),
                List.of(),
                List.of(
