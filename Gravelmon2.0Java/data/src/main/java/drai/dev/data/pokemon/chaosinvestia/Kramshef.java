...
import java.util.*;
public class Kramshef extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kramshef() {
        super("Kramshef",
                ...
                70,
                50, List.of(),
                List.of("Sein tiefer Ruf lockt andere Kramurx herbei. Man nennt es daher „Beschwörer der Nacht“."),
                List.of(),
                List.of(
