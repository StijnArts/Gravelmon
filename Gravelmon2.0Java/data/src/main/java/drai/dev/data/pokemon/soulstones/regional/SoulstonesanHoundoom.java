...
import java.util.*;
public class SoulstonesanHoundoom extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanHoundoom(int dex) {
        super(dex, "Houndoom",
                ...
                List.of("It is said that man's best friend will meet you in heaven when it passes on. It's actually quite a tragic story."),
                List.of(),
                List.of(
