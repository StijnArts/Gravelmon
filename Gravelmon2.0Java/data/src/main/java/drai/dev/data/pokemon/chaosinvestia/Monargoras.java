...
import java.util.*;
public class Monargoras extends drai.dev.gravelmon.pokemon.Pokemon {
    public Monargoras() {
        super("Monargoras",
                ...
                new Stats(82,
                        ...
                        69,
                        59),
                List.of(Ability.STRONG_JAW,Ability.ROCK_HEAD), null,
                25, 2700,
                ...
                70,
                50, List.of(),
                List.of("Vor 100 Millionen Jahren gab es niemanden, der sich mit ihm hätte messen können, weshalb sich dieses Pokémon wie ein König verhielt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROCK_SLIDE,68),
