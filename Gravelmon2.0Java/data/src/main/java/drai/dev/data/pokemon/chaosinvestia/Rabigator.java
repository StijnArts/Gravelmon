...
import java.util.*;
public class Rabigator extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rabigator() {
        super("Rabigator",
                ...
                70,
                50, List.of(),
                List.of("Seine Augen können wie ein Fernglas weit entfernte Objekte näher heranholen."),
                List.of(),
                List.of(
