...
import java.util.*;
public class Zigzachs extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zigzachs() {
        super("Zigzachs",
                Type.NORMAL,
                new Stats(38,
                ...
                70,
                50, List.of(),
                List.of("Es läuft im Zickzack. Es hat das Talent, Items im Gras, aber auch im Boden, zu finden."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BESTOW,33),
