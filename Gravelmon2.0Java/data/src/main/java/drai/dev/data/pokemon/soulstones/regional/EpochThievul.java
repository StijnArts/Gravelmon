...
import java.util.*;
public class EpochThievul extends drai.dev.data.pokemon.Pokemon {
    public EpochThievul(String name, Aspect aspect) {
        super(name, aspect, "EpochThievul",
                ...
                List.of("Despite its endearing appearance, it is actually very vicious and can drain the life force of sleeping targets, leaving them comatose."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.LULLABY,1),
                ...
                0, List.of(
                        ...
                        .setMinLevel(28).setPool(SpawnPool.RARE).setWeight(SpawnWeight.UNCOMMON)
