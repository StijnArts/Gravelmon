...
import java.util.*;
public class EpochMudkipOne extends drai.dev.data.pokemon.Pokemon {
    public EpochMudkipOne(String name, Aspect aspect) {
        super(name, aspect,"EpochMudkipOne",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MOONSTONERAY,"egg"),
