...
import java.util.*;
public class Jungglut extends drai.dev.gravelmon.pokemon.Pokemon {
    public Jungglut() {
        super("Jungglut",
                ...
                70,
                50, List.of(),
                List.of("Es kann 10 Tritte pro Sekunde austeilen. Es gibt schrille Schreie von sich, um Gegner einzuschüchtern."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.MIRROR_MOVE,43),
                        new MoveLearnSetEntry(Move.SKY_UPPERCUT,50),
                        ...
                        new MoveLearnSetEntry(Move.PECK,17),
