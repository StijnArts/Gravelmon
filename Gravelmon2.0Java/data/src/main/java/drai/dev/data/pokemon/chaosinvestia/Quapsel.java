...
import java.util.*;
public class Quapsel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quapsel() {
        super("Quapsel",
                Type.WATER,
                new Stats(40,
                ...
                70,
                50, List.of(),
                List.of("Seine Haut ist so dünn, dass man die inneren Organe sehen kann. Es hat Schwierigkeiten beim Laufen."),
                List.of(),
                List.of(
