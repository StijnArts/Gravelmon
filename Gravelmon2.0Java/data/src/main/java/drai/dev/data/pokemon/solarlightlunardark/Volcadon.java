...
import java.util.*;
public class Volcadon extends drai.dev.data.pokemon.Pokemon {
    public Volcadon() {
        super("Volcadon",
                Type.FIRE,Type.ROCK,
                new Stats(95,
                ...
                List.of("Though capable of immense devastation, Volcadon are said to deposit their excess lava on the coasts, enlarging the landmass of Rikoto."),
                List.of(),
                List.of(
