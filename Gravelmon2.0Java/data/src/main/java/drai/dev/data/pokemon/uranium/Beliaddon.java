...
public class Beliaddon extends Pokemon {
    public Beliaddon() {
        super("Beliaddon",
                Type.FIRE, Type.DARK,
                new Stats(115,
                ...
                26, 1782,
                new Stats(0,3,0,0,0,0), 140,
                0.5,
                147, ExperienceGroup.SLOW,
                70,
                100, List.of(EggGroup.HUMAN_LIKE),
                List.of("Its kind came out of a fiery chasm which contained an otherworldly portal. A furnace hotter than the sun burns within its chest. If it burns you, the pain will never fade."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 72, 88, 0.6, List.of(
