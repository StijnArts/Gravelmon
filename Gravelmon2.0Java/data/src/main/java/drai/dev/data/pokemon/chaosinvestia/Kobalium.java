...
import java.util.*;
public class Kobalium extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kobalium() {
        super("Kobalium",
                ...
                70,
                50, List.of(),
                List.of("Sein Körper und sein Herz sind aus Stahl. Ein böser Blick genügt und selbst die wildesten Pokémon unterwerfen sich ihm."),
                List.of(),
                List.of(
