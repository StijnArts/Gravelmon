...
import java.util.*;
public class Dragonir extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dragonir() {
        super("Dragonir",
                Type.DRAGON,
                new Stats(61,
                ...
                70,
                50, List.of(),
                List.of("Erscheint um seinen Körper eine Aura, gibt es einen Wetterwechsel. Es soll in Seen und Meeren leben."),
                List.of(),
                List.of(
