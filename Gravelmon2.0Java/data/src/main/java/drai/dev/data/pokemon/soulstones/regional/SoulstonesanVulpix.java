...
import java.util.*;
public class SoulstonesanVulpix extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanVulpix(int dex) {
        super(dex, "Vulpix",
                Type.COSMIC,
                new Stats(38,
                        41,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BLACK_HOLE,"egg"),
                        ...
                        new MoveLearnSetEntry(Move.SOLARFLARE,"egg"),
