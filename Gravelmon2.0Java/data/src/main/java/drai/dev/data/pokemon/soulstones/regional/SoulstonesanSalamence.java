...
import java.util.*;
public class SoulstonesanSalamence extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSalamence(int dex) {
        super(dex, "Salamence",
                ...
                15, 1026,
                new Stats(105,1,80,95,120,80), 90,
                0.5,
                300, ExperienceGroup.SLOW,
                70,
                50, List.of(EggGroup.DRAGON),
                List.of("It is rumoured that this is not even its final form, and it can transform into a much more fearsome multi-headed creature."),
                List.of(),
                List.of(
