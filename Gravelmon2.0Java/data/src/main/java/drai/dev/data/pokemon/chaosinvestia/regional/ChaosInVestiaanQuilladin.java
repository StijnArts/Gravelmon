...
import java.util.*;
public class ChaosInVestiaanQuilladin extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanQuilladin(String name, Aspect aspect) {
        super(name, aspect, "Quilladin",
