...
import java.util.*;
public class SoulstonesanKrookodile extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanKrookodile(int dex) {
        super(dex, "Krookodile",
                ...
                0.5,
                234, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("This Pokémon lets its minions do the dirty work of raiding marine vessels. It prefers to stay behind and await the spoils."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.MAGNET_BOMB,16),
                        new MoveLearnSetEntry(Move.FRENZY,51),
                        new MoveLearnSetEntry(Move.SWORDSTRIKE,1),
