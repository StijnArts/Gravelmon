...
import java.util.*;
public class EpochHoopa extends drai.dev.data.pokemon.Pokemon {
    public EpochHoopa(String name, Aspect aspect) {
        super(name, aspect, "EpochHoopa",
                ...
                new Stats(100,
                        ...
                        130,
                        60),
                List.of(Ability.LONG_REACH,Ability.SCRAPPY), Ability.POWER_SPOT,
                5, 90,
                ...
                List.of("This Pokemon will often prank people and then use its magic to disappear before being caught."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.ARM_THRUST,10),
                        new MoveLearnSetEntry(Move.BEWITCH,19),
                        new MoveLearnSetEntry(Move.MANIPULATION,38),
                        new MoveLearnSetEntry(Move.FRENZY,55),
                        new MoveLearnSetEntry(Move.BATTLEOFWITS,33),
                        new MoveLearnSetEntry(Move.ARCANEENERGY,66),
                        new MoveLearnSetEntry(Move.PRANKCALL,25),
                        ...
                        new MoveLearnSetEntry(Move.SYLPHSHORN,29),
                        new MoveLearnSetEntry(Move.CHAKRABLAST,72),
