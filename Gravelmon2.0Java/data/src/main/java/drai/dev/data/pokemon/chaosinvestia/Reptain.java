...
import java.util.*;
public class Reptain extends drai.dev.gravelmon.pokemon.Pokemon {
    public Reptain() {
        super("Reptain",
                Type.GRASS,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Es lebt im dichten Dschungel. Es springt von Ast zu Ast, wenn es sich einer Beute nähert."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FALSE_SWIPE,53),
                        new MoveLearnSetEntry(Move.ABSORB,6),
                        new MoveLearnSetEntry(Move.DETECT,47)                        ),
