...
import java.util.*;
public class Lombrero extends drai.dev.gravelmon.pokemon.Pokemon {
    public Lombrero() {
        super("Lombrero",
                ...
                70,
                50, List.of(),
                List.of("Es hat ein spitzbübisches Wesen. Sieht es einen Angler, zieht es an der Angelschnur, um ihn zu ärgern."),
                List.of(),
                List.of(
