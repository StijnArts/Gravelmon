...
import java.util.*;
public class AyreianCutiefly extends drai.dev.data.pokemon.Pokemon {
    public AyreianCutiefly(String name, Aspect aspect) {
        super(name, aspect, "Cutiefly",
                ...
                new Stats(40,
                        ...
                        45,
                        40),
                List.of(Ability.SHIELD_DUST,Ability.RECKLESS), null,
                1, 2,
