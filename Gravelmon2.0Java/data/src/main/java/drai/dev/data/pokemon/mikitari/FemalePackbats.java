...
import java.util.*;
public class FemalePackbats extends drai.dev.data.pokemon.Pokemon {
    public FemalePackbats(String s, Aspect female) {
        super(s, female, "Packbats",
                ...
                List.of("Cabats evolve into this Pokémon during mating season. They never splits up and always helps each other out."),
                List.of(),
                List.of(
