...
import java.util.*;
public class Gallopa extends drai.dev.gravelmon.pokemon.Pokemon {
    public Gallopa() {
        super("Gallopa",
                Type.FIRE,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("In vollem Galopp funkelt seine leuchtende Mähne, was wiederum seine Schönheit unterstreicht."),
                List.of(),
                List.of(
