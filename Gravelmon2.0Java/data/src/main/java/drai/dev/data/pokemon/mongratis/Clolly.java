...
import java.util.*;
public class Clolly extends drai.dev.data.pokemon.Pokemon {
    public Clolly() {
        super("Clolly",
                Type.GRASS,
                new Stats(0,
                ...
                List.of(new EvolutionEntry("clodiva", EvolutionType.ITEM_INTERACT, false, List.of(),
