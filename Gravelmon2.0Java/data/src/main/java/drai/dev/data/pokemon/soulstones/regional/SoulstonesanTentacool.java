...
import java.util.*;
public class SoulstonesanTentacool extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanTentacool(int dex) {
        super(dex, "Tentacool",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.METEOR_BEAM,"egg"),
