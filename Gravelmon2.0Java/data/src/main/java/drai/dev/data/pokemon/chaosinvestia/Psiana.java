...
import java.util.*;
public class Psiana extends drai.dev.gravelmon.pokemon.Pokemon {
    public Psiana() {
        super("Psiana",
                Type.PSYCHIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Kann durch sein Fell geringste Luftveränderungen wahrnehmen und das Wetter vorhersagen."),
                List.of(),
                List.of(
