...
import java.util.*;
public class Pii extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pii() {
        super("Pii",
                Type.FAIRY,
                new Stats(50,
                ...
                70,
                50, List.of(),
                List.of("Man sieht es oft, wenn der Himmel voller Sterne hängt. Es soll auf einer Sternschnuppe reiten."),
                List.of(),
                List.of(
