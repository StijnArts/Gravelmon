...
import java.util.*;
public class AyreianRiolu extends drai.dev.data.pokemon.Pokemon {
    public AyreianRiolu(String name, Aspect aspect) {
        super(name, aspect, "AyreianRiolu",
                ...
                new Stats(40,
                        ...
                        70,
                        40),
                List.of(Ability.STEADFAST,Ability.DOWNLOAD), null,
                7, 2,
