...
import java.util.*;
public class WestraOne extends drai.dev.data.pokemon.Pokemon {
    public WestraOne() {
        super("WestraOne",
                ...
                List.of("A dragon raised on stories of heroes and epic conflict. Its fierce demeanor and fiery breath makes short work of its foes."),
                List.of(),
                List.of(
