...
//        addNewPokemon(new Deeluge());     Member of line Not Finished
        ...
        addNewPokemon(new Voltowere(new Stats(520, StatArchetype.SLOW_BULKY_SPECIAL_ATTACKER,
...
//        addNewPokemon(new Netyke());   Member of line Not Finished
        ...
        addNewPokemon(new Giiem(new Stats(512, StatArchetype.SLOW_BULKY_SPECIAL_ATTACKER,
