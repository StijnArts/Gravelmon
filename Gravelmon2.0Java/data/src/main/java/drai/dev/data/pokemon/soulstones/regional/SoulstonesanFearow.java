...
import java.util.*;
public class SoulstonesanFearow extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanFearow(int dex) {
        super(dex, "Fearow",
                ...
                0.5,
                155, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.FLYING),
                List.of("It hunts out at sea and in oceans. It will dive into the water from a distance to pick up a fish Pokemon such as an Arrokuda when it is hungry."),
                List.of(),
                List.of(
