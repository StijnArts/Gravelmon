...
import java.util.*;
public class SoulstonesanPsyduck extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPsyduck(int dex) {
        super(dex, "Psyduck",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SEISMICSHIFT,"egg"),
