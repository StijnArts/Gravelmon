...
import java.util.*;
public class Hydragil extends drai.dev.gravelmon.pokemon.Pokemon {
    public Hydragil() {
        super("Hydragil",
                Type.BUG,
                new Stats(80,
                        ...
                        100,
                        60),
                List.of(Ability.HYDRATION,Ability.STICKY_HOLD), null,
                8, 253,
                ...
                70,
                50, List.of(),
                List.of("Seit es die schwere Muschel abgestreift hat, ist es viel leichter. Nun gleichen seine Kampfbewegungen denen eines Ninja."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AGILITY,32),
                        new MoveLearnSetEntry(Move.QUICK_ATTACK,13),
                        new MoveLearnSetEntry(Move.ME_FIRST,28),
                        ...
                        new MoveLearnSetEntry(Move.POWER_SWAP,52)                        ),
