...
import java.util.*;
public class Seeper extends drai.dev.gravelmon.pokemon.Pokemon {
    public Seeper() {
        super("Seeper",
                Type.WATER,
                new Stats(30,
                        ...
                        70,
                        25),
                List.of(Ability.SWIFT_SWIM,Ability.SNIPER), null,
                4, 80,
                ...
                70,
                50, List.of(),
                List.of("Im Schatten von Korallen legt es sein Nest an. Bei Gefahr versprüht es Tinte und flieht."),
                List.of(),
                List.of(
