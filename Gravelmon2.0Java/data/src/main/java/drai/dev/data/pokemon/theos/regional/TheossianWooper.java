...
import java.util.*;
public class TheossianWooper extends drai.dev.data.pokemon.Pokemon {
    public TheossianWooper(String name, Aspect aspect) {
        super(name, aspect, "Wooper",
                ...
                List.of(new EvolutionEntry("theossianquagsire", EvolutionType.LEVEL_UP, List.of(),
