...
public class Mystis extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        ...
        addNewPokemon(new MystisianImpidimp("", Aspect.MYSTISIAN));
        ...
        addNewPokemon(new MystisianAbsol("", Aspect.MYSTISIAN));
        addPokedexPokemon("tyrogue, hitmonlee, hitmonchan, hitmontop");
...
//        addNewPokemon(new Casstrike());MEMBER OF LINE NOT FINISHED
        ...
        addPokedexPokemon("croagunk, toxicroak");
