...
import java.util.*;
public class SoulstonesanDarumaka extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanDarumaka(int dex) {
        super(dex, "Darumaka",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FORTISSIMO,"egg"),
