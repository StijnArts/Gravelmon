...
import java.util.*;
public class EpochCyndaquil extends drai.dev.data.pokemon.Pokemon {
    public EpochCyndaquil(String name, Aspect aspect) {
        super(name, aspect,"EpochCyndaquil",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ELECTRONCRUSH,51),
                        new MoveLearnSetEntry(Move.TITANHAMMER,57),
                        new MoveLearnSetEntry(Move.DOUBLE_HIT,24),
                        ...
                        new MoveLearnSetEntry(Move.NERVESOFSTEEL,36),
                        new MoveLearnSetEntry(Move.SHIFT_GEAR,32),
                        new MoveLearnSetEntry(Move.METAL_SOUND,17),
                        new MoveLearnSetEntry(Move.SNAP_TRAP,6),
                        new MoveLearnSetEntry(Move.GROWL,1),
                        new MoveLearnSetEntry(Move.IRON_HEAD,47),
                        new MoveLearnSetEntry(Move.GEAR_UP,62),
                        ...
                        new MoveLearnSetEntry(Move.BOOMBOX,"egg"),
