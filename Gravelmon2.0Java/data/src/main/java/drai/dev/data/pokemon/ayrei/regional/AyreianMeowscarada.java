...
import java.util.*;
public class AyreianMeowscarada extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianMeowscarada(int dex) {
        super(dex, "Meowscarada",
                ...
                15, 312,
                new Stats(76,81,86,3,117,86), 45,
                0.875,
                265, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD,EggGroup.GRASS),
                List.of("Looks innocent, but has a dangerous personality. It tricks other Pokemon into accepting its bouquet, which then erupts into a shower of venomous spikes."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.NIGHTBOUQUET,0),
                        new MoveLearnSetEntry(Move.POISON_GAS,1),
                        new MoveLearnSetEntry(Move.WORK_UP,10),
                        new MoveLearnSetEntry(Move.SPECTRALHORDE,52),
