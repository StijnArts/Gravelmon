...
public class Charmeleon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Charmeleon() {
        super("Charmeleon",
                ...
                70,
                50, List.of(),
                List.of("Very impatient for its evolution, it feeds on the purest gems in the caves it lives in. While docile, it is quick to anger."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SPIRIT_BREAK,0),
