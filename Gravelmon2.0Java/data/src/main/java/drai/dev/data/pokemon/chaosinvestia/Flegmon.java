...
import java.util.*;
public class Flegmon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flegmon() {
        super("Flegmon",
                ...
                70,
                50, List.of(),
                List.of("Es ist langsam, hat aber ein Talent, mit seinem Schweif zu fischen. Beißt etwas an, tut es ihm nicht weh."),
                List.of(),
                List.of(
