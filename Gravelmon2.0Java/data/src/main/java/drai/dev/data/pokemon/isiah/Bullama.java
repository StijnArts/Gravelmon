...
public class Bullama extends drai.dev.data.pokemon.Pokemon {
    public Bullama() {
        super("Bullama",
                Type.GRASS,
                new Stats(0,
                ...
                List.of(new EvolutionEntry("kelbanast", EvolutionType.ITEM_INTERACT, false, List.of(),
                ...
                List.of(Label.ISIAH),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 21, 35, .5, List.of(
