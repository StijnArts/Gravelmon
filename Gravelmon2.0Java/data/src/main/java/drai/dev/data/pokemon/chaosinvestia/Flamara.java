...
import java.util.*;
public class Flamara extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flamara() {
        super("Flamara",
                Type.FIRE,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Eingeatmete Luft wird in einem Flammensack in seinem Körper auf ca. 1 700 Grad erhitzt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FIRE_BLAST,45),
                        new MoveLearnSetEntry(Move.SMOG,33),
