...
import java.util.*;
public class Zwottronin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zwottronin() {
        super("Zwottronin",
                Type.WATER,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Wie es seine Attacken ausführt, ist von Exemplar zu Exemplar unterschiedlich. Es gibt sehr auf seine Muscheln acht."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WATER_PULSE,25),
                        new MoveLearnSetEntry(Move.AQUA_TAIL,41),
                        new MoveLearnSetEntry(Move.ENCORE,36),
                        ...
                        new MoveLearnSetEntry(Move.RETALIATE,44),
