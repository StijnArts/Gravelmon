...
public class Sparkroll extends drai.dev.data.pokemon.Pokemon {
    public Sparkroll() {
        super("Sparkroll",
                ...
                List.of(""),
                List.of(new EvolutionEntry("megawatt", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.ISIAH),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 23, 43, 1, List.of(
