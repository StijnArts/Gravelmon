...
import java.util.*;
public class Battic extends drai.dev.data.pokemon.Pokemon {
    public Battic() {
        super("Battic",
                ...
                List.of("Battic are most active during blizzards when most of the prey they hunt is lost in snowstorms. They use ultrasounds so that they are not bothered by snow that obscures their vision."),
                List.of(new EvolutionEntry("blizzibat", EvolutionType.LEVEL_UP, List.of(), 
