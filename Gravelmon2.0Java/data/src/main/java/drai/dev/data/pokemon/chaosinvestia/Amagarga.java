...
import java.util.*;
public class Amagarga extends drai.dev.gravelmon.pokemon.Pokemon {
    public Amagarga() {
        super("Amagarga",
                Type.ROCK,Type.ICE,
                new Stats(123,
                ...
                70,
                50, List.of(),
                List.of("Mit der -150 °C kalten Luft, die den diamantförmigen Kristallen auf seinem Körper entströmt, friert es Gegner ein."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HYPER_BEAM,63),
                        new MoveLearnSetEntry(Move.ENCORE,46),
                        new MoveLearnSetEntry(Move.FREEZEDRY,77),
                        new MoveLearnSetEntry(Move.BLIZZARD,74),
