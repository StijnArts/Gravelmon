...
import java.util.*;
public class IshirianMagikarp extends drai.dev.data.pokemon.Pokemon {
    public IshirianMagikarp(String name, Aspect aspect) {
        super(name, aspect, "IshirianMagikarp",
                Type.ROCK,
                new Stats(30,
                        15,
                        65,
                ...
                List.of(new EvolutionEntry("ishiriangyarados", EvolutionType.LEVEL_UP, List.of(),
