...
import java.util.*;
public class Pinkmee extends drai.dev.data.pokemon.Pokemon {
    public Pinkmee() {
        super("Pinkmee",
                ...
                List.of("Pinkmee are extremely popular in Pokémon pageants, it is said they keep their lustrous pink shine by eating nothing but a certain species of plankton."),
                List.of(new EvolutionEntry("valure", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"35")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SCALE_SHOT,46),
