...
import java.util.*;
public class Plaudagei extends drai.dev.gravelmon.pokemon.Pokemon {
    public Plaudagei() {
        super("Plaudagei",
                ...
                70,
                50, List.of(),
                List.of("Seine Zunge ähnelt der eines Menschen. Daher kann es die menschliche Sprache gut nachahmen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FEATHER_DANCE,53),
