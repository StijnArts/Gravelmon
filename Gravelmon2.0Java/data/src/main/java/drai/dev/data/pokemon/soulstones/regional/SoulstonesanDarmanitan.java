...
import java.util.*;
public class SoulstonesanDarmanitan extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanDarmanitan(int dex) {
        super(dex, "Darmanitan",
                ...
                0.5,
                168, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("It is known for getting into screeching matches with the Primeape family. Get ear protection and take cover when you see this happen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.STUFF_CHEEKS,38),
                        ...
                        new MoveLearnSetEntry(Move.SONICPUNCH,7),
