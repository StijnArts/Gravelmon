...
import java.util.*;
public class AyreianBlaziken extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianBlaziken(int dex) {
        super(dex, "Blaziken",
                ...
                new Stats(70,
                        ...
                        80,
                        90),
                List.of(Ability.LONG_REACH,Ability.AVIAN), null,
                19, 520,
