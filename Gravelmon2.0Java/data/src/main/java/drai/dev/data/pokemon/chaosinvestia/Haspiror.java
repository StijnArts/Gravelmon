...
import java.util.*;
public class Haspiror extends drai.dev.gravelmon.pokemon.Pokemon {
    public Haspiror() {
        super("Haspiror",
                Type.NORMAL,
                new Stats(55,
                        ...
                        44,
                        56),
                List.of(Ability.RUN_AWAY,Ability.KLUTZ), null,
                4, 55,
                ...
                70,
                50, List.of(),
                List.of("Seine Ohren sind immer aufgerollt. Mit ihnen kann es selbst große Felsbrocken zertrümmern."),
                List.of(),
                List.of(
