...
import java.util.*;
public class Noctuh extends drai.dev.gravelmon.pokemon.Pokemon {
    public Noctuh() {
        super("Noctuh",
                ...
                70,
                50, List.of(),
                List.of("Seine Augen sind so gut entwickelt, dass es selbst in tiefster Dunkelheit noch klar sehen kann."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.EXTRASENSORY,52),
                        new MoveLearnSetEntry(Move.SKY_ATTACK,1),
                        new MoveLearnSetEntry(Move.PSYCHO_SHIFT,57),
                        ...
                        new MoveLearnSetEntry(Move.ECHOED_VOICE,27)                        ),
