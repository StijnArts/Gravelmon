...
import java.util.*;
public class ChaosInVestiaanHawlucha extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanHawlucha(String name, Aspect aspect) {
        super(name, aspect, "Hawlucha",
