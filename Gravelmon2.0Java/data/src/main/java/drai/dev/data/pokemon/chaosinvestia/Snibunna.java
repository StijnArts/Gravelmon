...
import java.util.*;
public class Snibunna extends drai.dev.gravelmon.pokemon.Pokemon {
    public Snibunna() {
        super("Snibunna",
                Type.DARK,Type.ICE,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Wird durch Entwicklung noch verschlagener. Kommuniziert durch in Felsen gekratzte Zeichen."),
                List.of(),
                List.of(
