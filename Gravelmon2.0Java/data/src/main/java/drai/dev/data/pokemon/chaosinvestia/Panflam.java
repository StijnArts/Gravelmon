...
import java.util.*;
public class Panflam extends drai.dev.gravelmon.pokemon.Pokemon {
    public Panflam() {
        super("Panflam",
                Type.FIRE,
                new Stats(44,
                ...
                70,
                50, List.of(),
                List.of("Dieses flinke Pokémon löscht vor dem Schlafengehen die Flamme auf seinem Schweif, um Feuer zu verhindern."),
                List.of(),
                List.of(
