...
import java.util.*;
public class Skallyk extends drai.dev.gravelmon.pokemon.Pokemon {
    public Skallyk() {
        super("Skallyk",
                ...
                70,
                50, List.of(),
                List.of("Es schlüpft in einen passenden Schädel, um sein Hinterteil zu schützen, und scheucht schwache Pokémon umher."),
                List.of(),
                List.of(
