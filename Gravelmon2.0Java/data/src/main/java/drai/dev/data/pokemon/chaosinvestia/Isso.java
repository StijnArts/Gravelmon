...
import java.util.*;
public class Isso extends drai.dev.gravelmon.pokemon.Pokemon {
    public Isso() {
        super("Isso",
                Type.PSYCHIC,
                new Stats(95,
                ...
                70,
                50, List.of(),
                List.of("Es wird stärker, indem es andere ständig anrempelt. Es liebt Süßigkeiten."),
                List.of(),
                List.of(
