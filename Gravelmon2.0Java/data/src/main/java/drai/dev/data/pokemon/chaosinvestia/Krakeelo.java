...
import java.util.*;
public class Krakeelo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Krakeelo() {
        super("Krakeelo",
                Type.NORMAL,
                new Stats(84,
