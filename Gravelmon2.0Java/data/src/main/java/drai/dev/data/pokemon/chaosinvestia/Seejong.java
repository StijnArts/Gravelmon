...
import java.util.*;
public class Seejong extends drai.dev.gravelmon.pokemon.Pokemon {
    public Seejong() {
        super("Seejong",
                Type.ICE,Type.WATER,
                new Stats(90,
                ...
                70,
                50, List.of(),
                List.of("Es balanciert Dinge auf seiner Nase. Dabei lernt es etwas über die Beschaffenheit und den Geruch."),
                List.of(),
                List.of(
