...
public class Blazilisk extends drai.dev.data.pokemon.Pokemon {
    public Blazilisk() {
        super("Blazilisk",
                ...
                List.of("Capable of launching roaring pillars of fire from their eyes, Blazilisk are both feared and respected widely among even experienced trainers."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGONICFLARE,66),
