...
import java.util.*;
public class Karippas extends drai.dev.gravelmon.pokemon.Pokemon {
    public Karippas() {
        super("Karippas",
                ...
                70,
                50, List.of(),
                List.of("Sein Kiefer ist so stark wie kaum etwas anderes. Mit seiner Beute verschluckt es auch mal Felsen und Stahlträger."),
                List.of(),
                List.of(
