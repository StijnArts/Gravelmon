...
import java.util.*;
public class Strikon extends drai.dev.data.pokemon.Pokemon {
    public Strikon() {
        super("Strikon",
                ...
                List.of("When thunderclouds gather densely on the tops of mountains, it is believed that many Strikon eggs are nested. People chase these storms in the hopes of obtaining one."),
                List.of(new EvolutionEntry("strikloud", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"35")))),
                List.of(
                        new MoveLearnSetEntry(Move.LIGHTNING_STRIKE,30),
                        new MoveLearnSetEntry(Move.HURRICANE,50),
                        new MoveLearnSetEntry(Move.FICKLEBEAM,46),
