...
import java.util.*;
public class EpochHariyama extends drai.dev.data.pokemon.Pokemon {
    public EpochHariyama(String name, Aspect aspect) {
        super(name, aspect, "EpochHariyama",
                ...
                List.of("It has many civil and military applications. For example, its built in lasers help it scan packaged items, assess weight and neutralize threats."),
                List.of(),
                List.of(
