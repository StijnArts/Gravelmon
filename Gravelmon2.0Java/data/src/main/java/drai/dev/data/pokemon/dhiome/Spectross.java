...
import java.util.*;
public class Spectross extends drai.dev.data.pokemon.Pokemon {
    public Spectross(Stats stats) {
        super("Spectross",
                Type.GHOST,
                stats,
                ...
                List.of("It's found flying around ships that are about to crash. Seeing this Pokemon at sea is considered very bad luck."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 31, 44, .4, List.of(
