...
import java.util.*;
public class Elestomp extends drai.dev.data.pokemon.Pokemon {
    public Elestomp() {
        super("Elestomp",
                Type.GROUND,
                new Stats(131,
                ...
                List.of("With a stout body, Elestomp are Pokémon with few predators. Their long trunks can hold a large volume of water which can then be used as projectiles."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.LAST_RESPECTS,64),
