...
import java.util.*;
public class Myrapla extends drai.dev.gravelmon.pokemon.Pokemon {
    public Myrapla() {
        super("Myrapla",
                ...
                70,
                50, List.of(),
                List.of("Tagsüber verankert es sich mit seinen Wurzelfüßen im Boden. Nachts wandert es und verteilt Samen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.PETAL_DANCE,41),
