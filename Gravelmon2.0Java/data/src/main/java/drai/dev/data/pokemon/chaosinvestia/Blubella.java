...
import java.util.*;
public class Blubella extends drai.dev.gravelmon.pokemon.Pokemon {
    public Blubella() {
        super("Blubella",
                Type.GRASS,
                new Stats(75,
                ...
                70,
                50, List.of(),
                List.of("Sobald die Regenzeit vorbei ist, wird es von der warmen Sonne nach draußen gezogen, wo es tanzt."),
                List.of(),
                List.of(
