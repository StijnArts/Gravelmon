...
import java.util.*;
public class AyreianVivillonOne extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonOne(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonOne",
