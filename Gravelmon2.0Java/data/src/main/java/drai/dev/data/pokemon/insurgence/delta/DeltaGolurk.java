...
public class DeltaGolurk extends Pokemon {
    public DeltaGolurk(String name, Aspect aspect) {
        super(name, aspect,"DeltaGolurk",
                ...
                List.of("It fights barehanded even against armed foes, as no weapon is capable of piercing its armor. No one knows what its face looks like without wearing its helmet."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.VITAL_THROW,75),
