...
import java.util.*;
public class Strawickl extends drai.dev.gravelmon.pokemon.Pokemon {
    public Strawickl() {
        super("Strawickl",
                Type.BUG,Type.GRASS,
                new Stats(45,
                        ...
                        40,
                        60),
                List.of(Ability.SWARM,Ability.CHLOROPHYLL), null,
                3, 25,
                ...
                70,
                50, List.of(),
                List.of("Schneidert sich ein Kleid, indem es sich Blätter zurechtbeißt und sie mit Klebefäden aus seinem Mund zusammennäht."),
                List.of(),
                List.of(
