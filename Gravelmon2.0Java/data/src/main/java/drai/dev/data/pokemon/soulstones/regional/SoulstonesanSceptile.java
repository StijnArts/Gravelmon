...
import java.util.*;
public class SoulstonesanSceptile extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanSceptile(int dex) {
        super(dex, "Sceptile",
                ...
                List.of("It is able to shimmer its tail in a rhythmic pattern to distract foes. During the night time, its compound eyes allow it to increase its vision range."),
                List.of(),
                List.of(
