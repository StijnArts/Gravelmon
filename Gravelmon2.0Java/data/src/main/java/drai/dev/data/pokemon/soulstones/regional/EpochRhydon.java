...
import java.util.*;
public class EpochRhydon extends drai.dev.data.pokemon.Pokemon {
    public EpochRhydon(String name, Aspect aspect) {
        super(name, aspect, "EpochRhydon",
                ...
                List.of("It towers in size and enjoys causing havoc wherever it goes. It often goes on rampages when it is hungry."),
                List.of(new EvolutionEntry("epochrhyperior", EvolutionType.ITEM_INTERACT, false, List.of(), 
 List.of(), List.of(), "gravelmon:astral_stone")),
                ...
                0, List.of(
                        ...
                        .setMinLevel(32).setPool(SpawnPool.ULTRA_RARE).setWeight(SpawnWeight.RARE)
