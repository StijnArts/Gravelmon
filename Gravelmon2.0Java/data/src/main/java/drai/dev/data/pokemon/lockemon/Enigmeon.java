...
public class Enigmeon extends Pokemon {
    public Enigmeon() {
        super("Enigmeon",
                Type.NORMAL,
                new Stats(130, 65, 65, 95, 110, 60),
                List.of(Ability.WARP_MIST, Ability.UNAWARE), Ability.CONDENSATION,
                14, 250,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MIST_BALL,20),
