...
import java.util.*;
public class Mitodos extends drai.dev.gravelmon.pokemon.Pokemon {
    public Mitodos() {
        super("Mitodos",
                Type.PSYCHIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Kommen beide Hälften seines gespaltenen Denkapparates auf dieselbe Idee, entfesselt sich seine volle Kraft."),
                List.of(),
                List.of(
