...
import java.util.*;
public class MikitarianOricorio extends drai.dev.data.pokemon.Pokemon {
    public MikitarianOricorio(String name, Aspect aspect) {
        super(name, aspect, "MikitarianOricorio",
