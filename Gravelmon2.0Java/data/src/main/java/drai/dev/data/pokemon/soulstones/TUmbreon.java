...
import java.util.*;
public class TUmbreon extends drai.dev.gravelmon.pokemon.Pokemon {
    public TUmbreon() {
        super("TUmbreon",
                Type.FIGHTING,
                new Stats(65,
                ...
                List.of("It has been trained as a vigilante and seeks out justice for those that have been subjected to cruelty or misfortune at the hands of others."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SWEEPINGWIND,35),
                        new MoveLearnSetEntry(Move.SHADOW_SNEAK,1),
                        new MoveLearnSetEntry(Move.DISABLE,1),
                        new MoveLearnSetEntry(Move.MEMENTO,55),
                        new MoveLearnSetEntry(Move.BATTLEOFWITS,1),
