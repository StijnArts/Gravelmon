...
import java.util.*;
public class Goldini extends drai.dev.gravelmon.pokemon.Pokemon {
    public Goldini() {
        super("Goldini",
                Type.WATER,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Mit ausgebreiteten Flossen wirkt es sehr elegant. Kann allerdings auch heftig mit seinem Horn zustoßen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WATER_PULSE,17),
                        new MoveLearnSetEntry(Move.AGILITY,47),
                        new MoveLearnSetEntry(Move.SOAK,51),
                        new MoveLearnSetEntry(Move.HORN_DRILL,41),
