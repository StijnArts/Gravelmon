...
import java.util.*;
public class EpochWartortle extends drai.dev.data.pokemon.Pokemon {
    public EpochWartortle(String name, Aspect aspect) {
        super(name, aspect, "EpochWartortle",
                ...
                List.of("It is found frolicking near industrial areas and toxic pools. It likes to test itself by seeing how far it can launch sludge."),
                List.of(new EvolutionEntry("epochblastoise", EvolutionType.LEVEL_UP, List.of(), 
