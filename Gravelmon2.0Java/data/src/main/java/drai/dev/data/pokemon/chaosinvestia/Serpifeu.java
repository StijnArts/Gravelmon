...
import java.util.*;
public class Serpifeu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Serpifeu() {
        super("Serpifeu",
                Type.GRASS,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Fängt mit dem Schweif Sonnenlicht auf, um Fotosynthese zu betreiben. Fehlt ihm die Kraft, hängt sein Schweif schlaff herab."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WRING_OUT,37),
