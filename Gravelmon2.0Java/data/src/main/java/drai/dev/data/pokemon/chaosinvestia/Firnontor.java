...
import java.util.*;
public class Firnontor extends drai.dev.gravelmon.pokemon.Pokemon {
    public Firnontor() {
        super("Firnontor",
                Type.ICE,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("Es verhindert, dass Beute flieht, indem es die Feuchtigkeit in der Luft augenblicklich einfriert."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHEER_COLD,59),
