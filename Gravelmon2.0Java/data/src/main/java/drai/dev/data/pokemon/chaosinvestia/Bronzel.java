...
import java.util.*;
public class Bronzel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bronzel() {
        super("Bronzel",
                ...
                70,
                50, List.of(),
                List.of("Manche Forscher glauben, dass dieses Pokémon in der Vergangenheit wie ein Spiegel reflektierte."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEAVY_SLAM,49)                        ),
