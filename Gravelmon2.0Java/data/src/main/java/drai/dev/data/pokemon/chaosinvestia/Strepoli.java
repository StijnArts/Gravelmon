...
import java.util.*;
public class Strepoli extends drai.dev.gravelmon.pokemon.Pokemon {
    public Strepoli() {
        super("Strepoli",
                Type.FIGHTING,
                new Stats(85,
                ...
                70,
                50, List.of(),
                List.of("Zu Trainingszwecken trägt es immer einen Stahlträger bei sich. Unter Kollegen gibt es nur zu gern mit seinen Muskeln an."),
                List.of(),
                List.of(
