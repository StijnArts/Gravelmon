...
import java.util.*;
public class Krebutack extends drai.dev.gravelmon.pokemon.Pokemon {
    public Krebutack() {
        super("Krebutack",
                ...
                70,
                50, List.of(),
                List.of("Dieser Grobian ergreift andere Pokémon mit seinen Scheren und wirft sie aus seinem Teich."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.CRABHAMMER,44),
                        new MoveLearnSetEntry(Move.BUBBLE_BEAM,20),
                        new MoveLearnSetEntry(Move.GUILLOTINE,65),
