...
import java.util.*;
public class Tapiblaze extends drai.dev.data.pokemon.Pokemon {
    public Tapiblaze() {
        super("Apiblaze",
                ...
                List.of("Tapiblaze produces a unique smoke that would put all that approaches into slumber. Every now and then, one may find a sleeping Tapiblaze, hypnotized by their own smoke."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.MESMER_SMOKE,39),
                        new MoveLearnSetEntry(Move.SMOKESCREEN,1),
                        new MoveLearnSetEntry(Move.SLACK_OFF,29),
                        new MoveLearnSetEntry(Move.DREAM_EATER,45),
                        new MoveLearnSetEntry(Move.BELCH,57),
