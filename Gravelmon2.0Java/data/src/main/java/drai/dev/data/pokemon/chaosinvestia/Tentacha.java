...
import java.util.*;
public class Tentacha extends drai.dev.gravelmon.pokemon.Pokemon {
    public Tentacha() {
        super("Tentacha",
                ...
                70,
                50, List.of(),
                List.of("Wird es an Land geschwemmt, vertrocknet es schnell, da es fast völlig aus Wasser besteht."),
                List.of(),
                List.of(
