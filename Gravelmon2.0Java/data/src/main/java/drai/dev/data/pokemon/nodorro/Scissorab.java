...
import java.util.*;
public class Scissorab extends drai.dev.data.pokemon.Pokemon {
    public Scissorab() {
        super("Scissorab",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("Crabruner", EvolutionType.LEVEL_UP, List.of(),
