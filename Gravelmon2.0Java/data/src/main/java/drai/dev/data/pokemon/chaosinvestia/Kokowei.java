...
import java.util.*;
public class Kokowei extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kokowei() {
        super("Kokowei",
                ...
                70,
                50, List.of(),
                List.of("Man nennt es den „Laufenden Dschungel“. Wird ein Kopf zu groß, fällt er ab und wird zu einem Owei."),
                List.of(),
                List.of(
