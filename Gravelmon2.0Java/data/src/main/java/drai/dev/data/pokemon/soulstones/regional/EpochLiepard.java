...
import java.util.*;
public class EpochLiepard extends drai.dev.data.pokemon.Pokemon {
    public EpochLiepard(String name, Aspect aspect) {
        super(name, aspect, "EpochLiepard",
                ...
                List.of("This Pokemon is very limber and climb high elevations with ease. Its fur reflects the night sky."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 30, 48, .4, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_MAGICAL))
                ), List.of(),
                List.of(SpawnPreset.NATURAL),
                0.28, 0.3,
                List.of());
           setLangFileName("Liepard");
