...
public class InterianPiplup extends drai.dev.data.pokemon.Pokemon {
    public InterianPiplup(String name, Aspect aspect) {
        super(name, aspect,"Piplup",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("interianprinplup", EvolutionType.LEVEL_UP, List.of(),
