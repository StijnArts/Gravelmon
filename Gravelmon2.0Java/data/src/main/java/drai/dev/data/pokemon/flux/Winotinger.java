...
import java.util.*;
public class Winotinger extends drai.dev.data.pokemon.Pokemon {
    public Winotinger() {
        super("Winotinger",
                ...
                new Stats(110,
                        ...
                        85,
                        85),
                List.of(Ability.UNAWARE), Ability.MAGIC_BOUNCE,
                13, 315,
                new Stats(2,0,0,1,0,0), 10,
                0.5,
                193, ExperienceGroup.MEDIUM_FAST,
                70,
                50, List.of(EggGroup.FAIRY,EggGroup.HUMAN_LIKE),
                List.of("It combines illusion and trickery with physical strength. Because it can only be seen by drunk people, it was considered an imaginary Pokémon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FINAL_GAMBIT,57),
