...
import java.util.*;
public class OlysosianScroul extends drai.dev.data.pokemon.Pokemon {
    public OlysosianScroul(String s, Aspect aspect) {
        super(s, aspect,"Scroul",
                ...
                List.of(new EvolutionEntry("scrolock", EvolutionType.LEVEL_UP, List.of(),
