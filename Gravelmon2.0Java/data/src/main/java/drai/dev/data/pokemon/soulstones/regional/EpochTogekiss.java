...
import java.util.*;
public class EpochTogekiss extends drai.dev.data.pokemon.Pokemon {
    public EpochTogekiss(String name, Aspect aspect) {
        super(name, aspect, "EpochTogekiss",
                ...
                0.875,
                273, ExperienceGroup.FAST,
                70,
                50, List.of(EggGroup.FLYING,EggGroup.FAIRY),
                List.of("Contrary to popular belief, you are able to feed these Pokemon after midnight and not cause any unintended consequences."),
                List.of(),
                List.of(
