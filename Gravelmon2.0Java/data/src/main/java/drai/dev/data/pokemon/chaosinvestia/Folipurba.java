...
import java.util.*;
public class Folipurba extends drai.dev.gravelmon.pokemon.Pokemon {
    public Folipurba() {
        super("Folipurba",
                Type.GRASS,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Mit seiner pflanzenähnlichen Zellstruktur betreibt es Photosynthese. Es kämpft eigentlich nie."),
                List.of(),
                List.of(
