...
import java.util.*;
public class Pheromeon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pheromeon() {
        super("Pheromeon",
                Type.BUG,
                new Stats(100,
                        ...
                        110,
                        70),
                List.of(Ability.COMPOUND_EYES), null,
                9, 165,
                ...
                70,
                50, List.of(),
                List.of("They appear at dawn, signaling the start of spring. While flightless, they glide through the sky using wind currents."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.TAIL_GLOW,55),
                        ...
                        new MoveLearnSetEntry(Move.HEAL_ORDER,30),
