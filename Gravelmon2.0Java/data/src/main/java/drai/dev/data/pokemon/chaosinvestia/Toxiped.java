...
import java.util.*;
public class Toxiped extends drai.dev.gravelmon.pokemon.Pokemon {
    public Toxiped() {
        super("Toxiped",
                ...
                70,
                50, List.of(),
                List.of("Mit seinen Ruten und den Fühlern an seinem Kopf tastet es die Umgebung ab. Ein überaus aggressiver Geselle."),
                List.of(),
                List.of(
