...
import java.util.*;
public class AyreianTrapinch extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianTrapinch(int dex) {
        super(dex, "Trapinch",
                ...
                70,
                50, List.of(),
                List.of("While it may look weak in this larva form, it can shoot devastatingly powerful toxins from its mouth, used as a defense mechanism until evolution."),
                List.of(),
                List.of(
