...
import java.util.*;
public class Libelldra extends drai.dev.gravelmon.pokemon.Pokemon {
    public Libelldra() {
        super("Libelldra",
                ...
                70,
                50, List.of(),
                List.of("Mit mächtigem Flügelschlag verursacht es einen Sandsturm. Es wird „Geist der Wüste“ genannt."),
                List.of(),
                List.of(
