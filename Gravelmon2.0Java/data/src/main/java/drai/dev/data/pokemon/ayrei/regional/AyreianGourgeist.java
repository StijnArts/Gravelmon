...
import java.util.*;
public class AyreianGourgeist extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianGourgeist(int dex) {
        super(dex, "Gourgeist",
                ...
                new Stats(80,
                        ...
                        75,
                        105),
                List.of(Ability.STAMINA,Ability.TRIAGE), null,
                9, 125,
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DECORATE,0),
