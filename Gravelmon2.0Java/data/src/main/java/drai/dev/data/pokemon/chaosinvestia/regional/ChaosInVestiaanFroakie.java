...
import java.util.*;
public class ChaosInVestiaanFroakie extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanFroakie(String name, Aspect aspect) {
        super(name, aspect, "Froakie",
