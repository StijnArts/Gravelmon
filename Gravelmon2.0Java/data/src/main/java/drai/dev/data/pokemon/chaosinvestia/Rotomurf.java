...
import java.util.*;
public class Rotomurf extends drai.dev.gravelmon.pokemon.Pokemon {
    public Rotomurf() {
        super("Rotomurf",
                Type.GROUND,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Es führt seine beiden Klauen zusammen, dreht sich rapide um die eigene Achse und gräbt sich ratzfatz durch das Erdreich."),
                List.of(),
                List.of(
