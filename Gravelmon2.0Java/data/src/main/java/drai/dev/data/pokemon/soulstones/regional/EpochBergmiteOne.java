...
import java.util.*;
public class EpochBergmiteOne extends drai.dev.data.pokemon.Pokemon {
    public EpochBergmiteOne(String name, Aspect aspect) {
        super(name, aspect, "EpochBergmiteOne",
                ...
                List.of("They make wonderful seats for children, but if they get excited, they can run around your house and knock other furniture over."),
                List.of(new EvolutionEntry("epochtwoavalugg", EvolutionType.LEVEL_UP, List.of(),
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"37")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.JUNGLE_HEALING,"egg"),
