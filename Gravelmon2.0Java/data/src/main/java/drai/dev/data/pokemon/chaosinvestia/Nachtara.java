...
import java.util.*;
public class Nachtara extends drai.dev.gravelmon.pokemon.Pokemon {
    public Nachtara() {
        super("Nachtara",
                Type.DARK,
                new Stats(95,
                ...
                70,
                50, List.of(),
                List.of("Wird es der Aura des Mondes ausgesetzt, glühen seine Ringe und es erhält eine mysteriöse Kraft."),
                List.of(),
                List.of(
