...
import java.util.*;
public class Draschel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Draschel() {
        super("Draschel",
                Type.DRAGON,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Die Zellen seines Panzers fingen an, sich zu verändern. Er fällt ab, sobald sich das Pokémon entwickelt."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGON_CLAW,55),
