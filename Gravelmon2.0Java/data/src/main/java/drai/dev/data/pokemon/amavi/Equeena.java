...
import java.util.*;
public class Equeena extends drai.dev.data.pokemon.Pokemon {
    public Equeena() {
        super("Equeena",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("amphreina", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.AMAVI),
                0, List.of(
                ), SpawnContext.SUBMERGED, SpawnPool.UNCOMMON, 41, 57, .3, List.of(
