...
public class Ferran extends drai.dev.data.games.registry.Game {
    ...
    public void registerPokemon() {
        addNewPokemon(new Chamaerol().setUsesBigModel());
        addNewPokemon(new Chamaelik().setUsesBigModel());
        addNewPokemon(new Chamaelec().setUsesBigModel());
        addNewPokemon(new Hogoat().setUsesBigModel());
        addNewPokemon(new Flamalope().setUsesBigModel());
        addNewPokemon(new Shamalope().setUsesBigModel());
        addNewPokemon(new Platyblub().setUsesBigModel());
        addNewPokemon(new Platypuf().setUsesBigModel());
        addNewPokemon(new Platox().setUsesBigModel());
        addNewPokemon(new Puddiny().setUsesBigModel());
        addNewPokemon(new Frosplit().setUsesBigModel());
        ...
        addNewPokemon(new Voocult().setUsesBigModel());
        addNewPokemon(new Dragose().setUsesBigModel());
        ...
        addNewPokemon(new Froyena().setUsesBigModel());
        addNewPokemon(new Frovalan().setUsesBigModel());
        addNewPokemon(new Ankylub().setUsesBigModel());
        addNewPokemon(new Cluborus().setUsesBigModel());
        addNewPokemon(new Morsterus().setUsesBigModel());
        addNewPokemon(new Pumpcula().setUsesBigModel());
        addNewPokemon(new Nosfercula().setUsesBigModel());
        addNewPokemon(new Gonezia().setUsesBigModel());
        ...
        addNewPokemon(new Easteg().setUsesBigModel());
        ...
        addNewPokemon(new Owizard().setUsesBigModel());
        addNewPokemon(new Capernoir().setUsesBigModel());
        addNewPokemon(new Casanoistra().setUsesBigModel());
        addNewPokemon(new Viras().setUsesBigModel());
        addNewPokemon(new Viradle().setUsesBigModel());
        addNewPokemon(new Tracoon().setUsesBigModel());
        addNewPokemon(new Garbagoon().setUsesBigModel());
        addNewPokemon(new Pechick().setUsesBigModel());
        addNewPokemon(new Pegrow().setUsesBigModel());
        addNewPokemon(new Jungrowl().setUsesBigModel());
        addNewPokemon(new Gorilagma().setUsesBigModel()); //fossil
        addNewPokemon(new Calameteo().setUsesBigModel());
        addNewPokemon(new Forestryx().setUsesBigModel()); //fossil
        addNewPokemon(new Bulldozon().setUsesBigModel());
        addNewPokemon(new Poanter().setUsesBigModel()); //fossil
        addNewPokemon(new Smiloachur().setUsesBigModel());
        addNewPokemon(new Babybara().setUsesBigModel());
        addNewPokemon(new Capypapa().setUsesBigModel());
        ...
        addNewPokemon(new Totorock().setUsesBigModel());
        addNewPokemon(new Snotom().setUsesBigModel());
        addNewPokemon(new Snonuke().setUsesBigModel());
        ...
        addNewPokemon(new Skadeer().setUsesBigModel());
        addNewPokemon(new Coadeer().setUsesBigModel());
        addNewPokemon(new Crickerist().setUsesBigModel());
        ...
        addNewPokemon(new Virtryph().setUsesBigModel());
        addNewPokemon(new Inuniferus().setUsesBigModel());
    }
