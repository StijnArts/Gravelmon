...
import java.util.*;
public class Machollo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Machollo() {
        super("Machollo",
                Type.FIGHTING,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Obwohl von kleiner Statur, ist es kräftig genug, mehrere Kleinstein zu hieven und dann zu werfen."),
                List.of(),
                List.of(
