...
import java.util.*;
public class Laternecto extends drai.dev.gravelmon.pokemon.Pokemon {
    public Laternecto() {
        super("Laternecto",
                ...
                70,
                50, List.of(),
                List.of("Es erscheint im Augenblick des Todes und verschlingt die Seele des Verblichenen, sofort nachdem sie den Körper verlässt."),
                List.of(),
                List.of(
