...
public class Bearserk extends drai.dev.data.pokemon.Pokemon {
    public Bearserk() {
        super("Bearserk",
                Type.FIRE, Type.DARK,
                new Stats(95,
                ...
                List.of("This Pokemon appears to have been corrupted by a sinister force within the jungle. When a Bearserk begins attacking, it will not stop. In their anger, they may start wildfires that consume many acres of rainforest."),
                List.of(),
                List.of(
