...
import java.util.*;
public class SoulstonesanGolett extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanGolett(int dex) {
        super(dex, "Golett",
