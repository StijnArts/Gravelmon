...
import java.util.*;
public class Knarksel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Knarksel() {
        super("Knarksel",
                ...
                70,
                50, List.of(),
                List.of("Es liebt funkelnde Dinge und sucht nach Schätzen in Höhlen, die es dann in seinem Nest hortet."),
                List.of(),
                List.of(
