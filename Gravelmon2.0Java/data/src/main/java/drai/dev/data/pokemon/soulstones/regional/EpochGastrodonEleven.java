...
import java.util.*;
public class EpochGastrodonEleven extends drai.dev.data.pokemon.Pokemon {
    public EpochGastrodonEleven(String name, Aspect aspect) {
        super(name, aspect, "EpochGastrodonEleven",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.GEOMANCY,1),
