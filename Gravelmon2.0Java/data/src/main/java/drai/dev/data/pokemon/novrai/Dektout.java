...
public class Dektout extends drai.dev.data.pokemon.Pokemon {
    public Dektout() {
        super("Dektout",
                ...
                List.of("It hates to lose, and it never plays fair. With a strange power, it sees into the hearts of its opponents and manipulates them to achieve victory."),
                List.of(),
                List.of(
