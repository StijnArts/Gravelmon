...
import java.util.*;
public class Nananan extends drai.dev.data.pokemon.Pokemon {
    public Nananan() {
        super("Nananan",
                Type.FAIRY,
                new Stats(50,
                ...
                List.of("Layers of pastry form impenetrable armor over its body. Its nonchalant nature comes from knowing it can take a bomb blast without a scratch."),
                List.of(),
                List.of(
