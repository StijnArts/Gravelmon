...
import java.util.*;
public class EpochMeowscarada extends drai.dev.data.pokemon.Pokemon {
    public EpochMeowscarada(String name, Aspect aspect) {
        super(name, aspect, "EpochMeowscarada",
                ...
                List.of("A skilled wizard, well versed in the magical arts. It is able to cast an array of magical spells and enchantments."),
                List.of(),
                List.of(
