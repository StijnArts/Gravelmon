...
import java.util.*;
public class Flampion extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flampion() {
        super("Flampion",
                Type.FIRE,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Früher nutzte man die heißen Ausscheidungen von Flampion, um sich den Körper zu wärmen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.OVERHEAT,42),
