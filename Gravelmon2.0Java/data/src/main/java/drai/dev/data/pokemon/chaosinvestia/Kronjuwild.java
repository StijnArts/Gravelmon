...
import java.util.*;
public class Kronjuwild extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kronjuwild() {
        super("Kronjuwild",
                ...
                70,
                50, List.of(),
                List.of("Je nach Jahreszeit wächst eine andere Pflanze auf seinem Geweih. Exemplare mit prächtiger Krone führen die Herde an."),
                List.of(),
                List.of(
