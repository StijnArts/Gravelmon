...
import java.util.*;
public class Clamperl extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clamperl() {
        super("Clamperl",
                Type.WATER,
                new Stats(35,
                ...
                70,
                50, List.of(),
                List.of("It is protected by a sturdy shell. Once in a lifetime, it makes a magnificent pearl."),
                List.of(),
                List.of(
