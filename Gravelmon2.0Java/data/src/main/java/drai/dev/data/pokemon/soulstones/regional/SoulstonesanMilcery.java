...
import java.util.*;
public class SoulstonesanMilcery extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMilcery(int dex) {
        super(dex, "Milcery",
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MELTAWAY,"egg"),
