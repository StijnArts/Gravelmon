...
import java.util.*;
public class EpochWeepinbell extends drai.dev.data.pokemon.Pokemon {
    public EpochWeepinbell(String name, Aspect aspect) {
        super(name, aspect, "EpochWeepinbell",
                ...
                List.of("It screams in agony as it rots away. The sound of its suffering is enough to terrorize those around it."),
                List.of(new EvolutionEntry("epochvictreebel", EvolutionType.ITEM_INTERACT, false, List.of(), 
