...
import java.util.*;
public class TVanilluxe extends drai.dev.gravelmon.pokemon.Pokemon {
    public TVanilluxe() {
        super("TVanilluxe",
                Type.FIRE,Type.ROCK,
                new Stats(71,
                ...
                List.of("One of its heads spews only sulfur whereas the other spews lava. They are constantly competing with one another to see which substance is produced most."),
                List.of(),
                List.of(
