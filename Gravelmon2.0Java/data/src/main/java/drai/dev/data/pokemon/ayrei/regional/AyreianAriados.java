...
import java.util.*;
public class AyreianAriados extends drai.dev.gravelmon.pokemon.Pokemon {
    public AyreianAriados(int dex) {
        super(dex, "Ariados",
                Type.BUG,Type.DARK,
                new Stats(70,
                        90,
                        ...
                        95,
                        65),
                List.of(Ability.MOLD_BREAKER,Ability.LONG_REACH), null,
                11, 335,
                ...
                70,
                50, List.of(),
                List.of("It uses the bright light emanating from its torso to blind its prey before striking."),
                List.of(),
                List.of(
