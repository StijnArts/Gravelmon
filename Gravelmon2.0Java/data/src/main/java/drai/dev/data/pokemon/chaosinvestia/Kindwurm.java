...
import java.util.*;
public class Kindwurm extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kindwurm() {
        super("Kindwurm",
                Type.DRAGON,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Es träumt davon, eines Tages fliegen zu können und springt daher jeden Tag von hohen Klippen."),
                List.of(),
                List.of(
