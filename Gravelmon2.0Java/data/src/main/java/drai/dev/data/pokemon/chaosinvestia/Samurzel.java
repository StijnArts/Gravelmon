...
import java.util.*;
public class Samurzel extends drai.dev.gravelmon.pokemon.Pokemon {
    public Samurzel() {
        super("Samurzel",
                Type.GRASS,
                new Stats(40,
                        ...
                        30,
                        30),
                List.of(Ability.CHLOROPHYLL,Ability.EARLY_BIRD), null,
                5, 40,
                ...
                70,
                50, List.of(),
                List.of("Es sieht aus wie eine Eichel, die am Baum hängt. Es liebt es, andere Pokémon zu erschrecken."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.NATURE_POWER,13),
