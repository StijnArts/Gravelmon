...
import java.util.*;
public class SoulstonesanEmboar extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanEmboar(int dex) {
        super(dex, "Emboar",
                ...
                0.875,
                264, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.FIELD),
                List.of("This Pokemon has jagged rocks that are encrusted into its skin around its torso. It can take these jagged rocks and fling them at enemies."),
                List.of(),
                List.of(
