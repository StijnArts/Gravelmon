...
import java.util.*;
public class Cryodrago extends drai.dev.data.pokemon.Pokemon {
    public Cryodrago() {
        super("Cryodrago",
                ...
                List.of("The areas in which the Cryodra resides are covered with beautiful crystals. It is said that there is a hidden crystal valley where many Cryodras gather."),
                List.of(),
                List.of(
