...
import java.util.*;
public class Waaty extends drai.dev.gravelmon.pokemon.Pokemon {
    public Waaty() {
        super("Waaty",
                Type.ELECTRIC,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Hat es sich mit Elektrizität aufgeladen, leuchtet sein Schweif und es feuert Haare ab, die sich entladen."),
                List.of(),
                List.of(
