...
import java.util.*;
public class JellitotOne extends drai.dev.data.pokemon.Pokemon {
    public JellitotOne() {
        super("JellitotOne",
                Type.WATER,
                new Stats(65,
                ...
                List.of("Jellitot♀'s body mainly consists of water. Although they can survive in most climates, a temperature that is too warm or too cold will tire them out."),
                List.of(new EvolutionEntry("jellinip", EvolutionType.LEVEL_UP, List.of(), 
