...
public class Morboose extends drai.dev.data.pokemon.Pokemon {
    public Morboose() {
        super("Morboose",
                ...
                new Stats(95,
                        ...
                        70,
                        80),
                List.of(Ability.CUD_CHEW,Ability.STRONG_JAW,Ability.PRESSURE), Ability.PRESSURE,
                33, 165,
                ...
                List.of("Its glowing antlers attract wandering spirits which then fall under its command. A foe that endures the onslaught of angry souls will find itself staring down a furious, charging Morboose."),
                List.of(),
                List.of(
