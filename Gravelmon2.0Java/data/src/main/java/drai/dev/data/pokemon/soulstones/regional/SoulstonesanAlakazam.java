...
import java.util.*;
public class SoulstonesanAlakazam extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanAlakazam(int dex) {
        super(dex, "Alakazam",
                ...
                0.25,
                225, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("Its Nunchakus are an extension of its arms. It has learned to use them seamlessly and flawlessly."),
                List.of(),
                List.of(
