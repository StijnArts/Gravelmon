...
import java.util.*;
public class SoulstonesanToxicroak extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanToxicroak(int dex) {
        super(dex, "Toxicroak",
                ...
                0.5,
                172, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("Squeezing one of the poisonous sacs on its skin can cause it to explode, which could trigger a corrosive reaction."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.MEMORYBLOCK,8),
                        new MoveLearnSetEntry(Move.MANICOVERLOAD,49),
                        new MoveLearnSetEntry(Move.HYPNOSIS,20),
                        new MoveLearnSetEntry(Move.PSYCHOBREAK,35),
                        ...
                        new MoveLearnSetEntry(Move.MOSSYPUNCH,1),
                        new MoveLearnSetEntry(Move.POISONSPIT,12),
                        new MoveLearnSetEntry(Move.ALKALINEBOMB,24),
