...
import java.util.*;
public class Knakrack extends drai.dev.gravelmon.pokemon.Pokemon {
    public Knakrack() {
        super("Knakrack",
                ...
                70,
                50, List.of(),
                List.of("Die schnelle Bewegung seiner Flügel erzeugt regelrechte Klingen des Windes, die Bäume fällen können."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DUAL_CHOP,24),
