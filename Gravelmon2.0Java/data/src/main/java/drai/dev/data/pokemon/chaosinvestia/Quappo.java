...
import java.util.*;
public class Quappo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Quappo() {
        super("Quappo",
                ...
                70,
                50, List.of(),
                List.of("Es hat extrem starke Muskeln und kann durch den Ozean schwimmen, ohne sich ausruhen zu müssen."),
                List.of(),
                List.of(
