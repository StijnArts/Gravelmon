...
public class NorheimanNumel extends drai.dev.data.pokemon.Pokemon {
    public NorheimanNumel(String name, Aspect aspect) {
        super(name, aspect, "Numel",
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 6, 31, 9, List.of(
