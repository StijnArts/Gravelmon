...
import java.util.*;
public class AyreianGraveler extends drai.dev.data.pokemon.Pokemon {
    public AyreianGraveler(String name, Aspect aspect) {
        super(name, aspect, "Graveler",
                ...
                List.of("It burrows deep in caves, indistinguishable from nearby rocks. Unaware prey is grabbed with all four limbs and eaten."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.POWER_GEM,0),
