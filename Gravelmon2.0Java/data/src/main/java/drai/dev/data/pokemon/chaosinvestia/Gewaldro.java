...
import java.util.*;
public class Gewaldro extends drai.dev.gravelmon.pokemon.Pokemon {
    public Gewaldro() {
        super("Gewaldro",
                Type.GRASS,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("Die Blätter an seinen Armen können dicke Bäume fällen. Im Dschungelkampf gibt es kein stärkeres Pokémon."),
                List.of(),
                List.of(
