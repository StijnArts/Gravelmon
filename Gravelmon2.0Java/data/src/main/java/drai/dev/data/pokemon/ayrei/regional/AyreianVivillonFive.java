...
import java.util.*;
public class AyreianVivillonFive extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonFive(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonFive",
                Type.STEEL,Type.BUG,
                new Stats(80,
                        52,
                        65,
