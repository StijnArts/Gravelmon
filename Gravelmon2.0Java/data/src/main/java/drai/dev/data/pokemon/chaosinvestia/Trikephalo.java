...
import java.util.*;
public class Trikephalo extends drai.dev.gravelmon.pokemon.Pokemon {
    public Trikephalo() {
        super("Trikephalo",
                ...
                70,
                50, List.of(),
                List.of("Die Köpfe an seinen beiden Armen haben kein eigenes Gehirn. Seine drei Mäuler kauen alles radikal kurz und klein."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.SLAM,28),
                        new MoveLearnSetEntry(Move.OUTRAGE,79),
                        ...
                        new MoveLearnSetEntry(Move.SCARY_FACE,55),
