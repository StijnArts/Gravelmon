...
import java.util.*;
public class SoulstonesanPawmi extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPawmi(int dex) {
        super(dex, "Pawmi",
                Type.NORMAL,
                new Stats(45,
                        50,
