...
import java.util.*;
public class Knogga extends drai.dev.gravelmon.pokemon.Pokemon {
    public Knogga() {
        super("Knogga",
                Type.GROUND,
                new Stats(60,
                ...
                70,
                50, List.of(),
                List.of("Von Geburt an trägt dieses wilde Pokémon Knochen. Es setzt sie talentiert als Waffen ein."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BONE_RUSH,43),
