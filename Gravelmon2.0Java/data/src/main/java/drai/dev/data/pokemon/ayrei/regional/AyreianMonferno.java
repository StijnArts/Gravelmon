...
import java.util.*;
public class AyreianMonferno extends drai.dev.data.pokemon.Pokemon {
    public AyreianMonferno(String name, Aspect aspect) {
        super(name, aspect, "Monferno",
                ...
                List.of("It's speed is barely matched by its rivals. Its punches are almost invisible due to how fast it strikes."),
                List.of(),
                List.of(
