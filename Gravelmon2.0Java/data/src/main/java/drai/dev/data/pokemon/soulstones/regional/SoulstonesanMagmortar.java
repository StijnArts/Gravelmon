...
import java.util.*;
public class SoulstonesanMagmortar extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMagmortar(int dex) {
        super(dex, "Magmortar",
                Type.WATER,Type.ICE,
                new Stats(108,
                        105,
                ...
                0.25,
                243, ExperienceGroup.MEDIUM,
                70,
                50, List.of(EggGroup.HUMAN_LIKE),
                List.of("It likes to sink ice breaker ships by blasting them with solid chunks of ice. It has caused millions in damages to local governments."),
                List.of(),
                List.of(
