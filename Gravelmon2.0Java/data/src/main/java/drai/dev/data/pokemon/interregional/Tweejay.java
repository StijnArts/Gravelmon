...
public class Tweejay extends drai.dev.data.pokemon.Pokemon {
    public Tweejay() {
        super("Tweejay",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("marchawk", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                        ...
                        new BiomeSpawnCondition(List.of(Biome.IS_PLAINS, Biome.IS_JUNGLE)),
