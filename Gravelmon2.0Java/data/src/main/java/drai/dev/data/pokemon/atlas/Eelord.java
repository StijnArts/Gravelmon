...
public class Eelord extends drai.dev.data.pokemon.Pokemon {
    public Eelord() {
        super("Eelord",
                ...
                List.of("Rumors say Eelord's blood can cure every disease. It has been hunted all over the world for its blood, and now only a few remain."),
                List.of(),
                List.of(
