...
import java.util.*;
public class Palimpalim extends drai.dev.gravelmon.pokemon.Pokemon {
    public Palimpalim() {
        super("Palimpalim",
                Type.PSYCHIC,
                new Stats(65,
                ...
                70,
                50, List.of(),
                List.of("Es ruft ein Echo in seinen Körper, das in Form wunderschöner Noten empordringt und Gegner erschreckt."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.WRAP,1),
                        new MoveLearnSetEntry(Move.SYNCHRONOISE,54),
                        ...
                        new MoveLearnSetEntry(Move.PSYWAVE,30),
                        new MoveLearnSetEntry(Move.UPROAR,17),
                        new MoveLearnSetEntry(Move.HEAL_BELL,38),
