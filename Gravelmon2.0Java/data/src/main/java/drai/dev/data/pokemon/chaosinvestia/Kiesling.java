...
import java.util.*;
public class Kiesling extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kiesling() {
        super("Kiesling",
                Type.ROCK,
                new Stats(55,
                ...
                70,
                50, List.of(),
                List.of("Wurde vor 100 Jahren nach einem großen Erdbeben in einer Erdspalte entdeckt. Es trägt eine Energiesphäre in sich."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SMACK_DOWN,23),
                        new MoveLearnSetEntry(Move.STONE_EDGE,36),
                        ...
                        new MoveLearnSetEntry(Move.ROCK_BLAST,14),
