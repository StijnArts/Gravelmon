...
import java.util.*;
public class Impergator extends drai.dev.gravelmon.pokemon.Pokemon {
    public Impergator() {
        super("Impergator",
                Type.WATER,
                new Stats(85,
                ...
                70,
                50, List.of(),
                List.of("Eigentlich bewegt es sich langsam,doch seine Beute greift es blitzschnell an."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AGILITY,30),
                        new MoveLearnSetEntry(Move.AQUA_TAIL,63),
                        new MoveLearnSetEntry(Move.FLAIL,24),
                        new MoveLearnSetEntry(Move.HYDRO_PUMP,76),
