...
import java.util.*;
public class SoulstonesanScolipede extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanScolipede(int dex) {
        super(dex, "Scolipede",
                ...
                25, 2005,
                new Stats(1,35,99,72,85,99), 100,
                0.5,
                218, ExperienceGroup.PARABOLIC,
                70,
                50, List.of(EggGroup.BUG),
                List.of("The original meteorite that controlled this Pokemon becomes simultaneously aware and is able to act in unison with other Scolipedes."),
                List.of(),
                List.of(
