...
import java.util.*;
public class FluxanTyrogueOne extends drai.dev.data.pokemon.Pokemon {
    public FluxanTyrogueOne(String name, Aspect aspect) {
        super(name, aspect, "FluxanTyrogueOne",
