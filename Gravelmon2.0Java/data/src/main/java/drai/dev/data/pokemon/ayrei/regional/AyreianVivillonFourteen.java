...
import java.util.*;
public class AyreianVivillonFourteen extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonFourteen(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonFourteen",
                Type.ICE,Type.BUG,
                new Stats(80,
                        52,
                        65,
