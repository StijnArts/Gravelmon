...
public class Skelerogue extends Pokemon {
    public Skelerogue() {
        super("Skelerogue",
                ...
                List.of("It requires seemingly no sustenance such as food or air. Although it can't swim, it will walk across the bottom of the sea until it makes it to shore."),
                List.of(new EvolutionEntry("navighast", EvolutionType.LEVEL_UP, List.of(),
