...
import java.util.*;
public class Endivie extends drai.dev.gravelmon.pokemon.Pokemon {
    public Endivie() {
        super("Endivie",
                Type.GRASS,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("Mit dem Blatt auf seinem Kopf bestimmt es die Temperatur und Feuchtigkeit. Es liebt Sonnenbäder."),
                List.of(),
                List.of(
