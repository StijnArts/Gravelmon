...
import java.util.*;
public class AyreianVivillonEleven extends drai.dev.data.pokemon.Pokemon {
    public AyreianVivillonEleven(String name, Aspect aspect) {
        super(name, aspect, "AyreianVivillonEleven",
