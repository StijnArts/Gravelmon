...
import java.util.*;
public class Paralsetto extends drai.dev.data.pokemon.Pokemon {
    public Paralsetto() {
        super("Paralsetto",
                Type.ICE,Type.FAIRY,
                new Stats(100,
                        ...
                        95,
                        45),
                List.of(Ability.SERENE_GRACE,Ability.FRIEND_GUARD), Ability.CACOPHONY,
                18, 775,
                ...
                List.of("Paralsetto are isolationists who prefer the cold winds of barren snowfields. They often are searching for the perfect gust of wind to create a beautiful melody with its harp tail vibrations."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.RAINBOWGUST,13),
                        ...
                        new MoveLearnSetEntry(Move.WHIRLWIND,60),
