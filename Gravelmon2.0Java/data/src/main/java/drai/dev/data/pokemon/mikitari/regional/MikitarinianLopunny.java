...
import java.util.*;
public class MikitarinianLopunny extends drai.dev.data.pokemon.Pokemon {
    public MikitarinianLopunny(String name, Aspect aspect) {
        super(name, aspect, "MikitarinianLopunny",
                Type.DARK,
                new Stats(65,
                        76,
                        84,
                        ...
                        96,
                        105),
                List.of(Ability.STAKEOUT,Ability.OBLIVIOUS), Ability.LIMBER,
                12, 333,
                ...
                List.of("It likes to toy with anyone who wander into the forest at night. It uses any opportunity to steal from humans."),
                List.of(),
                List.of(
