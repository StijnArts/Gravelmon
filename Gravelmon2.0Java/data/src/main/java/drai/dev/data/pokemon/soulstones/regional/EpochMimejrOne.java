...
import java.util.*;
public class EpochMimejrOne extends drai.dev.data.pokemon.Pokemon {
    public EpochMimejrOne(String name, Aspect aspect) {
        super(name, aspect, "EpochMimejrOne",
                ...
                List.of("A sinister force controls this Pokemon's actions. It is unable to break free and knows it has been imprisoned."),
                List.of(new EvolutionEntry("epochtwomrmime", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"20")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.HEXBOLT,"egg"),
