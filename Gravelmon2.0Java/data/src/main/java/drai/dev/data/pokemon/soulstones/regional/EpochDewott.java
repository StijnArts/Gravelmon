...
import java.util.*;
public class EpochDewott extends drai.dev.data.pokemon.Pokemon {
    public EpochDewott(String name, Aspect aspect) {
        super(name, aspect, "EpochDewott",
                ...
                List.of("It has equipped a toolbelt that carries a new hammer alongside a number of other useful tools that it has crafted itself."),
                List.of(new EvolutionEntry("epochsamurott", EvolutionType.LEVEL_UP, List.of(), 
