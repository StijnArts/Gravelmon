...
import java.util.*;
public class SoulstonesanBeautifly extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanBeautifly(int dex) {
        super(dex, "Beautifly",
                ...
                List.of("It spreads colourful dust all about from its wings and can use its psychic powers to form dazzling imagery to impress potential mates."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.HARDEN,1),
                        new MoveLearnSetEntry(Move.FLUTTER,33),
