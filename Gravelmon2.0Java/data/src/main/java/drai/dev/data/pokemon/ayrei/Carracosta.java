...
import java.util.*;
public class Carracosta extends drai.dev.gravelmon.pokemon.Pokemon {
    public Carracosta() {
        super("Carracosta",
                ...
                70,
                50, List.of(),
                List.of("Carracosta completely devours its prey, bones, shells, and all. Because of this, Carracosta's own shell grows thick and sturdy."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SHELL_SMASH,51),
