...
import java.util.*;
public class IshirianElekid extends drai.dev.data.pokemon.Pokemon {
    public IshirianElekid(String name, Aspect aspect) {
        super(name, aspect, "IshirianElekid",
                Type.STEEL,
                new Stats(45,
                        65,
                        57,
                ...
                List.of(new EvolutionEntry("ishirianelectabuzz", EvolutionType.LEVEL_UP, List.of(),
