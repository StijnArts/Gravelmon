...
import java.util.*;
public class SoulstonesanPorygon extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanPorygon(int dex) {
        super(dex, "Porygon",
                Type.BUG,Type.DARK,
                new Stats(65,
                        85,
                ...
                8, 365,
                new Stats(65,1,70,50,50,75), 95,
                -1.0,
                79, ExperienceGroup.MEDIUM,
                70,
