...
public class EpochReuniclus extends drai.dev.data.pokemon.Pokemon {
    public EpochReuniclus(String name, Aspect aspect) {
        super(name, aspect, "EpochReuniclus",
                ...
                List.of("These Pokemon are capable of bending water to its will and forming fantastic water sculptures with its mind."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.SUBMERGED, SpawnPool.RARE, 44, 56, .1, List.of(
