...
import java.util.*;
public class Gladiantri extends drai.dev.gravelmon.pokemon.Pokemon {
    public Gladiantri() {
        super("Gladiantri",
                ...
                new Stats(45,
                        ...
                        40,
                        40),
                List.of(Ability.DEFIANT,Ability.INNER_FOCUS), null,
                5, 102,
                ...
                70,
                50, List.of(),
                List.of("Im Kampf folgt es den Befehlen von Caesurio. Es nimmt sein Opfer in die Zange und verletzt es mit seinen Klingen."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.METAL_SOUND,38),
                        new MoveLearnSetEntry(Move.TORMENT,14),
                        new MoveLearnSetEntry(Move.FURY_CUTTER,9),
                        new MoveLearnSetEntry(Move.GUILLOTINE,62),
                        new MoveLearnSetEntry(Move.ASSURANCE,33),
                        new MoveLearnSetEntry(Move.IRON_HEAD,54),
