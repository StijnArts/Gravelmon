...
public class EpochGreedent extends drai.dev.data.pokemon.Pokemon {
    public EpochGreedent(String name, Aspect aspect) {
        super(name, aspect, "EpochGreedent",
                ...
                List.of("It hibernates in summer and emerges during winter. It prefers colder environments where it can easily find frozen food."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ICE_BALL,15),
                        ...
                        new MoveLearnSetEntry(Move.HYPER_FANG,40),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 24, 47, .6, List.of(
