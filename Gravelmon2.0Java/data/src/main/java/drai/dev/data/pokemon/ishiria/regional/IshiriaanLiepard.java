...
import java.util.*;
public class IshiriaanLiepard extends drai.dev.data.pokemon.Pokemon {
    public IshiriaanLiepard(String name, Aspect aspect) {
        super(name, aspect, "IshiriaanLiepard",
                Type.DARK,Type.ICE,
                new Stats(64,
                        88,
                        50,
                ...
                List.of("Its always appears for a brief moment after a snowstorm. It likes luring humans and letting them helpless on top of snowy mountains"),
                List.of(),
                List.of(
