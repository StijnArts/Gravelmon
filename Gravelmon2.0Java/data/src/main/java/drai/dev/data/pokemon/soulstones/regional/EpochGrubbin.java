...
import java.util.*;
public class EpochGrubbin extends drai.dev.data.pokemon.Pokemon {
    public EpochGrubbin(String name, Aspect aspect) {
        super(name, aspect, "EpochGrubbin",
                ...
                List.of("It uses its rail-like mandibles to focus light from its bulb into bursts capable of melting rock, which it then eats."),
                List.of(new EvolutionEntry("epochcharjabug", EvolutionType.LEVEL_UP, List.of(), 
