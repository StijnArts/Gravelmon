...
import java.util.*;
public class Heiteira extends drai.dev.gravelmon.pokemon.Pokemon {
    public Heiteira() {
        super("Heiteira",
                Type.NORMAL,
                new Stats(255,
                ...
                70,
                50, List.of(),
                List.of("Eier, die es legt, stecken voller Fröhlichkeit. Schon ein Bissen erzeugt ein breites Lächeln."),
                List.of(),
                List.of(
