...
import java.util.*;
public class Stahlos extends drai.dev.gravelmon.pokemon.Pokemon {
    public Stahlos() {
        super("Stahlos",
                ...
                70,
                50, List.of(),
                List.of("Man glaubt, dass sich sein Körper aufgrund des Schluckens von eisenhaltiger Erde verwandelt habe."),
                List.of(),
                List.of(
