...
import java.util.*;
public class Flampivian extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flampivian() {
        super("Flampivian",
                Type.FIRE,
                new Stats(105,
                ...
                70,
                50, List.of(),
                List.of("Schwächt man es im Kampf, wird es reglos wie ein Stein und horcht in sich hinein, um mit der Kraft seines Geistes zu kämpfen."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.FIRE_PUNCH,22),
                        ...
                        new MoveLearnSetEntry(Move.THRASH,27),
                        new MoveLearnSetEntry(Move.INCINERATE,6),
                        new MoveLearnSetEntry(Move.TAUNT,39),
                        new MoveLearnSetEntry(Move.ROLLOUT,3),
                        new MoveLearnSetEntry(Move.HAMMER_ARM,35),
