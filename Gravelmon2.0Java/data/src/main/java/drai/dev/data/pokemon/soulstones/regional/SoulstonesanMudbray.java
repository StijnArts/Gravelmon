...
import java.util.*;
public class SoulstonesanMudbray extends drai.dev.gravelmon.pokemon.Pokemon {
    public SoulstonesanMudbray(int dex) {
        super(dex, "Mudbray",
                Type.NORMAL,
                new Stats(70,
                        100,
