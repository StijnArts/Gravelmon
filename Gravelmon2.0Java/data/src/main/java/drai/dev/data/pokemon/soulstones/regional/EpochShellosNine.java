...
import java.util.*;
public class EpochShellosNine extends drai.dev.data.pokemon.Pokemon {
    public EpochShellosNine(String name, Aspect aspect) {
        super(name, aspect, "EpochShellosNine",
                ...
                List.of(new EvolutionEntry("epochnine gastrodon", EvolutionType.LEVEL_UP, List.of(),
