...
import java.util.*;
public class IshirianRalts extends drai.dev.data.pokemon.Pokemon {
    public IshirianRalts(String name, Aspect aspect) {
        super(name, aspect, "IshirianRalts",
                ...
                List.of(new EvolutionEntry("ishiriankirlia", EvolutionType.LEVEL_UP, List.of(),
