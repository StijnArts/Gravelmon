...
public class EpochKlinklang extends drai.dev.data.pokemon.Pokemon {
    public EpochKlinklang(String name, Aspect aspect) {
        super(name, aspect, "EpochKlinklang",
                ...
                List.of("When it is perfectly synchronized, the bells on Klinklang will ring to let you know."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 44, 57, .1, List.of(
