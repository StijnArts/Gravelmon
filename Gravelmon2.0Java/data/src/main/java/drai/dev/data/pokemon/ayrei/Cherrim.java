...
import java.util.*;
public class Cherrim extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cherrim() {
        super("Cherrim",
                Type.GRASS,
                new Stats(70,
                ...
                70,
                50, List.of(),
                List.of("The faint scent that emanates from its full blossom entices bug Pokémon to it."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.LEECH_SEED,28),
                        new MoveLearnSetEntry(Move.PETAL_DANCE,62),
