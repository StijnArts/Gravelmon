...
import java.util.*;
public class Slibloo extends drai.dev.data.pokemon.Pokemon {
    public Slibloo() {
        super("Slibloo",
                Type.POISON,
                new Stats(40,
                ...
                List.of("Slibloo are said to be a collective being of fungus gathered together. Even if it is struck apart, it can reform with much ease."),
                List.of(new EvolutionEntry("fungerm", EvolutionType.LEVEL_UP, List.of(), 
 List.of(new EvolutionRequirementEntry(EvolutionRequirementCondition.LEVEL,"29")))),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SULFURIC_SPRAY,43),
                        ...
                        new MoveLearnSetEntry(Move.SLEEP_POWDER,39),
