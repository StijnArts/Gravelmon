...
import java.util.*;
public class Piccolente extends drai.dev.gravelmon.pokemon.Pokemon {
    public Piccolente() {
        super("Piccolente",
                ...
                70,
                50, List.of(),
                List.of("Gerät es in Gefahr, versprüht es Wasser aus seinem Federkleid und nutzt den Sprühregen, um Reißaus zu nehmen."),
                List.of(),
                List.of(
