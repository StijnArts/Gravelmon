...
import java.util.*;
public class Driftlon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Driftlon() {
        super("Driftlon",
                ...
                70,
                50, List.of(),
                List.of("Laut einer alten Volkssage nennt man es den „Wegweiser für umherstreifende Geister“."),
                List.of(),
                List.of(
