...
import java.util.*;
public class Dartiri extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dartiri() {
        super("Dartiri",
                ...
                70,
                50, List.of(),
                List.of("Ein sehr zutrauliches Pokémon. Durch Zwitschern und Bewegen der Schwanzfedern sendet es Signale an seine Gefährten."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.AGILITY,13),
                        new MoveLearnSetEntry(Move.STEEL_WING,48),
                        new MoveLearnSetEntry(Move.QUICK_ATTACK,6),
                        new MoveLearnSetEntry(Move.FLAIL,16),
                        new MoveLearnSetEntry(Move.ME_FIRST,41),
                        new MoveLearnSetEntry(Move.TACKLE,1),
                        new MoveLearnSetEntry(Move.FLAME_CHARGE,34),
