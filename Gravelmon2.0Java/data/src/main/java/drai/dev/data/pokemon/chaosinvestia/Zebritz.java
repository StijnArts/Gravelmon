...
import java.util.*;
public class Zebritz extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zebritz() {
        super("Zebritz",
                Type.ELECTRIC,
                new Stats(75,
                        ...
                        80,
                        63),
                List.of(Ability.LIGHTNING_ROD,Ability.MOTOR_DRIVE), null,
                16, 795,
                ...
                70,
                50, List.of(),
                List.of("Ein stürmischer Geselle. Besonders gefährlich ist es, wenn es wütend ist und in alle Richtungen Stromsalven entlädt."),
                List.of(),
                List.of(
