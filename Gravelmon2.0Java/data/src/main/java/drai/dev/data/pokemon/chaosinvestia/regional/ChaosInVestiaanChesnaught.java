...
import java.util.*;
public class ChaosInVestiaanChesnaught extends drai.dev.data.pokemon.Pokemon {
    public ChaosInVestiaanChesnaught(String name, Aspect aspect) {
        super(name, aspect, "Chesnaught",
