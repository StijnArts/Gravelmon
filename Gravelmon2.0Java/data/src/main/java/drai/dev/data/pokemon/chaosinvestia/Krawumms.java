...
import java.util.*;
public class Krawumms extends drai.dev.gravelmon.pokemon.Pokemon {
    public Krawumms() {
        super("Krawumms",
                Type.NORMAL,
                new Stats(104,
                ...
                70,
                50, List.of(),
                List.of("Sein Heulen hört man in 10 km Entfernung. Es gibt alle Arten von Geräuschen von sich."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SLEEP_TALK,63),
