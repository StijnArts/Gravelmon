...
import java.util.*;
public class Meganie extends drai.dev.gravelmon.pokemon.Pokemon {
    public Meganie() {
        super("Meganie",
                Type.GRASS,
                new Stats(80,
                ...
                70,
                50, List.of(),
                List.of("Mit seinem Atem kann es tote Pflanzen und Blumen zu neuem Leben erwecken."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.POISON_POWDER,9),
                        new MoveLearnSetEntry(Move.PETAL_DANCE,32),
                        new MoveLearnSetEntry(Move.TACKLE,1),
                        new MoveLearnSetEntry(Move.SOLAR_BEAM,66),
                        new MoveLearnSetEntry(Move.REFLECT,18),
                        new MoveLearnSetEntry(Move.SAFEGUARD,54),
                        ...
                        new MoveLearnSetEntry(Move.SWEET_SCENT,34),
                        ...
                        new MoveLearnSetEntry(Move.NATURAL_GIFT,26)                        ),
