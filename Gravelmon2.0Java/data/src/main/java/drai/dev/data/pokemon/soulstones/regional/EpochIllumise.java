...
import java.util.*;
public class EpochIllumise extends drai.dev.data.pokemon.Pokemon {
    public EpochIllumise(String name, Aspect aspect) {
        super(name, aspect, "EpochIllumise",
                Type.BUG,Type.ROCK,
                new Stats(70,
                        47,
                        70,
                        ...
                        73,
                        90),
                List.of(Ability.LIGHTAURA,Ability.TORMENTED), Ability.INSOMNIA,
                6, 177,
                new Stats(0,0,0,0,0,1), 150,
                0.0,
                151, ExperienceGroup.FLUCTUATING,
                70,
                50, List.of(EggGroup.BUG,EggGroup.HUMAN_LIKE),
                List.of("They followed human miners into the depths, unearthing a terrible disease, causing their eyes to turn orange and sprout crystals from their exoskeleton."),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.PHEROMONESTREAM,30),
                        new MoveLearnSetEntry(Move.WEARDOWN,39),
                        new MoveLearnSetEntry(Move.DARKWHISPERS,1),
                        new MoveLearnSetEntry(Move.MINERALWAVE,15),
                        new MoveLearnSetEntry(Move.BLIGHT,33),
                        new MoveLearnSetEntry(Move.GEMSTORM,60),
                        new MoveLearnSetEntry(Move.BUG_BUZZ,42),
                        new MoveLearnSetEntry(Move.BLINDINGFLASH,45),
                        new MoveLearnSetEntry(Move.SIGNALOVERLOAD,56),
                        ...
                        new MoveLearnSetEntry(Move.DIAMOND_STORM,27),
                        new MoveLearnSetEntry(Move.SPARKLE,6),
                        new MoveLearnSetEntry(Move.CLACKACLACK,1),
                        ...
                        new MoveLearnSetEntry(Move.INFECTION,18),
                        new MoveLearnSetEntry(Move.AMBERWAVE,48),
                        ...
                        new MoveLearnSetEntry(Move.STONEGAZE,"egg"),
                        ...
                        new MoveLearnSetEntry(Move.DIRGE,"egg")),
