...
import java.util.*;
public class Amalgin extends drai.dev.data.pokemon.Pokemon {
    public Amalgin() {
        super("Amalgin",
                Type.DRAGON,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("chimericon", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.FLIGA),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 35, 47, 1.1, List.of(
