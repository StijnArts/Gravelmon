...
import java.util.*;
public class Claydol extends drai.dev.gravelmon.pokemon.Pokemon {
    public Claydol() {
        super("Claydol",
                ...
                List.of("Because it is able to detach itself using its psychic powers, but still control its limbs, it is able to mitigate damage to it and use surprise attacks."),
                List.of(),
                List.of(
