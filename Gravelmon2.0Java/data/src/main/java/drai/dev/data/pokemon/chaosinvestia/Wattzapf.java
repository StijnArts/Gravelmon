...
import java.util.*;
public class Wattzapf extends drai.dev.gravelmon.pokemon.Pokemon {
    public Wattzapf() {
        super("Wattzapf",
                ...
                new Stats(50,
                        ...
                        57,
                        50),
                List.of(Ability.COMPOUND_EYES,Ability.UNNERVE), null,
                1, 6,
                ...
                70,
                50, List.of(),
                List.of("Es pflanzt sich an großen Pokémon fest und zapft ihnen elektrische Energie ab. Diese hortet es in seinen Ladetaschen."),
                List.of(),
                List.of(
