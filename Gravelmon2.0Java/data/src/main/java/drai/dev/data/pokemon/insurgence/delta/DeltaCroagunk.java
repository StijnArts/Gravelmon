...
public class DeltaCroagunk extends Pokemon {
    public DeltaCroagunk(String name, Aspect aspect) {
        super(name, aspect,"DeltaCroagunk",
                Type.FIRE,
                new Stats(48, 61,40,61,40,50),
                ...
                List.of("A Delta Species discovered by pokefan1241. Its cheeks hold large amounts of fire. It generates thick smog to sneak up behind its opponents and attack them."),
                List.of(new EvolutionEntry("deltatoxicroak", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WORK_UP,38),
