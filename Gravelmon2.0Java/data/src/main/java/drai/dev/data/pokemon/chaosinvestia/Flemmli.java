...
import java.util.*;
public class Flemmli extends drai.dev.gravelmon.pokemon.Pokemon {
    public Flemmli() {
        super("Flemmli",
                Type.FIRE,
                new Stats(45,
                ...
                70,
                50, List.of(),
                List.of("In seinem Inneren lodert ein Feuer. Es schleudert 1 000 Grad heiße Feuerbälle."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SAND_ATTACK,19),
