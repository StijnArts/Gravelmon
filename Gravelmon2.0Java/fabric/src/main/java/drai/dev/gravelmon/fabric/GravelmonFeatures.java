...
public class GravelmonFeatures {
    ...
    public static final ResourceKey<PlacedFeature> ASTRAL_ORE_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("gravelmon","overworld_astral_ore"));
    public static final ResourceKey<PlacedFeature> AIR_ORE_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("gravelmon","overworld_air_ore"));
    public static final ResourceKey<PlacedFeature> MYSTIC_ORE_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("gravelmon","overworld_mystic_ore"));
    public static final ResourceKey<PlacedFeature> SOLID_ORE_PLACED_KEY =
            ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("gravelmon","overworld_solid_ore"));
