...
import java.util.*;
public class Spritzee extends drai.dev.gravelmon.pokemon.Pokemon {
    public Spritzee(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Spritzee",
                Type.FAIRY,
                new Stats(78,
                        52,
                        60,
                ...
                List.of("It emits a scent that enraptures those who smell it. This fragrance changes depending on what it has eaten."),
                List.of(),
                List.of(
