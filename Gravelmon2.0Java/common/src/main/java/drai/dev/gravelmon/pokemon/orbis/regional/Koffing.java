...
public class Koffing extends drai.dev.gravelmon.pokemon.Pokemon {
    public Koffing(String name, Aspect aspect) {
        super(name, aspect, "Koffing",
                ...
                List.of("Koffing embodies toxic substances. It mixes the toxins with raw garbage to set off a chemical reaction that results in a terribly powerful Poison Gas. The higher the temperature, the more gas is concocted by this Pokémon."),
                List.of(),
                List.of(
