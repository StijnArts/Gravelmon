...
import java.util.*;
public class Atillohunn extends drai.dev.gravelmon.pokemon.Pokemon {
    public Atillohunn() {
        super("Atillohunn",
                Type.NORMAL,
                new Stats(110,
                        ...
                        80,
                        70),
                List.of(Ability.INTIMIDATE,Ability.RIVALRY), Ability.ANGER_POINT,
                31, 1105,
                new Stats(1,1,0,0,0,0), 40,
                1.0,
