...
public class Crustle extends drai.dev.gravelmon.pokemon.Pokemon {
    public Crustle(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Crustle",
                Type.BUG, Type.ROCK,
                new Stats(70,
                        85,
                        115,
                ...
                List.of("Competing for territory, Crustle fight viciously. The one whose boulder is broken is the loser of the battle."),
                List.of(),
                List.of(
