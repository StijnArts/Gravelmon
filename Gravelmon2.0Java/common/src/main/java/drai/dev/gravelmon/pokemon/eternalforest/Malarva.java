...
public class Malarva extends Pokemon {
    public Malarva() {
        super("Malarva",
                ...
                List.of("Malarva is a parasite that likes to settle on large Pokémon to feed on their blood. It is said that the first strains of the Pokérus were found on this Pokémon and that it is the cause of its propagation."),
