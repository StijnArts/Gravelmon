...
public class Elekid extends drai.dev.gravelmon.pokemon.Pokemon {
    public Elekid(String name, Aspect aspect) {
        super(name, aspect, "Elekid",
                Type.ELECTRIC,
                new Stats(45,
                        63,
                        37,
                ...
                List.of("Elekid stores electricity in its body. If it touches metal and accidentally discharges all its built-up electricity, this Pokémon begins swinging its arms in circles to recharge itself."),
                List.of(),
                List.of(
