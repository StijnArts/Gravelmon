...
public class DeltaTentacruel extends Pokemon {
    public DeltaTentacruel(String originalMon, Aspect aspect) {
        super(originalMon, aspect,"DeltaTentacruel",
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 39, 57, 0.2, List.of(
