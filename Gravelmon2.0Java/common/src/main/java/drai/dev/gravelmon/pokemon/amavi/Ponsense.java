...
import java.util.*;
public class Ponsense extends drai.dev.gravelmon.pokemon.Pokemon {
    public Ponsense() {
        super("Ponsense",
                Type.NORMAL,
                new Stats(50,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("rhombish", EvolutionType.LEVEL_UP, List.of(),
