...
import java.util.*;
public class Celebaa extends drai.dev.gravelmon.pokemon.Pokemon {
    public Celebaa() {
        super("Celebaa",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("crestival", EvolutionType.LEVEL_UP, List.of(),
