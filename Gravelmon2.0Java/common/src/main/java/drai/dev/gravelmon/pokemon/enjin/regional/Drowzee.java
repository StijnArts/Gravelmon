...
public class Drowzee extends drai.dev.gravelmon.pokemon.Pokemon {
    public Drowzee(int dex) {
        super(dex, "Drowzee",
                ...
                List.of("If your nose becomes itchy while you are sleeping, it's a sure sign that one of these Pokémon is standing above your pillow and trying to eat your dream through your nostrils."),
                List.of(),
                List.of(
