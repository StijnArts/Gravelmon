...
import java.util.*;
public class Kragken extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kragken() {
        super("Kragken",
                ...
                List.of("Kragken lives in the darkest reaches of the ocean, its many eyes glowing ominously in the abyss. It surrounds prey in a cloud of inky smoke before engulfing them in its body to consume them."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRAGUNDER,60),
