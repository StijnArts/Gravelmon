...
public class Cuncoldron extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cuncoldron() {
        super("Cuncoldron",
                ...
                List.of("- AcidSTAB Poison - Acid Armor Poison - Acid SpraySTAB Poison - Poison Gas Poison - AstonishSTAB Ghost - Shadow BallSTAB Ghost - Memento Dark - Clear SmogSTAB Poison - Gastro Acid Poison - SludgeSTAB Poison - Sludge BombSTAB Poison - Caustic Breath Dragon - Singe Fire - Corrosion WaveSTAB Poison - Liquid Metal Steel"),
                List.of(),
                List.of(
                        new MoveLearnSetEntry(Move.LIQUIDMETAL,1),
