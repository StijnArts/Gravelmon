...
import java.util.*;
public class Blissey extends drai.dev.gravelmon.pokemon.Pokemon {
    public Blissey(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Blissey",
                Type.NORMAL,
                new Stats(255,
                        10,
                        10,
                        ...
                        135,
                        55),
                List.of(Ability.NATURAL_CURE,Ability.SERENE_GRACE), Ability.HEALER,
                15, 468,
                ...
                List.of("Blissey senses sadness with its fluffy coat of fur. If it does so, this Pokémon will rush over to a sad person, no matter how far away, to share a Lucky Egg that brings a smile to any face."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DOUBLEEDGE,65),
