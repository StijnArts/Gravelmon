...
import java.util.*;
public class Feilex extends drai.dev.gravelmon.pokemon.Pokemon {
    public Feilex() {
        super("Feilex",
                Type.FIGHTING,
                new Stats(45,
                ...
                List.of("Added Dec 17 2021 Evo line: Evolves at Level 24 Habitat: Jungle and grasslands"),
                List.of(),
                List.of(
