...
public class Bellabaah extends drai.dev.gravelmon.pokemon.Pokemon {
    public Bellabaah() {
        super("Bellabaah",
                ...
                new Stats(107,
                        ...
                        70,
                        51),
                List.of(Ability.CACOPHONY), Ability.FLUFFY,
                16, 165,
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 29, 43, .4, List.of(
