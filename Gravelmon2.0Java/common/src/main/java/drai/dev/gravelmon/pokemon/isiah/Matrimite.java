...
public class Matrimite extends drai.dev.gravelmon.pokemon.Pokemon {
    public Matrimite() {
        super("Matrimite",
                Type.BUG,
                new Stats(0,
                ...
                List.of(""),
                List.of(new EvolutionEntry("gremite", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.ISIAH),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 1, 18, 4, List.of(
