...
public class Voltasu extends Pokemon {
    public Voltasu() {
        super("Voltasu",
                ...
                List.of("It perches on rocky outcropping and looks at the sky for many hours. They can fortell changes in the weather."),
                List.of(new EvolutionEntry("yatagaryu", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.DRACO_METEOR,74),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 42, 55, 3, List.of(
