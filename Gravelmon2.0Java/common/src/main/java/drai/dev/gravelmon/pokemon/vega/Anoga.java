...
public class Anoga extends Pokemon {
    public Anoga() {
        super( "Anoga",
                Type.ELECTRIC, Type.GROUND,
                new Stats(60	,70	,60	,90	,80	,60),
                ...
                List.of(""),
                List.of(new EvolutionEntry("Kasodan", EvolutionType.ITEM_INTERACT, false, List.of(),
                ...
                0,
                List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 47, 57, 3, List.of(
