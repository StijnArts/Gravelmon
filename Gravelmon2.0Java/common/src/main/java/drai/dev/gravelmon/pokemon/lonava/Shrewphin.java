...
public class Shrewphin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Shrewphin() {
        super("Dolphin1",
                Type.PSYCHIC,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("dolpride", EvolutionType.LEVEL_UP, List.of(),
