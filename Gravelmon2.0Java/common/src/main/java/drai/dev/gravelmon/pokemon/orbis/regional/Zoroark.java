...
import java.util.*;
public class Zoroark extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zoroark(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Zoroark",
                Type.DARK,
                new Stats(60,
                        105,
                        60,
                        ...
                        60,
                        105),
                List.of(Ability.ILLUSION), Ability.ILLUSION,
                16, 811,
                ...
                List.of("Each has the ability to fool a large group of people simultaneously. They protect their lair with illusory scenery."),
                List.of(),
                List.of(
