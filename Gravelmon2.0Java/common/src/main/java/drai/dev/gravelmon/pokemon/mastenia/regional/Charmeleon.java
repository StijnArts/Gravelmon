...
public class Charmeleon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Charmeleon(String name, Aspect aspect) {
        super(name, aspect, "Charmeleon",
                Type.FIRE,
                new Stats(58,
                        64,
                        58,
                ...
                List.of("It lashes about with its tail to knock down its foe. It then tears up the fallen opponent with sharp claws."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FIRE_SPIN,50),
