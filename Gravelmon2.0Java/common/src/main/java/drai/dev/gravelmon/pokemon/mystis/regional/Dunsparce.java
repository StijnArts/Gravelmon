...
import java.util.*;
public class Dunsparce extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dunsparce(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Dunsparce",
                Type.NORMAL,
                new Stats(100,
                        70,
                        70,
                ...
                List.of("Dunsparce has a drill for its tail. It uses this tail to burrow into the ground backward. This Pokémon is known to make its nest in complex shapes deep under the ground. If you happen to find one, consider yourself lucky."),
                List.of(),
                List.of(
