...
public class Dustar extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dustar() {
        super("Dustar",
                Type.DARK,Type.ROCK,
                new Stats(40,
                ...
                List.of("They crash from outer space into various parts of the world. This Pokémon is impish and mean, but its said that there's another kind of Dustar which are good-natured."),
                List.of(),
                List.of(
