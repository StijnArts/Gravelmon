...
public class Litwick extends drai.dev.gravelmon.pokemon.Pokemon {
    public Litwick(String name, Aspect aspect) {
        super(name, aspect, "Litwick",
                ...
                List.of("The flame on its head keeps its body slightly warm. This Pokémon takes lost children by the hand to guide them to the spirit world."),
                List.of(),
                List.of(
