...
public class Slowpoke extends drai.dev.gravelmon.pokemon.Pokemon {
    public Slowpoke(String name, Aspect aspect) {
        super(name, aspect, "Slowpoke",
                ...
                List.of("It is always vacantly lost in thought, but no one knows what it is thinking about. It is good at fishing with its tail."),
                List.of(),
                List.of(
