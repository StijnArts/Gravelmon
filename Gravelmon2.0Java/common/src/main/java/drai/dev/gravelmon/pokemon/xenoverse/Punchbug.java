...
public class Punchbug extends Pokemon {
    public Punchbug() {
        super("Punchbug",
                Type.BUG, Type.FIGHTING,
                new Stats(60, 73, 85, 38, 64, 15),
                List.of(Ability.SWARM, Ability.BATTLE_ARMOR), Ability.HUGE_POWER,
                6, 328,
                new Stats(0,1,1,0,0,1), 120,
                0.5,
                130, ExperienceGroup.MEDIUM_FAST,
                70,
                32, List.of(EggGroup.BUG),
                List.of("They hang on tree branches, letting Beefle punching them to store the energy required to evolve."),
                List.of(new EvolutionEntry("hercurcules", EvolutionType.LEVEL_UP, List.of(),
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.UNCOMMON, 18, 31, 0.2, List.of(
