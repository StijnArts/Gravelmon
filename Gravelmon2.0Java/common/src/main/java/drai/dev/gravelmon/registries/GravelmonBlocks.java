...
public class GravelmonBlocks {
    ...
    public static RegistrySupplier<Block> ASTRAL_STONE_BLOCK = storageBlock("astral_stone_block");
    ...
    public static RegistrySupplier<Block> AIR_STONE_BLOCK = storageBlock("air_stone_block");
    ...
    public static RegistrySupplier<Block> MYSTIC_STONE_BLOCK = storageBlock("mystic_stone_block");
    ...
    public static  RegistrySupplier<Block> storageBlock(String name){
