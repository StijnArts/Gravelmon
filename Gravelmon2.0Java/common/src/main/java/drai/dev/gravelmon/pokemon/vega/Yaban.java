...
public class Yaban extends Pokemon {
    public Yaban() {
        super( "Yaban",
                Type.FIGHTING,
                new Stats(80	,100,	80	,30,	50,	65),
                ...
                List.of(""),
                List.of(new EvolutionEntry("janbos", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.DENEB),
                0,
                List.of(), SpawnContext.GROUNDED, SpawnPool.COMMON, 25, 40, 1.0, List.of(
