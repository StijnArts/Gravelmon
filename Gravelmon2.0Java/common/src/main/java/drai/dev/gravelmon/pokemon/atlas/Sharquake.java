...
public class Sharquake extends drai.dev.gravelmon.pokemon.Pokemon {
    public Sharquake() {
        super("Sharquake",
                ...
                70,
                50, List.of(),
                List.of("Sharquake love to flaunt their large mohawk-like hair. The larger the mohawk is, the more the Sharquake can attract mates. They're also territorial, guarding their mates with their life."),
                List.of(),
                List.of(
