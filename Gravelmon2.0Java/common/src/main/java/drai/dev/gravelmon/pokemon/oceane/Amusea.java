...
public class Amusea extends drai.dev.gravelmon.pokemon.Pokemon {
    public Amusea() {
        super("Amusea",
                Type.WATER,
                new Stats(0,
                ...
                List.of(""),
                List.of(new EvolutionEntry("finfetti", EvolutionType.LEVEL_UP, List.of(),
