...
public class Dopibara extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dopibara() {
        super("Dopibara",
                Type.NORMAL,
                new Stats(95,
                ...
                List.of("Dopibara's body is so sturdy that it can withstand attacks without even noticing. Because of this, it is oblivious to its surroundings and only cares about eating and sleeping."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ENDEAVOR,27),
