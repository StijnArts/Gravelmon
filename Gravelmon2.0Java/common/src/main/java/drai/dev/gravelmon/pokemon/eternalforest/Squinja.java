...
public class Squinja extends Pokemon {
    public Squinja() {
        super("Squinja",
                ...
                List.of("Squinja is a fast and accurate fighter. It generally prefers to keep its enemies at a distance, but is quite capable of close combat."),
                List.of(new EvolutionEntry("Squartial", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.BRINE, 40),
                        new MoveLearnSetEntry(Move.VACUUM_WAVE, 46),
                        new MoveLearnSetEntry(Move.AQUA_RING, 52),
                        new MoveLearnSetEntry(Move.CHAKRASTRENGTH, 60),
                        new MoveLearnSetEntry(Move.WORK_UP, 64),
                        new MoveLearnSetEntry(Move.LOW_SWEEP, 68),
                        new MoveLearnSetEntry(Move.WATER_PULSE, 72),
                        new MoveLearnSetEntry(Move.OCTAZOOKA, 76),
                        new MoveLearnSetEntry(Move.CIRCLE_THROW, 80),
                        new MoveLearnSetEntry(Move.FUDODACHI, 85),
                        new MoveLearnSetEntry(Move.SCALD, 90),
                        new MoveLearnSetEntry(Move.AGILITY, 96),
                        new MoveLearnSetEntry(Move.HYDROSHOCK, 102),
                        new MoveLearnSetEntry(Move.MEDITATION, 108),
                        new MoveLearnSetEntry(Move.FOCUS_BLAST, 114),
                        new MoveLearnSetEntry(Move.HYDRO_PUMP, 120),
