...
public class Shinx extends drai.dev.gravelmon.pokemon.Pokemon {
    public Shinx(String name, Aspect aspect) {
        super(name, aspect, "Shinx",
                Type.PSYCHIC,
                new Stats(45,
                        40,
                        35,
                ...
                List.of("It's said that Theosian Shinx can see into multiple universes, allowing to see different outcomes of events. When frightened, they will attack using flashes of light to distract their foes."),
                List.of(),
                List.of(
