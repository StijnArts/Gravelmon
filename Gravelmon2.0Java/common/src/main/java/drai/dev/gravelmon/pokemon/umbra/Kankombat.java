...
public class Kankombat extends Pokemon {
    public Kankombat() {
        super("Kankombat",
                ...
                new Stats(90,
                        ...
                        87,
                        96),
                List.of(Ability.IRON_FIST), Ability.FINISHER,
                22, 714,
                ...
                List.of("Kankombat are intimidating in stature, standing far taller than the average human grows. So, while it is dangerous to get on the wrong side of a Kankombat, it's quite easy to see them coming."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FIRE_PUNCH,59),
                        new MoveLearnSetEntry(Move.THUNDER_PUNCH,59),
                        new MoveLearnSetEntry(Move.ICE_PUNCH,59),
                        new MoveLearnSetEntry(Move.BOUNCE,64),
                        new MoveLearnSetEntry(Move.SKY_UPPERCUT,69),
