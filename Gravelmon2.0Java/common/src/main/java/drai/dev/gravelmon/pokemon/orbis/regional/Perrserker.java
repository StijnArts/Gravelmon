...
public class Perrserker extends drai.dev.gravelmon.pokemon.Pokemon {
    public Perrserker(String name, Aspect aspect) {
        super(name, aspect, "Perrserker",
                Type.STEEL,
                new Stats(70,
                        110,
                        100,
                        ...
                        60,
                        50),
                List.of(Ability.BATTLE_ARMOR,Ability.TOUGH_CLAWS), Ability.STEELY_SPIRIT,
                8, 280,
                ...
                List.of("What appears to be an iron helmet is actually hardened hair. This Pokémon lives for the thrill of battle."),
                List.of(),
                List.of(
