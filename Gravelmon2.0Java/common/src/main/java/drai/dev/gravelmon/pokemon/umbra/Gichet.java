...
public class Gichet extends Pokemon {
    public Gichet() {
        super("Gichet",
                Type.BUG,
                new Stats(30,
                        ...
                        30,
                        40),
                List.of(Ability.SWARM), Ability.RIVALRY,
                4, 29,
                ...
                List.of("Gichet have small jaws, but they will clack them together loudly when threatened."),
                List.of(new EvolutionEntry("crickjaw", EvolutionType.LEVEL_UP, List.of(),
