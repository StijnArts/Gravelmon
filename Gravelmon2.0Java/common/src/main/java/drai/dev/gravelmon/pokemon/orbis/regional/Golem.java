...
public class Golem extends drai.dev.gravelmon.pokemon.Pokemon {
    public Golem(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Golem",
                ...
                List.of("Once a year, this Pokémon molts, and its shed shell returns to the soil. This process creates enriched soil, so farmers collect the shells."),
                List.of(),
                List.of(
