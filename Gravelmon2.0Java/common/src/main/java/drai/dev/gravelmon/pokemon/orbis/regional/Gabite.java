...
public class Gabite extends drai.dev.gravelmon.pokemon.Pokemon {
    public Gabite(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Gabite",
                ...
                List.of("It sheds its skin and gradually grows larger. Its scales can be ground into a powder and used as raw materials for traditional medicine."),
                List.of(),
                List.of(
