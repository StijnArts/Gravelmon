...
public class Eevee extends drai.dev.gravelmon.pokemon.Pokemon {
    public Eevee(String name, Aspect aspect) {
        super(name, aspect, "Eevee",
                Type.NORMAL,
                new Stats(55,
                        55,
                        50,
                        ...
                        65,
                        55),
                List.of(Ability.RUN_AWAY,Ability.ADAPTABILITY), Ability.ANTICIPATION,
                3, 65,
                ...
                List.of("Thanks to its unstable genetic makeup, this rare Pokémon is able to adapt to harsh environments by taking on different evolutionary forms."),
                List.of(),
                List.of(
