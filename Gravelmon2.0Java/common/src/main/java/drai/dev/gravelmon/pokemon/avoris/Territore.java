...
public class Territore extends drai.dev.gravelmon.pokemon.Pokemon {
    public Territore() {
        super("Territore",
                ...
                List.of("These Pokémon are aggressive and territorial with Arctalon. Despite the fact that Arctalon's Ice-type moves put them at a disadvantage, they are incredibly skilled and shrewd in combat."),
                List.of(),
                List.of(
