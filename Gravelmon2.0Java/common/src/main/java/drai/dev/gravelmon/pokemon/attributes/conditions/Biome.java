...
public enum Biome {
    ...
    IS_OLD_GROWTH_TAIGA("#gravelmon","is_old_growth_taiga"),
    IS_WINTER("#cobblemon","is_winter"),
    IS_CHERRY_GROVE("minecraft", "cherry_grove"),
    IS_SPARSE_JUNGLE("minecraft", "sparse_jungle"),
