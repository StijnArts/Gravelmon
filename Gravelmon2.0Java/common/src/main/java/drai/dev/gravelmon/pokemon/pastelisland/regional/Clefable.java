...
public class Clefable extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clefable(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Clefable",
                Type.FAIRY,
                new Stats(95,
                        70,
                        73,
                        ...
                        90,
                        60),
                List.of(Ability.CUTE_CHARM,Ability.MAGIC_GUARD), Ability.UNAWARE,
                13, 400,
                ...
                List.of("A timid fairy Pokémon that is rarely seen. It will run and hide the moment it senses people."),
                List.of(),
                List.of(
