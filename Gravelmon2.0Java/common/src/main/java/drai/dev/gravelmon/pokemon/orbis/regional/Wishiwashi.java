...
import java.util.*;
public class Wishiwashi extends drai.dev.gravelmon.pokemon.Pokemon {
    public Wishiwashi(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Wishiwashi",
                Type.WATER,
                new Stats(45,
                        20,
                        20,
