...
import java.util.*;
public class Varaquake extends drai.dev.gravelmon.pokemon.Pokemon {
    public Varaquake(Stats stats) {
        super("Varaquake",
                Type.GROUND, Type.ROCK,
                stats,
                List.of(Ability.SANDBATH), Ability.SANDBATH,
                20, 3053,
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.RARE, 33, 54, 1.2, List.of(
                        new BiomeSpawnCondition(List.of(Biome.IS_DESERT, Biome.IS_LUSH))
                ), List.of(),
                List.of(SpawnPreset.NATURAL),
                0.28, 0.3,
                List.of());
           setLangFileName("Varaquake");
