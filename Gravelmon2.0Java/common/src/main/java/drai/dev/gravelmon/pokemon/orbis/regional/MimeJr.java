...
public class MimeJr extends drai.dev.gravelmon.pokemon.Pokemon {
    public MimeJr(String name, Aspect aspect) {
        super(name, aspect, "MimeJr",
                ...
                new Stats(20,
                        ...
                        90,
                        60),
                List.of(Ability.SOUNDPROOF,Ability.FILTER), Ability.TECHNICIAN,
                6, 130,
                ...
                List.of("When this gifted mimic surprises an opponent, Mime Jr. feels so happy that it ends up forgetting it was imitating something."),
                List.of(),
                List.of(
