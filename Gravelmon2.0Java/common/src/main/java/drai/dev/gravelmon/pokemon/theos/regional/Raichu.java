...
public class Raichu extends drai.dev.gravelmon.pokemon.Pokemon {
    public Raichu(String name, Aspect aspect) {
        super(name, aspect, "Raichu",
                ...
                new Stats(60,
                        ...
                        95,
                        85),
                List.of(Ability.AERILATE), Ability.LIGHTNING_ROD,
                8, 300,
                ...
                List.of("As electricity builds up inside its body, it becomes more aggressive. One theory is that the electricity buildup is actually causing stress."),
                List.of(),
                List.of(
