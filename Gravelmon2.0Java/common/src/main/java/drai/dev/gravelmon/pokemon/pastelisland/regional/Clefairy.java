...
public class Clefairy extends drai.dev.gravelmon.pokemon.Pokemon {
    public Clefairy(String name, Aspect aspect) {
        super(name, aspect, "Clefairy",
                Type.FAIRY,
                new Stats(70,
                        45,
                        48,
                ...
                List.of("The moonlight that it stores in the wings on its back apparently gives it the ability to float in midair."),
                List.of(),
                List.of(
