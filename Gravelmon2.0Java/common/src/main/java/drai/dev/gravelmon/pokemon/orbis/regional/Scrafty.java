...
import java.util.*;
public class Scrafty extends drai.dev.gravelmon.pokemon.Pokemon {
    public Scrafty(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Scrafty",
                ...
                List.of("It pulls up its shed skin to protect itself while it kicks. The bigger the crest, the more respected it is."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.ROCK_CLIMB,51),
