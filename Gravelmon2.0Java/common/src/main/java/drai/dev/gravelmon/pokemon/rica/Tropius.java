    ...
    public Tropius() {
        super("Tropius",
                ...
                new Stats(119,
                        ...
                        87,
                        61),
                List.of(Ability.CHLOROPHYLL,Ability.SOLAR_POWER,Ability.HARVEST), Ability.HARVEST,
                8, 165,
                ...
                List.of("The bunch of fruit around its neck ripens twice a year and is delicious. It’s a highly favored tropical snack."),
                List.of(),
                List.of(
