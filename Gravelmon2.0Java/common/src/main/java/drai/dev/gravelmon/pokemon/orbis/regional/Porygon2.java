...
public class Porygon2 extends drai.dev.gravelmon.pokemon.Pokemon {
    public Porygon2(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Porygon2",
                Type.NORMAL,
                new Stats(85,
                        80,
                        90,
                ...
                List.of("Porygon2 was created by humans using the power of science. The man-made Pokémon has been endowed with artificial intelligence that enables it to learn new gestures and emotions on its own."),
                List.of(),
                List.of(
