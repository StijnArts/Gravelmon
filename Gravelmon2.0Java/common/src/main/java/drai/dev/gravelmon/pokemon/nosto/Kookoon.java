...
public class Kookoon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kookoon() {
        super("Kookoon",
                Type.BUG,
                new Stats(45,
                ...
                List.of("Evo Harden Normal - Scuttle HopSTAB Bug - Growl Normal - String Shot Bug - Harden Normal 5 Struggle BugSTAB Bug 13 Protect Normal"),
                List.of(),
                List.of(
