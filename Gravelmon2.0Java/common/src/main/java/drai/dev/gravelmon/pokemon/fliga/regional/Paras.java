...
import java.util.*;
public class Paras extends drai.dev.gravelmon.pokemon.Pokemon {
    public Paras(int dex) {
        super(dex, "Paras",
                Type.GHOST,Type.BUG,
                new Stats(60,
                        50,
                ...
                70,
                50, List.of(),
                List.of("- Scratch Normal - Absorb Grass - Poison Powder Poison - Stun Spore Grass - Cross Poison Poison 6 Poison Powder Poison 6 Stun Spore Grass 11 Bug BiteSTAB Bug 17 Payback Dark 22 Spore Grass 29 Shadow ClawSTAB Ghost 34 Ingrain Grass 37 Growth Normal 44 Strident Echo Dark 51 Strength Sap Grass 59 Shadow Dance Ghost"),
                List.of(),
                List.of(
