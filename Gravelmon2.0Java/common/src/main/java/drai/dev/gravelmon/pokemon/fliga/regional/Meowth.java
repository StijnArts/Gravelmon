...
public class Meowth extends drai.dev.gravelmon.pokemon.Pokemon {
    public Meowth(String name, Aspect aspect) {
        super(name, aspect, "Meowth",
                ...
                List.of("It loves coins, so if you give it one, you can make friends with Meowth easily. But it's fickle, so you can't count on that friendship lasting."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.FEINT,50),
