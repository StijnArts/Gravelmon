...
public class Beberin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Beberin() {
        super("Beberin",
                Type.GRASS,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("nimbairy", EvolutionType.LEVEL_UP, List.of(),
