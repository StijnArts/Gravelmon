...
public class Muk extends drai.dev.gravelmon.pokemon.Pokemon {
    public Muk(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Muk",
                ...
                List.of("Muk eat garbage. Sometimes when they don't get garbage to eat, they take bites out of nearby buildings. Don't ask what happens when they eat enough."),
                List.of(),
                List.of(
