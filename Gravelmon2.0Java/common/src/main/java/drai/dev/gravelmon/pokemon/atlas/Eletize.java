...
public class Eletize extends drai.dev.gravelmon.pokemon.Pokemon {
    public Eletize() {
        super("Eletize",
                Type.ELECTRIC,
                new Stats(73,
                ...
                List.of("Eletize are very quick and can easily escape an attack. Their speed can almost match that of a Velocikat."),
                List.of(),
                List.of(
