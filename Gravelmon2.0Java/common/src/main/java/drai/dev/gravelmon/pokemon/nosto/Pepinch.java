...
public class Pepinch extends drai.dev.gravelmon.pokemon.Pokemon {
    public Pepinch() {
        super("Pepinch",
                Type.GRASS,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("torpepo", EvolutionType.LEVEL_UP, List.of(),
