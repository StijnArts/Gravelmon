...
public class Kappatoa extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kappatoa() {
        super("Kappatoa",
                ...
                List.of("The lava it carries in its shell never cools or hardens. But it may expel all of it during a harsh battle, forcing it to retreat into its volcano home."),
                List.of(),
                List.of(
