...
public class Dusknoir extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dusknoir(String name, Aspect aspect) {
        super(name, aspect, "Dusknoir",
                ...
                List.of("With the mouth on its belly, Dusknoir swallows its target whole. The soul is the only thing eaten— Dusknoir disgorges the body before departing."),
                List.of(),
                List.of(
