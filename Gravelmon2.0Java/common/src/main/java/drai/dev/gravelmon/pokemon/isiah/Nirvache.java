...
public class Nirvache extends drai.dev.gravelmon.pokemon.Pokemon {
    public Nirvache() {
        super("Nirvache",
                Type.PSYCHIC,
                new Stats(0,
                ...
                List.of(""),
                List.of(new EvolutionEntry("tabooves", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.ISIAH),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 18, 33, .3, List.of(
