...
//        MegaEvolution.addMegaEvolution(getChaosInVesitaMegas()); skipped
        MegaEvolution.addMegaEvolution(getPokengineMegas());
        MegaEvolution.clean();
    }

    private static List<MegaEvolution> getPokengineMegas() {
        return List.of(
                new MegaEvolution("forelk",
                        ...
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#ed1c24", "#ffb0ca", "#e7c580")),
                new MegaEvolution("bramboom",
                        ...
                        new Stats(78,
                                ...
                                104),
                        Ability.SHARPNESS,
                        19, "cyare", List.of(Label.CYARE))
                        .addPalette(new MegaStonePalette("#4eb660", "#ffb0ca", "#e7c580")),
                new MegaEvolution("phoenan",
                        ...
                        Ability.GALE_WINGS,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#908264", "#f37542", "#ffe56d")),
                new MegaEvolution("chloradise",
                        Type.GRASS, Type.BUG,
                        new Stats(70,
                                143,
                                131,
                        ...
                        Ability.TINTED_LENS,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#ed565b", "#d1805d", "#ede63f")),
                new MegaEvolution("razorvile",
                        ...
                        Ability.SWIFT_SWIM,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#2b6c6d", "#d25e5b", "#b1ec57")),
                new MegaEvolution("regalient",
                        ...
                        new Stats(85,
                                ...
                                132),
                        Ability.HOLY_GUARD,
                        21, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#d63838", "#fdf9f0", "#5a4166")),
                new MegaEvolution("ekiama",
                        ...
                        .addPalette(new MegaStonePalette("#4b3d41", "#a15dc9", "#f09c82")),
                new MegaEvolution("slymander",
                        ...
                        21, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#484848", "#ff4a4e", "#ffb973")),
                new MegaEvolution("rupsen",
                        ...
                        Ability.IGNITION,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#493c3a", "#f9e547", "#f24520")),
                new MegaEvolution("wolverize",
                        Type.FIRE, Type.DARK,
                        new Stats(73,
                                141,
                                68,
                                ...
                                134),
                        Ability.MOXIE,
                        17, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#3a3a3a", "#ffad40", "#c83540")),
                new MegaEvolution("gandolph",
                        ...
                        Ability.MAGIC_GUARD,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#b17ed3", "#ffffff", "#398bee")),
                new MegaEvolution("hydromedary",
                        ...
                        new Stats(120,
                                ...
                                65),
                        Ability.BOMBARDIER,
                        20, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#73898c", "#37a0ee", "#c0c0c0")),
                new MegaEvolution("emporeel",
                        ...
                        new Stats(104,
                                ...
                                90),
                        Ability.LEVITATE,
                        22, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#404040", "#f7da68", "#6fb8d0")),
                new MegaEvolution("damasoar",
                        Type.WATER, Type.ICE,
                        new Stats(85,
                                142,
                                123,
                                ...
                                72),
                        Ability.SHEER_FORCE,
                        33, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#186384", "#c7f3f1", "#8592a9")),
                new MegaEvolution("chambrawl",
                        ...
                        Ability.IRON_FIST,
                        18, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#515151", "#f18f48", "#5a77d3")),
                new MegaEvolution("jayzure",
                        ...
                        new Stats(71,
                                ...
                                170),
                        Ability.TECHNICIAN,
                        11, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#ff9a75", "#ffffff", "#82bcec")),
                new MegaEvolution("maidnite",
                        ...
                        new Stats(79,
                                ...
                                61),
                        Ability.DREAMTRAP,
                        13, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#773e7f", "#ffffff", "#7aa3e7")),
                new MegaEvolution("caramelix",
                        ...
                        new Stats(54,
                                ...
                                107),
                        Ability.MAGICBOUNCE,
                        8, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#b42c59", "#ffe9e8", "#0abbf1")),
                new MegaEvolution("emperiegle",
                        Type.NORMAL, Type.FLYING,
                        new Stats(95,
                                165,
                                107,
                                ...
                                78,
                                105),
                        Ability.PRIDEFULSTANCE,
                        20, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#4b4b52", "#fbfbfb", "#f6d069")),
                new MegaEvolution("phantomail",
                ...
                new MegaEvolution("strikezal",
                        ...
                        new Stats(88,
                                ...
                                100),
                        Ability.SKILL_LINK,
                        15, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#45494b", "#dfdbdc", "#4a6c8e")),
                new MegaEvolution("esterite",
                        Type.ROCK, Type.FIRE,
                        new Stats(80,
                                40,
                                126,
                                ...
                                45),
                        Ability.LEVITATE,
                        35, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#d60303", "#ffe95a", "#f8561e")),
                new MegaEvolution("radiaze",
                        ...
                        Ability.TOUGH_CLAWS,
                        19, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#4f4f60", "#ffe153", "#6a8293")),
                new MegaEvolution("akrovern",
                        ...
                        new Stats(95,
                                ...
                                45),
                        Ability.ANGER_POINT,
                        29, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#585874", "#ffc974", "#f65252")),
                new MegaEvolution("yanpaow",
                        Type.DRAGON,
                        new Stats(60,
                                140,
                                75,
                        ...
                        Ability.IGNITION,
                        22, "atlas", List.of(Label.ATLAS))
                        .addPalette(new MegaStonePalette("#e3b4ff", "#ffb4c7", "#fdb4ff")),
                new MegaEvolution("arbok",
                        ...
                        new Stats(60,
                                ...
                                90),
                        Ability.PETRIFY,
                        27, "uranium", List.of(Label.GEN1, Label.URANIUM))
                        .addPalette(new MegaStonePalette("#37353b", "#c0b000", "#7860a8")),
                new MegaEvolution("arbok",
                        Type.POISON, Type.NUCLEAR,
                        new Stats(60,
                                130,
                                100,
                                65,
                                ...
                                90),
                        Ability.PETRIFY,
                        27, "uranium", List.of(Label.GEN1, Label.URANIUM), "nuclear")
                        .addPalette(new MegaStonePalette("#21ba24", "#f8f8f8", "#29283e")),
                new MegaEvolution("archilles",
                        ...
                        new Stats(75,
                                ...
                                155),
                        Ability.DROUGHT,
                        19, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#29283e", "#ff730f", "#b81438")),
                new MegaEvolution("baariette",
                        ...
                        new Stats(100,
                                ...
                                100),
                        Ability.BLOODLUST,
                        16, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#3e3f60", "#fcd964", "#6e7987")),
                new MegaEvolution("baariette",
                        Type.DARK, Type.NUCLEAR,
                        new Stats(100,
                                160,
                                107,
                                75,
                                ...
                                100),
                        Ability.BLOODLUST,
                        16, "uranium", List.of(Label.URANIUM), "nuclear")
                        .addPalette(new MegaStonePalette("#141028", "#f7f7f7", "#3ffd43")),
                new MegaEvolution("dramsama",
                        ...
                        new Stats(85,
                                ...
                                120),
                        Ability.BAD_DREAMS,
                        15, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#433d4d", "#f4f4f1", "#f33955")),
                new MegaEvolution("drilgann",
                        ...
                        new Stats(75,
                                ...
                                84),
                        Ability.SAND_RUSH,
                        24, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#bf14d7", "#ffcb2e", "#b45050")),
                new MegaEvolution("electruxo",
                        Type.WATER, Type.ELECTRIC,
                        new Stats(95,
                                90,
                                95,
                                ...
                                110),
                        Ability.DRIZZLE,
                        18, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#bf3638", "#fae62e", "#364c91")),
                new MegaEvolution("gyarados",
                        ...
                        new Stats(95,
                                ...
                                81),
                        Ability.MOLDBREAKER,
                        38, "uranium", List.of(Label.GEN1, Label.URANIUM), "nuclear")
                        .addPalette(new MegaStonePalette("#302f51", "#3ffd43", "#b45050")),
                new MegaEvolution("electruxo",
                        Type.FIRE,
                        new Stats(85,
                                145,
                        ...
                        17, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#c02633", "#24ebdc", "#de9f0e")),
                new MegaEvolution("kiricorn",
                        ...
                        new Stats(75,
                                ...
                                128),
                        Ability.MAGICBOUNCE,
                        22, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#3d98eb", "#fdf5fe", "#f395d1")),
                new MegaEvolution("metalynx",
                        Type.GRASS, Type.STEEL,
                        new Stats(85,
                                140,
                                160,
                        ...
                        Ability.HEATPROOF,
                        16, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#a6bdd9", "#ffd452", "#2c8c49")),
                new MegaEvolution("s51a",
                        ...
                        18, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#509d1f", "#f5f55b", "#7b72bb")),
                new MegaEvolution("syrentide",
                        ...
                        Ability.PIXILATE,
                        18, "uranium", List.of(Label.URANIUM))
                        .addPalette(new MegaStonePalette("#e1db23", "#f188d9", "#1b93c0")),
