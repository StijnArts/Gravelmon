...
public class Geodude extends drai.dev.gravelmon.pokemon.Pokemon {
    public Geodude(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Geodude",
                ...
                List.of("When Geodude sleeps deeply, it buries itself halfway into the ground. It will not awaken even if hikers step on it unwittingly. In the morning, this Pokémon rolls downhill in search of food."),
                List.of(),
                List.of(
