...
public class Charmander extends drai.dev.gravelmon.pokemon.Pokemon {
    public Charmander(String name, Aspect aspect) {
        super(name, aspect, "Charmander",
                Type.FIRE,
                new Stats(39,
                        52,
                        43,
                ...
                List.of("From the time it is born, a flame burns at the tip of its tail. Its life would end if the flame were to go out."),
                List.of(),
                List.of(
