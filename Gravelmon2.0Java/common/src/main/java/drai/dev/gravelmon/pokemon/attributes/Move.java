...
public enum Move {
    ...
    SPLASH("splash",true),
    ACID_ARMOR("acidarmor",true, "slime"),
    ...
    CONVERSION("conversion",true, "digital"),
    ...
    CURSE("curse",true),
    FLAIL("flail",true),
    CONVERSION_2("conversion2",true, "digital"),
    ...
    DIRTY_POOL("dirtypool", true),
    DREAD_SPACE("dreadspace", true),
    EQUALIZE("equalize", true),
    ...
    AROMA_WIND("aromawind", true),
    LUSTER_BLOOM("lusterbloom", true),
    BOLD_BLAZE("boldblaze", true),
    TERRAFIRM("terrafirm", true),
    SOIL_THROW("soilthrow", true),
    REGAL_FANG("regalfang", true),
    CRIMSON_DIVE("crimsondive", false),
    MAGNUM_PUNCH("magnumpunch", true),
    WARBLE("warble", true, "sound"),
    GLORY_WING("glorywing", true),
    HAIRPIN_TURN("hairpinturn", true),
    QUICK_TURN("quickturn", true),
    ...
    ROCKET_DRIVE("rocketdrive", true),
    SHADOW_SPLIT("shadowsplit", true),
    ...
    HARD_KNOCK("hardknock", true),
    SPEEDMITE("speedmite", true),
    ...
    ASTROFORCE("astroforce", true, "cosmic"),
    TERRAHEDRON("terrahedron", false),
    GRAVELBREATH("gravelbreath", false),
    CHROME_BALL("chromeball", true),
    ...
    TITANIC_HORN("titanichorn", true),
    DOUBLE_SHOT("doubleshot", true),
    PRISM_ATTACK("prismattack", false),
    GRIMEBUSTER("grimebuster", true),
    ...
    GOODNIGHTMOON,
    HANABIDANCE,
    IADOSGUARD, SCARLETSPINE, CAPRISHOT, COCOZOOKA, OBERONSROAR, IRONBISCOTO, PSYCHOKICK, SLEEPWALTZ, DARK_NOVA, SCRAPSHOT, FIXITFLURRY, DUSTDEVILS, SANDSPRAY, SANDFLURRY, SHIVER, WRAITHPULSE, SANDSHROUD, SPIKEDRAM, DIVEBOMB, SHOTPUT, BULLETCHARGE, FABLEDSLAM, IRONIMPACT, HARNESS, WILLPOWER, ICYDELUGE, UMBRALWAVE, MALADY, CONTAGION, SOULFLAY, FORTIFY, DOUBLESCOOP, ARCINGBLOW, PETALTEMPEST, BUGSTING, SUCKBLOOD, SWARMATTACK, CHITINOUSSTRIKE, MIASMA, ARCANEBLAST, VIRUS, BLIGHT, WEARDOWN, STORMSHIELD, BALANCEDBEAM, ICICLESTRIKE, GLOOM, MANABLAST, FLUXWAVE, FLEETINGBLOW, SCRAMBLEMIND, WYRMSRAGE, BLINDINGFLASH, SIGNALOVERLOAD, COLDFRONT, SEANCE, SPECTRALLASH, SACREDSTRIKE, FANATICISM, VANGUARD, RAPTURE, BLESSEDHAMMER, BIRDOFPREY, DRACOTEMPEST, AUTUMNBLAST, DRENCH, PRIMORDIALBEAM, METALLICGLEAM, GHASTLYFLOOD, TIDALSHIFT, GRACEFULSTRIKE, CRASHINGWAVE, RIPTIDE, TORRENT, OVERFLOW, STALKPREY, ENCIRCLE, KAMEHAMEHA, RADIANTLANCE, ENCHANTMENT, PSYBLAST, HEXBOLT, MINDMELD, WELD, ZEPHYRPURGE, ATHENASWISDOM, RASENGAN, OVERWHELM, CHAINSWEEP, KINETICBLAST, AURABLOCK, TUNDRARUSH, SEPTICSTRIKE, FLAMEPILLAR, PIDDLE, VIBRATO, PERCUSSIONBLAST, SUPPRESSAURA, REFURBISH, MAGICPALM, CLACKACLACK, IRRITANT, DIRGE, HUNTDOWN, SOULRIP, DISTURB, RAPIDSTRIKE, DARKPRISM, SNOWBALL, SPITEFULCHANT, MALEFICACT, ARCANEBARRAGE, MINDCRUSH, DRACONICWAVE, THROWINGSTAR, CAUSTICACID, ESSENCEBLOOM, DRACONICMIGHT, QUILLVOLLEY, WINTERSGRASP, CHILLINGBLAST, GLORIOUSHYMN, POLARPUMMEL, SLURP, GUTTURALROAR, SOLARCLAW, CRAGBLITZ, DUSTFLARE, FLAREUP, SHININGTERRAIN, TOXINRUSH, LIGHTBURST, PLAYFIGHT, MIDNIGHTTERRAIN, MELLOWHUG, GEOGEYSER, FROSTCLAW, SQUALLBLOW, ELECTROSHOT, MAGNETPULSE, SCALEMAIL, DRAGONICFLARE, BALANCESEAL, AMITYWIND, BUNKERDOWN, MYSTICWAVE, SHATTERGEM, LUNATICWAVE, ELECTROKINESIS, FICKLEBEAM;
