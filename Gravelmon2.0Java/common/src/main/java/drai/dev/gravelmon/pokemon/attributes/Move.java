...
public enum Move {
    ...
    SLEEP_TALK("sleeptalk",true),
    HEAL_BELL("healbell",true),
    RETURN("return",true),
    ...
    DISARMING_VOICE("disarmingvoice",true),
    ...
    SPARKLING_ARIA("sparklingaria",true),
    ...
    PHOTON_GEYSER("photongeyser",true),
    ...
    WIND_SHEAR("windshear", false),
    LEAF_SHIELD("leafshield", false),
    JET_STRIKE("jetstrike", false),
    TEMPEST("tempest", false),
    STANDOFF("standoff", false),
    MUDSLIDE("mudslide", false),
    BRACE("brace", false),
    BATTERING_RAM("batteringram", false),
    SHIELD_BASH("shieldbash", false), 
    PINCER_ATTACK("pincerattack", false),
    DEPTH_CHARGE("depthcharge", false),
    SALT_CRASH("saltcrash", false),
    CHEAP_SHOT("cheapshot", false),
    SNOWY_TERRAIN("snowyterrain", false),
    FROST_SLASH("frostslash", false),
    CAUSTIC_BREATH("causticbreath", false),
    MIRACLE_WILL("miraclewill", false),
    KARMA_BEAM("karmabeam", false),
    WEB_BALL("webball", false),
    ACID_RAIN("acidrain", false),
    PSYBOLT("psybolt", false),
    POSSESSION("possession", false),
    TERRORIZE("terrorize", false),
    ASTEROID_SHOT("asteroidshot", false),
    CORRUPT("corrupt", false),
    NULL_ROOM("nullroom", false),
    FIESTA("fiesta", false),
    SINGULARITY("singularity", false),
    DUST_DEVIL("dustdevil", false),
    STOKE("stoke", false),
    ATOM_SPLIT("atomsplit", false),
    ASTEROID_BELT("asteroidbelt", false),
    PERPLEX("perplex", false),
    ENGULF("engulf", false),
    CATALOG("catalog", false),
    PRISM_BEAM("prismbeam", false),
    MELTDOWN("meltdown", false),
    DRY_NEEDLES("dryneedles", false),
    BARBED_TACKLE("barbedtackle", false),
    THORN_WHIP("thornwhip", false),
    CACTUS_SMASH("cactussmash", false),
    CINDER_BREATH("cinderbreath", false),
    NAIL_FLICK("nailflick", false),
    NOSTRIL_FLARE("nostrilflare", false),
    DRACO_BLITZ("dracoblitz", false),
    FLASH_FLOOD("flashflood", false),
    FOGGY_STRIKE("foggystrike", false),
    NIMBUS_FIST("nimbusfist", false),
    TYPHOON("typhoon", false),
    TARTANTRUM("tartantrum", false),
    AMBUSH("ambush", false),
    VENOM_SWIPE("venomswipe", false),
    FOCUSED_RAM("focussedram", false),
    SEARING_SLASH("searonslash", false),
    THUNDER_SLASH("thunderslash", false),
    FAENG_RUSH("faengrush", false),
    GROOM_GUARD("groomguard", false),
    PRESSURIZE("pressurize", false),
    EEVOBOOST("eevoboost", false),
    BONE_SWEEP("bonesweep", false),
    BRAIN_FREEZE("brainfreeze", false),
    DECAP_ATTACK("decapattack", false),
    COSMIC_RAY("cosmicray", false),
    DEJAVU("dejavu", false),
    BRAIN_STORM("brainstorm", false),
    ASTRAL_SHOT("astralshot", false),
    COMET_SHOWER("cometshower", false),
    BIG_BANG("bigbang", false),
    NEW_MOON("newmoon", false),
    ACHILLES_HEEL("achillesheel", false),
    DARK_MATTER("darkmatter", false),
    LUNAR_CANNON("lunarcannon", false),
    DRACO_JET("dracojet", false),
    DRAGONIFY("dragonify", false),
    JET_STREAM("jetstream", false),
    LIVEWIRE("livewire", false),
    PERMAFROST("permafrost", false),
    WILDFIRE("wildfire", false),
    CORRODE("corrode", false),
    NANOREPAIR("nanorepait", false),
    WORMHOLE("wormhole", false),
    DRAKON_VOICE("drakonvoice", false),
    ANCIENT_ROAR("ancientroar", false),
    MORPH("morph", false),
    RETROGRADE("retrograde", false),
    CRYSTAL_RUSH("crystalrush", false),
    ...
    VEILED_SKY("veiled_sky", false),
    SPECTRAL_SAP("spectral_sap", false);
