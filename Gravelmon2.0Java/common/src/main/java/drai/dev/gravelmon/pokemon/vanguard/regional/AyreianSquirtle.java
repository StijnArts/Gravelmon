...
public class AyreianSquirtle extends Pokemon {
    public AyreianSquirtle(String name, Aspect aspect) {
        super(name, aspect,"AyreianSquirtle",
                ...
                List.of("While underdeveloped, its tail has enough power to smash aside large boulders."),
                List.of(new EvolutionEntry("ayreianwartortle", EvolutionType.LEVEL_UP, List.of(),
