...
public class Kotukoatl extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kotukoatl() {
        super("Kotukoatl",
                ...
                new Stats(80,
                        ...
                        65,
                        130),
                List.of(Ability.STATIC,Ability.CLOUD_NINE), Ability.INNER_FOCUS,
                20, 463,
                ...
                List.of("Kotukoatl move at incredible speeds through the clouds, stirring up electrical storms as they pass through them. They often have little mercy for their prey, and pride themselves on a successful hunt."),
                List.of(),
                List.of(
