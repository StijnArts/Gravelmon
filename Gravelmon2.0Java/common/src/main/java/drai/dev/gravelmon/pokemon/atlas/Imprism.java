...
public class Imprism extends drai.dev.gravelmon.pokemon.Pokemon {
    public Imprism() {
        super("Imprism",
                Type.ICE,
                new Stats(40,
                ...
                List.of("Imprism is unable to keep itself warm. It is so cold that anything that touches it will freeze almost instantaneously."),
                List.of(),
                List.of(
