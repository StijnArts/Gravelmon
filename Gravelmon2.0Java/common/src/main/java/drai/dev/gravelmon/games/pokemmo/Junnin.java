...
public class Junnin extends drai.dev.gravelmon.games.registry.Game {
    public Junnin() {
        super("Junnin");
    }
...
//        pokemon.add(new Mavriquail()); NOT FINISHED
        ...
        pokemon.add(new Rollip());
        pokemon.add(new Rollipod());
        pokemon.add(new Isopanzer());
        pokemon.add(new Ploworm());
        pokemon.add(new Lumbrill());
        pokemon.add(new Baybolt());
        pokemon.add(new Bolteen());
...
//        pokemon.add(new Cavernight()); NOT FINISHED
        ...
        pokemon.add(new Antini());
        pokemon.add(new Insignel());
        pokemon.add(new Stagnel());
...
//        pokemon.add(new Cuncoldron()); NOT FINISHED
        ...
        pokemon.add(new Whiscleo());
        pokemon.add(new Pharoar());
        pokemon.add(new Equia());
        pokemon.add(new Treiarch());
        pokemon.add(new Andromini());
