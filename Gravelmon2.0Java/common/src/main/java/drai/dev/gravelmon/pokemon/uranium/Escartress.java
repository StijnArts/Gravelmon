...
public class Escartress extends Pokemon {
    public Escartress() {
        super("Escartress",
                ...
                List.of("Its shell has hardened into a nearly unbreakable fortress. It shoots water from the turrets on its back."),
                List.of(),
                List.of(
                ...
                0, List.of(
                ), SpawnContext.SEAFLOOR, SpawnPool.RARE, 45, 59, 3, List.of(
