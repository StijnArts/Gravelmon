...
import java.util.*;
public class Impulso extends drai.dev.gravelmon.pokemon.Pokemon {
    public Impulso() {
        super("Impulso",
                Type.ELECTRIC,
                new Stats(100,
                ...
                List.of("Electricity pulses through Impulso's veins. It constantly shocks itself."),
                List.of(),
                List.of(
