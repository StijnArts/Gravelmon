...
//        pokemon.add(new Pepinch()); //Missing Stats
//        pokemon.add(new Torpepo()); //Missing Stats
//        pokemon.add(new Melauncher()); //Missing Stats
...
//        pokemon.add(new Melabuzz()); //Missing Stats
//        pokemon.add(new Mieltz()); //Missing Stats
//        pokemon.add(new Mieltzar()); //Missing Stats
        pokemon.add(new Budcheep());
        pokemon.add(new Paratweet());
//        pokemon.add(new Pinksqueek()); //Missing Stats
//        pokemon.add(new Pinkaboo()); //Missing Stats
...
//        pokemon.add(new Twinkluppy()); //Missing Stats
//        pokemon.add(new Notillunar()); //Missing Stats
