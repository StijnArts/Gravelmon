...
//        pokemon.add(new Carrauntain());
//        pokemon.add(new Cephalotox());
//        pokemon.add(new Cephlame());
//        pokemon.add(new Cereboost());
