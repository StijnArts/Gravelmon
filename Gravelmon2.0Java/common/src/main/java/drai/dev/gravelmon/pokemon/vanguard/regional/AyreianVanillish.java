...
public class AyreianVanillish extends Pokemon {
    public AyreianVanillish(String originalMon, Aspect aspect) {
        super(originalMon, aspect,"AyreianVanillish",
                ...
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 24, 43, 1.5, List.of(
