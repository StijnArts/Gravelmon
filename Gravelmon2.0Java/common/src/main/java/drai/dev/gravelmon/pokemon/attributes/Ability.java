...
public enum Ability {
    ...
    MOOCH("mooch", false),
    ALLURE("allure", false),
    PSYCH_OUT("psychout", false),
    ADRENALINE("adrenaline", false),
    MALICE("malice", false),
    FEEDBACK("feedback", false),
    SUN_BATHE("sunbathe", false),
    DISCRETION("discretion", false),
    FULL_FORCE("fullforce", false),
    EVENTIDE("eventide", false),
    CONUNDRUM("conundrum", false),
    ECCENTRIC("eccentric", false),
    POLLUTION("pollution", false),
    PERFORATE("perforate", false),
    ORBITAL_TIDE("orbitaltide", false),
    SCAVENGER("scavenger", false),
    FEISTY("feisty", false),
    ...
    PSYCHO_CALL("psychocall", false),
    HUBRIS("hubris", false),
    SPIRIT_CALL("spiritcall", false),
    NOCTEM("noctem", false),
    SHADOW_CALL("shadowcall", false),
    SHADOW_DANCE("shadowdance", false),
    WIND_FORCE("windforce", false),
    ...
    HELIOPHOBIA("heliophobia", false),
    EVENT_HORIZON("eventhotizon", false),
    REGURGITATION("regurgitation", false),
    WINTER_JOY("winterjoy", false),
    SUPERCELL("supercell", false),
    ATHENIAN("athenian", false),
    ABSOLUTION("absolution", false),
    BLAZE_BOOST("blazeboost", false),
    INTOXICATE("intoxicate", false),
    PHOTOTROPH("phototroph", false),
    FOUNDRY("foundry", false),
