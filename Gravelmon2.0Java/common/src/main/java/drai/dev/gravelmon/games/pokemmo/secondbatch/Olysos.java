...
import java.util.*;
public class Olysos extends drai.dev.gravelmon.games.registry.Game {
    public Olysos() {
        super("Olysos");
    }
    ...
    public void registerPokemon() {
        ...
        pokemon.add(new Phasmox());
//        pokemon.add(new Teumixen());   Missing Art
        pokemon.add(new Arfruff());
...
//        pokemon.add(new Flamothra());   Missing Stats
//        pokemon.add(new Gnaphid());   Missing Stats
//        pokemon.add(new Locusteror());   Missing Art
//        pokemon.add(new Punling());   Missing Stats
...
//        pokemon.add(new Venobat());   Missing Stats
//        pokemon.add(new Noseferatu());   Missing Stats
...
//        pokemon.add(new Kopiuzu());   Missing Stats
//        pokemon.add(new Kebuzu());   Missing Art
//        pokemon.add(new Purazu());   Missing Art
        pokemon.add(new Molore());
//        pokemon.add(new Minerolt());   Missing Art
//        pokemon.add(new Lunuhu());   Missing Stats
//        pokemon.add(new Oracowl());   Missing Art
//        pokemon.add(new Plagfowl());   Missing Stats
//        pokemon.add(new Misphecy());   Missing Art
        pokemon.add(new Piedow());
//        pokemon.add(new Ceryneer());   Missing Art
//        pokemon.add(new Kabby());   Missing Stats
//        pokemon.add(new Avalak());   Missing Art
//        pokemon.add(new Buneary(427));   Missing Stats
//        pokemon.add(new Lopunny(428));   Missing Art
//        pokemon.add(new Bubby());   Missing Stats
//        pokemon.add(new Coarsent());   Missing Art
//        pokemon.add(new Yinyan());   Missing Stats
//        pokemon.add(new Vivater());   Missing Stats
//        pokemon.add(new Hydrona());   Missing Art
        pokemon.add(new Squishid());
//        pokemon.add(new Squidgeist());   Missing Art
//        pokemon.add(new Qoxipus());   Missing Stats
//        pokemon.add(new Plaxista());   Missing Art
//        pokemon.add(new Lapili());   Missing Stats
        pokemon.add(new Tasmon());
        pokemon.add(new Casanovil());
//        pokemon.add(new Lavaleon());   Missing Stats
//        pokemon.add(new Chamelaze());   Missing Art
//        pokemon.add(new Lavyrm());   Missing Stats
        pokemon.add(new Maganon());
        pokemon.add(new Eruptinon());
//        pokemon.add(new TorkoalPlaceholder());   Missing Stats
        pokemon.add(new Tortorge());
//        pokemon.add(new Poochyena(261));   Missing Stats
//        pokemon.add(new Mightyena(262));   Missing Stats
//        pokemon.add(new Alphayena());   Missing Stats
        pokemon.add(new Pepstep());
        pokemon.add(new Devilance());
//        pokemon.add(new Twoghast());   Missing Art
//        pokemon.add(new Forcaken());   Missing Art
        pokemon.add(new Scroul());
//        pokemon.add(new Scrolock());   Missing Art
        pokemon.add(new Skarawel());
        pokemon.add(new Traplat());
...
//        pokemon.add(new Artikit());   Missing Stats
//        pokemon.add(new Sabretal());   Missing Art
//        pokemon.add(new Solsaur());   Missing Stats
//        pokemon.add(new Spinerno());   Missing Art
//        pokemon.add(new Skorupi(451));   Missing Art
//        pokemon.add(new Drapion(452));   Missing Art
//        pokemon.add(new Snugub());   Missing Stats
//        pokemon.add(new Plushug());   Missing Art
        pokemon.add(new Draconaut());
...
//        pokemon.add(new Kryuu());   Missing Stats
        pokemon.add(new Kryoalis());
//        pokemon.add(new Phyuu());   Missing Stats
        pokemon.add(new Phosos());
//        pokemon.add(new Anyuu());   Missing Stats
        pokemon.add(new Anufelis());
        pokemon.add(new Kaisaos());
        pokemon.add(new Monokron());
        pokemon.add(new Klepeck());
//        pokemon.add(new Magusong());   Missing Stats
//        pokemon.add(new Yukibi());   Missing Stats
//        pokemon.add(new Yukiku());   Missing Art
//        pokemon.add(new Safrion());   Missing Stats
//        pokemon.add(new Saffry());   Missing Art
//        pokemon.add(new Nagamufin());   Missing Stats
...
//        pokemon.add(new Dideep());   Missing Stats
//        pokemon.add(new Searkat());   Missing Art
//        pokemon.add(new Mosaile());   Missing Stats
...
//        pokemon.add(new Zombark());   Missing Stats
//        pokemon.add(new Serenine());   Missing Stats
    }
