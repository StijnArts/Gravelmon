...
//        pokemon.add(new Buneary());   Missing Stats
//        pokemon.add(new Lopunny());   Missing Art
...
//        pokemon.add(new Poochyena());   Missing Stats
//        pokemon.add(new Mightyena());   Missing Stats
...
//        pokemon.add(new Skorupi());   Missing Art
//        pokemon.add(new Drapion());   Missing Art
