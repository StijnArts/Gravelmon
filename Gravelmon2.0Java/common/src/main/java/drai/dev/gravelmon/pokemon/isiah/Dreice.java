...
public class Dreice extends drai.dev.gravelmon.pokemon.Pokemon {
    public Dreice() {
        super("Dreice",
                Type.ICE,
                new Stats(0,
                ...
                List.of(""),
                List.of(new EvolutionEntry("icigloo", EvolutionType.LEVEL_UP, List.of(),
                ...
                List.of(Label.ISIAH),
                0, List.of(
                ), SpawnContext.GROUNDED, SpawnPool.COMMON, 21, 43, 2, List.of(
