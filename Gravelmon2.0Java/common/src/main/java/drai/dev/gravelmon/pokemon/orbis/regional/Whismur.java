...
import java.util.*;
public class Whismur extends drai.dev.gravelmon.pokemon.Pokemon {
    public Whismur(String name, Aspect aspect) {
        super(name, aspect, "Whismur",
                ...
                new Stats(64,
                        ...
                        23,
                        28),
                List.of(Ability.SOUNDPROOF), Ability.RATTLED,
                6, 163,
                ...
                List.of("Whismur is very timid. If it starts to cry loudly, it becomes startled by its own crying and cries even harder. When it finally stops crying, the Pokémon goes to sleep, all tired out."),
                List.of(),
                List.of(
