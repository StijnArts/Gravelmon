...
import java.util.*;
public class Kelpumpf extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kelpumpf() {
        super("Kelpumpf",
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("dispariot", EvolutionType.LEVEL_UP, List.of(),
