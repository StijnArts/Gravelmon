...
public class Blissey extends drai.dev.gravelmon.pokemon.Pokemon {
    public Blissey(int dex) {
        super(dex, "Blissey",
                ...
                List.of("- PoundSTAB Normal - Fire BlastSTAB Fire - Growl Normal - Defense Curl Normal - Caffeine Sip Dark - Stuff Cheeks Normal 5 Tail Whip Normal 9 Aromatherapy Grass 12 Double SlapSTAB Normal 16 Soft-Boiled Normal 20 Flame BurstSTAB Fire 23 Minimize Normal 27 Metal Sound Steel 31 Rest Psychic 34 Fling Dark 39 Heal Pulse Psychic 44 Flash Cannon Steel 50 Hyper VoiceSTAB Normal 57 Healing Wish Psychic 65 OverheatSTAB Fire"),
                List.of(),
                List.of(
