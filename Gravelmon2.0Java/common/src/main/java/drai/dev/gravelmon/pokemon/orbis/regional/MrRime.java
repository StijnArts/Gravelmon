...
import java.util.*;
public class MrRime extends drai.dev.gravelmon.pokemon.Pokemon {
    public MrRime(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "MrRime",
                ...
                new Stats(80,
                        ...
                        100,
                        70),
                List.of(Ability.TANGLED_FEET,Ability.SCREEN_CLEANER), Ability.ICE_BODY,
                15, 582,
                ...
                List.of("Its amusing movements make it very popular. It releases its psychic power from the pattern on its belly."),
                List.of(),
                List.of(
