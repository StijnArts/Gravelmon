...
import java.util.*;
public class Chansey extends drai.dev.gravelmon.pokemon.Pokemon {
    public Chansey(int dex) {
        super(dex, "Chansey",
                ...
                List.of("- PoundSTAB Normal - Double-EdgeSTAB Normal - Growl Normal - Defense Curl Normal 5 Tail Whip Normal 9 Refresh Normal 12 Double SlapSTAB Normal 16 Soft-Boiled Normal 20 Bestow Normal 23 Minimize Normal 27 Take DownSTAB Normal 31 Sing Normal 34 Fling Dark 39 Heal Pulse Psychic 44 Egg BombSTAB Normal 50 Light Screen Psychic 57 Healing Wish Psychic 64 Double-EdgeSTAB Normal"),
                List.of(),
                List.of(
