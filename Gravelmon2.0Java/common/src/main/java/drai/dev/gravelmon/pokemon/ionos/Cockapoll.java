...
public class Cockapoll extends drai.dev.gravelmon.pokemon.Pokemon {
    public Cockapoll() {
        super("Cockapoll",
                ...
                70,
                50, List.of(),
                List.of("cleffaapoll knows a lot about responsibility but rarely shows what it has been taught. Leading groups of goomyatoto during great berry heists, mudkipapoll is usually the worst of the bunch."),
                List.of(),
                List.of(
