...
public class PorygonZ extends drai.dev.gravelmon.pokemon.Pokemon {
    public PorygonZ(String name, Aspect aspect) {
        super(name, aspect, "PorygonZ",
                Type.NORMAL,
                new Stats(85,
                        80,
                        70,
                ...
                List.of("Its behavior is noticeably unstable, which is apparently due to the incompetence of the engineer who updated its programming."),
                List.of(),
                List.of(
