...
import java.util.*;
public class Paraboom extends drai.dev.gravelmon.pokemon.Pokemon {
    public Paraboom() {
        super("Paraboom",
                Type.ICE, Type.FAIRY,
                new Stats(100,
                ...
                List.of("Fligian Paraboom are far more zen than their Tandorian counterparts, and enjoy slower-paced tunes to relax to. They can create soundwaves that can lower the temperature of surrounding areas, making their music a literal means of chilling."),
                List.of(),
                List.of(
