...
public class Kitkin extends drai.dev.gravelmon.pokemon.Pokemon {
    public Kitkin() {
        super("Kitkin",
                Type.NORMAL,
                new Stats(45,
                ...
                List.of("- Astonish Ghost - Tail Whip Normal 5 ScratchSTAB Normal 8 Focus Energy Normal 14 Feint Attack Dark 19 Screech Normal 22 Fake OutSTAB Normal 26 SlashSTAB Normal 29 Shadow Claw Ghost 33 Will-O-Wisp Fire 36 Hone Claws Dark 40 Night Slash Dark"),
                List.of(),
                List.of(
