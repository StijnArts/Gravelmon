...
import drai.dev.gravelmon.pokemon.nodorro.Marment;
import drai.dev.gravelmon.pokemon.nodorro.Slifin;
import drai.dev.gravelmon.pokemon.nodorro.regional.*;
import drai.dev.gravelmon.pokemon.nodorro.*;

public class Nodorro extends drai.dev.gravelmon.games.registry.Game {
    public Nodorro() {
        super("Nodorro");
    }
...
//        pokemon.add(new Suncada());   Missing Stats
        ...
        pokemon.add(new Foongus(590));
        pokemon.add(new Amoonguss(591));
...
//        pokemon.add(new Graveler(75));   Missing Stats
...
//        pokemon.add(new Falpire());   Missing Art
        ...
        pokemon.add(new Buneary(427));
        pokemon.add(new Lopunny(428));
        pokemon.add(new Hoothoot(163));
        pokemon.add(new Noctowl(164));
        pokemon.add(new Hippopotas(449));
        pokemon.add(new Hippowdon(450));
        pokemon.add(new Cubchoo(613));
...
//        pokemon.add(new Ballevo());   Missing Art
        ...
        pokemon.add(new Ralts(280));
        pokemon.add(new Kirlia(281));
        pokemon.add(new Gardevoir(282));
        pokemon.add(new Gallade(475));
        pokemon.add(new Litwick(607));
        pokemon.add(new Lampent(608));
        pokemon.add(new Chandelure(609));
        pokemon.add(new Aron(304));
        pokemon.add(new Lairon(305));
        pokemon.add(new Aggron(306));
...
//        pokemon.add(new Sawsbuck(586));   Missing Art
        ...
        pokemon.add(new Zweilous(634));
        pokemon.add(new Hydreigon(635));
...
//        pokemon.add(new Sceptile(254));   Missing Art
        pokemon.add(new Oshawott(501));
        pokemon.add(new Dewott(502));
        pokemon.add(new Samurott(503));
        pokemon.add(new Chimchar(390));
