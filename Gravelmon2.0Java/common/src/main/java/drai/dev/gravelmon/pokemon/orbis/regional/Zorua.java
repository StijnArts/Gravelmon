...
public class Zorua extends drai.dev.gravelmon.pokemon.Pokemon {
    public Zorua(String name, Aspect aspect) {
        super(name, aspect, "Zorua",
                Type.DARK,
                new Stats(40,
                        65,
                        40,
                ...
                List.of("To protect themselves from danger, they hide their true identities by transforming into people and Pokémon."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.IMPRISON,53),
