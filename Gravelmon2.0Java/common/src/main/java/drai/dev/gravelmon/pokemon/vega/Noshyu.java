...
public class Noshyu extends Pokemon {
    public Noshyu() {
        super( "Noshyu",
                Type.ICE, Type.DARK,
                new Stats(45	,49	,35,	70,	40,	51),
                List.of(Ability.FUR_COAT), Ability.SNOW_CLOAK,
                5, 93,
                new Stats(0,0,0,1,0,0), 190,
                0.5,
                81, ExperienceGroup.MEDIUM_FAST,
                70,
                50, List.of(EggGroup.FIELD),
                List.of(""),
                List.of(new EvolutionEntry("snofa", EvolutionType.LEVEL_UP, List.of(),
