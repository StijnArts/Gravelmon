...
import java.util.*;
public class Raticate extends drai.dev.gravelmon.pokemon.Pokemon {
    public Raticate(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Raticate",
                Type.NORMAL,
                new Stats(55,
                        81,
                        60,
                ...
                List.of("Its whiskers are essential for maintaining its balance. No matter how friendly you are, it will get angry and bite you if you touch its whiskers."),
                List.of(),
                List.of(
