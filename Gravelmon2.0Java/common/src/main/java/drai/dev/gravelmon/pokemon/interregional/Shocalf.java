...
public class Shocalf extends drai.dev.gravelmon.pokemon.Pokemon {
    public Shocalf() {
        super("Shocalf",
                Type.ELECTRIC,
                new Stats(0,
                ...
                50, List.of(),
                List.of(""),
                List.of(new EvolutionEntry("voltuff", EvolutionType.LEVEL_UP, List.of(),
