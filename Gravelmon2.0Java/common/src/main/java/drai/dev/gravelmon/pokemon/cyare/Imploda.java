...
import java.util.*;
public class Imploda extends drai.dev.gravelmon.pokemon.Pokemon {
    public Imploda() {
        super("Imploda",
                Type.FIRE,
                new Stats(120,
                ...
                List.of("Imploda produces large amounts of methane, which cause it to balloon. Any spark can cause it to detonate."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.SMOKEBOMB,52),
