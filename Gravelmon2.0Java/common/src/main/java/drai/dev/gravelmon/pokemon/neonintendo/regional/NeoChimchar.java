...
public class NeoChimchar extends drai.dev.gravelmon.pokemon.Pokemon {
    public NeoChimchar(int dex) {
        super(dex, "Chimchar",
                ...
                List.of("A small group was first discovered bathing in natural hot springs in the mountains. They tend to have a very relaxed attitude at all times."),
                List.of(),
                List.of(
