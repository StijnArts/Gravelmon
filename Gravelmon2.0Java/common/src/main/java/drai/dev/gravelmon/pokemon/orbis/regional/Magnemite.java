...
public class Magnemite extends drai.dev.gravelmon.pokemon.Pokemon {
    public Magnemite(String name, Aspect aspect) {
        super(name, aspect, "Magnemite",
                ...
                List.of("Magnemite attaches itself to power lines to feed on electricity. If your house has a power outage, check your circuit breakers. You may find a large number of this Pokémon clinging to the breaker box."),
                List.of(),
                List.of(
