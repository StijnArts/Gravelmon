...
public class Leafeon extends drai.dev.gravelmon.pokemon.Pokemon {
    public Leafeon(String name, Aspect aspect) {
        super(name, aspect, "Leafeon",
                Type.GRASS,
                new Stats(65,
                        110,
                        130,
                ...
                List.of("Galarians favor the distinctive aroma that drifts from this Pokémon's leaves. There's a popular perfume made using that scent."),
                List.of(),
                List.of(
