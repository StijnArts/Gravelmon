...
public class Golduck extends drai.dev.gravelmon.pokemon.Pokemon {
    public Golduck(String originalMon, Aspect aspect) {
        super(originalMon, aspect, "Golduck",
                Type.WATER,
                new Stats(80,
                        82,
                        78,
                ...
                List.of("It swims along the banks of lakes and catches fish Pokémon. It takes them to the shore and quietly eats them up."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.WONDER_ROOM,51),
