...
public class Honchkrow extends drai.dev.gravelmon.pokemon.Pokemon {
    public Honchkrow(String name, Aspect aspect) {
        super(name, aspect, "Honchkrow",
                ...
                new Stats(100,
                        ...
                        52,
                        71),
                List.of(Ability.INSOMNIA,Ability.SUPER_LUCK), Ability.MOXIE,
                9, 273,
                ...
                List.of("If its Murkrow cronies fail to catch food for it, or if it feels they have betrayed it, it will hunt them down wherever they are and punish them."),
                List.of(),
                List.of(
                        ...
                        new MoveLearnSetEntry(Move.COMEUPPANCE,65),
