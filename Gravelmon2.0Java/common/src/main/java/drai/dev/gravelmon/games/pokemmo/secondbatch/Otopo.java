...
import java.util.*;
public class Otopo extends drai.dev.gravelmon.games.registry.Game {
    public Otopo() {
        super("Otopo");
    }
...
//        pokemon.add(new Gnawzzle());   Missing Stats
//        pokemon.add(new Maniscourge());   Missing Stats
...
//        pokemon.add(new Boliath());   Missing Stats
        pokemon.add(new Watter());
//        pokemon.add(new Marinott());   Missing Stats
...
//        pokemon.add(new Maraudair());   Missing Stats
...
//        pokemon.add(new Platypulse());   Missing Stats
        pokemon.add(new Surisand());
//        pokemon.add(new Surislash());   Missing Stats
        pokemon.add(new Zappinch());
        pokemon.add(new Parrocity());
//        pokemon.add(new Peaby());   Missing Stats
        pokemon.add(new Papea());
//        pokemon.add(new Tabuki());   Missing Stats
        pokemon.add(new Halseaon());
        pokemon.add(new Ventilio());
        pokemon.add(new Katanicut());
        pokemon.add(new Fibraark());
//        pokemon.add(new Snarligatr());   Missing Stats
//        pokemon.add(new Ferocidile());   Missing Stats
        pokemon.add(new Gorbler());
//        pokemon.add(new Gaiaminth());   Missing Stats
        pokemon.add(new Costanut());
//        pokemon.add(new Decareca());   Missing Stats
        pokemon.add(new Akakeru());
        pokemon.add(new Keruguru());
        pokemon.add(new Kerukeru());
//        pokemon.add(new Seevil());   Missing Stats
        pokemon.add(new Mimicnid());
        pokemon.add(new Tasmaniac());
        pokemon.add(new Toxipine());
//        pokemon.add(new Venetreme());   Missing Stats
        pokemon.add(new Ozzapi());
//        pokemon.add(new Oscillacone());   Missing Stats
//        pokemon.add(new Volswine());   Missing Stats
//        pokemon.add(new Blitzhogg());   Missing Stats
//        pokemon.add(new Scarug());   Missing Stats
//        pokemon.add(new Crypcoon());   Missing Stats
        pokemon.add(new Sarcofomoth());
//        pokemon.add(new Gubeluto());   Missing Stats
//        pokemon.add(new Barrenoose());   Missing Stats
//        pokemon.add(new Cubrosus());   Missing Stats
...
//        pokemon.add(new Folfaun());   Missing Stats
//        pokemon.add(new Elklore());   Missing Stats
//        pokemon.add(new Woodwoo());   Missing Stats
//        pokemon.add(new Forowl());   Missing Stats
