    ...
    public static void buildContents(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTab() == CobblemonItemGroups.getHELD_ITEMS()) {
            event.getEntries().put(GravelmonItems.LONG_CLUB.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().put(GravelmonItems.ICE_SHARD.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().put(GravelmonItems.PRETTY_RIBBON.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().put(GravelmonItems.MOSS_SHARD.get().asItem().getDefaultInstance(),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
